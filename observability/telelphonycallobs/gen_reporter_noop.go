...
func (r *noopCallReporter) ReportCalleeNumber(v string)                       {}
func (r *noopCallReporter) ReportCalleeHost(v string)                         {}
func (r *noopCallReporter) ReportCallerNumber(v string)                       {}
func (r *noopCallReporter) ReportCallerHost(v string)                         {}
...
func (r *noopCallReporter) ReportEncryption(v CallEncryption)                 {}
