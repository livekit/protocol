...
type RecordingResult struct {
	...
	// Types that are assignable to Output:
	//	*RecordingResult_File
	//	*RecordingResult_Rtmp
	Output isRecordingResult_Output `protobuf_oneof:"output"`
}
...
func (x *RecordingResult) GetRoomName() string {
	if x != nil {
		return x.RoomName
	}
	return ""
...
func (m *RecordingResult) GetOutput() isRecordingResult_Output {
	if m != nil {
		return m.Output
	}
	return nil
...
func (x *RecordingResult) GetFile() *FileResult {
	if x, ok := x.GetOutput().(*RecordingResult_File); ok {
		return x.File
	}
	return nil
}

func (x *RecordingResult) GetRtmp() *RtmpResult {
	if x, ok := x.GetOutput().(*RecordingResult_Rtmp); ok {
		return x.Rtmp
	}
	return nil
}

type isRecordingResult_Output interface {
	isRecordingResult_Output()
}

type RecordingResult_File struct {
	File *FileResult `protobuf:"bytes,4,opt,name=file,proto3,oneof"`
}

type RecordingResult_Rtmp struct {
	Rtmp *RtmpResult `protobuf:"bytes,5,opt,name=rtmp,proto3,oneof"`
}

func (*RecordingResult_File) isRecordingResult_Output() {}

func (*RecordingResult_Rtmp) isRecordingResult_Output() {}
...
var file_livekit_recording_proto_rawDesc = []byte{
	...
	0x99, 0x02, 0x0a, 0x10, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x4f, 0x70, 0x74,
	...
	0x69, 0x64, 0x65, 0x6f, 0x42, 0x69, 0x74, 0x72, 0x61, 0x74, 0x65, 0x22, 0x3b, 0x0a, 0x16, 0x53,
	...
	0x63, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x22, 0xb4, 0x01, 0x0a, 0x0f, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x0e, 0x0a,
	...
	0x52, 0x08, 0x72, 0x6f, 0x6f, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72,
	...
	0x75, 0x6c, 0x74, 0x48, 0x00, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x29, 0x0a, 0x04, 0x72,
	0x74, 0x6d, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x69, 0x76, 0x65,
	0x6b, 0x69, 0x74, 0x2e, 0x52, 0x74, 0x6d, 0x70, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x48, 0x00,
	0x52, 0x04, 0x72, 0x74, 0x6d, 0x70, 0x42, 0x08, 0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74,
...
var file_livekit_recording_proto_goTypes = []interface{}{
	...
	(*RecordingResult)(nil),        // 9: livekit.RecordingResult
...
var file_livekit_recording_proto_depIdxs = []int32{
	...
	10, // 4: livekit.RecordingResult.file:type_name -> livekit.FileResult
	11, // 5: livekit.RecordingResult.rtmp:type_name -> livekit.RtmpResult
...
func file_livekit_recording_proto_init() {
	...
	file_livekit_recording_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*RecordingResult_File)(nil),
		(*RecordingResult_Rtmp)(nil),
	}
	type x struct{}
