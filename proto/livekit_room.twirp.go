...
type RoomService interface {
	...
	UpdateRoomMetadata(context.Context, *SendDataRequest) (*SendDataResponse, error)
}
...
func (c *roomServiceProtobufClient) UpdateRoomMetadata(ctx context.Context, in *SendDataRequest) (*SendDataResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "livekit")
	ctx = ctxsetters.WithServiceName(ctx, "RoomService")
...
func (c *roomServiceProtobufClient) callUpdateRoomMetadata(ctx context.Context, in *SendDataRequest) (*SendDataResponse, error) {
	out := new(SendDataResponse)
...
func (c *roomServiceJSONClient) UpdateRoomMetadata(ctx context.Context, in *SendDataRequest) (*SendDataResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "livekit")
	ctx = ctxsetters.WithServiceName(ctx, "RoomService")
	ctx = ctxsetters.WithMethodName(ctx, "UpdateRoomMetadata")
	caller := c.callUpdateRoomMetadata
...
func (c *roomServiceJSONClient) callUpdateRoomMetadata(ctx context.Context, in *SendDataRequest) (*SendDataResponse, error) {
	out := new(SendDataResponse)
...
func (s *roomServiceServer) serveUpdateRoomMetadataJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *SendDataResponse and nil error while calling UpdateRoomMetadata. nil responses are not supported"))
		return
	}
...
var twirpFileDescriptor1 = []byte{
	...
	,
}
