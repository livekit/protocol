...
func (x *SignalResponse) GetQuality() *ConnectionQualityUpdate {
	if x, ok := x.GetMessage().(*SignalResponse_Quality); ok {
		return x.Quality
	}
	return nil
}
...
type SignalResponse_Quality struct {
	// when connection quality changed
	Quality *ConnectionQualityUpdate `protobuf:"bytes,12,opt,name=quality,proto3,oneof"`
}
...
func (*SignalResponse_Quality) isSignalResponse_Message() {}
...
func (x *ConnectionQualityUpdate) GetParticipantSid() string {
	if x != nil {
...
func (x *ConnectionQualityUpdate) GetQuality() ConnectionQuality {
	if x != nil {
		return x.Quality
	}
...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x88, 0x05, 0x0a, 0x0e, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70,
	...
	0x61, 0x74, 0x65, 0x12, 0x3c, 0x0a, 0x07, 0x71, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x0c,
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x48, 0x00, 0x52, 0x07, 0x71, 0x75, 0x61, 0x6c, 0x69, 0x74,
	0x79, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xf2, 0x01, 0x0a,
	...
	0x65, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x64, 0x74,
	0x78, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65,
	0x44, 0x74, 0x78, 0x12, 0x2c, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x08, 0x20,
	...
	0x65, 0x22, 0x65, 0x0a, 0x0e, 0x54, 0x72, 0x69, 0x63, 0x6b, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x69, 0x70, 0x61, 0x6e, 0x74, 0x73, 0x22, 0x51, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x22, 0xaf, 0x01, 0x0a, 0x13, 0x55, 0x70,
	...
	0x6f, 0x6f, 0x6d, 0x22, 0x78, 0x0a, 0x17, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x51, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x27,
	...
	0x6c, 0x69, 0x74, 0x79, 0x52, 0x07, 0x71, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x2a, 0x2d, 0x0a,
...
var file_livekit_rtc_proto_goTypes = []interface{}{
	...
	(*ConnectionQualityUpdate)(nil), // 17: livekit.ConnectionQualityUpdate
	...
	(ConnectionQuality)(0),          // 24: livekit.ConnectionQuality
}
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	17, // 18: livekit.SignalResponse.quality:type_name -> livekit.ConnectionQualityUpdate
	...
	20, // 22: livekit.JoinResponse.room:type_name -> livekit.Room
	21, // 23: livekit.JoinResponse.participant:type_name -> livekit.ParticipantInfo
	21, // 24: livekit.JoinResponse.other_participants:type_name -> livekit.ParticipantInfo
	14, // 25: livekit.JoinResponse.ice_servers:type_name -> livekit.ICEServer
	22, // 26: livekit.TrackPublishedResponse.track:type_name -> livekit.TrackInfo
	21, // 27: livekit.ParticipantUpdate.participants:type_name -> livekit.ParticipantInfo
	1,  // 28: livekit.UpdateTrackSettings.quality:type_name -> livekit.VideoQuality
	23, // 29: livekit.SpeakersChanged.speakers:type_name -> livekit.SpeakerInfo
	20, // 30: livekit.RoomUpdate.room:type_name -> livekit.Room
	24, // 31: livekit.ConnectionQualityUpdate.quality:type_name -> livekit.ConnectionQuality
