...
var livekit_rtc_pb_exports = {};
__export(livekit_rtc_pb_exports, {
...
module.exports = __toCommonJS(livekit_rtc_pb_exports);
...
import_protobuf.proto3.util.setEnumType(SignalTarget, "livekit.SignalTarget", [
  { no: 0, name: "PUBLISHER" },
...
import_protobuf.proto3.util.setEnumType(StreamState, "livekit.StreamState", [
  { no: 0, name: "ACTIVE" },
  { no: 1, name: "PAUSED" }
]);
...
import_protobuf.proto3.util.setEnumType(CandidateProtocol, "livekit.CandidateProtocol", [
  { no: 0, name: "UDP" },
  { no: 1, name: "TCP" },
  { no: 2, name: "TLS" }
]);
const _SignalRequest = class _SignalRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SignalRequest, a, b);
  }
};
_SignalRequest.runtime = import_protobuf.proto3;
_SignalRequest.typeName = "livekit.SignalRequest";
_SignalRequest.fields = import_protobuf.proto3.util.newFieldList(() => [
...
const _SignalResponse = class _SignalResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SignalResponse, a, b);
  }
};
_SignalResponse.runtime = import_protobuf.proto3;
_SignalResponse.typeName = "livekit.SignalResponse";
_SignalResponse.fields = import_protobuf.proto3.util.newFieldList(() => [
...
const _SimulcastCodec = class _SimulcastCodec extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SimulcastCodec, a, b);
  }
};
_SimulcastCodec.runtime = import_protobuf.proto3;
_SimulcastCodec.typeName = "livekit.SimulcastCodec";
_SimulcastCodec.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "codec",
    kind: "scalar",
...
const _AddTrackRequest = class _AddTrackRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.type = import_livekit_models_pb.TrackType.AUDIO;
    /**
     ...
     */
    this.source = import_livekit_models_pb.TrackSource.UNKNOWN;
    /**
     ...
     */
    this.encryption = import_livekit_models_pb.Encryption_Type.NONE;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_AddTrackRequest, a, b);
  }
};
_AddTrackRequest.runtime = import_protobuf.proto3;
_AddTrackRequest.typeName = "livekit.AddTrackRequest";
_AddTrackRequest.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "cid",
    kind: "scalar",
  ...
  { no: 3, name: "type", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.TrackType) },
  {
    no: 4,
    name: "width",
    kind: "scalar",
  ...
  { no: 8, name: "source", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.TrackSource) },
  { no: 9, name: "layers", kind: "message", T: import_livekit_models_pb.VideoLayer, repeated: true },
  ...
  { no: 14, name: "encryption", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.Encryption_Type) },
  {
    no: 15,
    name: "stream",
    kind: "scalar",
...
const _TrickleRequest = class _TrickleRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TrickleRequest, a, b);
  }
};
_TrickleRequest.runtime = import_protobuf.proto3;
_TrickleRequest.typeName = "livekit.TrickleRequest";
_TrickleRequest.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "candidateInit",
    kind: "scalar",
  ...
  { no: 2, name: "target", kind: "enum", T: import_protobuf.proto3.getEnumType(SignalTarget) },
  {
    no: 3,
    name: "final",
    kind: "scalar",
...
const _MuteTrackRequest = class _MuteTrackRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_MuteTrackRequest, a, b);
  }
};
_MuteTrackRequest.runtime = import_protobuf.proto3;
_MuteTrackRequest.typeName = "livekit.MuteTrackRequest";
_MuteTrackRequest.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "sid",
    kind: "scalar",
...
const _JoinResponse = class _JoinResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_JoinResponse, a, b);
  }
};
_JoinResponse.runtime = import_protobuf.proto3;
_JoinResponse.typeName = "livekit.JoinResponse";
_JoinResponse.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "room", kind: "message", T: import_livekit_models_pb.Room },
  { no: 2, name: "participant", kind: "message", T: import_livekit_models_pb.ParticipantInfo },
  { no: 3, name: "other_participants", kind: "message", T: import_livekit_models_pb.ParticipantInfo, repeated: true },
  {
    no: 4,
    name: "server_version",
    kind: "scalar",
  ...
  { no: 8, name: "client_configuration", kind: "message", T: import_livekit_models_pb.ClientConfiguration },
  {
    no: 9,
    name: "server_region",
    kind: "scalar",
  ...
  { no: 12, name: "server_info", kind: "message", T: import_livekit_models_pb.ServerInfo },
  {
    no: 13,
    name: "sif_trailer",
    kind: "scalar",
  ...
  { no: 14, name: "enabled_publish_codecs", kind: "message", T: import_livekit_models_pb.Codec, repeated: true },
  {
    no: 15,
    name: "fast_publish",
    kind: "scalar",
...
const _ReconnectResponse = class _ReconnectResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ReconnectResponse, a, b);
  }
};
_ReconnectResponse.runtime = import_protobuf.proto3;
_ReconnectResponse.typeName = "livekit.ReconnectResponse";
_ReconnectResponse.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "ice_servers", kind: "message", T: ICEServer, repeated: true },
  { no: 2, name: "client_configuration", kind: "message", T: import_livekit_models_pb.ClientConfiguration }
]);
let ReconnectResponse = _ReconnectResponse;
const _TrackPublishedResponse = class _TrackPublishedResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string cid = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TrackPublishedResponse, a, b);
  }
};
_TrackPublishedResponse.runtime = import_protobuf.proto3;
_TrackPublishedResponse.typeName = "livekit.TrackPublishedResponse";
_TrackPublishedResponse.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "cid",
    kind: "scalar",
  ...
  { no: 2, name: "track", kind: "message", T: import_livekit_models_pb.TrackInfo }
]);
let TrackPublishedResponse = _TrackPublishedResponse;
const _TrackUnpublishedResponse = class _TrackUnpublishedResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TrackUnpublishedResponse, a, b);
  }
};
_TrackUnpublishedResponse.runtime = import_protobuf.proto3;
_TrackUnpublishedResponse.typeName = "livekit.TrackUnpublishedResponse";
_TrackUnpublishedResponse.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "track_sid",
    kind: "scalar",
...
const _SessionDescription = class _SessionDescription extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SessionDescription, a, b);
  }
};
_SessionDescription.runtime = import_protobuf.proto3;
_SessionDescription.typeName = "livekit.SessionDescription";
_SessionDescription.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "type",
    kind: "scalar",
...
const _ParticipantUpdate = class _ParticipantUpdate extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ParticipantUpdate, a, b);
  }
};
_ParticipantUpdate.runtime = import_protobuf.proto3;
_ParticipantUpdate.typeName = "livekit.ParticipantUpdate";
_ParticipantUpdate.fields = import_protobuf.proto3.util.newFieldList(() => [
...
const _UpdateSubscription = class _UpdateSubscription extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UpdateSubscription, a, b);
  }
};
_UpdateSubscription.runtime = import_protobuf.proto3;
_UpdateSubscription.typeName = "livekit.UpdateSubscription";
_UpdateSubscription.fields = import_protobuf.proto3.util.newFieldList(() => [
  ...
  { no: 3, name: "participant_tracks", kind: "message", T: import_livekit_models_pb.ParticipantTracks, repeated: true }
]);
let UpdateSubscription = _UpdateSubscription;
const _UpdateTrackSettings = class _UpdateTrackSettings extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: repeated string track_sids = 1;
     ...
     */
    this.quality = import_livekit_models_pb.VideoQuality.LOW;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UpdateTrackSettings, a, b);
  }
};
_UpdateTrackSettings.runtime = import_protobuf.proto3;
_UpdateTrackSettings.typeName = "livekit.UpdateTrackSettings";
_UpdateTrackSettings.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "track_sids", kind: "scalar", T: 9, repeated: true },
  {
    no: 3,
    name: "disabled",
  ...
  { no: 4, name: "quality", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.VideoQuality) },
  {
    no: 5,
    name: "width",
    kind: "scalar",
...
const _UpdateLocalAudioTrack = class _UpdateLocalAudioTrack extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string track_sid = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UpdateLocalAudioTrack, a, b);
  }
};
_UpdateLocalAudioTrack.runtime = import_protobuf.proto3;
_UpdateLocalAudioTrack.typeName = "livekit.UpdateLocalAudioTrack";
_UpdateLocalAudioTrack.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "track_sid",
    kind: "scalar",
  ...
  { no: 2, name: "features", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.AudioTrackFeature), repeated: true }
]);
let UpdateLocalAudioTrack = _UpdateLocalAudioTrack;
const _UpdateLocalVideoTrack = class _UpdateLocalVideoTrack extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string track_sid = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UpdateLocalVideoTrack, a, b);
  }
};
_UpdateLocalVideoTrack.runtime = import_protobuf.proto3;
_UpdateLocalVideoTrack.typeName = "livekit.UpdateLocalVideoTrack";
_UpdateLocalVideoTrack.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "track_sid",
    kind: "scalar",
...
const _LeaveRequest = class _LeaveRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.reason = import_livekit_models_pb.DisconnectReason.UNKNOWN_REASON;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_LeaveRequest, a, b);
  }
};
_LeaveRequest.runtime = import_protobuf.proto3;
_LeaveRequest.typeName = "livekit.LeaveRequest";
_LeaveRequest.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "can_reconnect",
    kind: "scalar",
  ...
  { no: 2, name: "reason", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.DisconnectReason) },
  { no: 3, name: "action", kind: "enum", T: import_protobuf.proto3.getEnumType(LeaveRequest_Action) },
...
import_protobuf.proto3.util.setEnumType(LeaveRequest_Action, "livekit.LeaveRequest.Action", [
  { no: 0, name: "DISCONNECT" },
  { no: 1, name: "RESUME" },
  { no: 2, name: "RECONNECT" }
]);
const _UpdateVideoLayers = class _UpdateVideoLayers extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string track_sid = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UpdateVideoLayers, a, b);
  }
};
_UpdateVideoLayers.runtime = import_protobuf.proto3;
_UpdateVideoLayers.typeName = "livekit.UpdateVideoLayers";
_UpdateVideoLayers.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "track_sid",
    kind: "scalar",
  ...
  { no: 2, name: "layers", kind: "message", T: import_livekit_models_pb.VideoLayer, repeated: true }
]);
let UpdateVideoLayers = _UpdateVideoLayers;
const _UpdateParticipantMetadata = class _UpdateParticipantMetadata extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_UpdateParticipantMetadata, a, b);
  }
};
_UpdateParticipantMetadata.runtime = import_protobuf.proto3;
_UpdateParticipantMetadata.typeName = "livekit.UpdateParticipantMetadata";
_UpdateParticipantMetadata.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "metadata",
    kind: "scalar",
...
const _ICEServer = class _ICEServer extends import_protobuf.Message {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ICEServer, a, b);
  }
};
_ICEServer.runtime = import_protobuf.proto3;
_ICEServer.typeName = "livekit.ICEServer";
_ICEServer.fields = import_protobuf.proto3.util.newFieldList(() => [
...
const _SpeakersChanged = class _SpeakersChanged extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SpeakersChanged, a, b);
  }
};
_SpeakersChanged.runtime = import_protobuf.proto3;
_SpeakersChanged.typeName = "livekit.SpeakersChanged";
_SpeakersChanged.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "speakers", kind: "message", T: import_livekit_models_pb.SpeakerInfo, repeated: true }
]);
let SpeakersChanged = _SpeakersChanged;
const _RoomUpdate = class _RoomUpdate extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto3.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_RoomUpdate, a, b);
  }
};
_RoomUpdate.runtime = import_protobuf.proto3;
_RoomUpdate.typeName = "livekit.RoomUpdate";
_RoomUpdate.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "room", kind: "message", T: import_livekit_models_pb.Room }
]);
let RoomUpdate = _RoomUpdate;
const _ConnectionQualityInfo = class _ConnectionQualityInfo extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.quality = import_livekit_models_pb.ConnectionQuality.POOR;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ConnectionQualityInfo, a, b);
  }
};
_ConnectionQualityInfo.runtime = import_protobuf.proto3;
_ConnectionQualityInfo.typeName = "livekit.ConnectionQualityInfo";
_ConnectionQualityInfo.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
  ...
  { no: 2, name: "quality", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.ConnectionQuality) },
  {
    no: 3,
    name: "score",
    kind: "scalar",
...
const _ConnectionQualityUpdate = class _ConnectionQualityUpdate extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_ConnectionQualityUpdate, a, b);
  }
};
_ConnectionQualityUpdate.runtime = import_protobuf.proto3;
_ConnectionQualityUpdate.typeName = "livekit.ConnectionQualityUpdate";
_ConnectionQualityUpdate.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "updates", kind: "message", T: ConnectionQualityInfo, repeated: true }
]);
let ConnectionQualityUpdate = _ConnectionQualityUpdate;
const _StreamStateInfo = class _StreamStateInfo extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string participant_sid = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_StreamStateInfo, a, b);
  }
};
_StreamStateInfo.runtime = import_protobuf.proto3;
_StreamStateInfo.typeName = "livekit.StreamStateInfo";
_StreamStateInfo.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "participant_sid",
    kind: "scalar",
  ...
  { no: 3, name: "state", kind: "enum", T: import_protobuf.proto3.getEnumType(StreamState) }
]);
let StreamStateInfo = _StreamStateInfo;
const _StreamStateUpdate = class _StreamStateUpdate extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_StreamStateUpdate, a, b);
  }
};
_StreamStateUpdate.runtime = import_protobuf.proto3;
_StreamStateUpdate.typeName = "livekit.StreamStateUpdate";
_StreamStateUpdate.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "stream_states", kind: "message", T: StreamStateInfo, repeated: true }
]);
let StreamStateUpdate = _StreamStateUpdate;
const _SubscribedQuality = class _SubscribedQuality extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SubscribedQuality, a, b);
  }
};
_SubscribedQuality.runtime = import_protobuf.proto3;
_SubscribedQuality.typeName = "livekit.SubscribedQuality";
_SubscribedQuality.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "quality", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.VideoQuality) },
  {
    no: 2,
    name: "enabled",
    kind: "scalar",
...
const _SubscribedCodec = class _SubscribedCodec extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string codec = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SubscribedCodec, a, b);
  }
};
_SubscribedCodec.runtime = import_protobuf.proto3;
_SubscribedCodec.typeName = "livekit.SubscribedCodec";
_SubscribedCodec.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "codec",
    kind: "scalar",
...
const _SubscribedQualityUpdate = class _SubscribedQualityUpdate extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string track_sid = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SubscribedQualityUpdate, a, b);
  }
};
_SubscribedQualityUpdate.runtime = import_protobuf.proto3;
_SubscribedQualityUpdate.typeName = "livekit.SubscribedQualityUpdate";
_SubscribedQualityUpdate.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "track_sid",
    kind: "scalar",
...
const _TrackPermission = class _TrackPermission extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TrackPermission, a, b);
  }
};
_TrackPermission.runtime = import_protobuf.proto3;
_TrackPermission.typeName = "livekit.TrackPermission";
_TrackPermission.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "participant_sid",
    kind: "scalar",
...
const _SubscriptionPermission = class _SubscriptionPermission extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SubscriptionPermission, a, b);
  }
};
_SubscriptionPermission.runtime = import_protobuf.proto3;
_SubscriptionPermission.typeName = "livekit.SubscriptionPermission";
_SubscriptionPermission.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
...
const _SubscriptionPermissionUpdate = class _SubscriptionPermissionUpdate extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string participant_sid = 1;
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SubscriptionPermissionUpdate, a, b);
  }
};
_SubscriptionPermissionUpdate.runtime = import_protobuf.proto3;
_SubscriptionPermissionUpdate.typeName = "livekit.SubscriptionPermissionUpdate";
_SubscriptionPermissionUpdate.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "participant_sid",
    kind: "scalar",
...
const _SyncState = class _SyncState extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SyncState, a, b);
  }
};
_SyncState.runtime = import_protobuf.proto3;
_SyncState.typeName = "livekit.SyncState";
_SyncState.fields = import_protobuf.proto3.util.newFieldList(() => [
...
const _DataChannelInfo = class _DataChannelInfo extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_DataChannelInfo, a, b);
  }
};
_DataChannelInfo.runtime = import_protobuf.proto3;
_DataChannelInfo.typeName = "livekit.DataChannelInfo";
_DataChannelInfo.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "label",
    kind: "scalar",
  ...
  { no: 3, name: "target", kind: "enum", T: import_protobuf.proto3.getEnumType(SignalTarget) }
]);
let DataChannelInfo = _DataChannelInfo;
const _SimulateScenario = class _SimulateScenario extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SimulateScenario, a, b);
  }
};
_SimulateScenario.runtime = import_protobuf.proto3;
_SimulateScenario.typeName = "livekit.SimulateScenario";
_SimulateScenario.fields = import_protobuf.proto3.util.newFieldList(() => [
  ...
  { no: 5, name: "switch_candidate_protocol", kind: "enum", T: import_protobuf.proto3.getEnumType(CandidateProtocol), oneof: "scenario" },
...
const _Ping = class _Ping extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.rtt = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Ping, a, b);
  }
};
_Ping.runtime = import_protobuf.proto3;
_Ping.typeName = "livekit.Ping";
_Ping.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "timestamp",
    kind: "scalar",
...
let Ping = _Ping;
const _Pong = class _Pong extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.lastPingTimestamp = import_protobuf.protoInt64.zero;
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_Pong, a, b);
  }
};
_Pong.runtime = import_protobuf.proto3;
_Pong.typeName = "livekit.Pong";
_Pong.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
...
let Pong = _Pong;
const _RegionSettings = class _RegionSettings extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_RegionSettings, a, b);
  }
};
_RegionSettings.runtime = import_protobuf.proto3;
_RegionSettings.typeName = "livekit.RegionSettings";
_RegionSettings.fields = import_protobuf.proto3.util.newFieldList(() => [
  { no: 1, name: "regions", kind: "message", T: RegionInfo, repeated: true }
]);
let RegionSettings = _RegionSettings;
const _RegionInfo = class _RegionInfo extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.distance = import_protobuf.protoInt64.zero;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_RegionInfo, a, b);
  }
};
_RegionInfo.runtime = import_protobuf.proto3;
_RegionInfo.typeName = "livekit.RegionInfo";
_RegionInfo.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "region",
    kind: "scalar",
...
const _SubscriptionResponse = class _SubscriptionResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string track_sid = 1;
     ...
     */
    this.err = import_livekit_models_pb.SubscriptionError.SE_UNKNOWN;
    import_protobuf.proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_SubscriptionResponse, a, b);
  }
};
_SubscriptionResponse.runtime = import_protobuf.proto3;
_SubscriptionResponse.typeName = "livekit.SubscriptionResponse";
_SubscriptionResponse.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "track_sid",
    kind: "scalar",
  ...
  { no: 2, name: "err", kind: "enum", T: import_protobuf.proto3.getEnumType(import_livekit_models_pb.SubscriptionError) }
]);
let SubscriptionResponse = _SubscriptionResponse;
const _RequestResponse = class _RequestResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_RequestResponse, a, b);
  }
};
_RequestResponse.runtime = import_protobuf.proto3;
_RequestResponse.typeName = "livekit.RequestResponse";
_RequestResponse.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "request_id",
    kind: "scalar",
  ...
  { no: 2, name: "reason", kind: "enum", T: import_protobuf.proto3.getEnumType(RequestResponse_Reason) },
  {
    no: 3,
    name: "message",
    kind: "scalar",
...
import_protobuf.proto3.util.setEnumType(RequestResponse_Reason, "livekit.RequestResponse.Reason", [
  { no: 0, name: "OK" },
  { no: 1, name: "NOT_FOUND" },
...
const _TrackSubscribed = class _TrackSubscribed extends import_protobuf.Message {
  ...
  static equals(a, b) {
    return import_protobuf.proto3.util.equals(_TrackSubscribed, a, b);
  }
};
_TrackSubscribed.runtime = import_protobuf.proto3;
_TrackSubscribed.typeName = "livekit.TrackSubscribed";
_TrackSubscribed.fields = import_protobuf.proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "track_sid",
    kind: "scalar",
...
//# sourceMappingURL=livekit_rtc_pb.cjs.map