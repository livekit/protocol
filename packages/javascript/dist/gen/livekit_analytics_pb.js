...
const _AnalyticsVideoLayer = class _AnalyticsVideoLayer extends Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsVideoLayer, a, b);
  }
};
_AnalyticsVideoLayer.runtime = proto3;
_AnalyticsVideoLayer.typeName = "livekit.AnalyticsVideoLayer";
_AnalyticsVideoLayer.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "layer",
    kind: "scalar",
...
const _AnalyticsStream = class _AnalyticsStream extends Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.primaryBytes = protoInt64.zero;
    /**
     ...
     */
    this.retransmitBytes = protoInt64.zero;
    /**
     ...
     */
    this.paddingBytes = protoInt64.zero;
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsStream, a, b);
  }
};
_AnalyticsStream.runtime = proto3;
_AnalyticsStream.typeName = "livekit.AnalyticsStream";
_AnalyticsStream.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "ssrc",
    kind: "scalar",
...
const _AnalyticsStat = class _AnalyticsStat extends Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsStat, a, b);
  }
};
_AnalyticsStat.runtime = proto3;
_AnalyticsStat.typeName = "livekit.AnalyticsStat";
_AnalyticsStat.fields = proto3.util.newFieldList(() => [
  {
    no: 14,
    name: "id",
    kind: "scalar",
...
const _AnalyticsStats = class _AnalyticsStats extends Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsStats, a, b);
  }
};
_AnalyticsStats.runtime = proto3;
_AnalyticsStats.typeName = "livekit.AnalyticsStats";
_AnalyticsStats.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "stats", kind: "message", T: AnalyticsStat, repeated: true }
]);
let AnalyticsStats = _AnalyticsStats;
const _AnalyticsClientMeta = class _AnalyticsClientMeta extends Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsClientMeta, a, b);
  }
};
_AnalyticsClientMeta.runtime = proto3;
_AnalyticsClientMeta.typeName = "livekit.AnalyticsClientMeta";
_AnalyticsClientMeta.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "region",
    kind: "scalar",
...
const _AnalyticsEvent = class _AnalyticsEvent extends Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.maxSubscribedVideoQuality = VideoQuality.LOW;
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsEvent, a, b);
  }
};
_AnalyticsEvent.runtime = proto3;
_AnalyticsEvent.typeName = "livekit.AnalyticsEvent";
_AnalyticsEvent.fields = proto3.util.newFieldList(() => [
  {
    no: 25,
    name: "id",
    kind: "scalar",
...
const _AnalyticsEvents = class _AnalyticsEvents extends Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsEvents, a, b);
  }
};
_AnalyticsEvents.runtime = proto3;
_AnalyticsEvents.typeName = "livekit.AnalyticsEvents";
_AnalyticsEvents.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "events", kind: "message", T: AnalyticsEvent, repeated: true }
]);
let AnalyticsEvents = _AnalyticsEvents;
const _AnalyticsRoomParticipant = class _AnalyticsRoomParticipant extends Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsRoomParticipant, a, b);
  }
};
_AnalyticsRoomParticipant.runtime = proto3;
_AnalyticsRoomParticipant.typeName = "livekit.AnalyticsRoomParticipant";
_AnalyticsRoomParticipant.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "id",
    kind: "scalar",
...
const _AnalyticsRoom = class _AnalyticsRoom extends Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string id = 1;
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsRoom, a, b);
  }
};
_AnalyticsRoom.runtime = proto3;
_AnalyticsRoom.typeName = "livekit.AnalyticsRoom";
_AnalyticsRoom.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "id",
    kind: "scalar",
...
const _AnalyticsNodeRooms = class _AnalyticsNodeRooms extends Message {
  constructor(data) {
    super();
    /**
     ...
     */
    this.sequenceNumber = protoInt64.zero;
    /**
  ...
  static equals(a, b) {
    return proto3.util.equals(_AnalyticsNodeRooms, a, b);
  }
};
_AnalyticsNodeRooms.runtime = proto3;
_AnalyticsNodeRooms.typeName = "livekit.AnalyticsNodeRooms";
_AnalyticsNodeRooms.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "node_id",
    kind: "scalar",
...
//# sourceMappingURL=livekit_analytics_pb.js.map