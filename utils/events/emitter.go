...
func (o *blockingObserver[V]) emit(v V) { //lint:ignore U1000 implements Observer interface
	select {
	case o.ch <- v:
	case <-o.done:
	}
...
func (o nonblockingCallback[V]) emit(v V) { //lint:ignore U1000 implements Observer interface
	go o(v)
}
...
func (o blockingCallback[V]) emit(v V) { //lint:ignore U1000 implements Observer interface
	o(v)
}
