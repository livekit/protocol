...
type RoomEgress struct {
	...
	Tracks *AllTrackEgress             `protobuf:"bytes,2,opt,name=tracks,proto3" json:"tracks,omitempty"`
}
...
func (x *RoomEgress) GetTracks() *AllTrackEgress {
	if x != nil {
		return x.Tracks
	}
	return nil
...
type AllTrackEgress struct {
	...
	//	*AllTrackEgress_S3
	//	*AllTrackEgress_Gcp
	//	*AllTrackEgress_Azure
	Output isAllTrackEgress_Output `protobuf_oneof:"output"`
}

func (x *AllTrackEgress) Reset() {
	*x = AllTrackEgress{}
	if protoimpl.UnsafeEnabled {
...
func (x *AllTrackEgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AllTrackEgress) ProtoMessage() {}

func (x *AllTrackEgress) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_room_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AllTrackEgress.ProtoReflect.Descriptor instead.
func (*AllTrackEgress) Descriptor() ([]byte, []int) {
	return file_livekit_room_proto_rawDescGZIP(), []int{2}
}

func (x *AllTrackEgress) GetFilePrefix() string {
	if x != nil {
		return x.FilePrefix
	}
	return ""
...
func (m *AllTrackEgress) GetOutput() isAllTrackEgress_Output {
	if m != nil {
		return m.Output
	}
	return nil
...
func (x *AllTrackEgress) GetS3() *S3Upload {
	if x, ok := x.GetOutput().(*AllTrackEgress_S3); ok {
		return x.S3
	}
	return nil
}

func (x *AllTrackEgress) GetGcp() *GCPUpload {
	if x, ok := x.GetOutput().(*AllTrackEgress_Gcp); ok {
		return x.Gcp
	}
	return nil
}

func (x *AllTrackEgress) GetAzure() *AzureBlobUpload {
	if x, ok := x.GetOutput().(*AllTrackEgress_Azure); ok {
		return x.Azure
	}
	return nil
}

type isAllTrackEgress_Output interface {
	isAllTrackEgress_Output()
}

type AllTrackEgress_S3 struct {
	S3 *S3Upload `protobuf:"bytes,2,opt,name=s3,proto3,oneof"`
}

type AllTrackEgress_Gcp struct {
	Gcp *GCPUpload `protobuf:"bytes,3,opt,name=gcp,proto3,oneof"`
}

type AllTrackEgress_Azure struct {
	Azure *AzureBlobUpload `protobuf:"bytes,4,opt,name=azure,proto3,oneof"`
}

func (*AllTrackEgress_S3) isAllTrackEgress_Output() {}

func (*AllTrackEgress_Gcp) isAllTrackEgress_Output() {}

func (*AllTrackEgress_Azure) isAllTrackEgress_Output() {}
...
var file_livekit_room_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x65, 0x73, 0x73, 0x22, 0x76, 0x0a, 0x0a, 0x52, 0x6f, 0x6f, 0x6d, 0x45, 0x67, 0x72,
	...
	,
	...
	0x42, 0x08, 0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x28, 0x0a, 0x10, 0x4c, 0x69,
	...
	0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x22, 0xa6, 0x01, 0x0a,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xd4, 0x01, 0x0a, 0x1a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x22, 0x1d, 0x0a, 0x1b,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x92, 0x01, 0x0a, 0x0f,
	...
	0x6f, 0x6f, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x2c, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e,
	0x44, 0x61, 0x74, 0x61, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x4b, 0x69, 0x6e, 0x64, 0x52,
	0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x4b, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x6f,
	...
	0x61, 0x32, 0xe6, 0x06, 0x0a, 0x0b, 0x52, 0x6f, 0x6f, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x72, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x50, 0x0a, 0x11,
	...
	0x65, 0x12, 0x47, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x22, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	0x74, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x6c, 0x69,
	0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x42, 0x46, 0x5a, 0x23, 0x67, 0x69,
...
var file_livekit_room_proto_goTypes = []interface{}{
	...
	(*AllTrackEgress)(nil),              // 2: livekit.AllTrackEgress
	...
	(*S3Upload)(nil),                    // 20: livekit.S3Upload
	(*GCPUpload)(nil),                   // 21: livekit.GCPUpload
	(*AzureBlobUpload)(nil),             // 22: livekit.AzureBlobUpload
...
var file_livekit_room_proto_depIdxs = []int32{
	...
	2,  // 2: livekit.RoomEgress.tracks:type_name -> livekit.AllTrackEgress
	20, // 3: livekit.AllTrackEgress.s3:type_name -> livekit.S3Upload
	21, // 4: livekit.AllTrackEgress.gcp:type_name -> livekit.GCPUpload
	22, // 5: livekit.AllTrackEgress.azure:type_name -> livekit.AzureBlobUpload
	...
	3,  // 13: livekit.RoomService.ListRooms:input_type -> livekit.ListRoomsRequest
	5,  // 14: livekit.RoomService.DeleteRoom:input_type -> livekit.DeleteRoomRequest
	7,  // 15: livekit.RoomService.ListParticipants:input_type -> livekit.ListParticipantsRequest
	9,  // 16: livekit.RoomService.GetParticipant:input_type -> livekit.RoomParticipantIdentity
	9,  // 17: livekit.RoomService.RemoveParticipant:input_type -> livekit.RoomParticipantIdentity
	11, // 18: livekit.RoomService.MutePublishedTrack:input_type -> livekit.MuteRoomTrackRequest
	13, // 19: livekit.RoomService.UpdateParticipant:input_type -> livekit.UpdateParticipantRequest
	14, // 20: livekit.RoomService.UpdateSubscriptions:input_type -> livekit.UpdateSubscriptionsRequest
	16, // 21: livekit.RoomService.SendData:input_type -> livekit.SendDataRequest
	18, // 22: livekit.RoomService.UpdateRoomMetadata:input_type -> livekit.UpdateRoomMetadataRequest
	23, // 23: livekit.RoomService.CreateRoom:output_type -> livekit.Room
	4,  // 24: livekit.RoomService.ListRooms:output_type -> livekit.ListRoomsResponse
	6,  // 25: livekit.RoomService.DeleteRoom:output_type -> livekit.DeleteRoomResponse
	8,  // 26: livekit.RoomService.ListParticipants:output_type -> livekit.ListParticipantsResponse
	24, // 27: livekit.RoomService.GetParticipant:output_type -> livekit.ParticipantInfo
	10, // 28: livekit.RoomService.RemoveParticipant:output_type -> livekit.RemoveParticipantResponse
	12, // 29: livekit.RoomService.MutePublishedTrack:output_type -> livekit.MuteRoomTrackResponse
	24, // 30: livekit.RoomService.UpdateParticipant:output_type -> livekit.ParticipantInfo
	15, // 31: livekit.RoomService.UpdateSubscriptions:output_type -> livekit.UpdateSubscriptionsResponse
	17, // 32: livekit.RoomService.SendData:output_type -> livekit.SendDataResponse
...
func file_livekit_room_proto_init() {
	...
	file_livekit_room_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*AllTrackEgress_S3)(nil),
		(*AllTrackEgress_Gcp)(nil),
		(*AllTrackEgress_Azure)(nil),
	}
	type x struct{}
