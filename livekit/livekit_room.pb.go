...
const file_livekit_room_proto_rawDesc = "" +
	"\n" +
	"\x12livekit_room.proto\x12\alivekit\x1a\x14livekit_models.proto\x1a\x14livekit_egress.proto\x1a\x1clivekit_agent_dispatch.proto\x1a\x14logger/options.proto\"\xae\x04\n" +
	...
	"\bmetadata\x18\x05 \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\x12+\n" +
