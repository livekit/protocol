...
const file_livekit_connector_whatsapp_proto_rawDesc = "" +
	...
	"\x18whatsapp_to_phone_number\x18\x02 \x01(\tB\x03\xc0P\x01R\x15whatsappToPhoneNumber\x12-\n" +
	"\x10whatsapp_api_key\x18\x03 \x01(\tB\x03\xc0P\x02R\x0ewhatsappApiKey\x12;\n" +
	...
	"\x10participant_name\x18\b \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x0fparticipantName\x12W\n" +
	"\x14participant_metadata\x18\t \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x13participantMetadata\x12\x98\x01\n" +
	"\x16participant_attributes\x18\n" +
	" \x03(\v2;.livekit.DialWhatsAppCallRequest.ParticipantAttributesEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x15participantAttributes\x12/\n" +
	...
	"\x10whatsapp_api_key\x18\x02 \x01(\tB\x03\xc0P\x02R\x0ewhatsappApiKey\x12d\n" +
	...
	"\x18whatsapp_phone_number_id\x18\x01 \x01(\tB\x18\xbaP\x15whatsappPhoneNumberIDR\x15whatsappPhoneNumberId\x12-\n" +
	"\x10whatsapp_api_key\x18\x02 \x01(\tB\x03\xc0P\x02R\x0ewhatsappApiKey\x12;\n" +
	...
	"\x10participant_name\x18\t \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x0fparticipantName\x12W\n" +
	"\x14participant_metadata\x18\n" +
	" \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x13participantMetadata\x12\x9a\x01\n" +
	"\x16participant_attributes\x18\v \x03(\v2=.livekit.AcceptWhatsAppCallRequest.ParticipantAttributesEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x15participantAttributes\x12/\n" +
