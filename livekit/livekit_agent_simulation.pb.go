...
type SimulationRun struct {
	...
	// The deployed cloud agent version (the deploy tag shown by
	// `lk agent versions`) that served this run, as self-reported by the agent
	// participant's `lk.agent.version` attribute. Set only when every job in the
	// run reports the same version; unset when jobs disagree (a run that
	// straddles a deploy) or the agent did not report one.
	AgentVersion  *string `protobuf:"bytes,23,opt,name=agent_version,json=agentVersion,proto3,oneof" json:"agent_version,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SimulationRun) GetCi() *SimulationRun_CI {
	if x != nil {
		return x.Ci
	}
	return nil
...
func (x *SimulationRun) GetAgentVersion() string {
...
type SimulationRun_Job struct {
	...
	// The deployed cloud agent version that served this job, as self-reported
	// by the agent participant's `lk.agent.version` attribute. Unset when the
	// agent did not report one.
	AgentVersion  *string `protobuf:"bytes,15,opt,name=agent_version,json=agentVersion,proto3,oneof" json:"agent_version,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SimulationRun_Job) GetAgentVersion() string {
	if x != nil && x.AgentVersion != nil {
		return *x.AgentVersion
	}
	return ""
...
// The pipeline this run came from. Set by the client from its CI
// environment; absent for runs not started by a pipeline.
type SimulationRun_CI struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Provider      string                 `protobuf:"bytes,1,opt,name=provider,proto3" json:"provider,omitempty"` // e.g. "github_actions"
	CommitSha     string                 `protobuf:"bytes,2,opt,name=commit_sha,json=commitSha,proto3" json:"commit_sha,omitempty"`
	Ref           string                 `protobuf:"bytes,3,opt,name=ref,proto3" json:"ref,omitempty"` // branch or tag
	PullRequest   string                 `protobuf:"bytes,4,opt,name=pull_request,json=pullRequest,proto3" json:"pull_request,omitempty"`
	RunUrl        string                 `protobuf:"bytes,5,opt,name=run_url,json=runUrl,proto3" json:"run_url,omitempty"` // link back to the CI job
	Actor         string                 `protobuf:"bytes,6,opt,name=actor,proto3" json:"actor,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SimulationRun_CI) Reset() {
	*x = SimulationRun_CI{}
...
func (x *SimulationRun_CI) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimulationRun_CI) ProtoMessage() {}

func (x *SimulationRun_CI) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_agent_simulation_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SimulationRun_CI.ProtoReflect.Descriptor instead.
func (*SimulationRun_CI) Descriptor() ([]byte, []int) {
	return file_livekit_agent_simulation_proto_rawDescGZIP(), []int{1, 3}
}

func (x *SimulationRun_CI) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
func (x *SimulationRun_CI) GetCommitSha() string {
	if x != nil {
		return x.CommitSha
	}
	return ""
...
func (x *SimulationRun_CI) GetRef() string {
	if x != nil {
		return x.Ref
	}
	return ""
...
func (x *SimulationRun_CI) GetPullRequest() string {
	if x != nil {
...
func (x *SimulationRun_CI) GetRunUrl() string {
	if x != nil {
		return x.RunUrl
	}
	return ""
...
func (x *SimulationRun_CI) GetActor() string {
	if x != nil {
		return x.Actor
	}
	return ""
...
func (x *SimulationRun_Create_Request) GetCi() *SimulationRun_CI {
	if x != nil {
		return x.Ci
	}
	return nil
...
const file_livekit_agent_simulation_proto_rawDesc = "" +
	...
	"suggestion\x12\x14\n" +
	"\x05label\x18\x03 \x01(\tR\x05label\"\xb1M\n" +
	...
	"\ragent_version\x18\x17 \x01(\tH\x02R\fagentVersion\x88\x01\x01\x1a\x92\x06\n" +
	"\x03Job\x12\x0e\n" +
	...
	"\ametrics\x18\x0e \x01(\v2!.livekit.SimulationRun.JobMetricsR\ametrics\x12(\n" +
	"\ragent_version\x18\x0f \x01(\tH\x00R\fagentVersion\x88\x01\x01\x1a]\n" +
	"\x05Usage\x12(\n" +
	...
	"\x10STATUS_CANCELLED\x10\x04B\x10\n" +
	"\x0e_agent_versionJ\x04\b\t\x10\n" +
	"\x1a\xc1%\n" +
	"\n" +
	"JobMetrics\x12*\n" +
	...
	"\f_issue_countB\x05\n" +
	"\x03_ciB\x10\n" +
	"\x0e_agent_versionJ\x04\b\b\x10\tR\asummary\"\xa5\x03\n" +
	"\bScenario\x12\x14\n" +
...
func file_livekit_agent_simulation_proto_init() {
	...
	file_livekit_agent_simulation_proto_msgTypes[7].OneofWrappers = []any{}
