...
const file_livekit_agent_simulation_proto_rawDesc = "" +
	...
	"\asummary\x18\b \x01(\v2\x1d.livekit.SimulationRunSummaryR\asummary\x1a\xaa\x02\n" +
	"\x03Job\x12\x0e\n" +
	...
	"\x12agent_expectations\x18\x05 \x01(\tR\x11agentExpectations\"o\n" +
	"\x06Status\x12\x12\n" +
	...
	"\x10STATUS_CANCELLED\x10\x04\x1a\x80\x06\n" +
	"\x06Create\x1a\xec\x01\n" +
	"\bScenario\x12\"\n" +
	"\finstructions\x18\x01 \x01(\tR\finstructions\x12-\n" +
	"\x12agent_expectations\x18\x02 \x01(\tR\x11agentExpectations\x12P\n" +
	"\bmetadata\x18\x03 \x03(\v24.livekit.SimulationRun.Create.Scenario.MetadataEntryR\bmetadata\x1a;\n" +
