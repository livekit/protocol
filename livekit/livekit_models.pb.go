...
const file_livekit_models_proto_rawDesc = "" +
	...
	"joinedAtMs\x12:\n" +
	"\x04name\x18\t \x01(\tB&\x88\xb5\x18\x01\x92\xb5\x18\x1e<redacted ({{ .Size }} bytes)>R\x04name\x12\x18\n" +
	"\aversion\x18\n" +
	" \x01(\rR\aversion\x12>\n" +
	"\n" +
	...
	"\asdp_cid\x18\x06 \x01(\tR\x06sdpCid\"\x9e\x06\n" +
	"\tTrackInfo\x12\x10\n" +
	"\x03sid\x18\x01 \x01(\tR\x03sid\x12&\n" +
	"\x04type\x18\x02 \x01(\x0e2\x12.livekit.TrackTypeR\x04type\x12:\n" +
	"\x04name\x18\x03 \x01(\tB&\x88\xb5\x18\x01\x92\xb5\x18\x1e<redacted ({{ .Size }} bytes)>R\x04name\x12\x14\n" +
