...
type DataStream_TextHeader struct {
	...
	OperationType     DataStream_OperationType `protobuf:"varint,1,opt,name=operationType,proto3,enum=livekit.DataStream_OperationType" json:"operationType,omitempty"`
	Version           int32                    `protobuf:"varint,2,opt,name=version,proto3" json:"version,omitempty"`                // Optional: Version for updates/edits
	ReplyToStreamId   string                   `protobuf:"bytes,3,opt,name=replyToStreamId,proto3" json:"replyToStreamId,omitempty"` // Optional: Reply to specific message
	AttachedStreamIds []string                 `protobuf:"bytes,4,rep,name=attachedStreamIds,proto3" json:"attachedStreamIds,omitempty"`
...
type DataStream_Header struct {
	...
	StreamId       string            `protobuf:"bytes,1,opt,name=streamId,proto3" json:"streamId,omitempty"`    // unique identifier for this data stream
	...
	TotalLength    *uint64           `protobuf:"varint,5,opt,name=totalLength,proto3,oneof" json:"totalLength,omitempty"`                                                                                // only populated for finite streams, if it's a stream of unknown size this stays empty
	TotalChunks    *uint64           `protobuf:"varint,6,opt,name=totalChunks,proto3,oneof" json:"totalChunks,omitempty"`                                                                                // only populated for finite streams, if it's a stream of unknown size this stays empty
	EncryptionType Encryption_Type   `protobuf:"varint,7,opt,name=encryptionType,proto3,enum=livekit.Encryption_Type" json:"encryptionType,omitempty"`                                                   // defaults to NONE
...
type DataStream_Header_TextHeader struct {
	TextHeader *DataStream_TextHeader `protobuf:"bytes,9,opt,name=textHeader,proto3,oneof"`
}

type DataStream_Header_FileHeader struct {
	FileHeader *DataStream_FileHeader `protobuf:"bytes,10,opt,name=fileHeader,proto3,oneof"`
}
...
type DataStream_Chunk struct {
	...
	StreamId   string `protobuf:"bytes,1,opt,name=streamId,proto3" json:"streamId,omitempty"` // unique identifier for this data stream to map it to the correct header
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x69, 0x63, 0x6b, 0x73, 0x22, 0xc1, 0x08, 0x0a, 0x0a, 0x44, 0x61, 0x74, 0x61,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x1a, 0xe5, 0x01, 0x0a, 0x0a, 0x54, 0x65, 0x78, 0x74, 0x48,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x47, 0x0a, 0x0d, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x6c,
	...
	,
	...
	0x70, 0x69, 0x63, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x69, 0x6d, 0x65, 0x54, 0x79, 0x70, 0x65, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x69, 0x6d, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x25, 0x0a, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x04, 0x48, 0x01, 0x52, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x4c, 0x65, 0x6e,
	0x67, 0x74, 0x68, 0x88, 0x01, 0x01, 0x12, 0x25, 0x0a, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43,
	0x68, 0x75, 0x6e, 0x6b, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x48, 0x02, 0x52, 0x0b, 0x74,
	0x6f, 0x74, 0x61, 0x6c, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x88, 0x01, 0x01, 0x12, 0x40, 0x0a,
	...
	0x4a, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x08, 0x20,
	...
	0x0a, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x40, 0x0a, 0x0a, 0x74,
	0x65, 0x78, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x00, 0x52, 0x0a, 0x74, 0x65, 0x78, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x40, 0x0a,
	0x0a, 0x66, 0x69, 0x6c, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x44, 0x61, 0x74, 0x61,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x48, 0x00, 0x52, 0x0a, 0x66, 0x69, 0x6c, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x1a,
	...
	,
	...
	0x08, 0x52, 0x45, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x03, 0x2a, 0x2f, 0x0a, 0x0a, 0x41,
	...
	0x4c, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xac, 0x02, 0x0a, 0x10, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x6e,
	...
	0x45, 0x44, 0x10, 0x0a, 0x12, 0x14, 0x0a, 0x10, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x55, 0x4e, 0x41,
	0x56, 0x41, 0x49, 0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x0b, 0x12, 0x11, 0x0a, 0x0d, 0x55, 0x53,
	0x45, 0x52, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x0c, 0x12, 0x15, 0x0a,
	0x11, 0x53, 0x49, 0x50, 0x5f, 0x54, 0x52, 0x55, 0x4e, 0x4b, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x55,
	0x52, 0x45, 0x10, 0x0d, 0x2a, 0x89, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65,
...
var file_livekit_models_proto_depIdxs = []int32{
	...
	18, // 59: livekit.DataStream.TextHeader.operationType:type_name -> livekit.DataStream.OperationType
	14, // 60: livekit.DataStream.Header.encryptionType:type_name -> livekit.Encryption.Type
	60, // 61: livekit.DataStream.Header.extensions:type_name -> livekit.DataStream.Header.ExtensionsEntry
	56, // 62: livekit.DataStream.Header.textHeader:type_name -> livekit.DataStream.TextHeader
	57, // 63: livekit.DataStream.Header.fileHeader:type_name -> livekit.DataStream.FileHeader
