...
const (
	E2EEType_NONE   E2EEType = 0
	E2EEType_GCM    E2EEType = 1
	E2EEType_CUSTOM E2EEType = 2
)

// Enum value maps for E2EEType.
var (
	E2EEType_name = map[int32]string{
		0: "NONE",
		1: "GCM",
		2: "CUSTOM",
	}
	E2EEType_value = map[string]int32{
		"NONE":   0,
		"GCM":    1,
		"CUSTOM": 2,
	}
...
func (x E2EEType) Enum() *E2EEType {
	p := new(E2EEType)
	*p = x
	return p
}

func (x E2EEType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (E2EEType) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_models_proto_enumTypes[2].Descriptor()
}

func (E2EEType) Type() protoreflect.EnumType {
	return &file_livekit_models_proto_enumTypes[2]
}

func (x E2EEType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use E2EEType.Descriptor instead.
func (E2EEType) EnumDescriptor() ([]byte, []int) {
...
type TrackInfo struct {
	...
	E2Ee       E2EEType `protobuf:"varint,16,opt,name=e2ee,proto3,enum=livekit.E2EEType" json:"e2ee,omitempty"`
}
...
func (x *TrackInfo) GetE2Ee() E2EEType {
	if x != nil {
		return x.E2Ee
	}
	return E2EEType_NONE
}
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0xfb, 0x03, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x49,
	...
	0x52, 0x0a, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x64, 0x12, 0x25, 0x0a, 0x04,
	0x65, 0x32, 0x65, 0x65, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x6c, 0x69, 0x76,
	0x65, 0x6b, 0x69, 0x74, 0x2e, 0x45, 0x32, 0x45, 0x45, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x65,
	0x32, 0x65, 0x65, 0x22, 0x99, 0x01, 0x0a, 0x0a, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x61, 0x79,
	...
	0x52, 0x45, 0x5f, 0x41, 0x55, 0x44, 0x49, 0x4f, 0x10, 0x04, 0x2a, 0x29, 0x0a, 0x08, 0x45, 0x32,
	0x45, 0x45, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00,
	0x12, 0x07, 0x0a, 0x03, 0x47, 0x43, 0x4d, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x55, 0x53,
	0x54, 0x4f, 0x4d, 0x10, 0x02, 0x2a, 0x36, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x51, 0x75,
...
var file_livekit_models_proto_enumTypes = make([]protoimpl.EnumInfo, 11)
var file_livekit_models_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_livekit_models_proto_goTypes = []interface{}{
	(TrackType)(0),                // 0: livekit.TrackType
	(TrackSource)(0),              // 1: livekit.TrackSource
	(E2EEType)(0),                 // 2: livekit.E2EEType
	(VideoQuality)(0),             // 3: livekit.VideoQuality
	(ConnectionQuality)(0),        // 4: livekit.ConnectionQuality
	(ClientConfigSetting)(0),      // 5: livekit.ClientConfigSetting
	(DisconnectReason)(0),         // 6: livekit.DisconnectReason
	(ParticipantInfo_State)(0),    // 7: livekit.ParticipantInfo.State
	(DataPacket_Kind)(0),          // 8: livekit.DataPacket.Kind
	(ServerInfo_Edition)(0),       // 9: livekit.ServerInfo.Edition
	(ClientInfo_SDK)(0),           // 10: livekit.ClientInfo.SDK
	(*Room)(nil),                  // 11: livekit.Room
	(*Codec)(nil),                 // 12: livekit.Codec
	(*ParticipantPermission)(nil), // 13: livekit.ParticipantPermission
	(*ParticipantInfo)(nil),       // 14: livekit.ParticipantInfo
	(*SimulcastCodecInfo)(nil),    // 15: livekit.SimulcastCodecInfo
	(*TrackInfo)(nil),             // 16: livekit.TrackInfo
	(*VideoLayer)(nil),            // 17: livekit.VideoLayer
	(*DataPacket)(nil),            // 18: livekit.DataPacket
	(*ActiveSpeakerUpdate)(nil),   // 19: livekit.ActiveSpeakerUpdate
	(*SpeakerInfo)(nil),           // 20: livekit.SpeakerInfo
	(*UserPacket)(nil),            // 21: livekit.UserPacket
	...
	(*ClientConfiguration)(nil),   // 25: livekit.ClientConfiguration
	(*VideoConfiguration)(nil),    // 26: livekit.VideoConfiguration
	(*DisabledCodecs)(nil),        // 27: livekit.DisabledCodecs
	(*RTPStats)(nil),              // 28: livekit.RTPStats
	(*TimedVersion)(nil),          // 29: livekit.TimedVersion
	nil,                           // 30: livekit.RTPStats.GapHistogramEntry
	(*timestamppb.Timestamp)(nil), // 31: google.protobuf.Timestamp
}
var file_livekit_models_proto_depIdxs = []int32{
	12, // 0: livekit.Room.enabled_codecs:type_name -> livekit.Codec
	7,  // 1: livekit.ParticipantInfo.state:type_name -> livekit.ParticipantInfo.State
	16, // 2: livekit.ParticipantInfo.tracks:type_name -> livekit.TrackInfo
	13, // 3: livekit.ParticipantInfo.permission:type_name -> livekit.ParticipantPermission
	17, // 4: livekit.SimulcastCodecInfo.layers:type_name -> livekit.VideoLayer
	0,  // 5: livekit.TrackInfo.type:type_name -> livekit.TrackType
	1,  // 6: livekit.TrackInfo.source:type_name -> livekit.TrackSource
	17, // 7: livekit.TrackInfo.layers:type_name -> livekit.VideoLayer
	15, // 8: livekit.TrackInfo.codecs:type_name -> livekit.SimulcastCodecInfo
	2,  // 9: livekit.TrackInfo.e2ee:type_name -> livekit.E2EEType
	3,  // 10: livekit.VideoLayer.quality:type_name -> livekit.VideoQuality
	8,  // 11: livekit.DataPacket.kind:type_name -> livekit.DataPacket.Kind
	21, // 12: livekit.DataPacket.user:type_name -> livekit.UserPacket
	19, // 13: livekit.DataPacket.speaker:type_name -> livekit.ActiveSpeakerUpdate
	20, // 14: livekit.ActiveSpeakerUpdate.speakers:type_name -> livekit.SpeakerInfo
	9,  // 15: livekit.ServerInfo.edition:type_name -> livekit.ServerInfo.Edition
	10, // 16: livekit.ClientInfo.sdk:type_name -> livekit.ClientInfo.SDK
	26, // 17: livekit.ClientConfiguration.video:type_name -> livekit.VideoConfiguration
	26, // 18: livekit.ClientConfiguration.screen:type_name -> livekit.VideoConfiguration
	5,  // 19: livekit.ClientConfiguration.resume_connection:type_name -> livekit.ClientConfigSetting
	27, // 20: livekit.ClientConfiguration.disabled_codecs:type_name -> livekit.DisabledCodecs
	5,  // 21: livekit.ClientConfiguration.force_relay:type_name -> livekit.ClientConfigSetting
	5,  // 22: livekit.VideoConfiguration.hardware_encoder:type_name -> livekit.ClientConfigSetting
	12, // 23: livekit.DisabledCodecs.codecs:type_name -> livekit.Codec
	31, // 24: livekit.RTPStats.start_time:type_name -> google.protobuf.Timestamp
	31, // 25: livekit.RTPStats.end_time:type_name -> google.protobuf.Timestamp
	30, // 26: livekit.RTPStats.gap_histogram:type_name -> livekit.RTPStats.GapHistogramEntry
	31, // 27: livekit.RTPStats.last_pli:type_name -> google.protobuf.Timestamp
	31, // 28: livekit.RTPStats.last_fir:type_name -> google.protobuf.Timestamp
	31, // 29: livekit.RTPStats.last_key_frame:type_name -> google.protobuf.Timestamp
	31, // 30: livekit.RTPStats.last_layer_lock_pli:type_name -> google.protobuf.Timestamp
