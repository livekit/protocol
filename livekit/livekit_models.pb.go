...
type DataPacket struct {
	...
	//	*DataPacket_TimeSyncRequest
	//	*DataPacket_TimeSyncResponse
...
func (x *DataPacket) GetTimeSyncRequest() *TimeSyncRequest {
	if x, ok := x.GetValue().(*DataPacket_TimeSyncRequest); ok {
		return x.TimeSyncRequest
	}
	return nil
}

func (x *DataPacket) GetTimeSyncResponse() *TimeSyncResponse {
	if x, ok := x.GetValue().(*DataPacket_TimeSyncResponse); ok {
...
type DataPacket_TimeSyncRequest struct {
	TimeSyncRequest *TimeSyncRequest `protobuf:"bytes,8,opt,name=time_sync_request,json=timeSyncRequest,proto3,oneof"`
}

type DataPacket_TimeSyncResponse struct {
	TimeSyncResponse *TimeSyncResponse `protobuf:"bytes,9,opt,name=time_sync_response,json=timeSyncResponse,proto3,oneof"`
}
...
func (*DataPacket_TimeSyncRequest) isDataPacket_Value() {}

func (*DataPacket_TimeSyncResponse) isDataPacket_Value() {}
...
func (x *TimeSyncRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type TimeSyncResponse struct {
	...
	Id      string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	NtpTime uint64 `protobuf:"varint,2,opt,name=ntp_time,json=ntpTime,proto3" json:"ntp_time,omitempty"`
}
...
func (x *TimeSyncResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *TimeSyncResponse) GetNtpTime() uint64 {
	if x != nil {
		return x.NtpTime
	}
	return 0
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x28, 0x0d, 0x52, 0x04, 0x73, 0x73, 0x72, 0x63, 0x22, 0xbd, 0x04, 0x0a, 0x0a, 0x44, 0x61, 0x74,
	...
	,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x64, 0x69, 0x67, 0x69, 0x74, 0x22, 0xb4, 0x01,
	...
	0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x61, 0x6e, 0x67,
	0x75, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x61, 0x6e, 0x67,
	0x75, 0x61, 0x67, 0x65, 0x22, 0x8a, 0x01, 0x0a, 0x14, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x72,
	...
	0x6c, 0x22, 0x21, 0x0a, 0x0f, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x02, 0x69, 0x64, 0x22, 0x3d, 0x0a, 0x10, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x79, 0x6e, 0x63,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x6e, 0x74, 0x70, 0x5f,
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x6e, 0x74, 0x70, 0x54,
	0x69, 0x6d, 0x65, 0x22, 0x5b, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61,
	...
	0x6b, 0x52, 0x61, 0x74, 0x65, 0x22, 0xf6, 0x0e, 0x0a, 0x08, 0x52, 0x54, 0x50, 0x53, 0x74, 0x61,
	...
	0x66, 0x74, 0x12, 0x34, 0x0a, 0x0c, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x64, 0x72, 0x69,
	0x66, 0x74, 0x18, 0x2d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b,
	0x69, 0x74, 0x2e, 0x52, 0x54, 0x50, 0x44, 0x72, 0x69, 0x66, 0x74, 0x52, 0x0b, 0x72, 0x65, 0x70,
	...
	0x63, 0x6b, 0x73, 0x2a, 0x2f, 0x0a, 0x0a, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x43, 0x6f, 0x64, 0x65,
	...
	0x12, 0x0b, 0x0a, 0x07, 0x45, 0x4e, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xdb, 0x01,
	...
	0x4e, 0x41, 0x4c, 0x5f, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x10, 0x09, 0x2a, 0x89, 0x01, 0x0a, 0x0f,
...
var file_livekit_models_proto_goTypes = []interface{}{
	...
	(*TimeSyncRequest)(nil),       // 34: livekit.TimeSyncRequest
	(*TimeSyncResponse)(nil),      // 35: livekit.TimeSyncResponse
	(*ParticipantTracks)(nil),     // 36: livekit.ParticipantTracks
	(*ServerInfo)(nil),            // 37: livekit.ServerInfo
	(*ClientInfo)(nil),            // 38: livekit.ClientInfo
	(*ClientConfiguration)(nil),   // 39: livekit.ClientConfiguration
	(*VideoConfiguration)(nil),    // 40: livekit.VideoConfiguration
	(*DisabledCodecs)(nil),        // 41: livekit.DisabledCodecs
	(*RTPDrift)(nil),              // 42: livekit.RTPDrift
	(*RTPStats)(nil),              // 43: livekit.RTPStats
	(*TimedVersion)(nil),          // 44: livekit.TimedVersion
...
var file_livekit_models_proto_depIdxs = []int32{
	...
	44, // 1: livekit.Room.version:type_name -> livekit.TimedVersion
	...
	44, // 13: livekit.TrackInfo.version:type_name -> livekit.TimedVersion
	...
	34, // 21: livekit.DataPacket.time_sync_request:type_name -> livekit.TimeSyncRequest
	35, // 22: livekit.DataPacket.time_sync_response:type_name -> livekit.TimeSyncResponse
	...
	40, // 27: livekit.ClientConfiguration.video:type_name -> livekit.VideoConfiguration
	40, // 28: livekit.ClientConfiguration.screen:type_name -> livekit.VideoConfiguration
	7,  // 29: livekit.ClientConfiguration.resume_connection:type_name -> livekit.ClientConfigSetting
	41, // 30: livekit.ClientConfiguration.disabled_codecs:type_name -> livekit.DisabledCodecs
	...
	45, // 39: livekit.RTPStats.gap_histogram:type_name -> livekit.RTPStats.GapHistogramEntry
	...
	42, // 44: livekit.RTPStats.packet_drift:type_name -> livekit.RTPDrift
	42, // 45: livekit.RTPStats.report_drift:type_name -> livekit.RTPDrift
	42, // 46: livekit.RTPStats.rebased_report_drift:type_name -> livekit.RTPDrift
...
func file_livekit_models_proto_init() {
	...
	file_livekit_models_proto_msgTypes[9].OneofWrappers = []interface{}{
		...
		(*DataPacket_TimeSyncRequest)(nil),
		(*DataPacket_TimeSyncResponse)(nil),
	}
