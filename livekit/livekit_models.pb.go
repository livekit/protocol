...
type DataTrackFrameEncoding int32
...
var (
	DataTrackFrameEncoding_name = map[int32]string{
		0: "DATA_TRACK_FRAME_ENCODING_UNSPECIFIED",
		1: "DATA_TRACK_FRAME_ENCODING_ROS1",
		2: "DATA_TRACK_FRAME_ENCODING_CDR",
		3: "DATA_TRACK_FRAME_ENCODING_PROTOBUF",
		4: "DATA_TRACK_FRAME_ENCODING_FLATBUFFER",
		5: "DATA_TRACK_FRAME_ENCODING_CBOR",
		6: "DATA_TRACK_FRAME_ENCODING_MSGPACK",
		7: "DATA_TRACK_FRAME_ENCODING_JSON",
	}
	DataTrackFrameEncoding_value = map[string]int32{
		"DATA_TRACK_FRAME_ENCODING_UNSPECIFIED": 0,
		"DATA_TRACK_FRAME_ENCODING_ROS1":        1,
		"DATA_TRACK_FRAME_ENCODING_CDR":         2,
		"DATA_TRACK_FRAME_ENCODING_PROTOBUF":    3,
		"DATA_TRACK_FRAME_ENCODING_FLATBUFFER":  4,
		"DATA_TRACK_FRAME_ENCODING_CBOR":        5,
		"DATA_TRACK_FRAME_ENCODING_MSGPACK":     6,
		"DATA_TRACK_FRAME_ENCODING_JSON":        7,
	}
)

func (x DataTrackFrameEncoding) Enum() *DataTrackFrameEncoding {
	p := new(DataTrackFrameEncoding)
	*p = x
	return p
}
...
func (DataTrackFrameEncoding) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_models_proto_enumTypes[6].Descriptor()
}

func (DataTrackFrameEncoding) Type() protoreflect.EnumType {
	return &file_livekit_models_proto_enumTypes[6]
}

func (x DataTrackFrameEncoding) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DataTrackFrameEncoding.Descriptor instead.
func (DataTrackFrameEncoding) EnumDescriptor() ([]byte, []int) {
...
type DataTrackSchemaEncoding int32
...
// Enum value maps for DataTrackSchemaEncoding.
var (
	DataTrackSchemaEncoding_name = map[int32]string{
		0: "DATA_TRACK_SCHEMA_ENCODING_UNSPECIFIED",
		1: "DATA_TRACK_SCHEMA_ENCODING_PROTOBUF",
		2: "DATA_TRACK_SCHEMA_ENCODING_FLATBUFFER",
		3: "DATA_TRACK_SCHEMA_ENCODING_ROS1_MSG",
		4: "DATA_TRACK_SCHEMA_ENCODING_ROS2_MSG",
		5: "DATA_TRACK_SCHEMA_ENCODING_ROS2_IDL",
		6: "DATA_TRACK_SCHEMA_ENCODING_OMG_IDL",
		7: "DATA_TRACK_SCHEMA_ENCODING_JSON_SCHEMA",
	}
	DataTrackSchemaEncoding_value = map[string]int32{
		"DATA_TRACK_SCHEMA_ENCODING_UNSPECIFIED": 0,
		"DATA_TRACK_SCHEMA_ENCODING_PROTOBUF":    1,
		"DATA_TRACK_SCHEMA_ENCODING_FLATBUFFER":  2,
		"DATA_TRACK_SCHEMA_ENCODING_ROS1_MSG":    3,
		"DATA_TRACK_SCHEMA_ENCODING_ROS2_MSG":    4,
		"DATA_TRACK_SCHEMA_ENCODING_ROS2_IDL":    5,
		"DATA_TRACK_SCHEMA_ENCODING_OMG_IDL":     6,
		"DATA_TRACK_SCHEMA_ENCODING_JSON_SCHEMA": 7,
	}
)

func (x DataTrackSchemaEncoding) Enum() *DataTrackSchemaEncoding {
	p := new(DataTrackSchemaEncoding)
	*p = x
	return p
}
...
func (DataTrackSchemaEncoding) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_models_proto_enumTypes[7].Descriptor()
}

func (DataTrackSchemaEncoding) Type() protoreflect.EnumType {
	return &file_livekit_models_proto_enumTypes[7]
}

func (x DataTrackSchemaEncoding) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DataTrackSchemaEncoding.Descriptor instead.
func (DataTrackSchemaEncoding) EnumDescriptor() ([]byte, []int) {
...
func (DataStream_OperationType) EnumDescriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{46, 0}
}
...
func (x *DataTrackInfo) GetTypeInfo() *DataTrackTypeInfo {
	if x != nil {
		return x.TypeInfo
	}
	return nil
...
// Type information for a data track.
type DataTrackTypeInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FrameEncoding DataTrackFrameEncoding `protobuf:"varint,1,opt,name=frame_encoding,json=frameEncoding,proto3,enum=livekit.DataTrackFrameEncoding" json:"frame_encoding,omitempty"`
	// ID of the schema used by frames on this track.
	Schema        *DataTrackSchemaId `protobuf:"bytes,2,opt,name=schema,proto3,oneof" json:"schema,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DataTrackTypeInfo) Reset() {
	*x = DataTrackTypeInfo{}
...
func (x *DataTrackTypeInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataTrackTypeInfo) ProtoMessage() {}

func (x *DataTrackTypeInfo) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_models_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataTrackTypeInfo.ProtoReflect.Descriptor instead.
func (*DataTrackTypeInfo) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{12}
}

func (x *DataTrackTypeInfo) GetFrameEncoding() DataTrackFrameEncoding {
	if x != nil {
...
func (x *DataTrackTypeInfo) GetSchema() *DataTrackSchemaId {
	if x != nil {
		return x.Schema
	}
	return nil
...
func (x *DataTrackSchemaId) GetEncoding() DataTrackSchemaEncoding {
	...
	return DataTrackSchemaEncoding_DATA_TRACK_SCHEMA_ENCODING_UNSPECIFIED
}
...
func (x *DataTrackSchemaDefinition) Reset() {
	*x = DataTrackSchemaDefinition{}
	mi := &file_livekit_models_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DataTrackSchemaDefinition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataTrackSchemaDefinition) ProtoMessage() {}

func (x *DataTrackSchemaDefinition) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_models_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataTrackSchemaDefinition.ProtoReflect.Descriptor instead.
func (*DataTrackSchemaDefinition) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{14}
}

func (x *DataTrackSchemaDefinition) GetId() *DataTrackSchemaId {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *DataTrackSchemaDefinition) GetDefinition() []byte {
	if x != nil {
		return x.Definition
	}
	return nil
...
// Type definition for a data track.
type DataTrackTypeDefinition struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FrameEncoding DataTrackFrameEncoding `protobuf:"varint,1,opt,name=frame_encoding,json=frameEncoding,proto3,enum=livekit.DataTrackFrameEncoding" json:"frame_encoding,omitempty"`
	// Schema definition for frames on this track. Must be compatible
	// with the frame encoding, and may be omitted for self-describing frame encodings.
	Schema        *DataTrackSchemaDefinition `protobuf:"bytes,2,opt,name=schema,proto3,oneof" json:"schema,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DataTrackTypeDefinition) Reset() {
	*x = DataTrackTypeDefinition{}
	mi := &file_livekit_models_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DataTrackTypeDefinition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataTrackTypeDefinition) ProtoMessage() {}

func (x *DataTrackTypeDefinition) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_models_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataTrackTypeDefinition.ProtoReflect.Descriptor instead.
func (*DataTrackTypeDefinition) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{15}
}

func (x *DataTrackTypeDefinition) GetFrameEncoding() DataTrackFrameEncoding {
	if x != nil {
		return x.FrameEncoding
	}
	return DataTrackFrameEncoding_DATA_TRACK_FRAME_ENCODING_UNSPECIFIED
...
func (x *DataTrackTypeDefinition) GetSchema() *DataTrackSchemaDefinition {
	if x != nil {
		return x.Schema
	}
	return nil
...
func (*DataStream_ByteHeader) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{46, 1}
}
...
func (*DataStream_Header) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{46, 2}
}
...
func (*DataStream_Chunk) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{46, 3}
}
...
func (*DataStream_Trailer) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{46, 4}
}
...
const file_livekit_models_proto_rawDesc = "" +
	...
	"\n" +
	"definition\x18\x02 \x01(\fB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\n" +
	"definition\"\xad\x01\n" +
...
var file_livekit_models_proto_enumTypes = make([]protoimpl.EnumInfo, 27)
var file_livekit_models_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_livekit_models_proto_goTypes = []any{
	...
	(DataTrackFrameEncoding)(0),              // 6: livekit.DataTrackFrameEncoding
	(DataTrackSchemaEncoding)(0),             // 7: livekit.DataTrackSchemaEncoding
	...
	(*Pagination)(nil),                       // 27: livekit.Pagination
	(*TokenPagination)(nil),                  // 28: livekit.TokenPagination
	(*ListUpdate)(nil),                       // 29: livekit.ListUpdate
	(*Room)(nil),                             // 30: livekit.Room
	(*Codec)(nil),                            // 31: livekit.Codec
	(*PlayoutDelay)(nil),                     // 32: livekit.PlayoutDelay
	(*ParticipantPermission)(nil),            // 33: livekit.ParticipantPermission
	(*ParticipantInfo)(nil),                  // 34: livekit.ParticipantInfo
	(*Encryption)(nil),                       // 35: livekit.Encryption
	(*SimulcastCodecInfo)(nil),               // 36: livekit.SimulcastCodecInfo
	(*TrackInfo)(nil),                        // 37: livekit.TrackInfo
	(*DataTrackInfo)(nil),                    // 38: livekit.DataTrackInfo
	(*DataTrackTypeInfo)(nil),                // 39: livekit.DataTrackTypeInfo
	(*DataTrackSchemaId)(nil),                // 40: livekit.DataTrackSchemaId
	(*DataTrackSchemaDefinition)(nil),        // 41: livekit.DataTrackSchemaDefinition
	(*DataTrackTypeDefinition)(nil),          // 42: livekit.DataTrackTypeDefinition
	...
	(*VideoLayer)(nil),                       // 45: livekit.VideoLayer
	(*DataPacket)(nil),                       // 46: livekit.DataPacket
	(*EncryptedPacket)(nil),                  // 47: livekit.EncryptedPacket
	(*EncryptedPacketPayload)(nil),           // 48: livekit.EncryptedPacketPayload
	(*ActiveSpeakerUpdate)(nil),              // 49: livekit.ActiveSpeakerUpdate
	(*SpeakerInfo)(nil),                      // 50: livekit.SpeakerInfo
	(*UserPacket)(nil),                       // 51: livekit.UserPacket
	(*SipDTMF)(nil),                          // 52: livekit.SipDTMF
	(*Transcription)(nil),                    // 53: livekit.Transcription
	(*TranscriptionSegment)(nil),             // 54: livekit.TranscriptionSegment
	(*ChatMessage)(nil),                      // 55: livekit.ChatMessage
	(*RpcRequest)(nil),                       // 56: livekit.RpcRequest
	(*RpcAck)(nil),                           // 57: livekit.RpcAck
	(*RpcResponse)(nil),                      // 58: livekit.RpcResponse
	(*RpcError)(nil),                         // 59: livekit.RpcError
	(*ParticipantTracks)(nil),                // 60: livekit.ParticipantTracks
	(*ServerInfo)(nil),                       // 61: livekit.ServerInfo
	(*ClientInfo)(nil),                       // 62: livekit.ClientInfo
	(*ClientConfiguration)(nil),              // 63: livekit.ClientConfiguration
	(*VideoConfiguration)(nil),               // 64: livekit.VideoConfiguration
	(*DisabledCodecs)(nil),                   // 65: livekit.DisabledCodecs
	(*RTPDrift)(nil),                         // 66: livekit.RTPDrift
	(*RTPStats)(nil),                         // 67: livekit.RTPStats
	(*RTCPSenderReportState)(nil),            // 68: livekit.RTCPSenderReportState
	(*RTPForwarderState)(nil),                // 69: livekit.RTPForwarderState
	(*RTPMungerState)(nil),                   // 70: livekit.RTPMungerState
	(*VP8MungerState)(nil),                   // 71: livekit.VP8MungerState
	(*TimedVersion)(nil),                     // 72: livekit.TimedVersion
	(*DataStream)(nil),                       // 73: livekit.DataStream
	(*FilterParams)(nil),                     // 74: livekit.FilterParams
	(*WebhookConfig)(nil),                    // 75: livekit.WebhookConfig
	(*SubscribedAudioCodec)(nil),             // 76: livekit.SubscribedAudioCodec
	nil,                                      // 77: livekit.ParticipantInfo.AttributesEntry
	nil,                                      // 78: livekit.RTPStats.GapHistogramEntry
	(*DataStream_TextHeader)(nil),            // 79: livekit.DataStream.TextHeader
	(*DataStream_ByteHeader)(nil),            // 80: livekit.DataStream.ByteHeader
	(*DataStream_Header)(nil),                // 81: livekit.DataStream.Header
	(*DataStream_Chunk)(nil),                 // 82: livekit.DataStream.Chunk
	(*DataStream_Trailer)(nil),               // 83: livekit.DataStream.Trailer
	nil,                                      // 84: livekit.DataStream.Header.AttributesEntry
	nil,                                      // 85: livekit.DataStream.Trailer.AttributesEntry
	(*MetricsBatch)(nil),                     // 86: livekit.MetricsBatch
	(*timestamppb.Timestamp)(nil),            // 87: google.protobuf.Timestamp
}
var file_livekit_models_proto_depIdxs = []int32{
	31, // 0: livekit.Room.enabled_codecs:type_name -> livekit.Codec
	72, // 1: livekit.Room.version:type_name -> livekit.TimedVersion
	...
	37, // 4: livekit.ParticipantInfo.tracks:type_name -> livekit.TrackInfo
	33, // 5: livekit.ParticipantInfo.permission:type_name -> livekit.ParticipantPermission
	18, // 6: livekit.ParticipantInfo.kind:type_name -> livekit.ParticipantInfo.Kind
	77, // 7: livekit.ParticipantInfo.attributes:type_name -> livekit.ParticipantInfo.AttributesEntry
	...
	38, // 10: livekit.ParticipantInfo.data_tracks:type_name -> livekit.DataTrackInfo
	45, // 11: livekit.SimulcastCodecInfo.layers:type_name -> livekit.VideoLayer
	21, // 12: livekit.SimulcastCodecInfo.video_layer_mode:type_name -> livekit.VideoLayer.Mode
	4,  // 13: livekit.TrackInfo.type:type_name -> livekit.TrackType
	5,  // 14: livekit.TrackInfo.source:type_name -> livekit.TrackSource
	45, // 15: livekit.TrackInfo.layers:type_name -> livekit.VideoLayer
	36, // 16: livekit.TrackInfo.codecs:type_name -> livekit.SimulcastCodecInfo
	20, // 17: livekit.TrackInfo.encryption:type_name -> livekit.Encryption.Type
	72, // 18: livekit.TrackInfo.version:type_name -> livekit.TimedVersion
	15, // 19: livekit.TrackInfo.audio_features:type_name -> livekit.AudioTrackFeature
	3,  // 20: livekit.TrackInfo.backup_codec_policy:type_name -> livekit.BackupCodecPolicy
	16, // 21: livekit.TrackInfo.packet_trailer_features:type_name -> livekit.PacketTrailerFeature
	20, // 22: livekit.DataTrackInfo.encryption:type_name -> livekit.Encryption.Type
	39, // 23: livekit.DataTrackInfo.type_info:type_name -> livekit.DataTrackTypeInfo
	6,  // 24: livekit.DataTrackTypeInfo.frame_encoding:type_name -> livekit.DataTrackFrameEncoding
	40, // 25: livekit.DataTrackTypeInfo.schema:type_name -> livekit.DataTrackSchemaId
	7,  // 26: livekit.DataTrackSchemaId.encoding:type_name -> livekit.DataTrackSchemaEncoding
	40, // 27: livekit.DataTrackSchemaDefinition.id:type_name -> livekit.DataTrackSchemaId
	6,  // 28: livekit.DataTrackTypeDefinition.frame_encoding:type_name -> livekit.DataTrackFrameEncoding
	41, // 29: livekit.DataTrackTypeDefinition.schema:type_name -> livekit.DataTrackSchemaDefinition
	8,  // 30: livekit.DataTrackExtensionParticipantSid.id:type_name -> livekit.DataTrackExtensionID
	9,  // 31: livekit.VideoLayer.quality:type_name -> livekit.VideoQuality
	22, // 32: livekit.DataPacket.kind:type_name -> livekit.DataPacket.Kind
	51, // 33: livekit.DataPacket.user:type_name -> livekit.UserPacket
	49, // 34: livekit.DataPacket.speaker:type_name -> livekit.ActiveSpeakerUpdate
	52, // 35: livekit.DataPacket.sip_dtmf:type_name -> livekit.SipDTMF
	53, // 36: livekit.DataPacket.transcription:type_name -> livekit.Transcription
	86, // 37: livekit.DataPacket.metrics:type_name -> livekit.MetricsBatch
	55, // 38: livekit.DataPacket.chat_message:type_name -> livekit.ChatMessage
	56, // 39: livekit.DataPacket.rpc_request:type_name -> livekit.RpcRequest
	57, // 40: livekit.DataPacket.rpc_ack:type_name -> livekit.RpcAck
	58, // 41: livekit.DataPacket.rpc_response:type_name -> livekit.RpcResponse
	81, // 42: livekit.DataPacket.stream_header:type_name -> livekit.DataStream.Header
	82, // 43: livekit.DataPacket.stream_chunk:type_name -> livekit.DataStream.Chunk
	83, // 44: livekit.DataPacket.stream_trailer:type_name -> livekit.DataStream.Trailer
	47, // 45: livekit.DataPacket.encrypted_packet:type_name -> livekit.EncryptedPacket
	20, // 46: livekit.EncryptedPacket.encryption_type:type_name -> livekit.Encryption.Type
	51, // 47: livekit.EncryptedPacketPayload.user:type_name -> livekit.UserPacket
	55, // 48: livekit.EncryptedPacketPayload.chat_message:type_name -> livekit.ChatMessage
	56, // 49: livekit.EncryptedPacketPayload.rpc_request:type_name -> livekit.RpcRequest
	57, // 50: livekit.EncryptedPacketPayload.rpc_ack:type_name -> livekit.RpcAck
	58, // 51: livekit.EncryptedPacketPayload.rpc_response:type_name -> livekit.RpcResponse
	81, // 52: livekit.EncryptedPacketPayload.stream_header:type_name -> livekit.DataStream.Header
	82, // 53: livekit.EncryptedPacketPayload.stream_chunk:type_name -> livekit.DataStream.Chunk
	83, // 54: livekit.EncryptedPacketPayload.stream_trailer:type_name -> livekit.DataStream.Trailer
	50, // 55: livekit.ActiveSpeakerUpdate.speakers:type_name -> livekit.SpeakerInfo
	54, // 56: livekit.Transcription.segments:type_name -> livekit.TranscriptionSegment
	59, // 57: livekit.RpcResponse.error:type_name -> livekit.RpcError
	23, // 58: livekit.ServerInfo.edition:type_name -> livekit.ServerInfo.Edition
	24, // 59: livekit.ClientInfo.sdk:type_name -> livekit.ClientInfo.SDK
	25, // 60: livekit.ClientInfo.capabilities:type_name -> livekit.ClientInfo.Capability
	64, // 61: livekit.ClientConfiguration.video:type_name -> livekit.VideoConfiguration
	64, // 62: livekit.ClientConfiguration.screen:type_name -> livekit.VideoConfiguration
	11, // 63: livekit.ClientConfiguration.resume_connection:type_name -> livekit.ClientConfigSetting
	65, // 64: livekit.ClientConfiguration.disabled_codecs:type_name -> livekit.DisabledCodecs
	11, // 65: livekit.ClientConfiguration.force_relay:type_name -> livekit.ClientConfigSetting
	11, // 66: livekit.VideoConfiguration.hardware_encoder:type_name -> livekit.ClientConfigSetting
	31, // 67: livekit.DisabledCodecs.codecs:type_name -> livekit.Codec
	31, // 68: livekit.DisabledCodecs.publish:type_name -> livekit.Codec
	87, // 69: livekit.RTPDrift.start_time:type_name -> google.protobuf.Timestamp
	87, // 70: livekit.RTPDrift.end_time:type_name -> google.protobuf.Timestamp
	87, // 71: livekit.RTPStats.start_time:type_name -> google.protobuf.Timestamp
	87, // 72: livekit.RTPStats.end_time:type_name -> google.protobuf.Timestamp
	78, // 73: livekit.RTPStats.gap_histogram:type_name -> livekit.RTPStats.GapHistogramEntry
	87, // 74: livekit.RTPStats.last_pli:type_name -> google.protobuf.Timestamp
	87, // 75: livekit.RTPStats.last_fir:type_name -> google.protobuf.Timestamp
	87, // 76: livekit.RTPStats.last_key_frame:type_name -> google.protobuf.Timestamp
	87, // 77: livekit.RTPStats.last_layer_lock_pli:type_name -> google.protobuf.Timestamp
	66, // 78: livekit.RTPStats.packet_drift:type_name -> livekit.RTPDrift
	66, // 79: livekit.RTPStats.ntp_report_drift:type_name -> livekit.RTPDrift
	66, // 80: livekit.RTPStats.rebased_report_drift:type_name -> livekit.RTPDrift
	66, // 81: livekit.RTPStats.received_report_drift:type_name -> livekit.RTPDrift
	70, // 82: livekit.RTPForwarderState.rtp_munger:type_name -> livekit.RTPMungerState
	71, // 83: livekit.RTPForwarderState.vp8_munger:type_name -> livekit.VP8MungerState
	68, // 84: livekit.RTPForwarderState.sender_report_state:type_name -> livekit.RTCPSenderReportState
	74, // 85: livekit.WebhookConfig.filter_params:type_name -> livekit.FilterParams
	26, // 86: livekit.DataStream.TextHeader.operation_type:type_name -> livekit.DataStream.OperationType
	20, // 87: livekit.DataStream.Header.encryption_type:type_name -> livekit.Encryption.Type
	84, // 88: livekit.DataStream.Header.attributes:type_name -> livekit.DataStream.Header.AttributesEntry
	79, // 89: livekit.DataStream.Header.text_header:type_name -> livekit.DataStream.TextHeader
	80, // 90: livekit.DataStream.Header.byte_header:type_name -> livekit.DataStream.ByteHeader
	85, // 91: livekit.DataStream.Trailer.attributes:type_name -> livekit.DataStream.Trailer.AttributesEntry
...
func file_livekit_models_proto_init() {
	...
	file_livekit_models_proto_msgTypes[54].OneofWrappers = []any{
