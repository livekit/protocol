...
type Room struct {
	...
	Egress          *AutoEgress `protobuf:"bytes,11,opt,name=egress,proto3" json:"egress,omitempty"`
}
...
func (x *Room) GetEgress() *AutoEgress {
	if x != nil {
		return x.Egress
	}
	return nil
...
type AutoEgress struct {
	...
	Tracks *AutoTrackEgress `protobuf:"bytes,1,opt,name=tracks,proto3" json:"tracks,omitempty"`
}

func (x *AutoEgress) Reset() {
	*x = AutoEgress{}
	if protoimpl.UnsafeEnabled {
...
func (x *AutoEgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutoEgress) ProtoMessage() {}

func (x *AutoEgress) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_models_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AutoEgress.ProtoReflect.Descriptor instead.
func (*AutoEgress) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{1}
}

func (x *AutoEgress) GetTracks() *AutoTrackEgress {
	if x != nil {
		return x.Tracks
	}
	return nil
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9c, 0x03, 0x0a, 0x04, 0x52, 0x6f, 0x6f, 0x6d, 0x12,
	...
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x12, 0x2b, 0x0a, 0x06, 0x65, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b,
	0x69, 0x74, 0x2e, 0x41, 0x75, 0x74, 0x6f, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x52, 0x06, 0x65,
	0x67, 0x72, 0x65, 0x73, 0x73, 0x22, 0x3e, 0x0a, 0x0a, 0x41, 0x75, 0x74, 0x6f, 0x45, 0x67, 0x72,
	0x65, 0x73, 0x73, 0x12, 0x30, 0x0a, 0x06, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x18, 0x01, 0x20,
	...
	0x72, 0x61, 0x63, 0x6b, 0x73, 0x22, 0xbb, 0x01, 0x0a, 0x0f, 0x41, 0x75, 0x74, 0x6f, 0x54, 0x72,
...
var file_livekit_models_proto_goTypes = []interface{}{
	...
	(*AutoEgress)(nil),            // 11: livekit.AutoEgress
...
var file_livekit_models_proto_depIdxs = []int32{
	...
	11, // 1: livekit.Room.egress:type_name -> livekit.AutoEgress
	12, // 2: livekit.AutoEgress.tracks:type_name -> livekit.AutoTrackEgress
	32, // 3: livekit.AutoTrackEgress.s3:type_name -> livekit.S3Upload
	33, // 4: livekit.AutoTrackEgress.gcp:type_name -> livekit.GCPUpload
	34, // 5: livekit.AutoTrackEgress.azure:type_name -> livekit.AzureBlobUpload
	6,  // 6: livekit.ParticipantInfo.state:type_name -> livekit.ParticipantInfo.State
	17, // 7: livekit.ParticipantInfo.tracks:type_name -> livekit.TrackInfo
	14, // 8: livekit.ParticipantInfo.permission:type_name -> livekit.ParticipantPermission
	18, // 9: livekit.SimulcastCodecInfo.layers:type_name -> livekit.VideoLayer
	0,  // 10: livekit.TrackInfo.type:type_name -> livekit.TrackType
	1,  // 11: livekit.TrackInfo.source:type_name -> livekit.TrackSource
	18, // 12: livekit.TrackInfo.layers:type_name -> livekit.VideoLayer
	16, // 13: livekit.TrackInfo.codecs:type_name -> livekit.SimulcastCodecInfo
	2,  // 14: livekit.VideoLayer.quality:type_name -> livekit.VideoQuality
	7,  // 15: livekit.DataPacket.kind:type_name -> livekit.DataPacket.Kind
	22, // 16: livekit.DataPacket.user:type_name -> livekit.UserPacket
	20, // 17: livekit.DataPacket.speaker:type_name -> livekit.ActiveSpeakerUpdate
	21, // 18: livekit.ActiveSpeakerUpdate.speakers:type_name -> livekit.SpeakerInfo
	8,  // 19: livekit.ServerInfo.edition:type_name -> livekit.ServerInfo.Edition
	9,  // 20: livekit.ClientInfo.sdk:type_name -> livekit.ClientInfo.SDK
	27, // 21: livekit.ClientConfiguration.video:type_name -> livekit.VideoConfiguration
	27, // 22: livekit.ClientConfiguration.screen:type_name -> livekit.VideoConfiguration
	4,  // 23: livekit.ClientConfiguration.resume_connection:type_name -> livekit.ClientConfigSetting
	28, // 24: livekit.ClientConfiguration.disabled_codecs:type_name -> livekit.DisabledCodecs
	4,  // 25: livekit.ClientConfiguration.force_relay:type_name -> livekit.ClientConfigSetting
	4,  // 26: livekit.VideoConfiguration.hardware_encoder:type_name -> livekit.ClientConfigSetting
	13, // 27: livekit.DisabledCodecs.codecs:type_name -> livekit.Codec
	35, // 28: livekit.RTPStats.start_time:type_name -> google.protobuf.Timestamp
	35, // 29: livekit.RTPStats.end_time:type_name -> google.protobuf.Timestamp
	31, // 30: livekit.RTPStats.gap_histogram:type_name -> livekit.RTPStats.GapHistogramEntry
	35, // 31: livekit.RTPStats.last_pli:type_name -> google.protobuf.Timestamp
	35, // 32: livekit.RTPStats.last_fir:type_name -> google.protobuf.Timestamp
	35, // 33: livekit.RTPStats.last_key_frame:type_name -> google.protobuf.Timestamp
	35, // 34: livekit.RTPStats.last_layer_lock_pli:type_name -> google.protobuf.Timestamp
