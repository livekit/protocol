...
type PersistableUserData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Packets []*PersistableUserPacket `protobuf:"bytes,1,rep,name=packets,proto3" json:"packets,omitempty"`
}

func (x *PersistableUserData) Reset() {
	*x = PersistableUserData{}
	if protoimpl.UnsafeEnabled {
...
func (x *PersistableUserData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PersistableUserData) ProtoMessage() {}

func (x *PersistableUserData) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_models_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PersistableUserData.ProtoReflect.Descriptor instead.
func (*PersistableUserData) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{14}
}

func (x *PersistableUserData) GetPackets() []*PersistableUserPacket {
	if x != nil {
		return x.Packets
	}
	return nil
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x06, 0x5f, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0x4f, 0x0a, 0x13, 0x50, 0x65, 0x72, 0x73, 0x69,
	0x73, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12, 0x38,
	0x0a, 0x07, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x69, 0x73,
	0x74, 0x61, 0x62, 0x6c, 0x65, 0x55, 0x73, 0x65, 0x72, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x52,
	0x07, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x22, 0x5b, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x74,
	...
	0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x07, 0x2a, 0x89, 0x01, 0x0a, 0x0f, 0x52, 0x65,
	...
	0x5f, 0x4e, 0x4f, 0x54, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x02, 0x42, 0x46, 0x5a, 0x23, 0x67,
...
var file_livekit_models_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_livekit_models_proto_goTypes = []interface{}{
	...
	(*PersistableUserData)(nil),   // 30: livekit.PersistableUserData
...
var file_livekit_models_proto_depIdxs = []int32{
	...
	29, // 17: livekit.PersistableUserData.packets:type_name -> livekit.PersistableUserPacket
	14, // 18: livekit.ServerInfo.edition:type_name -> livekit.ServerInfo.Edition
	15, // 19: livekit.ClientInfo.sdk:type_name -> livekit.ClientInfo.SDK
	35, // 20: livekit.ClientConfiguration.video:type_name -> livekit.VideoConfiguration
	35, // 21: livekit.ClientConfiguration.screen:type_name -> livekit.VideoConfiguration
	7,  // 22: livekit.ClientConfiguration.resume_connection:type_name -> livekit.ClientConfigSetting
	36, // 23: livekit.ClientConfiguration.disabled_codecs:type_name -> livekit.DisabledCodecs
	...
	17, // 26: livekit.DisabledCodecs.codecs:type_name -> livekit.Codec
	17, // 27: livekit.DisabledCodecs.publish:type_name -> livekit.Codec
	41, // 28: livekit.RTPDrift.start_time:type_name -> google.protobuf.Timestamp
	41, // 29: livekit.RTPDrift.end_time:type_name -> google.protobuf.Timestamp
	41, // 30: livekit.RTPStats.start_time:type_name -> google.protobuf.Timestamp
	41, // 31: livekit.RTPStats.end_time:type_name -> google.protobuf.Timestamp
	40, // 32: livekit.RTPStats.gap_histogram:type_name -> livekit.RTPStats.GapHistogramEntry
	41, // 33: livekit.RTPStats.last_pli:type_name -> google.protobuf.Timestamp
	41, // 34: livekit.RTPStats.last_fir:type_name -> google.protobuf.Timestamp
	41, // 35: livekit.RTPStats.last_key_frame:type_name -> google.protobuf.Timestamp
	41, // 36: livekit.RTPStats.last_layer_lock_pli:type_name -> google.protobuf.Timestamp
	37, // 37: livekit.RTPStats.packet_drift:type_name -> livekit.RTPDrift
	37, // 38: livekit.RTPStats.report_drift:type_name -> livekit.RTPDrift
...
func file_livekit_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_livekit_models_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PersistableUserData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
