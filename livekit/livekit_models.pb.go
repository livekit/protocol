...
func (x *DataPacket) GetStream() *StreamPacket {
	if x, ok := x.GetValue().(*DataPacket_Stream); ok {
		return x.Stream
	}
	return nil
}
...
type DataPacket_Stream struct {
	Stream *StreamPacket `protobuf:"bytes,4,opt,name=stream,proto3,oneof"`
}
...
func (*DataPacket_Stream) isDataPacket_Value() {}
...
func (x *StreamPacket) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *StreamPacket) GetPersistent() bool {
	if x != nil {
		return x.Persistent
	}
	return false
...
func (x *StreamPacket) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *StreamPacket) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0xd4, 0x03, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x49,
	...
	0x52, 0x0a, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x64, 0x22, 0x99, 0x01, 0x0a,
	...
	0x28, 0x0d, 0x52, 0x04, 0x73, 0x73, 0x72, 0x63, 0x22, 0xfa, 0x01, 0x0a, 0x0a, 0x44, 0x61, 0x74,
	...
	0x00, 0x52, 0x07, 0x73, 0x70, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x12, 0x2f, 0x0a, 0x06, 0x73, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6c, 0x69, 0x76,
	0x65, 0x6b, 0x69, 0x74, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x50, 0x61, 0x63, 0x6b, 0x65,
	0x74, 0x48, 0x00, 0x52, 0x06, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x22, 0x1f, 0x0a, 0x04, 0x4b,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x6a, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x50,
	...
	0x65, 0x72, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79,
	...
	0x10, 0x01, 0x22, 0x8a, 0x03, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66,
	...
	0x28, 0x09, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x52, 0x0a, 0x03, 0x53,
	...
	0x61, 0x72, 0x65, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x22, 0x38, 0x0a, 0x0e, 0x44, 0x69,
	...
	0x64, 0x65, 0x63, 0x73, 0x22, 0xc5, 0x0d, 0x0a, 0x08, 0x52, 0x54, 0x50, 0x53, 0x74, 0x61, 0x74,
	...
	0x61, 0x79, 0x65, 0x72, 0x4c, 0x6f, 0x63, 0x6b, 0x50, 0x6c, 0x69, 0x1a, 0x3f, 0x0a, 0x11, 0x47,
	0x61, 0x70, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	0x73, 0x2a, 0x2b, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x12, 0x09,
	...
	0x5f, 0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x07, 0x42, 0x46, 0x5a, 0x23, 0x67, 0x69,
...
var file_livekit_models_proto_goTypes = []interface{}{
	...
	(*StreamPacket)(nil),          // 18: livekit.StreamPacket
...
var file_livekit_models_proto_depIdxs = []int32{
	...
	21, // 11: livekit.DataPacket.user:type_name -> livekit.UserPacket
	19, // 12: livekit.DataPacket.speaker:type_name -> livekit.ActiveSpeakerUpdate
	18, // 13: livekit.DataPacket.stream:type_name -> livekit.StreamPacket
	20, // 14: livekit.ActiveSpeakerUpdate.speakers:type_name -> livekit.SpeakerInfo
	8,  // 15: livekit.ServerInfo.edition:type_name -> livekit.ServerInfo.Edition
	9,  // 16: livekit.ClientInfo.sdk:type_name -> livekit.ClientInfo.SDK
	...
	4,  // 19: livekit.ClientConfiguration.resume_connection:type_name -> livekit.ClientConfigSetting
	27, // 20: livekit.ClientConfiguration.disabled_codecs:type_name -> livekit.DisabledCodecs
	4,  // 21: livekit.ClientConfiguration.force_relay:type_name -> livekit.ClientConfigSetting
	4,  // 22: livekit.VideoConfiguration.hardware_encoder:type_name -> livekit.ClientConfigSetting
	11, // 23: livekit.DisabledCodecs.codecs:type_name -> livekit.Codec
