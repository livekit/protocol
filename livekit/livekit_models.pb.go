...
// Header properties specific to file or image streams
type DataStream_CustomHeader struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Extensions map[string]string `protobuf:"bytes,1,rep,name=extensions,proto3" json:"extensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Optional: Name of the file
}

func (x *DataStream_CustomHeader) Reset() {
	*x = DataStream_CustomHeader{}
	mi := &file_livekit_models_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DataStream_CustomHeader) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataStream_CustomHeader) ProtoMessage() {}

func (x *DataStream_CustomHeader) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_models_proto_msgTypes[39]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataStream_CustomHeader.ProtoReflect.Descriptor instead.
func (*DataStream_CustomHeader) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{34, 2}
}

func (x *DataStream_CustomHeader) GetExtensions() map[string]string {
	if x != nil {
		return x.Extensions
	}
	return nil
...
type DataStream_Header struct {
	...
	TotalLength    int32                 `protobuf:"varint,7,opt,name=totalLength,proto3" json:"totalLength,omitempty"`                                    // Optional: Only for finite streams
	TotalChunks    int32                 `protobuf:"varint,8,opt,name=totalChunks,proto3" json:"totalChunks,omitempty"`                                    // Optional: Only for finite streams
	...
	//	*DataStream_Header_CustomHeader
...
func (x *DataStream_Header) GetCustomHeader() *DataStream_CustomHeader {
	if x, ok := x.GetContentHeader().(*DataStream_Header_CustomHeader); ok {
...
type DataStream_Header_TextHeader struct {
	TextHeader *DataStream_TextHeader `protobuf:"bytes,10,opt,name=textHeader,proto3,oneof"`
}

type DataStream_Header_FileHeader struct {
	FileHeader *DataStream_FileHeader `protobuf:"bytes,11,opt,name=fileHeader,proto3,oneof"`
}

type DataStream_Header_CustomHeader struct {
	CustomHeader *DataStream_CustomHeader `protobuf:"bytes,12,opt,name=customHeader,proto3,oneof"`
}
...
func (*DataStream_Header_CustomHeader) isDataStream_Header_ContentHeader() {}
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x6b, 0x73, 0x22, 0xae, 0x09, 0x0a, 0x0a, 0x44, 0x61, 0x74, 0x61, 0x53, 0x74, 0x72,
	...
	0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x9f, 0x01, 0x0a, 0x0c,
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x50, 0x0a, 0x0a,
	0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x30, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x48, 0x65, 0x61, 0x64,
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x9a, 0x04,
	0x0a, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x6d, 0x65, 0x73, 0x73,
	...
	,
	...
	0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x40, 0x0a, 0x0a,
	0x74, 0x65, 0x78, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x24, 0x0a, 0x0d, 0x63, 0x6f, 0x6e, 0x74, 0x65,
	0x6e, 0x74, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d,
	...
	0x08, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x76, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x69, 0x76, 0x22, 0x27, 0x0a, 0x0a, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x49, 0x4e, 0x49, 0x54,
	0x45, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x53, 0x54, 0x52, 0x45, 0x41, 0x4d, 0x49, 0x4e, 0x47,
	0x10, 0x01, 0x22, 0x41, 0x0a, 0x0d, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54,
	...
	0x95, 0x02, 0x0a, 0x10, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x52, 0x65,
	...
	0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x0c, 0x2a, 0x89, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x63, 0x6f,
...
var file_livekit_models_proto_goTypes = []any{
	...
	(*DataStream_CustomHeader)(nil), // 59: livekit.DataStream.CustomHeader
	(*DataStream_Header)(nil),       // 60: livekit.DataStream.Header
	(*DataStream_Packet)(nil),       // 61: livekit.DataStream.Packet
	nil,                             // 62: livekit.DataStream.CustomHeader.ExtensionsEntry
...
var file_livekit_models_proto_depIdxs = []int32{
	...
	64, // 41: livekit.RTPDrift.start_time:type_name -> google.protobuf.Timestamp
	64, // 42: livekit.RTPDrift.end_time:type_name -> google.protobuf.Timestamp
	64, // 43: livekit.RTPStats.start_time:type_name -> google.protobuf.Timestamp
	64, // 44: livekit.RTPStats.end_time:type_name -> google.protobuf.Timestamp
	56, // 45: livekit.RTPStats.gap_histogram:type_name -> livekit.RTPStats.GapHistogramEntry
	64, // 46: livekit.RTPStats.last_pli:type_name -> google.protobuf.Timestamp
	64, // 47: livekit.RTPStats.last_fir:type_name -> google.protobuf.Timestamp
	64, // 48: livekit.RTPStats.last_key_frame:type_name -> google.protobuf.Timestamp
	64, // 49: livekit.RTPStats.last_layer_lock_pli:type_name -> google.protobuf.Timestamp
	...
	62, // 58: livekit.DataStream.CustomHeader.extensions:type_name -> livekit.DataStream.CustomHeader.ExtensionsEntry
	18, // 59: livekit.DataStream.Header.streamType:type_name -> livekit.DataStream.StreamType
	...
	59, // 63: livekit.DataStream.Header.customHeader:type_name -> livekit.DataStream.CustomHeader
...
func file_livekit_models_proto_init() {
	...
	file_livekit_models_proto_msgTypes[40].OneofWrappers = []any{
		...
		(*DataStream_Header_CustomHeader)(nil),
	}
	type x struct{}
