...
const file_livekit_models_proto_rawDesc = "" +
	...
	"\x15can_subscribe_metrics\x18\f \x01(\bR\x13canSubscribeMetrics\"\xcc\x06\n" +
	...
	"attributes\x12F\n" +
	"\x11disconnect_reason\x18\x10 \x01(\x0e2\x19.livekit.DisconnectReasonR\x10disconnectReason\x1a=\n" +
	...
	"\tFORWARDED\x10\x05\x12\x0f\n" +
	"\vCLOUD_AGENT\x10\x06\"3\n" +
	"\n" +
	"Encryption\"%\n" +
	"\x04Type\x12\b\n" +
	...
	"\n" +
	"other_sdks\x18\v \x01(\tR\totherSdks\"\x9c\x01\n" +
	"\x03SDK\x12\v\n" +
