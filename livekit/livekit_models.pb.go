...
type RpcResponse_ErrorCode int32

const (
	RpcResponse_NO_ERROR RpcResponse_ErrorCode = 0
)

// Enum value maps for RpcResponse_ErrorCode.
var (
	RpcResponse_ErrorCode_name = map[int32]string{
		0: "NO_ERROR",
	}
	RpcResponse_ErrorCode_value = map[string]int32{
		"NO_ERROR": 0,
	}
)

func (x RpcResponse_ErrorCode) Enum() *RpcResponse_ErrorCode {
	p := new(RpcResponse_ErrorCode)
	*p = x
	return p
}

func (x RpcResponse_ErrorCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RpcResponse_ErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_models_proto_enumTypes[16].Descriptor()
}

func (RpcResponse_ErrorCode) Type() protoreflect.EnumType {
	return &file_livekit_models_proto_enumTypes[16]
}

func (x RpcResponse_ErrorCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RpcResponse_ErrorCode.Descriptor instead.
func (RpcResponse_ErrorCode) EnumDescriptor() ([]byte, []int) {
...
func (ServerInfo_Edition) EnumDescriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{21, 0}
}
...
func (x *DataPacket) GetRpcMessage() *RpcMessage {
	if x, ok := x.GetValue().(*DataPacket_RpcMessage); ok {
		return x.RpcMessage
	}
	return nil
}
...
type DataPacket_RpcMessage struct {
	RpcMessage *RpcMessage `protobuf:"bytes,10,opt,name=rpc_message,json=rpcMessage,proto3,oneof"`
}
...
func (*DataPacket_RpcMessage) isDataPacket_Value() {}
...
func (x *RpcMessage) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *RpcAck) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
type RpcResponse struct {
	...
	MessageId string `protobuf:"bytes,1,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"` // ID of the request message
	Data      string `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	ErrorCode int32  `protobuf:"varint,3,opt,name=error_code,json=errorCode,proto3" json:"error_code,omitempty"` // Can be a value from ErrorCode enum or a custom value
	ErrorData string `protobuf:"bytes,4,opt,name=error_data,json=errorData,proto3" json:"error_data,omitempty"`
}
...
func (x *RpcResponse) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
func (x *RpcResponse) GetErrorData() string {
	if x != nil {
		return x.ErrorData
	}
	return ""
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x0b, 0x72, 0x70, 0x63, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x52, 0x70, 0x63,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x0a, 0x72, 0x70, 0x63, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x2a, 0x0a, 0x07, 0x72, 0x70, 0x63, 0x5f, 0x61, 0x63, 0x6b,
	...
	0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x22, 0xae, 0x01, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x4d,
	...
	0x65, 0x74, 0x65, 0x64, 0x42, 0x11, 0x0a, 0x0f, 0x5f, 0x65, 0x64, 0x69, 0x74, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x44, 0x0a, 0x0a, 0x52, 0x70, 0x63, 0x4d, 0x65,
	...
	0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x27, 0x0a,
	0x06, 0x52, 0x70, 0x63, 0x41, 0x63, 0x6b, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x49, 0x64, 0x22, 0x99, 0x01, 0x0a, 0x0b, 0x52, 0x70, 0x63, 0x52, 0x65,
	...
	0x61, 0x67, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1d, 0x0a, 0x0a, 0x65, 0x72, 0x72,
	...
	0x72, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x65, 0x72,
	0x72, 0x6f, 0x72, 0x44, 0x61, 0x74, 0x61, 0x22, 0x19, 0x0a, 0x09, 0x45, 0x72, 0x72, 0x6f, 0x72,
	0x43, 0x6f, 0x64, 0x65, 0x12, 0x0c, 0x0a, 0x08, 0x4e, 0x4f, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52,
	0x10, 0x00, 0x22, 0x5b, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e,
	...
	0x6c, 0x6f, 0x75, 0x64, 0x10, 0x01, 0x22, 0xd5, 0x03, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x65, 0x6e,
	...
	0x9c, 0x01, 0x0a, 0x03, 0x53, 0x44, 0x4b, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f,
	...
	0x45, 0x42, 0x10, 0x0b, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x44, 0x45, 0x10, 0x0c, 0x22, 0xc9,
	...
	0x6b, 0x73, 0x2a, 0x2f, 0x0a, 0x0a, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x43, 0x6f, 0x64, 0x65, 0x63,
	...
	0x43, 0x10, 0x02, 0x2a, 0x56, 0x0a, 0x0a, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x43, 0x6f, 0x64, 0x65,
	0x63, 0x12, 0x0e, 0x0a, 0x0a, 0x44, 0x45, 0x46, 0x41, 0x55, 0x4c, 0x54, 0x5f, 0x56, 0x43, 0x10,
	...
	0x10, 0x03, 0x12, 0x07, 0x0a, 0x03, 0x56, 0x50, 0x38, 0x10, 0x04, 0x2a, 0x29, 0x0a, 0x0a, 0x49,
	0x6d, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x63, 0x12, 0x0e, 0x0a, 0x0a, 0x49, 0x43, 0x5f,
	0x44, 0x45, 0x46, 0x41, 0x55, 0x4c, 0x54, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x49, 0x43, 0x5f,
	0x4a, 0x50, 0x45, 0x47, 0x10, 0x01, 0x2a, 0x2b, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x54,
	...
	0x47, 0x48, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x4f, 0x46, 0x46, 0x10, 0x03, 0x2a, 0x40, 0x0a,
	...
	0x45, 0x4e, 0x54, 0x10, 0x02, 0x12, 0x08, 0x0a, 0x04, 0x4c, 0x4f, 0x53, 0x54, 0x10, 0x03, 0x2a,
	...
	0x0b, 0x0a, 0x07, 0x45, 0x4e, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xec, 0x01, 0x0a,
	...
	0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x07, 0x12, 0x0d, 0x0a, 0x09, 0x4d, 0x49, 0x47,
	0x52, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x08, 0x12, 0x10, 0x0a, 0x0c, 0x53, 0x49, 0x47, 0x4e,
	0x41, 0x4c, 0x5f, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x10, 0x09, 0x12, 0x0f, 0x0a, 0x0b, 0x52, 0x4f,
	0x4f, 0x4d, 0x5f, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x44, 0x10, 0x0a, 0x2a, 0x89, 0x01, 0x0a, 0x0f,
	...
	0x43, 0x4b, 0x5f, 0x4e, 0x4f, 0x54, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x02, 0x2a, 0xa3, 0x01,
	...
	0x4e, 0x10, 0x05, 0x42, 0x46, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_livekit_models_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_livekit_models_proto_goTypes = []any{
	...
	(RpcResponse_ErrorCode)(0),    // 16: livekit.RpcResponse.ErrorCode
	...
	(*RpcMessage)(nil),            // 36: livekit.RpcMessage
...
var file_livekit_models_proto_depIdxs = []int32{
	...
	36, // 25: livekit.DataPacket.rpc_message:type_name -> livekit.RpcMessage
	...
	30, // 28: livekit.ActiveSpeakerUpdate.speakers:type_name -> livekit.SpeakerInfo
	34, // 29: livekit.Transcription.segments:type_name -> livekit.TranscriptionSegment
	17, // 30: livekit.ServerInfo.edition:type_name -> livekit.ServerInfo.Edition
	18, // 31: livekit.ClientInfo.sdk:type_name -> livekit.ClientInfo.SDK
	43, // 32: livekit.ClientConfiguration.video:type_name -> livekit.VideoConfiguration
	43, // 33: livekit.ClientConfiguration.screen:type_name -> livekit.VideoConfiguration
	7,  // 34: livekit.ClientConfiguration.resume_connection:type_name -> livekit.ClientConfigSetting
	44, // 35: livekit.ClientConfiguration.disabled_codecs:type_name -> livekit.DisabledCodecs
	7,  // 36: livekit.ClientConfiguration.force_relay:type_name -> livekit.ClientConfigSetting
	7,  // 37: livekit.VideoConfiguration.hardware_encoder:type_name -> livekit.ClientConfigSetting
	20, // 38: livekit.DisabledCodecs.codecs:type_name -> livekit.Codec
	20, // 39: livekit.DisabledCodecs.publish:type_name -> livekit.Codec
	55, // 40: livekit.RTPDrift.start_time:type_name -> google.protobuf.Timestamp
	55, // 41: livekit.RTPDrift.end_time:type_name -> google.protobuf.Timestamp
	55, // 42: livekit.RTPStats.start_time:type_name -> google.protobuf.Timestamp
	55, // 43: livekit.RTPStats.end_time:type_name -> google.protobuf.Timestamp
	53, // 44: livekit.RTPStats.gap_histogram:type_name -> livekit.RTPStats.GapHistogramEntry
	55, // 45: livekit.RTPStats.last_pli:type_name -> google.protobuf.Timestamp
	55, // 46: livekit.RTPStats.last_fir:type_name -> google.protobuf.Timestamp
	55, // 47: livekit.RTPStats.last_key_frame:type_name -> google.protobuf.Timestamp
	55, // 48: livekit.RTPStats.last_layer_lock_pli:type_name -> google.protobuf.Timestamp
	45, // 49: livekit.RTPStats.packet_drift:type_name -> livekit.RTPDrift
	45, // 50: livekit.RTPStats.ntp_report_drift:type_name -> livekit.RTPDrift
	45, // 51: livekit.RTPStats.rebased_report_drift:type_name -> livekit.RTPDrift
	45, // 52: livekit.RTPStats.received_report_drift:type_name -> livekit.RTPDrift
	49, // 53: livekit.RTPForwarderState.rtp_munger:type_name -> livekit.RTPMungerState
	50, // 54: livekit.RTPForwarderState.vp8_munger:type_name -> livekit.VP8MungerState
	47, // 55: livekit.RTPForwarderState.sender_report_state:type_name -> livekit.RTCPSenderReportState
...
func file_livekit_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_livekit_models_proto_msgTypes[30].Exporter = func(v any, i int) any {
		...
		file_livekit_models_proto_msgTypes[31].Exporter = func(v any, i int) any {
		...
		file_livekit_models_proto_msgTypes[32].Exporter = func(v any, i int) any {
	...
	file_livekit_models_proto_msgTypes[29].OneofWrappers = []any{
