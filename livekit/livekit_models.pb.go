...
type DataStream_StreamType int32

const (
	DataStream_FINITE    DataStream_StreamType = 0
	DataStream_STREAMING DataStream_StreamType = 1
)

// Enum value maps for DataStream_StreamType.
var (
	DataStream_StreamType_name = map[int32]string{
		0: "FINITE",
		1: "STREAMING",
	}
	DataStream_StreamType_value = map[string]int32{
		"FINITE":    0,
		"STREAMING": 1,
	}
)

func (x DataStream_StreamType) Enum() *DataStream_StreamType {
	p := new(DataStream_StreamType)
	*p = x
	return p
}

func (x DataStream_StreamType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DataStream_StreamType) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_models_proto_enumTypes[18].Descriptor()
}

func (DataStream_StreamType) Type() protoreflect.EnumType {
	return &file_livekit_models_proto_enumTypes[18]
}

func (x DataStream_StreamType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DataStream_StreamType.Descriptor instead.
func (DataStream_StreamType) EnumDescriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{34, 0}
}

// Enum for operation types (specific to TextStreamHeader)
...
type DataStream_TextHeader struct {
	...
	ReplyToMessageId string                   `protobuf:"bytes,3,opt,name=replyToMessageId,proto3" json:"replyToMessageId,omitempty"` // Optional: Reply to specific message
	AttachedFileIds  []string                 `protobuf:"bytes,4,rep,name=attachedFileIds,proto3" json:"attachedFileIds,omitempty"`
}
...
func (x *DataStream_TextHeader) GetReplyToMessageId() string {
	if x != nil {
...
func (x *DataStream_TextHeader) GetAttachedFileIds() []string {
	if x != nil {
...
type DataStream_FileHeader struct {
	...
	FileName string `protobuf:"bytes,1,opt,name=fileName,proto3" json:"fileName,omitempty"` // Optional: Name of the file
}
...
type DataStream_Header struct {
	...
	MessageId      string                `protobuf:"bytes,1,opt,name=messageId,proto3" json:"messageId,omitempty"`  // Unique identifier for this data stream
	...
	StreamType     DataStream_StreamType `protobuf:"varint,4,opt,name=streamType,proto3,enum=livekit.DataStream_StreamType" json:"streamType,omitempty"`
	MimeType       string                `protobuf:"bytes,6,opt,name=mimeType,proto3" json:"mimeType,omitempty"`
	TotalLength    *uint64               `protobuf:"varint,7,opt,name=totalLength,proto3,oneof" json:"totalLength,omitempty"`                                                                                 // Optional: Only for finite streams
	TotalChunks    *uint64               `protobuf:"varint,8,opt,name=totalChunks,proto3,oneof" json:"totalChunks,omitempty"`                                                                                 // Optional: Only for finite streams
	EncryptionType Encryption_Type       `protobuf:"varint,9,opt,name=encryptionType,proto3,enum=livekit.Encryption_Type" json:"encryptionType,omitempty"`                                                    // Optional, defaults to NONE
	Extensions     map[string]string     `protobuf:"bytes,10,rep,name=extensions,proto3" json:"extensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Optional, user defined extensions map that can carry additional info
...
func (x *DataStream_Header) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
func (x *DataStream_Header) GetStreamType() DataStream_StreamType {
	if x != nil {
		return x.StreamType
	}
	return DataStream_FINITE
}
...
type DataStream_Header_TextHeader struct {
	TextHeader *DataStream_TextHeader `protobuf:"bytes,11,opt,name=textHeader,proto3,oneof"`
}

type DataStream_Header_FileHeader struct {
	FileHeader *DataStream_FileHeader `protobuf:"bytes,12,opt,name=fileHeader,proto3,oneof"`
}
...
type DataStream_Packet struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	MessageId     string `protobuf:"bytes,1,opt,name=messageId,proto3" json:"messageId,omitempty"`          // unique identifier for this data stream to map it to the correct header
	ChunkIndex    uint64 `protobuf:"varint,2,opt,name=chunkIndex,proto3" json:"chunkIndex,omitempty"`       // chunkId as an unsigned 32-bit integer
	Content       []byte `protobuf:"bytes,3,opt,name=content,proto3" json:"content,omitempty"`              // content as binary (bytes)
	ContentLength uint32 `protobuf:"varint,4,opt,name=contentLength,proto3" json:"contentLength,omitempty"` // content length in bytes
	Complete      bool   `protobuf:"varint,5,opt,name=complete,proto3" json:"complete,omitempty"`           // optional, if the stream is complete
	Iv            []byte `protobuf:"bytes,6,opt,name=iv,proto3" json:"iv,omitempty"`                        // optional, initialization vector for AES-GCM encryption
}

func (x *DataStream_Packet) Reset() {
	*x = DataStream_Packet{}
...
func (x *DataStream_Packet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataStream_Packet) ProtoMessage() {}

func (x *DataStream_Packet) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_models_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataStream_Packet.ProtoReflect.Descriptor instead.
func (*DataStream_Packet) Descriptor() ([]byte, []int) {
	return file_livekit_models_proto_rawDescGZIP(), []int{34, 3}
}

func (x *DataStream_Packet) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
func (x *DataStream_Packet) GetChunkIndex() uint64 {
	if x != nil {
		return x.ChunkIndex
	}
	return 0
...
func (x *DataStream_Packet) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
func (x *DataStream_Packet) GetContentLength() uint32 {
	if x != nil {
...
func (x *DataStream_Packet) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
func (x *DataStream_Packet) GetIv() []byte {
	if x != nil {
		return x.Iv
	}
	return nil
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x6b, 0x73, 0x22, 0xa9, 0x09, 0x0a, 0x0a, 0x44, 0x61, 0x74, 0x61, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x1a, 0xc5, 0x01, 0x0a, 0x0a, 0x54, 0x65, 0x78, 0x74, 0x48, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x12, 0x47, 0x0a, 0x0d, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54,
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x0a, 0x10, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x54, 0x6f,
	...
	0x64, 0x12, 0x28, 0x0a, 0x0f, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0x65, 0x64, 0x46, 0x69, 0x6c,
	0x65, 0x49, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x74, 0x74, 0x61,
	0x63, 0x68, 0x65, 0x64, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x64, 0x73, 0x1a, 0x28, 0x0a, 0x0a, 0x46,
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x87, 0x05, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72,
	...
	,
	...
	0x52, 0x0a, 0x74, 0x65, 0x78, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x40, 0x0a, 0x0a,
	0x66, 0x69, 0x6c, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x48, 0x00, 0x52, 0x0a, 0x66, 0x69, 0x6c, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x1a, 0x3d,
	...
	0x0e, 0x0a, 0x0c, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x42,
	0x0e, 0x0a, 0x0c, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x1a,
	0xb2, 0x01, 0x0a, 0x06, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x68, 0x75, 0x6e,
	0x6b, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x63, 0x68,
	...
	,
	...
	0x07, 0x45, 0x4e, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x95, 0x02, 0x0a, 0x10, 0x44,
	...
	0x10, 0x0c, 0x2a, 0x89, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	...
	0x4e, 0x44, 0x10, 0x02, 0x2a, 0xa3, 0x01, 0x0a, 0x11, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x54, 0x72,
	...
	0x45, 0x4c, 0x4c, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x05, 0x42, 0x46, 0x5a, 0x23, 0x67, 0x69,
...
var file_livekit_models_proto_goTypes = []any{
	...
	(DataStream_StreamType)(0),    // 18: livekit.DataStream.StreamType
	...
	(*DataStream_Packet)(nil),     // 60: livekit.DataStream.Packet
...
var file_livekit_models_proto_depIdxs = []int32{
	...
	31, // 28: livekit.ActiveSpeakerUpdate.speakers:type_name -> livekit.SpeakerInfo
	35, // 29: livekit.Transcription.segments:type_name -> livekit.TranscriptionSegment
	40, // 30: livekit.RpcResponse.error:type_name -> livekit.RpcError
	...
	45, // 33: livekit.ClientConfiguration.video:type_name -> livekit.VideoConfiguration
	45, // 34: livekit.ClientConfiguration.screen:type_name -> livekit.VideoConfiguration
	7,  // 35: livekit.ClientConfiguration.resume_connection:type_name -> livekit.ClientConfigSetting
	46, // 36: livekit.ClientConfiguration.disabled_codecs:type_name -> livekit.DisabledCodecs
	...
	21, // 39: livekit.DisabledCodecs.codecs:type_name -> livekit.Codec
	21, // 40: livekit.DisabledCodecs.publish:type_name -> livekit.Codec
	63, // 41: livekit.RTPDrift.start_time:type_name -> google.protobuf.Timestamp
	63, // 42: livekit.RTPDrift.end_time:type_name -> google.protobuf.Timestamp
	63, // 43: livekit.RTPStats.start_time:type_name -> google.protobuf.Timestamp
	63, // 44: livekit.RTPStats.end_time:type_name -> google.protobuf.Timestamp
	56, // 45: livekit.RTPStats.gap_histogram:type_name -> livekit.RTPStats.GapHistogramEntry
	63, // 46: livekit.RTPStats.last_pli:type_name -> google.protobuf.Timestamp
	63, // 47: livekit.RTPStats.last_fir:type_name -> google.protobuf.Timestamp
	63, // 48: livekit.RTPStats.last_key_frame:type_name -> google.protobuf.Timestamp
	63, // 49: livekit.RTPStats.last_layer_lock_pli:type_name -> google.protobuf.Timestamp
	47, // 50: livekit.RTPStats.packet_drift:type_name -> livekit.RTPDrift
	47, // 51: livekit.RTPStats.ntp_report_drift:type_name -> livekit.RTPDrift
	47, // 52: livekit.RTPStats.rebased_report_drift:type_name -> livekit.RTPDrift
	47, // 53: livekit.RTPStats.received_report_drift:type_name -> livekit.RTPDrift
	51, // 54: livekit.RTPForwarderState.rtp_munger:type_name -> livekit.RTPMungerState
	52, // 55: livekit.RTPForwarderState.vp8_munger:type_name -> livekit.VP8MungerState
	49, // 56: livekit.RTPForwarderState.sender_report_state:type_name -> livekit.RTCPSenderReportState
	19, // 57: livekit.DataStream.TextHeader.operationType:type_name -> livekit.DataStream.OperationType
	18, // 58: livekit.DataStream.Header.streamType:type_name -> livekit.DataStream.StreamType
	14, // 59: livekit.DataStream.Header.encryptionType:type_name -> livekit.Encryption.Type
	61, // 60: livekit.DataStream.Header.extensions:type_name -> livekit.DataStream.Header.ExtensionsEntry
	57, // 61: livekit.DataStream.Header.textHeader:type_name -> livekit.DataStream.TextHeader
	58, // 62: livekit.DataStream.Header.fileHeader:type_name -> livekit.DataStream.FileHeader
