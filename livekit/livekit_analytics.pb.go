...
func (x *APICallResponse) GetMessage() isAPICallResponse_Message {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *APICallResponse) GetRoom() *Room {
	if x != nil {
		if x, ok := x.Message.(*APICallResponse_Room); ok {
			return x.Room
		}
	}
	return nil
...
func file_livekit_analytics_proto_init() {
	...
	file_livekit_analytics_proto_msgTypes[14].OneofWrappers = []any{
