...
// 	protoc        v3.17.3
// source: livekit/livekit_analytics.proto
...
func (StreamType) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_livekit_analytics_proto_enumTypes[0].Descriptor()
}

func (StreamType) Type() protoreflect.EnumType {
	return &file_livekit_livekit_analytics_proto_enumTypes[0]
}
...
func (StreamType) EnumDescriptor() ([]byte, []int) {
	return file_livekit_livekit_analytics_proto_rawDescGZIP(), []int{0}
}
...
func (AnalyticsEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_livekit_analytics_proto_enumTypes[1].Descriptor()
}

func (AnalyticsEventType) Type() protoreflect.EnumType {
	return &file_livekit_livekit_analytics_proto_enumTypes[1]
}
...
func (AnalyticsEventType) EnumDescriptor() ([]byte, []int) {
	return file_livekit_livekit_analytics_proto_rawDescGZIP(), []int{1}
}
...
func (x *AnalyticsStat) Reset() {
	*x = AnalyticsStat{}
	if protoimpl.UnsafeEnabled {
		mi := &file_livekit_livekit_analytics_proto_msgTypes[0]
...
func (x *AnalyticsStats) Reset() {
	*x = AnalyticsStats{}
	if protoimpl.UnsafeEnabled {
		mi := &file_livekit_livekit_analytics_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *AnalyticsEvent) Reset() {
	*x = AnalyticsEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_livekit_livekit_analytics_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AnalyticsEvent) Descriptor() ([]byte, []int) {
	return file_livekit_livekit_analytics_proto_rawDescGZIP(), []int{2}
}
...
func (x *AnalyticsEvents) Reset() {
	*x = AnalyticsEvents{}
	if protoimpl.UnsafeEnabled {
		mi := &file_livekit_livekit_analytics_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AnalyticsEvents) Descriptor() ([]byte, []int) {
	return file_livekit_livekit_analytics_proto_rawDescGZIP(), []int{3}
}
...
var File_livekit_livekit_analytics_proto protoreflect.FileDescriptor

var file_livekit_livekit_analytics_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2f, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	0x74, 0x5f, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1c, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	0x74, 0x2f, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2f,
	0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf7, 0x03, 0x0a, 0x0d, 0x41, 0x6e, 0x61, 0x6c, 0x79,
	...
	0x22, 0xf5, 0x03, 0x0a, 0x0e, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x73, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x12, 0x2f, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1b, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x41, 0x6e, 0x61, 0x6c,
	0x79, 0x74, 0x69, 0x63, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04,
	...
	0x0a, 0x08, 0x72, 0x6f, 0x6f, 0x6d, 0x5f, 0x73, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x72, 0x6f, 0x6f, 0x6d, 0x53, 0x69, 0x64, 0x12, 0x21, 0x0a, 0x04, 0x72, 0x6f, 0x6f,
	...
	,
	...
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x28, 0x01, 0x42, 0x25, 0x5a, 0x23,
...
var (
	file_livekit_livekit_analytics_proto_rawDescOnce sync.Once
	file_livekit_livekit_analytics_proto_rawDescData = file_livekit_livekit_analytics_proto_rawDesc
)

func file_livekit_livekit_analytics_proto_rawDescGZIP() []byte {
	file_livekit_livekit_analytics_proto_rawDescOnce.Do(func() {
		file_livekit_livekit_analytics_proto_rawDescData = protoimpl.X.CompressGZIP(file_livekit_livekit_analytics_proto_rawDescData)
	})
	return file_livekit_livekit_analytics_proto_rawDescData
}

var file_livekit_livekit_analytics_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_livekit_livekit_analytics_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_livekit_livekit_analytics_proto_goTypes = []interface{}{
...
var file_livekit_livekit_analytics_proto_depIdxs = []int32{
...
func init() { file_livekit_livekit_analytics_proto_init() }
func file_livekit_livekit_analytics_proto_init() {
	if File_livekit_livekit_analytics_proto != nil {
		return
	}
	file_livekit_livekit_models_proto_init()
	file_livekit_livekit_internal_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_livekit_livekit_analytics_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_livekit_analytics_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_livekit_analytics_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_livekit_analytics_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_livekit_livekit_analytics_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_livekit_livekit_analytics_proto_goTypes,
		DependencyIndexes: file_livekit_livekit_analytics_proto_depIdxs,
		EnumInfos:         file_livekit_livekit_analytics_proto_enumTypes,
		MessageInfos:      file_livekit_livekit_analytics_proto_msgTypes,
	}.Build()
	File_livekit_livekit_analytics_proto = out.File
	file_livekit_livekit_analytics_proto_rawDesc = nil
	file_livekit_livekit_analytics_proto_goTypes = nil
	file_livekit_livekit_analytics_proto_depIdxs = nil
}
