...
func (x *TrafficStats) GetStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *TrafficStats) GetEndTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
func (x *TrafficStats) GetPackets() uint32 {
	if x != nil {
		return x.Packets
	}
	return 0
...
type TrafficTypeStats struct {
	...
	TrackType    TrackType     `protobuf:"varint,1,opt,name=track_type,json=trackType,proto3,enum=livekit.TrackType" json:"track_type,omitempty"`
	StreamType   StreamType    `protobuf:"varint,2,opt,name=stream_type,json=streamType,proto3,enum=livekit.StreamType" json:"stream_type,omitempty"`
	TrafficStats *TrafficStats `protobuf:"bytes,3,opt,name=traffic_stats,json=trafficStats,proto3" json:"traffic_stats,omitempty"`
}

func (x *TrafficTypeStats) Reset() {
	*x = TrafficTypeStats{}
	if protoimpl.UnsafeEnabled {
...
func (x *TrafficTypeStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrafficTypeStats) ProtoMessage() {}

func (x *TrafficTypeStats) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_analytics_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrafficTypeStats.ProtoReflect.Descriptor instead.
func (*TrafficTypeStats) Descriptor() ([]byte, []int) {
	return file_livekit_analytics_proto_rawDescGZIP(), []int{8}
}

func (x *TrafficTypeStats) GetTrackType() TrackType {
	if x != nil {
		return x.TrackType
	}
...
func (x *TrafficTypeStats) GetStreamType() StreamType {
	if x != nil {
		return x.StreamType
	}
	return StreamType_UPSTREAM
...
func (x *TrafficTypeStats) GetTrafficStats() *TrafficStats {
	if x != nil {
...
type TrafficLoad struct {
	...
	TrafficTypeStats []*TrafficTypeStats `protobuf:"bytes,1,rep,name=traffic_type_stats,json=trafficTypeStats,proto3" json:"traffic_type_stats,omitempty"`
}

func (x *TrafficLoad) Reset() {
	*x = TrafficLoad{}
	if protoimpl.UnsafeEnabled {
...
func (*TrafficLoad) ProtoMessage() {}

func (x *TrafficLoad) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_analytics_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrafficLoad.ProtoReflect.Descriptor instead.
func (*TrafficLoad) Descriptor() ([]byte, []int) {
	return file_livekit_analytics_proto_rawDescGZIP(), []int{9}
}

func (x *TrafficLoad) GetTrafficTypeStats() []*TrafficTypeStats {
	if x != nil {
		return x.TrafficTypeStats
	}
	return nil
}
...
var file_livekit_analytics_proto_rawDesc = []byte{
	...
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xb0, 0x01, 0x0a, 0x0c, 0x54, 0x72, 0x61, 0x66, 0x66,
	0x69, 0x63, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x39, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74,
	...
	0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61, 0x63,
	0x6b, 0x65, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x70, 0x61, 0x63, 0x6b,
	0x65, 0x74, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x05, 0x62, 0x79, 0x74, 0x65, 0x73, 0x22, 0xb7, 0x01, 0x0a, 0x10, 0x54, 0x72,
	0x61, 0x66, 0x66, 0x69, 0x63, 0x54, 0x79, 0x70, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x31,
	...
	0x65, 0x12, 0x34, 0x0a, 0x0b, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f, 0x74, 0x79, 0x70, 0x65,
	...
	,
	...
	0x74, 0x79, 0x22, 0x00, 0x28, 0x01, 0x42, 0x46, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_livekit_analytics_proto_goTypes = []interface{}{
	...
	(*TrafficStats)(nil),          // 9: livekit.TrafficStats
	(*TrafficTypeStats)(nil),      // 10: livekit.TrafficTypeStats
	(*TrafficLoad)(nil),           // 11: livekit.TrafficLoad
...
var file_livekit_analytics_proto_depIdxs = []int32{
	...
	12, // 19: livekit.TrafficStats.start_time:type_name -> google.protobuf.Timestamp
	12, // 20: livekit.TrafficStats.end_time:type_name -> google.protobuf.Timestamp
	22, // 21: livekit.TrafficTypeStats.track_type:type_name -> livekit.TrackType
	0,  // 22: livekit.TrafficTypeStats.stream_type:type_name -> livekit.StreamType
	9,  // 23: livekit.TrafficTypeStats.traffic_stats:type_name -> livekit.TrafficStats
	10, // 24: livekit.TrafficLoad.traffic_type_stats:type_name -> livekit.TrafficTypeStats
	...
	23, // 27: livekit.AnalyticsRecorderService.IngestStats:output_type -> google.protobuf.Empty
	23, // 28: livekit.AnalyticsRecorderService.IngestEvents:output_type -> google.protobuf.Empty
