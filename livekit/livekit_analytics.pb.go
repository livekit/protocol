...
type AnalyticsRoomParticipant struct {
	...
	Kind     ParticipantInfo_Kind   `protobuf:"varint,5,opt,name=kind,proto3,enum=livekit.ParticipantInfo_Kind" json:"kind,omitempty"`
...
func (x *AnalyticsRoomParticipant) GetKind() ParticipantInfo_Kind {
	if x != nil {
		return x.Kind
	}
...
type AnalyticsRoom struct {
	...
	Participants    []*AnalyticsRoomParticipant `protobuf:"bytes,5,rep,name=participants,proto3" json:"participants,omitempty"`
}
...
func (x *AnalyticsRoom) GetNumParticipants() uint32 {
	if x != nil {
...
var file_livekit_analytics_proto_rawDesc = []byte{
	...
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xfc, 0x01, 0x0a, 0x18, 0x41, 0x6e, 0x61, 0x6c, 0x79,
	...
	0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x31, 0x0a, 0x04, 0x6b, 0x69, 0x6e,
	0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	0x74, 0x2e, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x49, 0x6e, 0x66,
	0x6f, 0x2e, 0x4b, 0x69, 0x6e, 0x64, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x37, 0x0a, 0x09,
	...
	0x6e, 0x65, 0x64, 0x41, 0x74, 0x22, 0xe0, 0x01, 0x0a, 0x0d, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x74,
	0x69, 0x63, 0x73, 0x52, 0x6f, 0x6f, 0x6d, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
...
var file_livekit_analytics_proto_goTypes = []interface{}{
	...
	(ParticipantInfo_Kind)(0),        // 23: livekit.ParticipantInfo.Kind
...
var file_livekit_analytics_proto_depIdxs = []int32{
	...
	23, // 20: livekit.AnalyticsRoomParticipant.kind:type_name -> livekit.ParticipantInfo.Kind
	12, // 21: livekit.AnalyticsRoomParticipant.joined_at:type_name -> google.protobuf.Timestamp
	12, // 22: livekit.AnalyticsRoom.created_at:type_name -> google.protobuf.Timestamp
	9,  // 23: livekit.AnalyticsRoom.participants:type_name -> livekit.AnalyticsRoomParticipant
	12, // 24: livekit.AnalyticsNodeRooms.timestamp:type_name -> google.protobuf.Timestamp
	10, // 25: livekit.AnalyticsNodeRooms.rooms:type_name -> livekit.AnalyticsRoom
	5,  // 26: livekit.AnalyticsRecorderService.IngestStats:input_type -> livekit.AnalyticsStats
	8,  // 27: livekit.AnalyticsRecorderService.IngestEvents:input_type -> livekit.AnalyticsEvents
	11, // 28: livekit.AnalyticsRecorderService.IngestNodeRoomStates:input_type -> livekit.AnalyticsNodeRooms
	24, // 29: livekit.AnalyticsRecorderService.IngestStats:output_type -> google.protobuf.Empty
	24, // 30: livekit.AnalyticsRecorderService.IngestEvents:output_type -> google.protobuf.Empty
	24, // 31: livekit.AnalyticsRecorderService.IngestNodeRoomStates:output_type -> google.protobuf.Empty
