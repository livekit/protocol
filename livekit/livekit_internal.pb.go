...
const file_livekit_internal_proto_rawDesc = "" +
	"\n" +
	"\x16livekit_internal.proto\x12\alivekit\x1a\x14livekit_models.proto\x1a\x14livekit_egress.proto\x1a\x1clivekit_agent_dispatch.proto\x1a\x12livekit_room.proto\x1a\x14livekit_rtc_v2.proto\"\xd4\x01\n" +
	"\x04Node\x12\x0e\n" +
	...
	"createRoomB\x19\n" +
	"\x17_subscriber_allow_pause\"\xab\x01\n" +
	"\x18CreateParticipantSession\x12\x1f\n" +
	"\vgrants_json\x18\x03 \x01(\tR\n" +
	"grantsJson\x12;\n" +
	"\vcreate_room\x18\x04 \x01(\v2\x1a.livekit.CreateRoomRequestR\n" +
	"createRoom\x121\n" +
	"\aconnect\x18\x05 \x01(\v2\x17.livekit.ConnectRequestR\aconnect\"\xe7\x02\n" +
	"\fRoomInternal\x12;\n" +
