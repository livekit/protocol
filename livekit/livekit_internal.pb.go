...
type RoomInternal struct {
	...
	Dispatches        []*RoomAgentDispatch   `protobuf:"bytes,5,rep,name=dispatches,proto3" json:"dispatches,omitempty"`
...
func (x *RoomInternal) GetDispatches() []*RoomAgentDispatch {
	if x != nil {
		return x.Dispatches
	}
	return nil
...
var file_livekit_internal_proto_rawDesc = []byte{
	...
	0xb5, 0x02, 0x0a, 0x0c, 0x52, 0x6f, 0x6f, 0x6d, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	...
	0x6f, 0x75, 0x74, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x12, 0x3a, 0x0a, 0x0a, 0x64, 0x69, 0x73, 0x70,
...
var file_livekit_internal_proto_depIdxs = []int32{
	...
	13, // 8: livekit.RoomInternal.dispatches:type_name -> livekit.RoomAgentDispatch
