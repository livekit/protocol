...
func (c *cloudAgentProtobufClient) ListAgent(ctx context.Context, in *ListAgentRequest) (*ListAgentResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "livekit")
	ctx = ctxsetters.WithServiceName(ctx, "CloudAgent")
	ctx = ctxsetters.WithMethodName(ctx, "ListAgent")
	caller := c.callListAgent
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *ListAgentRequest) (*ListAgentResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*ListAgentRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*ListAgentRequest) when calling interceptor")
					}
					return c.callListAgent(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ListAgentResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*ListAgentResponse) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *cloudAgentProtobufClient) callListAgent(ctx context.Context, in *ListAgentRequest) (*ListAgentResponse, error) {
...
func (c *cloudAgentJSONClient) ListAgent(ctx context.Context, in *ListAgentRequest) (*ListAgentResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "livekit")
	ctx = ctxsetters.WithServiceName(ctx, "CloudAgent")
	ctx = ctxsetters.WithMethodName(ctx, "ListAgent")
	caller := c.callListAgent
...
func (c *cloudAgentJSONClient) callListAgent(ctx context.Context, in *ListAgentRequest) (*ListAgentResponse, error) {
	out := new(ListAgentResponse)
...
func (s *cloudAgentServer) serveListAgentJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(ListAgentRequest)
	unmarshaler := protojson.UnmarshalOptions{DiscardUnknown: true}
	if err = unmarshaler.Unmarshal(rawReqBody, reqContent); err != nil {
		s.handleRequestBodyError(ctx, resp, "the json request could not be decoded", err)
		return
	...
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *ListAgentRequest) (*ListAgentResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*ListAgentRequest)
					if !ok {
	...
	// Call service method
	var respContent *ListAgentResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = handler(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *ListAgentResponse and nil error while calling ListAgent. nil responses are not supported"))
		return
	}
...
var twirpFileDescriptor5 = []byte{
	...
	,
}
