...
type PrivateLink struct {
	...
	Endpoint      string                 `protobuf:"bytes,6,opt,name=endpoint,proto3" json:"endpoint,omitempty"`                       // Customer-provided endpoint identifier.
	LkEndpoint    string                 `protobuf:"bytes,7,opt,name=lk_endpoint,json=lkEndpoint,proto3" json:"lk_endpoint,omitempty"` // LiveKit-provided DNS endpoint for agent code.
...
func (x *PrivateLink) GetLkEndpoint() string {
	if x != nil {
		return x.LkEndpoint
	}
	return ""
...
const file_livekit_cloud_agent_proto_rawDesc = "" +
	...
	"\x15ClientSettingsRequest\"\xb4\x02\n" +
	"\vPrivateLink\x129\n" +
