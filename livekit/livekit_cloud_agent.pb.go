...
func (x *CreateAgentResponse) GetBuildId() string {
	if x != nil {
		return x.BuildId
	}
	return ""
...
func (x *DeployAgentResponse) GetBuildId() string {
	if x != nil {
		return x.BuildId
	}
	return ""
...
const file_livekit_cloud_agent_proto_rawDesc = "" +
	...
	"\aregions\x18\x06 \x03(\tR\aregions\"\xc1\x01\n" +
	...
	"\rpresigned_url\x18\x05 \x01(\tR\fpresignedUrl\x12\x19\n" +
	"\bbuild_id\x18\x06 \x01(\tR\abuildId\"\xdc\x02\n" +
	...
	"\acpu_req\x18\x06 \x01(\tB\x02\x18\x01R\x06cpuReq\"\xa4\x01\n" +
	"\x13DeployAgentResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x19\n" +
	"\bagent_id\x18\x03 \x01(\tR\aagentId\x12#\n" +
	"\rpresigned_url\x18\x04 \x01(\tR\fpresignedUrl\x12\x19\n" +
	"\bbuild_id\x18\x05 \x01(\tR\abuildId\"\xa3\x01\n" +
