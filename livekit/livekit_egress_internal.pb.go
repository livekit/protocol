...
func (x *EgressRequest) GetUpdateLayout() *UpdateLayoutRequest {
	if x, ok := x.GetRequest().(*EgressRequest_UpdateLayout); ok {
...
type EgressRequest_UpdateLayout struct {
	UpdateLayout *UpdateLayoutRequest `protobuf:"bytes,6,opt,name=update_layout,json=updateLayout,proto3,oneof"`
}
...
func (*EgressRequest_UpdateLayout) isEgressRequest_Request() {}
...
var file_livekit_egress_internal_proto_rawDesc = []byte{
	...
	0x6c, 0x42, 0x09, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xaf, 0x02, 0x0a,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x04, 0x73, 0x74, 0x6f, 0x70, 0x12, 0x43,
	0x0a, 0x0d, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x18,
	...
	0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x0c, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x79,
	0x6f, 0x75, 0x74, 0x42, 0x09, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x6e,
...
var file_livekit_egress_internal_proto_goTypes = []interface{}{
	...
	(*UpdateLayoutRequest)(nil),         // 8: livekit.UpdateLayoutRequest
...
var file_livekit_egress_internal_proto_depIdxs = []int32{
	...
	8, // 5: livekit.EgressRequest.update_layout:type_name -> livekit.UpdateLayoutRequest
...
func file_livekit_egress_internal_proto_init() {
	...
	file_livekit_egress_internal_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*EgressRequest_UpdateLayout)(nil),
	}
	type x struct{}
