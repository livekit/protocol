...
const file_livekit_connector_twilio_proto_rawDesc = "" +
	"\n" +
	"\x1elivekit_connector_twilio.proto\x12\alivekit\x1a\x1clivekit_agent_dispatch.proto\x1a\x14logger/options.proto\"\xa8\x06\n" +
	...
	"\x10participant_name\x18\x05 \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x0fparticipantName\x12W\n" +
	"\x14participant_metadata\x18\x06 \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x13participantMetadata\x12\x99\x01\n" +
	"\x16participant_attributes\x18\a \x03(\v2<.livekit.ConnectTwilioCallRequest.ParticipantAttributesEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x15participantAttributes\x12/\n" +
