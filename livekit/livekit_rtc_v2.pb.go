...
type ConnectRequest struct {
	...
	ParticipantAttributes map[string]string      `protobuf:"bytes,6,rep,name=participant_attributes,json=participantAttributes,proto3" json:"participant_attributes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
const file_livekit_rtc_v2_proto_rawDesc = "" +
	...
	"\x0fserver_messages\x18\x01 \x03(\v2\x1e.livekit.Signalv2ServerMessageR\x0eserverMessages\"\xc4\x01\n" +
	"\x12ConnectionSettings\x12%\n" +
	"\x0eauto_subscribe\x18\x01 \x01(\bR\rautoSubscribe\x12'\n" +
	"\x0fadaptive_stream\x18\x02 \x01(\bR\x0eadaptiveStream\x124\n" +
	"\x16subscriber_allow_pause\x18\x03 \x01(\bR\x14subscriberAllowPause\x12(\n" +
	"\x10disable_ice_lite\x18\x04 \x01(\bR\x0edisableIceLite\"\xd2\x01\n" +
	...
	"encryption\x12\x15\n" +
	"\x03sid\x18\x06 \x01(\tH\x00R\x03sid\x88\x01\x01B\x06\n" +
	"\x04_sid\"\xaf\x01\n" +
	"\n" +
	"AudioTrack\x12=\n" +
	...
	"\n" +
	"VideoTrack\x12=\n" +
	"\x0etrack_settings\x18\x01 \x01(\v2\x16.livekit.TrackSettingsR\rtrackSettings\x12B\n" +
	"\x10simulcast_codecs\x18\x02 \x03(\v2\x17.livekit.SimulcastCodecR\x0fsimulcastCodecs\x12J\n" +
	"\x13backup_codec_policy\x18\x03 \x01(\x0e2\x1a.livekit.BackupCodecPolicyR\x11backupCodecPolicy\"\xfb\x03\n" +
	"\x0eConnectRequest\x124\n" +
	"\vclient_info\x18\x01 \x01(\v2\x13.livekit.ClientInfoR\n" +
	"clientInfo\x12@\n" +
	"\rpublisher_sdp\x18\x02 \x01(\v2\x1b.livekit.SessionDescriptionR\fpublisherSdp\x12L\n" +
	"\x13connection_settings\x18\x03 \x01(\v2\x1b.livekit.ConnectionSettingsR\x12connectionSettings\x126\n" +
	"\faudio_tracks\x18\x04 \x03(\v2\x13.livekit.AudioTrackR\vaudioTracks\x126\n" +
	"\fvideo_tracks\x18\x05 \x03(\v2\x13.livekit.VideoTrackR\vvideoTracks\x12i\n" +
	"\x16participant_attributes\x18\x06 \x03(\v22.livekit.ConnectRequest.ParticipantAttributesEntryR\x15participantAttributes\x1aH\n" +
	...
	"\n" +
	"sync_state\x18\x03 \x01(\v2\x12.livekit.SyncStateR\tsyncState\"\xaa\x05\n" +
	...
	"iceServers\x12O\n" +
	"\x14client_configuration\x18\x05 \x01(\v2\x1c.livekit.ClientConfigurationR\x13clientConfiguration\x12!\n" +
	"\fping_timeout\x18\x06 \x01(\x05R\vpingTimeout\x12#\n" +
	"\rping_interval\x18\a \x01(\x05R\fpingInterval\x124\n" +
	"\vserver_info\x18\b \x01(\v2\x13.livekit.ServerInfoR\n" +
	"serverInfo\x12\x1f\n" +
	"\vsif_trailer\x18\t \x01(\fR\n" +
	"sifTrailer\x12D\n" +
	"\x16enabled_publish_codecs\x18\n" +
	" \x03(\v2\x0e.livekit.CodecR\x14enabledPublishCodecs\x12@\n" +
	"\rpublisher_sdp\x18\v \x01(\v2\x1b.livekit.SessionDescriptionR\fpublisherSdp\x12B\n" +
	"\x0esubscriber_sdp\x18\f \x01(\v2\x1b.livekit.SessionDescriptionR\rsubscriberSdp\"D\n" +
