...
const file_livekit_rtc_v2_proto_rawDesc = "" +
	...
	"\x0fserver_messages\x18\x01 \x03(\v2\x1e.livekit.Signalv2ServerMessageR\x0eserverMessages\"\xe0\x01\n" +
	"\x12ConnectionSettings\x12\x1a\n" +
	"\bprotocol\x18\x01 \x01(\rR\bprotocol\x12%\n" +
	"\x0eauto_subscribe\x18\x02 \x01(\bR\rautoSubscribe\x12'\n" +
	"\x0fadaptive_stream\x18\x03 \x01(\bR\x0eadaptiveStream\x124\n" +
	"\x16subscriber_allow_pause\x18\x04 \x01(\bR\x14subscriberAllowPause\x12(\n" +
	"\x10disable_ice_lite\x18\x05 \x01(\bR\x0edisableIceLite\"\xd2\x01\n" +
