...
const file_livekit_rtc_v2_proto_rawDesc = "" +
	...
	" last_processed_remote_message_id\x18\x02 \x01(\rR\x1clastProcessedRemoteMessageId\"\x88\x02\n" +
	"\x15Signalv2ClientMessage\x120\n" +
	"\tsequencer\x18\x01 \x01(\v2\x12.livekit.SequencerR\tsequencer\x12B\n" +
	"\x0fconnect_request\x18\x02 \x01(\v2\x17.livekit.ConnectRequestH\x00R\x0econnectRequest\x126\n" +
	"\vaudio_track\x18\x03 \x01(\v2\x13.livekit.AudioTrackH\x00R\n" +
	"audioTrack\x126\n" +
	"\vvideo_track\x18\x04 \x01(\v2\x13.livekit.VideoTrackH\x00R\n" +
	"videoTrackB\t\n" +
	"\amessage\"\x9b\x01\n" +
