...
func (x *Signalv2ClientMessage) GetReplayRequest() bool {
	if x != nil {
		if x, ok := x.Message.(*Signalv2ClientMessage_ReplayRequest); ok {
...
const file_livekit_rtc_v2_proto_rawDesc = "" +
	"\n" +
	"\x14livekit_rtc_v2.proto\x12\alivekit\x1a\x11livekit_rtc.proto\x1a\x14livekit_models.proto\"\x9b\v\n" +
	...
	"\x0ereplay_request\x18\x14 \x01(\bH\x00R\rreplayRequestB\t\n" +
	"\amessage\"a\n" +
	"\x16Signalv2ClientEnvelope\x12G\n" +
	"\x0fclient_messages\x18\x01 \x03(\v2\x1e.livekit.Signalv2ClientMessageR\x0eclientMessages\"\x84\f\n" +
	...
	"\x13room_moved_response\x18\x16 \x01(\v2\x1a.livekit.RoomMovedResponseH\x00R\x11roomMovedResponseB\t\n" +
	"\amessage\"a\n" +
	...
	"\x13backup_codec_policy\x18\x03 \x01(\x0e2\x1a.livekit.BackupCodecPolicyR\x11backupCodecPolicy\"\xc6\x02\n" +
	...
	"\fvideo_tracks\x18\x05 \x03(\v2\x13.livekit.VideoTrackR\vvideoTracks\"\xb3\x01\n" +
