...
const file_livekit_rtc_v2_proto_rawDesc = "" +
	"\n" +
	"\x14livekit_rtc_v2.proto\x12\alivekit\x1a\x11livekit_rtc.proto\x1a\x14livekit_models.proto\"\x8c\x02\n" +
	...
	"\benvelope\x18\x03 \x01(\v2\x1f.livekit.Signalv2ClientEnvelopeH\x00R\benvelope\x12B\n" +
	"\x0fconnect_request\x18\x04 \x01(\v2\x17.livekit.ConnectRequestH\x00R\x0econnectRequestB\t\n" +
	"\amessage\"a\n" +
	"\x16Signalv2ClientEnvelope\x12G\n" +
	"\x0fclient_messages\x18\x01 \x03(\v2\x1e.livekit.Signalv2ClientMessageR\x0eclientMessages\"\xbf\x02\n" +
