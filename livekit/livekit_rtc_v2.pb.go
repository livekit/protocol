...
const file_livekit_rtc_v2_proto_rawDesc = "" +
	"\n" +
	"\x14livekit_rtc_v2.proto\x12\alivekit\x1a\x11livekit_rtc.proto\x1a\x14livekit_models.proto\"\xf2\n" +
	"\n" +
	...
	"\x18update_local_video_track\x18\x13 \x01(\v2\x1e.livekit.UpdateLocalVideoTrackH\x00R\x15updateLocalVideoTrackB\t\n" +
	"\amessage\"a\n" +
