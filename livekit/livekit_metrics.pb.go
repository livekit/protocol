...
func (x *MetricsRecordingHeader) GetTags() map[string]string {
	if x != nil {
		return x.Tags
	}
	return nil
...
const file_livekit_metrics_proto_rawDesc = "" +
	...
	"\x19_normalized_end_timestamp\"\x80\x02\n" +
	...
	"\x04tags\x18\x05 \x03(\v2).livekit.MetricsRecordingHeader.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
...
var file_livekit_metrics_proto_goTypes = []any{
	...
	nil,                            // 6: livekit.MetricsRecordingHeader.TagsEntry
...
var file_livekit_metrics_proto_depIdxs = []int32{
	...
	6, // 8: livekit.MetricsRecordingHeader.tags:type_name -> livekit.MetricsRecordingHeader.TagsEntry
