...
type MetricsBatch struct {
	...
	Timestamp int64 `protobuf:"varint,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // current time based on some monotonic clock
...
type EventMetric struct {
	...
	StartTimestamp      int64  `protobuf:"varint,4,opt,name=start_timestamp,json=startTimestamp,proto3" json:"start_timestamp,omitempty"` // time of event based on a monotonic clock
