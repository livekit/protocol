...
type MetricsRecordingHeader struct {
	...
	Parts         map[string]*MetricsRecordingHeader_Part `protobuf:"bytes,2,rep,name=parts,proto3" json:"parts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetricsRecordingHeader) GetParts() map[string]*MetricsRecordingHeader_Part {
	if x != nil {
		return x.Parts
	}
	return nil
...
type MetricsRecordingHeader_Part struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MetricsRecordingHeader_Part) Reset() {
	*x = MetricsRecordingHeader_Part{}
	mi := &file_livekit_metrics_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MetricsRecordingHeader_Part) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MetricsRecordingHeader_Part) ProtoMessage() {}

func (x *MetricsRecordingHeader_Part) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_metrics_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MetricsRecordingHeader_Part.ProtoReflect.Descriptor instead.
func (*MetricsRecordingHeader_Part) Descriptor() ([]byte, []int) {
	return file_livekit_metrics_proto_rawDescGZIP(), []int{4, 0}
}

func (x *MetricsRecordingHeader_Part) GetContentLength() uint32 {
	if x != nil {
...
var file_livekit_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_livekit_metrics_proto_goTypes = []any{
	...
	(*MetricsRecordingHeader_Part)(nil), // 6: livekit.MetricsRecordingHeader.Part
	nil,                                 // 7: livekit.MetricsRecordingHeader.PartsEntry
	(*timestamppb.Timestamp)(nil),       // 8: google.protobuf.Timestamp
}
var file_livekit_metrics_proto_depIdxs = []int32{
	8, // 0: livekit.MetricsBatch.normalized_timestamp:type_name -> google.protobuf.Timestamp
	...
	8, // 4: livekit.MetricSample.normalized_timestamp:type_name -> google.protobuf.Timestamp
	8, // 5: livekit.EventMetric.normalized_start_timestamp:type_name -> google.protobuf.Timestamp
	8, // 6: livekit.EventMetric.normalized_end_timestamp:type_name -> google.protobuf.Timestamp
	7, // 7: livekit.MetricsRecordingHeader.parts:type_name -> livekit.MetricsRecordingHeader.PartsEntry
	6, // 8: livekit.MetricsRecordingHeader.PartsEntry.value:type_name -> livekit.MetricsRecordingHeader.Part
