...
const file_livekit_ingress_proto_rawDesc = "" +
	"\n" +
	"\x15livekit_ingress.proto\x12\alivekit\x1a\x14livekit_models.proto\x1a\x14logger/options.proto\"\x81\x05\n" +
	...
	"\x06layers\x18\x03 \x03(\v2\x13.livekit.VideoLayerR\x06layers\"\xff\x05\n" +
	...
	"\x14participant_identity\x18\t \x01(\tR\x13participantIdentity\x12Q\n" +
	"\x10participant_name\x18\n" +
	" \x01(\tB&\x88\xec,\x01\x92\xec,\x1e<redacted ({{ .Size }} bytes)>R\x0fparticipantName\x12Y\n" +
