...
type IngressInfo struct {
	...
	SessionEnabled      *bool                `protobuf:"varint,16,opt,name=session_enabled,json=sessionEnabled,proto3,oneof" json:"session_enabled,omitempty"`
}
...
type UpdateIngressRequest struct {
	...
	Audio             *IngressAudioOptions `protobuf:"bytes,6,opt,name=audio,proto3" json:"audio,omitempty"`
	Video             *IngressVideoOptions `protobuf:"bytes,7,opt,name=video,proto3" json:"video,omitempty"`
	SessionEnabled    *bool                `protobuf:"varint,11,opt,name=session_enabled,json=sessionEnabled,proto3,oneof" json:"session_enabled,omitempty"` // NEXT_ID: 12
}
