...
const file_livekit_ingress_proto_rawDesc = "" +
	"\n" +
	"\x15livekit_ingress.proto\x12\alivekit\x1a\x14livekit_models.proto\x1a\x14logger/options.proto\"\xdc\x04\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x14.livekit.IngressInfoR\x05items\"C\n" +
