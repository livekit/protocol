...
const (
	AudioCodec_OPUS AudioCodec = 0
	AudioCodec_AAC  AudioCodec = 1
)
...
const (
	VideoCodec_H264_BASELINE VideoCodec = 0 // maximum compatibility
	VideoCodec_H264_MAIN     VideoCodec = 1 // modern devices and web playback
	VideoCodec_H264_HIGH     VideoCodec = 2 // best quality and compression
	VideoCodec_VP8           VideoCodec = 3
	VideoCodec_VP9           VideoCodec = 4
	VideoCodec_HEVC_MAIN     VideoCodec = 5
	VideoCodec_HEVC_HIGH     VideoCodec = 6
)
...
type EncodingOptions struct {
	...
	AudioCodec     AudioCodec `protobuf:"varint,5,opt,name=audio_codec,json=audioCodec,proto3,enum=livekit.AudioCodec" json:"audio_codec,omitempty"` // (default AAC)
...
func (x *EncodingOptions) GetVideoCodec() VideoCodec {
	...
	return VideoCodec_H264_BASELINE
}
...
var file_livekit_egress_proto_rawDesc = []byte{
	...
	,
