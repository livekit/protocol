...
type TrackEgressRequest struct {
	...
	Containerize bool   `protobuf:"varint,3,opt,name=containerize,proto3" json:"containerize,omitempty"`        // does not work with websocket output
	// Types that are assignable to Output:
	//	*TrackEgressRequest_S3
	//	*TrackEgressRequest_Gcp
	//	*TrackEgressRequest_Azure
...
func (x *TrackEgressRequest) GetContainerize() bool {
	if x != nil {
		return x.Containerize
	}
	return false
}
...
func (x *TrackEgressRequest) GetS3() *S3Upload {
	if x, ok := x.GetOutput().(*TrackEgressRequest_S3); ok {
		return x.S3
	}
	return nil
}

func (x *TrackEgressRequest) GetGcp() *GCPUpload {
	if x, ok := x.GetOutput().(*TrackEgressRequest_Gcp); ok {
		return x.Gcp
	}
	return nil
}

func (x *TrackEgressRequest) GetAzure() *AzureBlobUpload {
	if x, ok := x.GetOutput().(*TrackEgressRequest_Azure); ok {
		return x.Azure
	}
	return nil
}
...
type TrackEgressRequest_S3 struct {
	S3 *S3Upload `protobuf:"bytes,4,opt,name=s3,proto3,oneof"`
}

type TrackEgressRequest_Gcp struct {
	Gcp *GCPUpload `protobuf:"bytes,5,opt,name=gcp,proto3,oneof"`
}

type TrackEgressRequest_Azure struct {
	Azure *AzureBlobUpload `protobuf:"bytes,6,opt,name=azure,proto3,oneof"`
}

type TrackEgressRequest_WebsocketUrl struct {
	WebsocketUrl string `protobuf:"bytes,7,opt,name=websocket_url,json=websocketUrl,proto3,oneof"`
}

func (*TrackEgressRequest_S3) isTrackEgressRequest_Output() {}

func (*TrackEgressRequest_Gcp) isTrackEgressRequest_Output() {}

func (*TrackEgressRequest_Azure) isTrackEgressRequest_Output() {}
...
func (x *EncodedFileOutput) GetFileType() EncodedFileType {
	...
	return EncodedFileType_DEFAULT
}
...
var file_livekit_egress_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xa0, 0x02, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x63, 0x6b,
	...
	0x61, 0x63, 0x6b, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x63, 0x6f, 0x6e,
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x69, 0x7a, 0x65, 0x12, 0x23, 0x0a, 0x02, 0x73, 0x33, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e,
	0x53, 0x33, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x48, 0x00, 0x52, 0x02, 0x73, 0x33, 0x12, 0x26,
	0x0a, 0x03, 0x67, 0x63, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x69,
	...
	0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e,
	0x41, 0x7a, 0x75, 0x72, 0x65, 0x42, 0x6c, 0x6f, 0x62, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x48,
	0x00, 0x52, 0x05, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x12, 0x25, 0x0a, 0x0d, 0x77, 0x65, 0x62, 0x73,
	0x6f, 0x63, 0x6b, 0x65, 0x74, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x48,
	...
	0x52, 0x08, 0x65, 0x67, 0x72, 0x65, 0x73, 0x73, 0x49, 0x64, 0x22, 0xcc, 0x03, 0x0a, 0x0a, 0x45,
	...
	0x63, 0x6b, 0x12, 0x31, 0x0a, 0x06, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x18, 0x07, 0x20, 0x01,
	...
	0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x48, 0x01, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x14,
	0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x42, 0x09, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42,
	...
	0x69, 0x6e, 0x66, 0x6f, 0x22, 0x58, 0x0a, 0x0a, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x49, 0x6e,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x65, 0x64, 0x41, 0x74, 0x22, 0x90,
	...
	0x6e, 0x2a, 0x30, 0x0a, 0x0f, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x64, 0x46, 0x69, 0x6c, 0x65,
	...
	0x47, 0x10, 0x02, 0x2a, 0x1a, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x50, 0x72, 0x6f,
	0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x08, 0x0a, 0x04, 0x52, 0x54, 0x4d, 0x50, 0x10, 0x00, 0x2a,
	...
	0x61, 0x0a, 0x15, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x4f, 0x70, 0x74, 0x69, 0x6f,
	...
	0x10, 0x03, 0x2a, 0x5e, 0x0a, 0x0c, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74, 0x61, 0x74,
	...
	0x10, 0x03, 0x32, 0xea, 0x02, 0x0a, 0x06, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x54, 0x0a,
...
var file_livekit_egress_proto_depIdxs = []int32{
	...
	13, // 1: livekit.RoomCompositeEgressRequest.stream:type_name -> livekit.StreamOutput
	4,  // 2: livekit.RoomCompositeEgressRequest.preset:type_name -> livekit.EncodingOptionsPreset
	14, // 3: livekit.RoomCompositeEgressRequest.advanced:type_name -> livekit.EncodingOptions
	...
	10, // 8: livekit.TrackEgressRequest.s3:type_name -> livekit.S3Upload
	11, // 9: livekit.TrackEgressRequest.gcp:type_name -> livekit.GCPUpload
	12, // 10: livekit.TrackEgressRequest.azure:type_name -> livekit.AzureBlobUpload
	0,  // 11: livekit.EncodedFileOutput.file_type:type_name -> livekit.EncodedFileType
	10, // 12: livekit.EncodedFileOutput.s3:type_name -> livekit.S3Upload
	11, // 13: livekit.EncodedFileOutput.gcp:type_name -> livekit.GCPUpload
	12, // 14: livekit.EncodedFileOutput.azure:type_name -> livekit.AzureBlobUpload
	1,  // 15: livekit.StreamOutput.protocol:type_name -> livekit.StreamProtocol
	2,  // 16: livekit.EncodingOptions.audio_codec:type_name -> livekit.AudioCodec
	3,  // 17: livekit.EncodingOptions.video_codec:type_name -> livekit.VideoCodec
	20, // 18: livekit.ListEgressResponse.items:type_name -> livekit.EgressInfo
	5,  // 19: livekit.EgressInfo.status:type_name -> livekit.EgressStatus
	6,  // 20: livekit.EgressInfo.room_composite:type_name -> livekit.RoomCompositeEgressRequest
	7,  // 21: livekit.EgressInfo.track_composite:type_name -> livekit.TrackCompositeEgressRequest
	8,  // 22: livekit.EgressInfo.track:type_name -> livekit.TrackEgressRequest
	21, // 23: livekit.EgressInfo.stream:type_name -> livekit.StreamInfoList
	23, // 24: livekit.EgressInfo.file:type_name -> livekit.FileInfo
	22, // 25: livekit.StreamInfoList.info:type_name -> livekit.StreamInfo
	6,  // 26: livekit.Egress.StartRoomCompositeEgress:input_type -> livekit.RoomCompositeEgressRequest
	15, // 27: livekit.Egress.UpdateLayout:input_type -> livekit.UpdateLayoutRequest
	16, // 28: livekit.Egress.UpdateStream:input_type -> livekit.UpdateStreamRequest
	17, // 29: livekit.Egress.ListEgress:input_type -> livekit.ListEgressRequest
	19, // 30: livekit.Egress.StopEgress:input_type -> livekit.StopEgressRequest
	20, // 31: livekit.Egress.StartRoomCompositeEgress:output_type -> livekit.EgressInfo
	20, // 32: livekit.Egress.UpdateLayout:output_type -> livekit.EgressInfo
	20, // 33: livekit.Egress.UpdateStream:output_type -> livekit.EgressInfo
	18, // 34: livekit.Egress.ListEgress:output_type -> livekit.ListEgressResponse
	20, // 35: livekit.Egress.StopEgress:output_type -> livekit.EgressInfo
...
func file_livekit_egress_proto_init() {
	...
	file_livekit_egress_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*TrackEgressRequest_S3)(nil),
		(*TrackEgressRequest_Gcp)(nil),
		(*TrackEgressRequest_Azure)(nil),
