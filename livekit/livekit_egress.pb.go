...
func (x *EncodedFileOutput) GetAz() *AzBlobUpload {
	if x, ok := x.GetOutput().(*EncodedFileOutput_Az); ok {
		return x.Az
	}
	return nil
}
...
func (*EncodedFileOutput_Az) isEncodedFileOutput_Output() {}
...
var file_livekit_egress_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x61, 0x74, 0x68, 0x12, 0x23, 0x0a, 0x02, 0x73, 0x33, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x48, 0x00, 0x52, 0x03, 0x67, 0x63, 0x70, 0x42, 0x08, 0x0a, 0x06, 0x6f,
