...
type ParticipantCompositeEgressRequest struct {
	...
	CustomTemplateUrl   string `protobuf:"bytes,5,opt,name=custom_template_url,json=customTemplateUrl,proto3" json:"custom_template_url,omitempty"`
	// Types that are assignable to Output:
	//
...
func (x *ParticipantCompositeEgressRequest) GetCustomTemplateUrl() string {
	if x != nil {
...
type ParticipantCompositeEgressRequest_Preset struct {
	Preset EncodingOptionsPreset `protobuf:"varint,9,opt,name=preset,proto3,enum=livekit.EncodingOptionsPreset,oneof"` // (default H264_720P_30)
}

type ParticipantCompositeEgressRequest_Advanced struct {
	Advanced *EncodingOptions `protobuf:"bytes,10,opt,name=advanced,proto3,oneof"` // (optional)
}
...
var file_livekit_egress_proto_rawDesc = []byte{
	...
	0x87, 0x04, 0x0a, 0x21, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x43,
	...
	0x6e, 0x6c, 0x79, 0x12, 0x2e, 0x0a, 0x13, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x74, 0x65,
	0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x11, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65,
	0x55, 0x72, 0x6c, 0x12, 0x30, 0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	...
	0x74, 0x73, 0x12, 0x38, 0x0a, 0x06, 0x70, 0x72, 0x65, 0x73, 0x65, 0x74, 0x18, 0x09, 0x20, 0x01,
	...
	0x61, 0x64, 0x76, 0x61, 0x6e, 0x63, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18,
