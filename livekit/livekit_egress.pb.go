...
type SegmentedStreamType int32

const (
	SegmentedStreamType_DEFAULT_STREAMTYPE SegmentedStreamType = 0
	SegmentedStreamType_HLS_STREAMTYPE     SegmentedStreamType = 1
)

// Enum value maps for SegmentedStreamType.
var (
	SegmentedStreamType_name = map[int32]string{
		0: "DEFAULT_STREAMTYPE",
		1: "HLS_STREAMTYPE",
	}
	SegmentedStreamType_value = map[string]int32{
		"DEFAULT_STREAMTYPE": 0,
		"HLS_STREAMTYPE":     1,
	}
)

func (x SegmentedStreamType) Enum() *SegmentedStreamType {
	p := new(SegmentedStreamType)
	*p = x
	return p
}

func (x SegmentedStreamType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SegmentedStreamType) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_egress_proto_enumTypes[2].Descriptor()
}

func (SegmentedStreamType) Type() protoreflect.EnumType {
	return &file_livekit_egress_proto_enumTypes[2]
}

func (x SegmentedStreamType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SegmentedStreamType.Descriptor instead.
func (SegmentedStreamType) EnumDescriptor() ([]byte, []int) {
...
func (x *TrackCompositeEgressRequest) GetSegments() *SegmentedStreamOutput {
...
type TrackCompositeEgressRequest_Segments struct {
	Segments *SegmentedStreamOutput `protobuf:"bytes,8,opt,name=segments,proto3,oneof"`
}
...
type SegmentedStreamOutput struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	StreamType            SegmentedStreamType `protobuf:"varint,1,opt,name=stream_type,json=streamType,proto3,enum=livekit.SegmentedStreamType" json:"stream_type,omitempty"`  // (optional)
	...
	// Types that are assignable to Output:
	//	*SegmentedStreamOutput_S3
	//	*SegmentedStreamOutput_Gcp
	//	*SegmentedStreamOutput_Azure
	Output isSegmentedStreamOutput_Output `protobuf_oneof:"output"`
}

func (x *SegmentedStreamOutput) Reset() {
	*x = SegmentedStreamOutput{}
	if protoimpl.UnsafeEnabled {
...
func (x *SegmentedStreamOutput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SegmentedStreamOutput) ProtoMessage() {}

func (x *SegmentedStreamOutput) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_egress_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SegmentedStreamOutput.ProtoReflect.Descriptor instead.
func (*SegmentedStreamOutput) Descriptor() ([]byte, []int) {
	return file_livekit_egress_proto_rawDescGZIP(), []int{4}
}

func (x *SegmentedStreamOutput) GetStreamType() SegmentedStreamType {
	if x != nil {
		return x.StreamType
	}
	return SegmentedStreamType_DEFAULT_STREAMTYPE
}

func (x *SegmentedStreamOutput) GetSegmentFilenamePrefix() string {
	if x != nil {
...
func (x *SegmentedStreamOutput) GetPlaylistFilename() string {
	if x != nil {
...
func (m *SegmentedStreamOutput) GetOutput() isSegmentedStreamOutput_Output {
	if m != nil {
		return m.Output
	}
	return nil
...
func (x *SegmentedStreamOutput) GetS3() *S3Upload {
	if x, ok := x.GetOutput().(*SegmentedStreamOutput_S3); ok {
		return x.S3
	}
	return nil
}

func (x *SegmentedStreamOutput) GetGcp() *GCPUpload {
	if x, ok := x.GetOutput().(*SegmentedStreamOutput_Gcp); ok {
		return x.Gcp
	}
	return nil
}

func (x *SegmentedStreamOutput) GetAzure() *AzureBlobUpload {
	if x, ok := x.GetOutput().(*SegmentedStreamOutput_Azure); ok {
		return x.Azure
	}
	return nil
}

type isSegmentedStreamOutput_Output interface {
	isSegmentedStreamOutput_Output()
}

type SegmentedStreamOutput_S3 struct {
	S3 *S3Upload `protobuf:"bytes,4,opt,name=s3,proto3,oneof"`
}

type SegmentedStreamOutput_Gcp struct {
	Gcp *GCPUpload `protobuf:"bytes,5,opt,name=gcp,proto3,oneof"`
}

type SegmentedStreamOutput_Azure struct {
	Azure *AzureBlobUpload `protobuf:"bytes,6,opt,name=azure,proto3,oneof"`
}

func (*SegmentedStreamOutput_S3) isSegmentedStreamOutput_Output() {}

func (*SegmentedStreamOutput_Gcp) isSegmentedStreamOutput_Output() {}

func (*SegmentedStreamOutput_Azure) isSegmentedStreamOutput_Output() {}
...
var file_livekit_egress_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x22, 0xae, 0x03, 0x0a, 0x1b, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x43, 0x6f, 0x6d,
	...
	0x3c, 0x0a, 0x08, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x53, 0x65, 0x67, 0x6d,
	0x65, 0x6e, 0x74, 0x65, 0x64, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x75, 0x74, 0x70, 0x75,
	0x74, 0x48, 0x00, 0x52, 0x08, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x38, 0x0a,
	...
	0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xef, 0x01, 0x0a, 0x11, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65,
	...
	,
	...
	0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	0x74, 0x2e, 0x47, 0x43, 0x50, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x48, 0x00, 0x52, 0x03, 0x67,
	0x63, 0x70, 0x12, 0x30, 0x0a, 0x05, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	...
	0x7a, 0x75, 0x72, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xb7,
	0x01, 0x0a, 0x10, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x4f, 0x75, 0x74,
	...
	0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x8d, 0x01, 0x0a, 0x08, 0x53, 0x33, 0x55,
	...
	0x52, 0x06, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x45, 0x0a, 0x09, 0x47, 0x43, 0x50, 0x55,
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x63, 0x72, 0x65, 0x64,
	...
	0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x57, 0x0a,
	...
	0x67, 0x72, 0x65, 0x73, 0x73, 0x49, 0x64, 0x22, 0x86, 0x04, 0x0a, 0x0a, 0x45, 0x67, 0x72, 0x65,
	...
	0x6e, 0x66, 0x6f, 0x48, 0x01, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x72,
	...
	0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x3a, 0x0a, 0x0a, 0x53,
	...
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x72, 0x0a, 0x08, 0x46, 0x69, 0x6c, 0x65, 0x49,
	...
	0x09, 0x52, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x39, 0x0a, 0x0f, 0x45,
	...
	0x0a, 0x04, 0x52, 0x54, 0x4d, 0x50, 0x10, 0x01, 0x2a, 0x41, 0x0a, 0x13, 0x53, 0x65, 0x67, 0x6d,
	0x65, 0x6e, 0x74, 0x65, 0x64, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x16, 0x0a, 0x12, 0x44, 0x45, 0x46, 0x41, 0x55, 0x4c, 0x54, 0x5f, 0x53, 0x54, 0x52, 0x45, 0x41,
	0x4d, 0x54, 0x59, 0x50, 0x45, 0x10, 0x00, 0x12, 0x12, 0x0a, 0x0e, 0x48, 0x4c, 0x53, 0x5f, 0x53,
	0x54, 0x52, 0x45, 0x41, 0x4d, 0x54, 0x59, 0x50, 0x45, 0x10, 0x01, 0x2a, 0x2f, 0x0a, 0x0a, 0x41,
	...
	0x48, 0x32, 0x36, 0x34, 0x5f, 0x48, 0x49, 0x47, 0x48, 0x10, 0x03, 0x2a, 0x61, 0x0a, 0x15, 0x45,
	...
	0x32, 0x36, 0x34, 0x5f, 0x31, 0x30, 0x38, 0x30, 0x50, 0x5f, 0x36, 0x30, 0x10, 0x03, 0x2a, 0x5e,
	...
	0x45, 0x53, 0x53, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x03, 0x32, 0x88,
	0x04, 0x0a, 0x06, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x54, 0x0a, 0x18, 0x53, 0x74, 0x61,
...
var file_livekit_egress_proto_goTypes = []interface{}{
	...
	(SegmentedStreamType)(0),            // 2: livekit.SegmentedStreamType
	...
	(*SegmentedStreamOutput)(nil),       // 11: livekit.SegmentedStreamOutput
...
var file_livekit_egress_proto_depIdxs = []int32{
	...
	11, // 6: livekit.TrackCompositeEgressRequest.segments:type_name -> livekit.SegmentedStreamOutput
	...
	2,  // 14: livekit.SegmentedStreamOutput.stream_type:type_name -> livekit.SegmentedStreamType
	13, // 15: livekit.SegmentedStreamOutput.s3:type_name -> livekit.S3Upload
	14, // 16: livekit.SegmentedStreamOutput.gcp:type_name -> livekit.GCPUpload
	15, // 17: livekit.SegmentedStreamOutput.azure:type_name -> livekit.AzureBlobUpload
...
func file_livekit_egress_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_livekit_egress_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SegmentedStreamOutput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_livekit_egress_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SegmentedStreamOutput_S3)(nil),
		(*SegmentedStreamOutput_Gcp)(nil),
		(*SegmentedStreamOutput_Azure)(nil),
	}
