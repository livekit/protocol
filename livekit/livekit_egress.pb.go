...
const (
	...
	AudioMixing_MULTI_CHANNEL          AudioMixing = 3 // every audio track is mixed into a new channel, max 255 channels
)
...
type EncodingOptions struct {
	...
	AudioMixing      AudioMixing            `protobuf:"varint,13,opt,name=audio_mixing,json=audioMixing,proto3,enum=livekit.AudioMixing" json:"audio_mixing,omitempty"` // (default DEFAULT_MIXING)
...
func (x *EncodingOptions) GetAudioMixing() AudioMixing {
	if x != nil {
...
var file_livekit_egress_proto_rawDesc = string([]byte{
	...
	0x52, 0x04, 0x75, 0x72, 0x6c, 0x73, 0x22, 0x83, 0x04, 0x0a, 0x0f, 0x45, 0x6e, 0x63, 0x6f, 0x64,
	...
	0x75, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x37, 0x0a, 0x0c, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x5f, 0x6d,
	0x69, 0x78, 0x69, 0x6e, 0x67, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x6c, 0x69,
	0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x4d, 0x69, 0x78, 0x69, 0x6e,
	0x67, 0x52, 0x0b, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x4d, 0x69, 0x78, 0x69, 0x6e, 0x67, 0x12, 0x34,
	...
	0x68, 0x0a, 0x0b, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x4d, 0x69, 0x78, 0x69, 0x6e, 0x67, 0x12, 0x12,
	...
	0x4e, 0x41, 0x54, 0x45, 0x10, 0x02, 0x12, 0x11, 0x0a, 0x0d, 0x4d, 0x55, 0x4c, 0x54, 0x49, 0x5f,
	0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c, 0x10, 0x03, 0x2a, 0xcf, 0x01, 0x0a, 0x15, 0x45, 0x6e,
	...
	0x4d, 0x49, 0x54, 0x5f, 0x52, 0x45, 0x41, 0x43, 0x48, 0x45, 0x44, 0x10, 0x06, 0x2a, 0x4a, 0x0a,
	0x10, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x1a, 0x0a, 0x16, 0x45, 0x47, 0x52, 0x45, 0x53, 0x53, 0x5f, 0x53, 0x4f, 0x55, 0x52,
	0x43, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x57, 0x45, 0x42, 0x10, 0x00, 0x12, 0x1a, 0x0a,
	0x16, 0x45, 0x47, 0x52, 0x45, 0x53, 0x53, 0x5f, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x54,
	0x59, 0x50, 0x45, 0x5f, 0x53, 0x44, 0x4b, 0x10, 0x01, 0x32, 0x9c, 0x05, 0x0a, 0x06, 0x45, 0x67,
...
var file_livekit_egress_proto_depIdxs = []int32{
	15, // 0: livekit.RoomCompositeEgressRequest.file:type_name -> livekit.EncodedFileOutput
	24, // 1: livekit.RoomCompositeEgressRequest.stream:type_name -> livekit.StreamOutput
	16, // 2: livekit.RoomCompositeEgressRequest.segments:type_name -> livekit.SegmentedFileOutput
	6,  // 3: livekit.RoomCompositeEgressRequest.preset:type_name -> livekit.EncodingOptionsPreset
	25, // 4: livekit.RoomCompositeEgressRequest.advanced:type_name -> livekit.EncodingOptions
	15, // 5: livekit.RoomCompositeEgressRequest.file_outputs:type_name -> livekit.EncodedFileOutput
	24, // 6: livekit.RoomCompositeEgressRequest.stream_outputs:type_name -> livekit.StreamOutput
	16, // 7: livekit.RoomCompositeEgressRequest.segment_outputs:type_name -> livekit.SegmentedFileOutput
	18, // 8: livekit.RoomCompositeEgressRequest.image_outputs:type_name -> livekit.ImageOutput
	15, // 9: livekit.WebEgressRequest.file:type_name -> livekit.EncodedFileOutput
	24, // 10: livekit.WebEgressRequest.stream:type_name -> livekit.StreamOutput
	16, // 11: livekit.WebEgressRequest.segments:type_name -> livekit.SegmentedFileOutput
	6,  // 12: livekit.WebEgressRequest.preset:type_name -> livekit.EncodingOptionsPreset
	25, // 13: livekit.WebEgressRequest.advanced:type_name -> livekit.EncodingOptions
	15, // 14: livekit.WebEgressRequest.file_outputs:type_name -> livekit.EncodedFileOutput
	24, // 15: livekit.WebEgressRequest.stream_outputs:type_name -> livekit.StreamOutput
	16, // 16: livekit.WebEgressRequest.segment_outputs:type_name -> livekit.SegmentedFileOutput
	18, // 17: livekit.WebEgressRequest.image_outputs:type_name -> livekit.ImageOutput
	6,  // 18: livekit.ParticipantEgressRequest.preset:type_name -> livekit.EncodingOptionsPreset
	25, // 19: livekit.ParticipantEgressRequest.advanced:type_name -> livekit.EncodingOptions
	15, // 20: livekit.ParticipantEgressRequest.file_outputs:type_name -> livekit.EncodedFileOutput
	24, // 21: livekit.ParticipantEgressRequest.stream_outputs:type_name -> livekit.StreamOutput
	16, // 22: livekit.ParticipantEgressRequest.segment_outputs:type_name -> livekit.SegmentedFileOutput
	18, // 23: livekit.ParticipantEgressRequest.image_outputs:type_name -> livekit.ImageOutput
	15, // 24: livekit.TrackCompositeEgressRequest.file:type_name -> livekit.EncodedFileOutput
	24, // 25: livekit.TrackCompositeEgressRequest.stream:type_name -> livekit.StreamOutput
	16, // 26: livekit.TrackCompositeEgressRequest.segments:type_name -> livekit.SegmentedFileOutput
	6,  // 27: livekit.TrackCompositeEgressRequest.preset:type_name -> livekit.EncodingOptionsPreset
	25, // 28: livekit.TrackCompositeEgressRequest.advanced:type_name -> livekit.EncodingOptions
	15, // 29: livekit.TrackCompositeEgressRequest.file_outputs:type_name -> livekit.EncodedFileOutput
	24, // 30: livekit.TrackCompositeEgressRequest.stream_outputs:type_name -> livekit.StreamOutput
	16, // 31: livekit.TrackCompositeEgressRequest.segment_outputs:type_name -> livekit.SegmentedFileOutput
	18, // 32: livekit.TrackCompositeEgressRequest.image_outputs:type_name -> livekit.ImageOutput
	17, // 33: livekit.TrackEgressRequest.file:type_name -> livekit.DirectFileOutput
	0,  // 34: livekit.EncodedFileOutput.file_type:type_name -> livekit.EncodedFileType
	19, // 35: livekit.EncodedFileOutput.s3:type_name -> livekit.S3Upload
	20, // 36: livekit.EncodedFileOutput.gcp:type_name -> livekit.GCPUpload
	21, // 37: livekit.EncodedFileOutput.azure:type_name -> livekit.AzureBlobUpload
	22, // 38: livekit.EncodedFileOutput.aliOSS:type_name -> livekit.AliOSSUpload
	...
	19, // 41: livekit.SegmentedFileOutput.s3:type_name -> livekit.S3Upload
	20, // 42: livekit.SegmentedFileOutput.gcp:type_name -> livekit.GCPUpload
	21, // 43: livekit.SegmentedFileOutput.azure:type_name -> livekit.AzureBlobUpload
	22, // 44: livekit.SegmentedFileOutput.aliOSS:type_name -> livekit.AliOSSUpload
	19, // 45: livekit.DirectFileOutput.s3:type_name -> livekit.S3Upload
	20, // 46: livekit.DirectFileOutput.gcp:type_name -> livekit.GCPUpload
	21, // 47: livekit.DirectFileOutput.azure:type_name -> livekit.AzureBlobUpload
	22, // 48: livekit.DirectFileOutput.aliOSS:type_name -> livekit.AliOSSUpload
	3,  // 49: livekit.ImageOutput.filename_suffix:type_name -> livekit.ImageFileSuffix
	40, // 50: livekit.ImageOutput.image_codec:type_name -> livekit.ImageCodec
	19, // 51: livekit.ImageOutput.s3:type_name -> livekit.S3Upload
	20, // 52: livekit.ImageOutput.gcp:type_name -> livekit.GCPUpload
	21, // 53: livekit.ImageOutput.azure:type_name -> livekit.AzureBlobUpload
	22, // 54: livekit.ImageOutput.aliOSS:type_name -> livekit.AliOSSUpload
	39, // 55: livekit.S3Upload.metadata:type_name -> livekit.S3Upload.MetadataEntry
	23, // 56: livekit.S3Upload.proxy:type_name -> livekit.ProxyConfig
	23, // 57: livekit.GCPUpload.proxy:type_name -> livekit.ProxyConfig
	4,  // 58: livekit.StreamOutput.protocol:type_name -> livekit.StreamProtocol
	41, // 59: livekit.EncodingOptions.audio_codec:type_name -> livekit.AudioCodec
	5,  // 60: livekit.EncodingOptions.audio_mixing:type_name -> livekit.AudioMixing
