...
type FileAndStreamInfo struct {
	...
	Location  string `protobuf:"bytes,5,opt,name=location,proto3" json:"location,omitempty"`
	// for stream
	Info []*StreamInfo `protobuf:"bytes,7,rep,name=info,proto3" json:"info,omitempty"`
}
...
func (x *FileAndStreamInfo) GetStartedAt() int64 {
	if x != nil {
		return x.StartedAt
	}
	return 0
...
func (x *FileAndStreamInfo) GetEndedAt() int64 {
	if x != nil {
		return x.EndedAt
	}
	return 0
...
func (x *FileAndStreamInfo) GetDuration() int64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
func (x *FileAndStreamInfo) GetSize() int64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *FileAndStreamInfo) GetInfo() []*StreamInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
var file_livekit_egress_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x64, 0x41, 0x74, 0x22, 0xde, 0x01, 0x0a, 0x11, 0x46, 0x69, 0x6c, 0x65, 0x41, 0x6e,
	0x64, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1a, 0x0a, 0x08, 0x66,
	...
	0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x69,
	0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x49, 0x6e, 0x66, 0x6f,
	0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0xe1, 0x01, 0x0a, 0x0f, 0x41, 0x75, 0x74, 0x6f, 0x54,
	...
	0x74, 0x12, 0x23, 0x0a, 0x02, 0x73, 0x33, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e,
	0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x53, 0x33, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x48, 0x00, 0x52, 0x02, 0x73, 0x33, 0x12, 0x26, 0x0a, 0x03, 0x67, 0x63, 0x70, 0x18, 0x03, 0x20,
	...
	0x0a, 0x05, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	0x42, 0x08, 0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x2a, 0x39, 0x0a, 0x0f, 0x45, 0x6e,
	...
	0x54, 0x5f, 0x52, 0x45, 0x41, 0x43, 0x48, 0x45, 0x44, 0x10, 0x06, 0x32, 0xca, 0x04, 0x0a, 0x06,
	...
	0x74, 0x2e, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x56, 0x0a, 0x19,
	0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x73,
	0x69, 0x74, 0x65, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x24, 0x2e, 0x6c, 0x69, 0x76, 0x65,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x44, 0x0a, 0x10, 0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x72, 0x61,
	0x63, 0x6b, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1b, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b,
...
var file_livekit_egress_proto_goTypes = []interface{}{
	...
	(*FileAndStreamOutput)(nil),         // 14: livekit.FileAndStreamOutput
	(*DirectFileOutput)(nil),            // 15: livekit.DirectFileOutput
	(*S3Upload)(nil),                    // 16: livekit.S3Upload
	(*GCPUpload)(nil),                   // 17: livekit.GCPUpload
	(*AzureBlobUpload)(nil),             // 18: livekit.AzureBlobUpload
	(*AliOSSUpload)(nil),                // 19: livekit.AliOSSUpload
	(*StreamOutput)(nil),                // 20: livekit.StreamOutput
	(*EncodingOptions)(nil),             // 21: livekit.EncodingOptions
	(*UpdateLayoutRequest)(nil),         // 22: livekit.UpdateLayoutRequest
	(*UpdateStreamRequest)(nil),         // 23: livekit.UpdateStreamRequest
	(*ListEgressRequest)(nil),           // 24: livekit.ListEgressRequest
	(*ListEgressResponse)(nil),          // 25: livekit.ListEgressResponse
	(*StopEgressRequest)(nil),           // 26: livekit.StopEgressRequest
	(*EgressInfo)(nil),                  // 27: livekit.EgressInfo
	(*StreamInfoList)(nil),              // 28: livekit.StreamInfoList
	(*StreamInfo)(nil),                  // 29: livekit.StreamInfo
	(*FileInfo)(nil),                    // 30: livekit.FileInfo
	(*SegmentsInfo)(nil),                // 31: livekit.SegmentsInfo
	(*FileAndStreamInfo)(nil),           // 32: livekit.FileAndStreamInfo
	(*AutoTrackEgress)(nil),             // 33: livekit.AutoTrackEgress
	nil,                                 // 34: livekit.S3Upload.MetadataEntry
}
var file_livekit_egress_proto_depIdxs = []int32{
	...
	20, // 1: livekit.RoomCompositeEgressRequest.stream:type_name -> livekit.StreamOutput
	...
	21, // 4: livekit.RoomCompositeEgressRequest.advanced:type_name -> livekit.EncodingOptions
	12, // 5: livekit.TrackCompositeEgressRequest.file:type_name -> livekit.EncodedFileOutput
	20, // 6: livekit.TrackCompositeEgressRequest.stream:type_name -> livekit.StreamOutput
	13, // 7: livekit.TrackCompositeEgressRequest.segments:type_name -> livekit.SegmentedFileOutput
	14, // 8: livekit.TrackCompositeEgressRequest.fileAndStream:type_name -> livekit.FileAndStreamOutput
	5,  // 9: livekit.TrackCompositeEgressRequest.preset:type_name -> livekit.EncodingOptionsPreset
	21, // 10: livekit.TrackCompositeEgressRequest.advanced:type_name -> livekit.EncodingOptions
	15, // 11: livekit.TrackEgressRequest.file:type_name -> livekit.DirectFileOutput
	12, // 12: livekit.WebEgressRequest.file:type_name -> livekit.EncodedFileOutput
	20, // 13: livekit.WebEgressRequest.stream:type_name -> livekit.StreamOutput
	13, // 14: livekit.WebEgressRequest.segments:type_name -> livekit.SegmentedFileOutput
	5,  // 15: livekit.WebEgressRequest.preset:type_name -> livekit.EncodingOptionsPreset
	21, // 16: livekit.WebEgressRequest.advanced:type_name -> livekit.EncodingOptions
	0,  // 17: livekit.EncodedFileOutput.file_type:type_name -> livekit.EncodedFileType
	16, // 18: livekit.EncodedFileOutput.s3:type_name -> livekit.S3Upload
	17, // 19: livekit.EncodedFileOutput.gcp:type_name -> livekit.GCPUpload
	18, // 20: livekit.EncodedFileOutput.azure:type_name -> livekit.AzureBlobUpload
	19, // 21: livekit.EncodedFileOutput.aliOSS:type_name -> livekit.AliOSSUpload
	2,  // 22: livekit.SegmentedFileOutput.protocol:type_name -> livekit.SegmentedFileProtocol
	16, // 23: livekit.SegmentedFileOutput.s3:type_name -> livekit.S3Upload
	17, // 24: livekit.SegmentedFileOutput.gcp:type_name -> livekit.GCPUpload
	18, // 25: livekit.SegmentedFileOutput.azure:type_name -> livekit.AzureBlobUpload
	19, // 26: livekit.SegmentedFileOutput.aliOSS:type_name -> livekit.AliOSSUpload
	0,  // 27: livekit.FileAndStreamOutput.file_type:type_name -> livekit.EncodedFileType
	16, // 28: livekit.FileAndStreamOutput.s3:type_name -> livekit.S3Upload
	17, // 29: livekit.FileAndStreamOutput.gcp:type_name -> livekit.GCPUpload
	18, // 30: livekit.FileAndStreamOutput.azure:type_name -> livekit.AzureBlobUpload
	19, // 31: livekit.FileAndStreamOutput.aliOSS:type_name -> livekit.AliOSSUpload
	1,  // 32: livekit.FileAndStreamOutput.protocol:type_name -> livekit.StreamProtocol
	16, // 33: livekit.DirectFileOutput.s3:type_name -> livekit.S3Upload
	17, // 34: livekit.DirectFileOutput.gcp:type_name -> livekit.GCPUpload
	18, // 35: livekit.DirectFileOutput.azure:type_name -> livekit.AzureBlobUpload
	19, // 36: livekit.DirectFileOutput.aliOSS:type_name -> livekit.AliOSSUpload
	34, // 37: livekit.S3Upload.metadata:type_name -> livekit.S3Upload.MetadataEntry
	...
	27, // 41: livekit.ListEgressResponse.items:type_name -> livekit.EgressInfo
	6,  // 42: livekit.EgressInfo.status:type_name -> livekit.EgressStatus
	8,  // 43: livekit.EgressInfo.room_composite:type_name -> livekit.RoomCompositeEgressRequest
	9,  // 44: livekit.EgressInfo.track_composite:type_name -> livekit.TrackCompositeEgressRequest
	10, // 45: livekit.EgressInfo.track:type_name -> livekit.TrackEgressRequest
	11, // 46: livekit.EgressInfo.web:type_name -> livekit.WebEgressRequest
	28, // 47: livekit.EgressInfo.stream:type_name -> livekit.StreamInfoList
	30, // 48: livekit.EgressInfo.file:type_name -> livekit.FileInfo
	31, // 49: livekit.EgressInfo.segments:type_name -> livekit.SegmentsInfo
	32, // 50: livekit.EgressInfo.fileAndStream:type_name -> livekit.FileAndStreamInfo
	29, // 51: livekit.StreamInfoList.info:type_name -> livekit.StreamInfo
	7,  // 52: livekit.StreamInfo.status:type_name -> livekit.StreamInfo.Status
	29, // 53: livekit.FileAndStreamInfo.info:type_name -> livekit.StreamInfo
	16, // 54: livekit.AutoTrackEgress.s3:type_name -> livekit.S3Upload
	17, // 55: livekit.AutoTrackEgress.gcp:type_name -> livekit.GCPUpload
	18, // 56: livekit.AutoTrackEgress.azure:type_name -> livekit.AzureBlobUpload
	8,  // 57: livekit.Egress.StartRoomCompositeEgress:input_type -> livekit.RoomCompositeEgressRequest
	9,  // 58: livekit.Egress.StartTrackCompositeEgress:input_type -> livekit.TrackCompositeEgressRequest
	10, // 59: livekit.Egress.StartTrackEgress:input_type -> livekit.TrackEgressRequest
	11, // 60: livekit.Egress.StartWebEgress:input_type -> livekit.WebEgressRequest
	22, // 61: livekit.Egress.UpdateLayout:input_type -> livekit.UpdateLayoutRequest
	23, // 62: livekit.Egress.UpdateStream:input_type -> livekit.UpdateStreamRequest
	24, // 63: livekit.Egress.ListEgress:input_type -> livekit.ListEgressRequest
	26, // 64: livekit.Egress.StopEgress:input_type -> livekit.StopEgressRequest
	27, // 65: livekit.Egress.StartRoomCompositeEgress:output_type -> livekit.EgressInfo
	27, // 66: livekit.Egress.StartTrackCompositeEgress:output_type -> livekit.EgressInfo
	27, // 67: livekit.Egress.StartTrackEgress:output_type -> livekit.EgressInfo
	27, // 68: livekit.Egress.StartWebEgress:output_type -> livekit.EgressInfo
	27, // 69: livekit.Egress.UpdateLayout:output_type -> livekit.EgressInfo
	27, // 70: livekit.Egress.UpdateStream:output_type -> livekit.EgressInfo
	25, // 71: livekit.Egress.ListEgress:output_type -> livekit.ListEgressResponse
	27, // 72: livekit.Egress.StopEgress:output_type -> livekit.EgressInfo
