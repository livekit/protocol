...
type SIPCallInfo_Direction int32

const (
	SIPCallInfo_DIR_UNKNOWN  SIPCallInfo_Direction = 0 // legacy
	SIPCallInfo_DIR_INBOUND  SIPCallInfo_Direction = 1
	SIPCallInfo_DIR_OUTBOUND SIPCallInfo_Direction = 2
)

// Enum value maps for SIPCallInfo_Direction.
var (
	SIPCallInfo_Direction_name = map[int32]string{
		0: "DIR_UNKNOWN",
		1: "DIR_INBOUND",
		2: "DIR_OUTBOUND",
	}
	SIPCallInfo_Direction_value = map[string]int32{
		"DIR_UNKNOWN":  0,
		"DIR_INBOUND":  1,
		"DIR_OUTBOUND": 2,
	}
...
func (x SIPCallInfo_Direction) Enum() *SIPCallInfo_Direction {
	p := new(SIPCallInfo_Direction)
	*p = x
	return p
}

func (x SIPCallInfo_Direction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SIPCallInfo_Direction) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_sip_proto_enumTypes[0].Descriptor()
}

func (SIPCallInfo_Direction) Type() protoreflect.EnumType {
	return &file_livekit_sip_proto_enumTypes[0]
}

func (x SIPCallInfo_Direction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SIPCallInfo_Direction.Descriptor instead.
func (SIPCallInfo_Direction) EnumDescriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{16, 0}
}

type SIPCallInfo_Status int32

const (
	SIPCallInfo_UNKNOWN    SIPCallInfo_Status = 0 // legacy
	SIPCallInfo_CREATED    SIPCallInfo_Status = 1 // call created, but not yet dialed
	SIPCallInfo_HANDSHAKE  SIPCallInfo_Status = 2 // SIP protocol handshake is ongoing
	SIPCallInfo_AUTOMATION SIPCallInfo_Status = 3 // SIP call established, running automation (e.g. pin prompt or sending DTMF)
	SIPCallInfo_ACTIVE     SIPCallInfo_Status = 4 // SIP call active
	SIPCallInfo_ERROR      SIPCallInfo_Status = 5 // call failed
	SIPCallInfo_COMPLETE   SIPCallInfo_Status = 6 // call hangup
)

// Enum value maps for SIPCallInfo_Status.
var (
	SIPCallInfo_Status_name = map[int32]string{
		0: "UNKNOWN",
		1: "CREATED",
		2: "HANDSHAKE",
		3: "AUTOMATION",
	...
	SIPCallInfo_Status_value = map[string]int32{
		"UNKNOWN":    0,
		"CREATED":    1,
		"HANDSHAKE":  2,
		"AUTOMATION": 3,
...
func (x SIPCallInfo_Status) Enum() *SIPCallInfo_Status {
	p := new(SIPCallInfo_Status)
	*p = x
	return p
}

func (x SIPCallInfo_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SIPCallInfo_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_sip_proto_enumTypes[1].Descriptor()
}

func (SIPCallInfo_Status) Type() protoreflect.EnumType {
	return &file_livekit_sip_proto_enumTypes[1]
}

func (x SIPCallInfo_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SIPCallInfo_Status.Descriptor instead.
func (SIPCallInfo_Status) EnumDescriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{16, 1}
}
...
type SIPUri struct {
	...
	User    string `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty"` // SIP username or phone number
	Host    string `protobuf:"bytes,3,opt,name=host,proto3" json:"host,omitempty"` // SIP hostname
}
...
func (x *SIPUri) GetFullUri() string {
	if x != nil {
		return x.FullUri
	}
	return ""
...
type SIPCallInfo struct {
	...
	From        *SIPUri                `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"`
	To          *SIPUri                `protobuf:"bytes,2,opt,name=to,proto3" json:"to,omitempty"`
	Dir         SIPCallInfo_Direction  `protobuf:"varint,3,opt,name=dir,proto3,enum=livekit.SIPCallInfo_Direction" json:"dir,omitempty"`
	Status      SIPCallInfo_Status     `protobuf:"varint,4,opt,name=status,proto3,enum=livekit.SIPCallInfo_Status" json:"status,omitempty"`
	Error       string                 `protobuf:"bytes,5,opt,name=error,proto3" json:"error,omitempty"`             // error message, if any
	Participant *SIPParticipantInfo    `protobuf:"bytes,6,opt,name=participant,proto3" json:"participant,omitempty"` // participant (only for active calls)
...
func (x *SIPCallInfo) GetFrom() *SIPUri {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *SIPCallInfo) GetTo() *SIPUri {
	if x != nil {
		return x.To
	}
	return nil
...
func (x *SIPCallInfo) GetDir() SIPCallInfo_Direction {
	if x != nil {
		return x.Dir
	}
	return SIPCallInfo_DIR_UNKNOWN
}

func (x *SIPCallInfo) GetStatus() SIPCallInfo_Status {
	if x != nil {
		return x.Status
	}
	return SIPCallInfo_UNKNOWN
}
...
func (x *SIPCallInfo) GetParticipant() *SIPParticipantInfo {
	if x != nil {
...
func (x *SIPCallInfo) GetStartedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.StartedAt
	}
	return nil
...
func (x *SIPCallInfo) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *SIPCallInfo) GetEndedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.EndedAt
	}
	return nil
...
var file_livekit_sip_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x07, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x1a, 0x1f, 0x67, 0x6f,
	...
	0x64, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xc2, 0x03, 0x0a, 0x0c, 0x53, 0x49,
	...
	0x52, 0x0a, 0x73, 0x69, 0x70, 0x54, 0x72, 0x75, 0x6e, 0x6b, 0x49, 0x64, 0x12, 0x2b, 0x0a, 0x11,
	...
	0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x15,
	0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x49, 0x50, 0x54, 0x72, 0x75, 0x6e, 0x6b, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x43, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x49, 0x50,
	...
	0x69, 0x64, 0x75, 0x61, 0x6c, 0x42, 0x06, 0x0a, 0x04, 0x72, 0x75, 0x6c, 0x65, 0x22, 0x95, 0x01,
	...
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0xbd, 0x01, 0x0a, 0x13, 0x53, 0x49, 0x50, 0x44, 0x69, 0x73,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x68, 0x69, 0x64, 0x65, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x4e,
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x1c, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x49, 0x50,
	...
	0x68, 0x52, 0x75, 0x6c, 0x65, 0x49, 0x64, 0x22, 0x93, 0x02, 0x0a, 0x1b, 0x43, 0x72, 0x65, 0x61,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x74, 0x6d, 0x66, 0x18, 0x05, 0x20, 0x01,
	...
	0x0c, 0x70, 0x6c, 0x61, 0x79, 0x52, 0x69, 0x6e, 0x67, 0x74, 0x6f, 0x6e, 0x65, 0x22, 0x8b, 0x01,
	...
	0x09, 0x52, 0x08, 0x72, 0x6f, 0x6f, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x4b, 0x0a, 0x06, 0x53,
	0x49, 0x50, 0x55, 0x72, 0x69, 0x12, 0x19, 0x0a, 0x08, 0x66, 0x75, 0x6c, 0x6c, 0x5f, 0x75, 0x72,
	0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x66, 0x75, 0x6c, 0x6c, 0x55, 0x72, 0x69,
	...
	,
	...
	,
	...
	0x48, 0x41, 0x4e, 0x44, 0x53, 0x48, 0x41, 0x4b, 0x45, 0x10, 0x02, 0x12, 0x0e, 0x0a, 0x0a, 0x41,
	0x55, 0x54, 0x4f, 0x4d, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x41,
	0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x04, 0x12, 0x09, 0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52,
	0x10, 0x05, 0x12, 0x0c, 0x0a, 0x08, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x06,
	0x32, 0xdd, 0x04, 0x0a, 0x03, 0x53, 0x49, 0x50, 0x12, 0x47, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61,
	...
	0x6f, 0x12, 0x4b, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x49, 0x50, 0x54, 0x72, 0x75, 0x6e,
	...
	0x50, 0x54, 0x72, 0x75, 0x6e, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x47,
...
var file_livekit_sip_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_livekit_sip_proto_goTypes = []interface{}{
	(SIPCallInfo_Direction)(0),           // 0: livekit.SIPCallInfo.Direction
	(SIPCallInfo_Status)(0),              // 1: livekit.SIPCallInfo.Status
	(*CreateSIPTrunkRequest)(nil),        // 2: livekit.CreateSIPTrunkRequest
	(*SIPTrunkInfo)(nil),                 // 3: livekit.SIPTrunkInfo
	(*ListSIPTrunkRequest)(nil),          // 4: livekit.ListSIPTrunkRequest
	(*ListSIPTrunkResponse)(nil),         // 5: livekit.ListSIPTrunkResponse
	(*DeleteSIPTrunkRequest)(nil),        // 6: livekit.DeleteSIPTrunkRequest
	(*SIPDispatchRuleDirect)(nil),        // 7: livekit.SIPDispatchRuleDirect
	(*SIPDispatchRuleIndividual)(nil),    // 8: livekit.SIPDispatchRuleIndividual
	(*SIPDispatchRule)(nil),              // 9: livekit.SIPDispatchRule
	(*CreateSIPDispatchRuleRequest)(nil), // 10: livekit.CreateSIPDispatchRuleRequest
	(*SIPDispatchRuleInfo)(nil),          // 11: livekit.SIPDispatchRuleInfo
	(*ListSIPDispatchRuleRequest)(nil),   // 12: livekit.ListSIPDispatchRuleRequest
	(*ListSIPDispatchRuleResponse)(nil),  // 13: livekit.ListSIPDispatchRuleResponse
	(*DeleteSIPDispatchRuleRequest)(nil), // 14: livekit.DeleteSIPDispatchRuleRequest
	(*CreateSIPParticipantRequest)(nil),  // 15: livekit.CreateSIPParticipantRequest
	(*SIPParticipantInfo)(nil),           // 16: livekit.SIPParticipantInfo
	(*SIPUri)(nil),                       // 17: livekit.SIPUri
	(*SIPCallInfo)(nil),                  // 18: livekit.SIPCallInfo
	(*timestamppb.Timestamp)(nil),        // 19: google.protobuf.Timestamp
}
var file_livekit_sip_proto_depIdxs = []int32{
	3,  // 0: livekit.ListSIPTrunkResponse.items:type_name -> livekit.SIPTrunkInfo
	7,  // 1: livekit.SIPDispatchRule.dispatch_rule_direct:type_name -> livekit.SIPDispatchRuleDirect
	8,  // 2: livekit.SIPDispatchRule.dispatch_rule_individual:type_name -> livekit.SIPDispatchRuleIndividual
	9,  // 3: livekit.CreateSIPDispatchRuleRequest.rule:type_name -> livekit.SIPDispatchRule
	9,  // 4: livekit.SIPDispatchRuleInfo.rule:type_name -> livekit.SIPDispatchRule
	11, // 5: livekit.ListSIPDispatchRuleResponse.items:type_name -> livekit.SIPDispatchRuleInfo
	17, // 6: livekit.SIPCallInfo.from:type_name -> livekit.SIPUri
	17, // 7: livekit.SIPCallInfo.to:type_name -> livekit.SIPUri
	0,  // 8: livekit.SIPCallInfo.dir:type_name -> livekit.SIPCallInfo.Direction
	1,  // 9: livekit.SIPCallInfo.status:type_name -> livekit.SIPCallInfo.Status
	16, // 10: livekit.SIPCallInfo.participant:type_name -> livekit.SIPParticipantInfo
	19, // 11: livekit.SIPCallInfo.started_at:type_name -> google.protobuf.Timestamp
	19, // 12: livekit.SIPCallInfo.updated_at:type_name -> google.protobuf.Timestamp
	19, // 13: livekit.SIPCallInfo.ended_at:type_name -> google.protobuf.Timestamp
	2,  // 14: livekit.SIP.CreateSIPTrunk:input_type -> livekit.CreateSIPTrunkRequest
	4,  // 15: livekit.SIP.ListSIPTrunk:input_type -> livekit.ListSIPTrunkRequest
	6,  // 16: livekit.SIP.DeleteSIPTrunk:input_type -> livekit.DeleteSIPTrunkRequest
	10, // 17: livekit.SIP.CreateSIPDispatchRule:input_type -> livekit.CreateSIPDispatchRuleRequest
	12, // 18: livekit.SIP.ListSIPDispatchRule:input_type -> livekit.ListSIPDispatchRuleRequest
	14, // 19: livekit.SIP.DeleteSIPDispatchRule:input_type -> livekit.DeleteSIPDispatchRuleRequest
	15, // 20: livekit.SIP.CreateSIPParticipant:input_type -> livekit.CreateSIPParticipantRequest
	3,  // 21: livekit.SIP.CreateSIPTrunk:output_type -> livekit.SIPTrunkInfo
	5,  // 22: livekit.SIP.ListSIPTrunk:output_type -> livekit.ListSIPTrunkResponse
	3,  // 23: livekit.SIP.DeleteSIPTrunk:output_type -> livekit.SIPTrunkInfo
	11, // 24: livekit.SIP.CreateSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	13, // 25: livekit.SIP.ListSIPDispatchRule:output_type -> livekit.ListSIPDispatchRuleResponse
	11, // 26: livekit.SIP.DeleteSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	16, // 27: livekit.SIP.CreateSIPParticipant:output_type -> livekit.SIPParticipantInfo
