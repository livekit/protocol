...
func file_livekit_sip_proto_init() {
	...
	file_livekit_sip_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*UpdateSIPInboundTrunkRequest_Replace)(nil),
		(*UpdateSIPInboundTrunkRequest_Update)(nil),
	}
	file_livekit_sip_proto_msgTypes[6].OneofWrappers = []interface{}{}
	...
	file_livekit_sip_proto_msgTypes[10].OneofWrappers = []interface{}{}
	file_livekit_sip_proto_msgTypes[25].OneofWrappers = []interface{}{
		(*SIPDispatchRule_DispatchRuleDirect)(nil),
		(*SIPDispatchRule_DispatchRuleIndividual)(nil),
		(*SIPDispatchRule_DispatchRuleCallee)(nil),
	}
	file_livekit_sip_proto_msgTypes[27].OneofWrappers = []interface{}{
		(*UpdateSIPDispatchRuleRequest_Replace)(nil),
		(*UpdateSIPDispatchRuleRequest_Update)(nil),
	}
	file_livekit_sip_proto_msgTypes[29].OneofWrappers = []interface{}{}
	type x struct{}
