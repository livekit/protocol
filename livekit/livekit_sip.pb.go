...
type SIPTransferReason int32

const (
	SIPTransferReason_STR_UNSPECIFIED             SIPTransferReason = 0 // No reason reported
	SIPTransferReason_STR_COMPLETED               SIPTransferReason = 1 // The transferee answered and the transfer completed
	SIPTransferReason_STR_CALL_ENDED              SIPTransferReason = 2 // The call ended before the transfer completed: remote BYE, room deleted or local hangup
	SIPTransferReason_STR_REJECTED                SIPTransferReason = 3 // The transferee, or its provider, rejected the transfer
	SIPTransferReason_STR_RINGING_TIMEOUT         SIPTransferReason = 4 // The transferee did not answer in time
	SIPTransferReason_STR_SUBSCRIPTION_TERMINATED SIPTransferReason = 5 // The provider stopped reporting the transfer status without a final response
	SIPTransferReason_STR_CANCELED                SIPTransferReason = 6 // Canceled through the API
)

// Enum value maps for SIPTransferReason.
var (
	SIPTransferReason_name = map[int32]string{
		0: "STR_UNSPECIFIED",
		1: "STR_COMPLETED",
		2: "STR_CALL_ENDED",
		3: "STR_REJECTED",
		4: "STR_RINGING_TIMEOUT",
		5: "STR_SUBSCRIPTION_TERMINATED",
		6: "STR_CANCELED",
	}
	SIPTransferReason_value = map[string]int32{
		"STR_UNSPECIFIED":             0,
		"STR_COMPLETED":               1,
		"STR_CALL_ENDED":              2,
		"STR_REJECTED":                3,
		"STR_RINGING_TIMEOUT":         4,
		"STR_SUBSCRIPTION_TERMINATED": 5,
		"STR_CANCELED":                6,
	}
)

func (x SIPTransferReason) Enum() *SIPTransferReason {
	p := new(SIPTransferReason)
	*p = x
	return p
}

func (x SIPTransferReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SIPTransferReason) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_sip_proto_enumTypes[7].Descriptor()
}

func (SIPTransferReason) Type() protoreflect.EnumType {
	return &file_livekit_sip_proto_enumTypes[7]
}

func (x SIPTransferReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SIPTransferReason.Descriptor instead.
func (SIPTransferReason) EnumDescriptor() ([]byte, []int) {
...
func (SIPTrunkInfo_TrunkKind) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_sip_proto_enumTypes[10].Descriptor()
}

func (SIPTrunkInfo_TrunkKind) Type() protoreflect.EnumType {
	return &file_livekit_sip_proto_enumTypes[10]
}
...
func (SIPTrunkInfo_TrunkKind) EnumDescriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{5, 0}
}
...
type SIPMediaConfig struct {
	...
	Encryption *SIPMediaEncryption `protobuf:"varint,3,opt,name=encryption,proto3,enum=livekit.SIPMediaEncryption,oneof" json:"encryption,omitempty"`
...
type SIPInboundTrunkInfo struct {
	...
	// SIP status sent to the caller when ringing_timeout elapses. Defaults to 486 Busy Here.
	// Code must be in the 4xx-6xx range; empty status text uses the standard reason phrase.
	RingingTimeoutStatus *SIPStatus `protobuf:"bytes,21,opt,name=ringing_timeout_status,json=ringingTimeoutStatus,proto3" json:"ringing_timeout_status,omitempty"`
	// Max call duration.
	...
	Media           *SIPMediaConfig        `protobuf:"bytes,20,opt,name=media,proto3" json:"media,omitempty"`
...
func (x *SIPInboundTrunkInfo) GetRingingTimeoutStatus() *SIPStatus {
	if x != nil {
		return x.RingingTimeoutStatus
	}
	return nil
}
...
type SIPInboundTrunkUpdate struct {
	...
	Media           *SIPMediaConfig     `protobuf:"bytes,10,opt,name=media,proto3" json:"media,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type SIPOutboundTrunkInfo struct {
	...
	Media           *SIPMediaConfig    `protobuf:"bytes,18,opt,name=media,proto3" json:"media,omitempty"`
...
type SIPOutboundTrunkUpdate struct {
	...
	// Deprecated: Marked as deprecated in livekit_sip.proto.
	MediaEncryption *SIPMediaEncryption `protobuf:"varint,8,opt,name=media_encryption,json=mediaEncryption,proto3,enum=livekit.SIPMediaEncryption,oneof" json:"media_encryption,omitempty"`
	Media           *SIPMediaConfig     `protobuf:"bytes,11,opt,name=media,proto3" json:"media,omitempty"`
...
type TransferSIPParticipantResponse struct {
	...
	Status     SIPTransferStatus      `protobuf:"varint,2,opt,name=status,proto3,enum=livekit.SIPTransferStatus" json:"status,omitempty"`
	Reason     SIPTransferReason      `protobuf:"varint,3,opt,name=reason,proto3,enum=livekit.SIPTransferReason" json:"reason,omitempty"`
	// Set when the outcome was reported by a SIP response.
	SipStatus     *SIPStatus `protobuf:"bytes,4,opt,name=sip_status,json=sipStatus,proto3" json:"sip_status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TransferSIPParticipantResponse) Reset() {
	*x = TransferSIPParticipantResponse{}
	mi := &file_livekit_sip_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TransferSIPParticipantResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransferSIPParticipantResponse) ProtoMessage() {}

func (x *TransferSIPParticipantResponse) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_sip_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransferSIPParticipantResponse.ProtoReflect.Descriptor instead.
func (*TransferSIPParticipantResponse) Descriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{40}
}

func (x *TransferSIPParticipantResponse) GetTransferId() string {
	if x != nil {
		return x.TransferId
	}
	return ""
...
func (x *TransferSIPParticipantResponse) GetStatus() SIPTransferStatus {
	if x != nil {
		return x.Status
	}
...
func (x *TransferSIPParticipantResponse) GetReason() SIPTransferReason {
	if x != nil {
		return x.Reason
	}
	return SIPTransferReason_STR_UNSPECIFIED
}

func (x *TransferSIPParticipantResponse) GetSipStatus() *SIPStatus {
	if x != nil {
		return x.SipStatus
	}
	return nil
...
type SIPTransferError struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	TransferId string                 `protobuf:"bytes,1,opt,name=transfer_id,json=transferId,proto3" json:"transfer_id,omitempty"`
	Reason     SIPTransferReason      `protobuf:"varint,2,opt,name=reason,proto3,enum=livekit.SIPTransferReason" json:"reason,omitempty"`
	// Set when the outcome was reported by a SIP response.
	SipStatus     *SIPStatus `protobuf:"bytes,3,opt,name=sip_status,json=sipStatus,proto3" json:"sip_status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SIPTransferError) Reset() {
	*x = SIPTransferError{}
...
func (x *SIPTransferError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SIPTransferError) ProtoMessage() {}

func (x *SIPTransferError) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_sip_proto_msgTypes[41]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SIPTransferError.ProtoReflect.Descriptor instead.
func (*SIPTransferError) Descriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{41}
}

func (x *SIPTransferError) GetTransferId() string {
	if x != nil {
		return x.TransferId
	}
	return ""
...
func (x *SIPTransferError) GetReason() SIPTransferReason {
	if x != nil {
		return x.Reason
	}
	return SIPTransferReason_STR_UNSPECIFIED
...
func (x *SIPTransferError) GetSipStatus() *SIPStatus {
	if x != nil {
		return x.SipStatus
	}
	return nil
...
func (x *SIPCallInfo) Reset() {
	*x = SIPCallInfo{}
	mi := &file_livekit_sip_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPCallInfo) Descriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{42}
}
...
type SIPTransferInfo struct {
	...
	Reason                SIPTransferReason      `protobuf:"varint,9,opt,name=reason,proto3,enum=livekit.SIPTransferReason" json:"reason,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *SIPTransferInfo) GetReason() SIPTransferReason {
	if x != nil {
		return x.Reason
	}
	return SIPTransferReason_STR_UNSPECIFIED
...
func (x *SIPNamedDest) Reset() {
	*x = SIPNamedDest{}
	mi := &file_livekit_sip_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPNamedDest) Descriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{46}
}
...
func (x *Destination) Reset() {
	*x = Destination{}
	mi := &file_livekit_sip_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Destination) Descriptor() ([]byte, []int) {
	return file_livekit_sip_proto_rawDescGZIP(), []int{47}
}
...
const file_livekit_sip_proto_rawDesc = "" +
	"\n" +
	"\x11livekit_sip.proto\x12\alivekit\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14livekit_models.proto\x1a\x12livekit_room.proto\x1a\x14logger/options.proto\"O\n" +
	"\tSIPStatus\x12*\n" +
	...
	"\x10inbound_username\x18\x05 \x01(\tB\x03\xc0P\x01R\x0finboundUsername\x12.\n" +
	"\x10inbound_password\x18\x06 \x01(\tB\x03\xc0P\x02R\x0finboundPassword\x120\n" +
	"\x11outbound_username\x18\a \x01(\tB\x03\xc0P\x01R\x10outboundUsername\x120\n" +
	"\x11outbound_password\x18\b \x01(\tB\x03\xc0P\x02R\x10outboundPassword\x12\x12\n" +
	"\x04name\x18\n" +
	" \x01(\tR\x04name\x12@\n" +
	"\bmetadata\x18\v \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\bmetadata:\x02\x18\x01\"2\n" +
	"\bSIPCodec\x12\x12\n" +
	...
	"\x10inbound_username\x18\x06 \x01(\tB\x03\xc0P\x01R\x0finboundUsername\x12.\n" +
	"\x10inbound_password\x18\a \x01(\tB\x03\xc0P\x02R\x0finboundPassword\x120\n" +
	"\x11outbound_username\x18\b \x01(\tB\x03\xc0P\x01R\x10outboundUsername\x120\n" +
	"\x11outbound_password\x18\t \x01(\tB\x03\xc0P\x02R\x10outboundPassword\x12\x12\n" +
	"\x04name\x18\v \x01(\tR\x04name\x12@\n" +
	"\bmetadata\x18\f \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\bmetadata\"D\n" +
	"\tTrunkKind\x12\x10\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1c.livekit.SIPInboundTrunkInfoR\x05trunk\"\xcd\x01\n" +
	...
	"sipTrunkId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12@\n" +
	"\bmetadata\x18\x03 \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\bmetadata\x12\x18\n" +
	...
	"\rauth_username\x18\a \x01(\tB\x03\xc0P\x01R\fauthUsername\x12(\n" +
	"\rauth_password\x18\b \x01(\tB\x03\xc0P\x02R\fauthPassword\x12\x1d\n" +
	"\n" +
	"auth_realm\x18\x13 \x01(\tR\tauthRealm\x12i\n" +
	"\aheaders\x18\t \x03(\v2).livekit.SIPInboundTrunkInfo.HeadersEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\aheaders\x12i\n" +
	...
	"\x0fringing_timeout\x18\v \x01(\v2\x19.google.protobuf.DurationR\x0eringingTimeout\x12H\n" +
	"\x16ringing_timeout_status\x18\x15 \x01(\v2\x12.livekit.SIPStatusR\x14ringingTimeoutStatus\x12E\n" +
	"\x11max_call_duration\x18\f \x01(\v2\x19.google.protobuf.DurationR\x0fmaxCallDuration\x12#\n" +
	"\rkrisp_enabled\x18\r \x01(\bR\fkrispEnabled\x12J\n" +
	"\x10media_encryption\x18\x10 \x01(\x0e2\x1b.livekit.SIPMediaEncryptionB\x02\x18\x01R\x0fmediaEncryption\x12-\n" +
	"\x05media\x18\x14 \x01(\v2\x17.livekit.SIPMediaConfigR\x05media\x129\n" +
	"\n" +
	...
	"\rauth_username\x18\x04 \x01(\tB\x03\xc0P\x01H\x00R\fauthUsername\x88\x01\x01\x12-\n" +
	"\rauth_password\x18\x05 \x01(\tB\x03\xc0P\x02H\x01R\fauthPassword\x88\x01\x01\x12\"\n" +
	"\n" +
	"auth_realm\x18\t \x01(\tH\x02R\tauthRealm\x88\x01\x01\x12\x17\n" +
	"\x04name\x18\x06 \x01(\tH\x03R\x04name\x88\x01\x01\x12E\n" +
	"\bmetadata\x18\a \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01H\x04R\bmetadata\x88\x01\x01\x12O\n" +
	"\x10media_encryption\x18\b \x01(\x0e2\x1b.livekit.SIPMediaEncryptionB\x02\x18\x01H\x05R\x0fmediaEncryption\x88\x01\x01\x12-\n" +
	"\x05media\x18\n" +
	" \x01(\v2\x17.livekit.SIPMediaConfigR\x05mediaB\x10\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1d.livekit.SIPOutboundTrunkInfoR\x05trunk\"\xd0\x01\n" +
	...
	"\rauth_username\x18\a \x01(\tB\x03\xc0P\x01R\fauthUsername\x12(\n" +
	"\rauth_password\x18\b \x01(\tB\x03\xc0P\x02R\fauthPassword\x12j\n" +
	"\aheaders\x18\t \x03(\v2*.livekit.SIPOutboundTrunkInfo.HeadersEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\aheaders\x12j\n" +
	"\x15headers_to_attributes\x18\n" +
	...
	"\x0finclude_headers\x18\f \x01(\x0e2\x19.livekit.SIPHeaderOptionsR\x0eincludeHeaders\x12J\n" +
	"\x10media_encryption\x18\r \x01(\x0e2\x1b.livekit.SIPMediaEncryptionB\x02\x18\x01R\x0fmediaEncryption\x12-\n" +
	"\x05media\x18\x12 \x01(\v2\x17.livekit.SIPMediaConfigR\x05media\x12\x1b\n" +
	...
	"\rauth_username\x18\x04 \x01(\tB\x03\xc0P\x01H\x03R\fauthUsername\x88\x01\x01\x12-\n" +
	"\rauth_password\x18\x05 \x01(\tB\x03\xc0P\x02H\x04R\fauthPassword\x88\x01\x01\x12\x17\n" +
	"\x04name\x18\x06 \x01(\tH\x05R\x04name\x88\x01\x01\x12E\n" +
	"\bmetadata\x18\a \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01H\x06R\bmetadata\x88\x01\x01\x12O\n" +
	"\x10media_encryption\x18\b \x01(\x0e2\x1b.livekit.SIPMediaEncryptionB\x02\x18\x01H\aR\x0fmediaEncryption\x88\x01\x01\x12-\n" +
	"\x05media\x18\v \x01(\v2\x17.livekit.SIPMediaConfigR\x05media\x12 \n" +
	"\tfrom_host\x18\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1c.livekit.SIPInboundTrunkInfoR\x05trunk\"M\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x1d.livekit.SIPOutboundTrunkInfoR\x05items\"H\n" +
	...
	"\bmetadata\x18\x05 \x01(\tB&\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01\x18\x01R\bmetadata\x12}\n" +
	"\n" +
	"attributes\x18\a \x03(\v25.livekit.CreateSIPDispatchRuleRequest.AttributesEntryB&\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01\x18\x01R\n" +
	"attributes\x12#\n" +
	...
	"\bmetadata\x18\x06 \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\bmetadata\x12r\n" +
	"\n" +
	"attributes\x18\b \x03(\v2,.livekit.SIPDispatchRuleInfo.AttributesEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\n" +
	"attributes\x12\x1f\n" +
	...
	"\bmetadata\x18\x04 \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01H\x01R\bmetadata\x88\x01\x01\x12t\n" +
	"\n" +
	"attributes\x18\x05 \x03(\v2..livekit.SIPDispatchRuleUpdate.AttributesEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\n" +
	"attributes\x12O\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x1c.livekit.SIPDispatchRuleInfoR\x05items\"e\n" +
	...
	"\rauth_username\x18\x03 \x01(\tB\x03\xc0P\x01R\fauthUsername\x12(\n" +
	"\rauth_password\x18\x04 \x01(\tB\x03\xc0P\x02R\fauthPassword\x12g\n" +
	...
	"\x14participant_metadata\x18\b \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x13participantMetadata\x12\x9c\x01\n" +
	"\x16participant_attributes\x18\t \x03(\v2?.livekit.CreateSIPParticipantRequest.ParticipantAttributesEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x15participantAttributes\x12\x12\n" +
	...
	"\aheaders\x18\x10 \x03(\v21.livekit.CreateSIPParticipantRequest.HeadersEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\aheaders\x12B\n" +
	...
	"\fdisplay_name\x18\x15 \x01(\tB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01H\x00R\vdisplayName\x88\x01\x01\x12;\n" +
	...
	"\aheaders\x18\x05 \x03(\v23.livekit.TransferSIPParticipantRequest.HeadersEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\aheaders\x12B\n" +
	...
	"transferIDR\n" +
	"transferId\x122\n" +
	"\x06reason\x18\x02 \x01(\x0e2\x1a.livekit.SIPTransferReasonR\x06reason\x121\n" +
	"\n" +
	"sip_status\x18\x03 \x01(\v2\x12.livekit.SIPStatusR\tsipStatus\"\x87\v\n" +
	"\vSIPCallInfo\x12\"\n" +
	...
	"\x16participant_attributes\x18\x12 \x03(\v2/.livekit.SIPCallInfo.ParticipantAttributesEntryB$\xb2P\x1e<redacted ({{ .Size }} bytes)>\xc0P\x01R\x15participantAttributes\x12*\n" +
	...
	"\rprovider_info\x18\x1b \x01(\v2\x15.livekit.ProviderInfoR\fproviderInfo\x12,\n" +
	...
	"\x14transfer_status_code\x18\b \x01(\v2\x12.livekit.SIPStatusR\x12transferStatusCode\x122\n" +
	"\x06reason\x18\t \x01(\x0e2\x1a.livekit.SIPTransferReasonR\x06reason\"\x89\x01\n" +
	"\x06SIPUri\x12\x12\n" +
	...
	"\x14CreateSIPParticipant\x12$.livekit.CreateSIPParticipantRequest\x1a\x1b.livekit.SIPParticipantInfo\x12i\n" +
...
var file_livekit_sip_proto_enumTypes = make([]protoimpl.EnumInfo, 11)
var file_livekit_sip_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_livekit_sip_proto_goTypes = []any{
	...
	(SIPTransferReason)(0),                 // 7: livekit.SIPTransferReason
	(SIPFeature)(0),                        // 8: livekit.SIPFeature
	(SIPCallDirection)(0),                  // 9: livekit.SIPCallDirection
	(SIPTrunkInfo_TrunkKind)(0),            // 10: livekit.SIPTrunkInfo.TrunkKind
	(*SIPStatus)(nil),                      // 11: livekit.SIPStatus
	(*CreateSIPTrunkRequest)(nil),          // 12: livekit.CreateSIPTrunkRequest
	(*SIPCodec)(nil),                       // 13: livekit.SIPCodec
	(*SIPMediaConfig)(nil),                 // 14: livekit.SIPMediaConfig
	(*ProviderInfo)(nil),                   // 15: livekit.ProviderInfo
	(*SIPTrunkInfo)(nil),                   // 16: livekit.SIPTrunkInfo
	(*CreateSIPInboundTrunkRequest)(nil),   // 17: livekit.CreateSIPInboundTrunkRequest
	(*UpdateSIPInboundTrunkRequest)(nil),   // 18: livekit.UpdateSIPInboundTrunkRequest
	(*SIPInboundTrunkInfo)(nil),            // 19: livekit.SIPInboundTrunkInfo
	(*SIPInboundTrunkUpdate)(nil),          // 20: livekit.SIPInboundTrunkUpdate
	(*CreateSIPOutboundTrunkRequest)(nil),  // 21: livekit.CreateSIPOutboundTrunkRequest
	(*UpdateSIPOutboundTrunkRequest)(nil),  // 22: livekit.UpdateSIPOutboundTrunkRequest
	(*SIPOutboundTrunkInfo)(nil),           // 23: livekit.SIPOutboundTrunkInfo
	(*SIPOutboundTrunkUpdate)(nil),         // 24: livekit.SIPOutboundTrunkUpdate
	(*GetSIPInboundTrunkRequest)(nil),      // 25: livekit.GetSIPInboundTrunkRequest
	(*GetSIPInboundTrunkResponse)(nil),     // 26: livekit.GetSIPInboundTrunkResponse
	(*GetSIPOutboundTrunkRequest)(nil),     // 27: livekit.GetSIPOutboundTrunkRequest
	(*GetSIPOutboundTrunkResponse)(nil),    // 28: livekit.GetSIPOutboundTrunkResponse
	(*ListSIPTrunkRequest)(nil),            // 29: livekit.ListSIPTrunkRequest
	(*ListSIPTrunkResponse)(nil),           // 30: livekit.ListSIPTrunkResponse
	(*ListSIPInboundTrunkRequest)(nil),     // 31: livekit.ListSIPInboundTrunkRequest
	(*ListSIPInboundTrunkResponse)(nil),    // 32: livekit.ListSIPInboundTrunkResponse
	(*ListSIPOutboundTrunkRequest)(nil),    // 33: livekit.ListSIPOutboundTrunkRequest
	(*ListSIPOutboundTrunkResponse)(nil),   // 34: livekit.ListSIPOutboundTrunkResponse
	(*DeleteSIPTrunkRequest)(nil),          // 35: livekit.DeleteSIPTrunkRequest
	(*SIPDispatchRuleDirect)(nil),          // 36: livekit.SIPDispatchRuleDirect
	(*SIPDispatchRuleIndividual)(nil),      // 37: livekit.SIPDispatchRuleIndividual
	(*SIPDispatchRuleCallee)(nil),          // 38: livekit.SIPDispatchRuleCallee
	(*SIPDispatchRule)(nil),                // 39: livekit.SIPDispatchRule
	(*CreateSIPDispatchRuleRequest)(nil),   // 40: livekit.CreateSIPDispatchRuleRequest
	(*UpdateSIPDispatchRuleRequest)(nil),   // 41: livekit.UpdateSIPDispatchRuleRequest
	(*SIPDispatchRuleInfo)(nil),            // 42: livekit.SIPDispatchRuleInfo
	(*SIPDispatchRuleUpdate)(nil),          // 43: livekit.SIPDispatchRuleUpdate
	(*ListSIPDispatchRuleRequest)(nil),     // 44: livekit.ListSIPDispatchRuleRequest
	(*ListSIPDispatchRuleResponse)(nil),    // 45: livekit.ListSIPDispatchRuleResponse
	(*DeleteSIPDispatchRuleRequest)(nil),   // 46: livekit.DeleteSIPDispatchRuleRequest
	(*SIPOutboundConfig)(nil),              // 47: livekit.SIPOutboundConfig
	(*CreateSIPParticipantRequest)(nil),    // 48: livekit.CreateSIPParticipantRequest
	(*SIPParticipantInfo)(nil),             // 49: livekit.SIPParticipantInfo
	(*TransferSIPParticipantRequest)(nil),  // 50: livekit.TransferSIPParticipantRequest
	(*TransferSIPParticipantResponse)(nil), // 51: livekit.TransferSIPParticipantResponse
	(*SIPTransferError)(nil),               // 52: livekit.SIPTransferError
	(*SIPCallInfo)(nil),                    // 53: livekit.SIPCallInfo
	(*SIPTransferInfo)(nil),                // 54: livekit.SIPTransferInfo
	(*SIPUri)(nil),                         // 55: livekit.SIPUri
	(*SIPRequestDest)(nil),                 // 56: livekit.SIPRequestDest
	(*SIPNamedDest)(nil),                   // 57: livekit.SIPNamedDest
	(*Destination)(nil),                    // 58: livekit.Destination
	nil,                                    // 59: livekit.SIPInboundTrunkInfo.HeadersEntry
	nil,                                    // 60: livekit.SIPInboundTrunkInfo.HeadersToAttributesEntry
	nil,                                    // 61: livekit.SIPInboundTrunkInfo.AttributesToHeadersEntry
	nil,                                    // 62: livekit.SIPOutboundTrunkInfo.HeadersEntry
	nil,                                    // 63: livekit.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	nil,                                    // 64: livekit.SIPOutboundTrunkInfo.AttributesToHeadersEntry
	nil,                                    // 65: livekit.CreateSIPDispatchRuleRequest.AttributesEntry
	nil,                                    // 66: livekit.SIPDispatchRuleInfo.AttributesEntry
	nil,                                    // 67: livekit.SIPDispatchRuleUpdate.AttributesEntry
	nil,                                    // 68: livekit.SIPOutboundConfig.HeadersToAttributesEntry
	nil,                                    // 69: livekit.SIPOutboundConfig.AttributesToHeadersEntry
	nil,                                    // 70: livekit.CreateSIPParticipantRequest.ParticipantAttributesEntry
	nil,                                    // 71: livekit.CreateSIPParticipantRequest.HeadersEntry
	nil,                                    // 72: livekit.TransferSIPParticipantRequest.HeadersEntry
	nil,                                    // 73: livekit.SIPCallInfo.ParticipantAttributesEntry
	(*durationpb.Duration)(nil),            // 74: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),          // 75: google.protobuf.Timestamp
	(*ListUpdate)(nil),                     // 76: livekit.ListUpdate
	(*Pagination)(nil),                     // 77: livekit.Pagination
	(*RoomConfiguration)(nil),              // 78: livekit.RoomConfiguration
	(DisconnectReason)(0),                  // 79: livekit.DisconnectReason
...
var file_livekit_sip_proto_depIdxs = []int32{
	...
	13,  // 1: livekit.SIPMediaConfig.codecs:type_name -> livekit.SIPCodec
	3,   // 2: livekit.SIPMediaConfig.encryption:type_name -> livekit.SIPMediaEncryption
	74,  // 3: livekit.SIPMediaConfig.media_timeout:type_name -> google.protobuf.Duration
	4,   // 4: livekit.ProviderInfo.type:type_name -> livekit.ProviderType
	10,  // 5: livekit.SIPTrunkInfo.kind:type_name -> livekit.SIPTrunkInfo.TrunkKind
	1,   // 6: livekit.SIPTrunkInfo.transport:type_name -> livekit.SIPTransport
	19,  // 7: livekit.CreateSIPInboundTrunkRequest.trunk:type_name -> livekit.SIPInboundTrunkInfo
	19,  // 8: livekit.UpdateSIPInboundTrunkRequest.replace:type_name -> livekit.SIPInboundTrunkInfo
	20,  // 9: livekit.UpdateSIPInboundTrunkRequest.update:type_name -> livekit.SIPInboundTrunkUpdate
	59,  // 10: livekit.SIPInboundTrunkInfo.headers:type_name -> livekit.SIPInboundTrunkInfo.HeadersEntry
	60,  // 11: livekit.SIPInboundTrunkInfo.headers_to_attributes:type_name -> livekit.SIPInboundTrunkInfo.HeadersToAttributesEntry
	61,  // 12: livekit.SIPInboundTrunkInfo.attributes_to_headers:type_name -> livekit.SIPInboundTrunkInfo.AttributesToHeadersEntry
	2,   // 13: livekit.SIPInboundTrunkInfo.include_headers:type_name -> livekit.SIPHeaderOptions
	74,  // 14: livekit.SIPInboundTrunkInfo.ringing_timeout:type_name -> google.protobuf.Duration
	11,  // 15: livekit.SIPInboundTrunkInfo.ringing_timeout_status:type_name -> livekit.SIPStatus
	74,  // 16: livekit.SIPInboundTrunkInfo.max_call_duration:type_name -> google.protobuf.Duration
	3,   // 17: livekit.SIPInboundTrunkInfo.media_encryption:type_name -> livekit.SIPMediaEncryption
	14,  // 18: livekit.SIPInboundTrunkInfo.media:type_name -> livekit.SIPMediaConfig
	75,  // 19: livekit.SIPInboundTrunkInfo.created_at:type_name -> google.protobuf.Timestamp
	75,  // 20: livekit.SIPInboundTrunkInfo.updated_at:type_name -> google.protobuf.Timestamp
	76,  // 21: livekit.SIPInboundTrunkUpdate.numbers:type_name -> livekit.ListUpdate
	76,  // 22: livekit.SIPInboundTrunkUpdate.allowed_addresses:type_name -> livekit.ListUpdate
	76,  // 23: livekit.SIPInboundTrunkUpdate.allowed_numbers:type_name -> livekit.ListUpdate
	3,   // 24: livekit.SIPInboundTrunkUpdate.media_encryption:type_name -> livekit.SIPMediaEncryption
	14,  // 25: livekit.SIPInboundTrunkUpdate.media:type_name -> livekit.SIPMediaConfig
	23,  // 26: livekit.CreateSIPOutboundTrunkRequest.trunk:type_name -> livekit.SIPOutboundTrunkInfo
	23,  // 27: livekit.UpdateSIPOutboundTrunkRequest.replace:type_name -> livekit.SIPOutboundTrunkInfo
	24,  // 28: livekit.UpdateSIPOutboundTrunkRequest.update:type_name -> livekit.SIPOutboundTrunkUpdate
	1,   // 29: livekit.SIPOutboundTrunkInfo.transport:type_name -> livekit.SIPTransport
	62,  // 30: livekit.SIPOutboundTrunkInfo.headers:type_name -> livekit.SIPOutboundTrunkInfo.HeadersEntry
	63,  // 31: livekit.SIPOutboundTrunkInfo.headers_to_attributes:type_name -> livekit.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	64,  // 32: livekit.SIPOutboundTrunkInfo.attributes_to_headers:type_name -> livekit.SIPOutboundTrunkInfo.AttributesToHeadersEntry
	2,   // 33: livekit.SIPOutboundTrunkInfo.include_headers:type_name -> livekit.SIPHeaderOptions
	3,   // 34: livekit.SIPOutboundTrunkInfo.media_encryption:type_name -> livekit.SIPMediaEncryption
	14,  // 35: livekit.SIPOutboundTrunkInfo.media:type_name -> livekit.SIPMediaConfig
	75,  // 36: livekit.SIPOutboundTrunkInfo.created_at:type_name -> google.protobuf.Timestamp
	75,  // 37: livekit.SIPOutboundTrunkInfo.updated_at:type_name -> google.protobuf.Timestamp
	1,   // 38: livekit.SIPOutboundTrunkUpdate.transport:type_name -> livekit.SIPTransport
	76,  // 39: livekit.SIPOutboundTrunkUpdate.numbers:type_name -> livekit.ListUpdate
	3,   // 40: livekit.SIPOutboundTrunkUpdate.media_encryption:type_name -> livekit.SIPMediaEncryption
	14,  // 41: livekit.SIPOutboundTrunkUpdate.media:type_name -> livekit.SIPMediaConfig
	19,  // 42: livekit.GetSIPInboundTrunkResponse.trunk:type_name -> livekit.SIPInboundTrunkInfo
	23,  // 43: livekit.GetSIPOutboundTrunkResponse.trunk:type_name -> livekit.SIPOutboundTrunkInfo
	77,  // 44: livekit.ListSIPTrunkRequest.page:type_name -> livekit.Pagination
	16,  // 45: livekit.ListSIPTrunkResponse.items:type_name -> livekit.SIPTrunkInfo
	77,  // 46: livekit.ListSIPInboundTrunkRequest.page:type_name -> livekit.Pagination
	19,  // 47: livekit.ListSIPInboundTrunkResponse.items:type_name -> livekit.SIPInboundTrunkInfo
	77,  // 48: livekit.ListSIPOutboundTrunkRequest.page:type_name -> livekit.Pagination
	23,  // 49: livekit.ListSIPOutboundTrunkResponse.items:type_name -> livekit.SIPOutboundTrunkInfo
	36,  // 50: livekit.SIPDispatchRule.dispatch_rule_direct:type_name -> livekit.SIPDispatchRuleDirect
	37,  // 51: livekit.SIPDispatchRule.dispatch_rule_individual:type_name -> livekit.SIPDispatchRuleIndividual
	38,  // 52: livekit.SIPDispatchRule.dispatch_rule_callee:type_name -> livekit.SIPDispatchRuleCallee
	42,  // 53: livekit.CreateSIPDispatchRuleRequest.dispatch_rule:type_name -> livekit.SIPDispatchRuleInfo
	39,  // 54: livekit.CreateSIPDispatchRuleRequest.rule:type_name -> livekit.SIPDispatchRule
	65,  // 55: livekit.CreateSIPDispatchRuleRequest.attributes:type_name -> livekit.CreateSIPDispatchRuleRequest.AttributesEntry
	78,  // 56: livekit.CreateSIPDispatchRuleRequest.room_config:type_name -> livekit.RoomConfiguration
	42,  // 57: livekit.UpdateSIPDispatchRuleRequest.replace:type_name -> livekit.SIPDispatchRuleInfo
	43,  // 58: livekit.UpdateSIPDispatchRuleRequest.update:type_name -> livekit.SIPDispatchRuleUpdate
	39,  // 59: livekit.SIPDispatchRuleInfo.rule:type_name -> livekit.SIPDispatchRule
	66,  // 60: livekit.SIPDispatchRuleInfo.attributes:type_name -> livekit.SIPDispatchRuleInfo.AttributesEntry
	78,  // 61: livekit.SIPDispatchRuleInfo.room_config:type_name -> livekit.RoomConfiguration
	14,  // 62: livekit.SIPDispatchRuleInfo.media:type_name -> livekit.SIPMediaConfig
	3,   // 63: livekit.SIPDispatchRuleInfo.media_encryption:type_name -> livekit.SIPMediaEncryption
	75,  // 64: livekit.SIPDispatchRuleInfo.created_at:type_name -> google.protobuf.Timestamp
	75,  // 65: livekit.SIPDispatchRuleInfo.updated_at:type_name -> google.protobuf.Timestamp
	76,  // 66: livekit.SIPDispatchRuleUpdate.trunk_ids:type_name -> livekit.ListUpdate
	39,  // 67: livekit.SIPDispatchRuleUpdate.rule:type_name -> livekit.SIPDispatchRule
	67,  // 68: livekit.SIPDispatchRuleUpdate.attributes:type_name -> livekit.SIPDispatchRuleUpdate.AttributesEntry
	3,   // 69: livekit.SIPDispatchRuleUpdate.media_encryption:type_name -> livekit.SIPMediaEncryption
	14,  // 70: livekit.SIPDispatchRuleUpdate.media:type_name -> livekit.SIPMediaConfig
	77,  // 71: livekit.ListSIPDispatchRuleRequest.page:type_name -> livekit.Pagination
	42,  // 72: livekit.ListSIPDispatchRuleResponse.items:type_name -> livekit.SIPDispatchRuleInfo
	1,   // 73: livekit.SIPOutboundConfig.transport:type_name -> livekit.SIPTransport
	68,  // 74: livekit.SIPOutboundConfig.headers_to_attributes:type_name -> livekit.SIPOutboundConfig.HeadersToAttributesEntry
	69,  // 75: livekit.SIPOutboundConfig.attributes_to_headers:type_name -> livekit.SIPOutboundConfig.AttributesToHeadersEntry
	47,  // 76: livekit.CreateSIPParticipantRequest.trunk:type_name -> livekit.SIPOutboundConfig
	56,  // 77: livekit.CreateSIPParticipantRequest.sip_request_uri:type_name -> livekit.SIPRequestDest
	57,  // 78: livekit.CreateSIPParticipantRequest.sip_to_header:type_name -> livekit.SIPNamedDest
	57,  // 79: livekit.CreateSIPParticipantRequest.sip_from_header:type_name -> livekit.SIPNamedDest
	70,  // 80: livekit.CreateSIPParticipantRequest.participant_attributes:type_name -> livekit.CreateSIPParticipantRequest.ParticipantAttributesEntry
	71,  // 81: livekit.CreateSIPParticipantRequest.headers:type_name -> livekit.CreateSIPParticipantRequest.HeadersEntry
	2,   // 82: livekit.CreateSIPParticipantRequest.include_headers:type_name -> livekit.SIPHeaderOptions
	74,  // 83: livekit.CreateSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	74,  // 84: livekit.CreateSIPParticipantRequest.max_call_duration:type_name -> google.protobuf.Duration
	3,   // 85: livekit.CreateSIPParticipantRequest.media_encryption:type_name -> livekit.SIPMediaEncryption
	14,  // 86: livekit.CreateSIPParticipantRequest.media:type_name -> livekit.SIPMediaConfig
	58,  // 87: livekit.CreateSIPParticipantRequest.destination:type_name -> livekit.Destination
	72,  // 88: livekit.TransferSIPParticipantRequest.headers:type_name -> livekit.TransferSIPParticipantRequest.HeadersEntry
	74,  // 89: livekit.TransferSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	6,   // 90: livekit.TransferSIPParticipantResponse.status:type_name -> livekit.SIPTransferStatus
	7,   // 91: livekit.TransferSIPParticipantResponse.reason:type_name -> livekit.SIPTransferReason
	11,  // 92: livekit.TransferSIPParticipantResponse.sip_status:type_name -> livekit.SIPStatus
	7,   // 93: livekit.SIPTransferError.reason:type_name -> livekit.SIPTransferReason
	11,  // 94: livekit.SIPTransferError.sip_status:type_name -> livekit.SIPStatus
	73,  // 95: livekit.SIPCallInfo.participant_attributes:type_name -> livekit.SIPCallInfo.ParticipantAttributesEntry
	55,  // 96: livekit.SIPCallInfo.from_uri:type_name -> livekit.SIPUri
	55,  // 97: livekit.SIPCallInfo.to_uri:type_name -> livekit.SIPUri
	8,   // 98: livekit.SIPCallInfo.enabled_features:type_name -> livekit.SIPFeature
	9,   // 99: livekit.SIPCallInfo.call_direction:type_name -> livekit.SIPCallDirection
	5,   // 100: livekit.SIPCallInfo.call_status:type_name -> livekit.SIPCallStatus
	79,  // 101: livekit.SIPCallInfo.disconnect_reason:type_name -> livekit.DisconnectReason
	11,  // 102: livekit.SIPCallInfo.call_status_code:type_name -> livekit.SIPStatus
	80,  // 103: livekit.SIPCallInfo.call_context:type_name -> google.protobuf.Any
	15,  // 104: livekit.SIPCallInfo.provider_info:type_name -> livekit.ProviderInfo
	6,   // 105: livekit.SIPTransferInfo.transfer_status:type_name -> livekit.SIPTransferStatus
	11,  // 106: livekit.SIPTransferInfo.transfer_status_code:type_name -> livekit.SIPStatus
	7,   // 107: livekit.SIPTransferInfo.reason:type_name -> livekit.SIPTransferReason
	1,   // 108: livekit.SIPUri.transport:type_name -> livekit.SIPTransport
	55,  // 109: livekit.SIPRequestDest.values:type_name -> livekit.SIPUri
	55,  // 110: livekit.SIPNamedDest.values:type_name -> livekit.SIPUri
	29,  // 111: livekit.SIP.ListSIPTrunk:input_type -> livekit.ListSIPTrunkRequest
	17,  // 112: livekit.SIP.CreateSIPInboundTrunk:input_type -> livekit.CreateSIPInboundTrunkRequest
	21,  // 113: livekit.SIP.CreateSIPOutboundTrunk:input_type -> livekit.CreateSIPOutboundTrunkRequest
	18,  // 114: livekit.SIP.UpdateSIPInboundTrunk:input_type -> livekit.UpdateSIPInboundTrunkRequest
	22,  // 115: livekit.SIP.UpdateSIPOutboundTrunk:input_type -> livekit.UpdateSIPOutboundTrunkRequest
	25,  // 116: livekit.SIP.GetSIPInboundTrunk:input_type -> livekit.GetSIPInboundTrunkRequest
	27,  // 117: livekit.SIP.GetSIPOutboundTrunk:input_type -> livekit.GetSIPOutboundTrunkRequest
	31,  // 118: livekit.SIP.ListSIPInboundTrunk:input_type -> livekit.ListSIPInboundTrunkRequest
	33,  // 119: livekit.SIP.ListSIPOutboundTrunk:input_type -> livekit.ListSIPOutboundTrunkRequest
	35,  // 120: livekit.SIP.DeleteSIPTrunk:input_type -> livekit.DeleteSIPTrunkRequest
	40,  // 121: livekit.SIP.CreateSIPDispatchRule:input_type -> livekit.CreateSIPDispatchRuleRequest
	41,  // 122: livekit.SIP.UpdateSIPDispatchRule:input_type -> livekit.UpdateSIPDispatchRuleRequest
	44,  // 123: livekit.SIP.ListSIPDispatchRule:input_type -> livekit.ListSIPDispatchRuleRequest
	46,  // 124: livekit.SIP.DeleteSIPDispatchRule:input_type -> livekit.DeleteSIPDispatchRuleRequest
	48,  // 125: livekit.SIP.CreateSIPParticipant:input_type -> livekit.CreateSIPParticipantRequest
	50,  // 126: livekit.SIP.TransferSIPParticipant:input_type -> livekit.TransferSIPParticipantRequest
	30,  // 127: livekit.SIP.ListSIPTrunk:output_type -> livekit.ListSIPTrunkResponse
	19,  // 128: livekit.SIP.CreateSIPInboundTrunk:output_type -> livekit.SIPInboundTrunkInfo
	23,  // 129: livekit.SIP.CreateSIPOutboundTrunk:output_type -> livekit.SIPOutboundTrunkInfo
	19,  // 130: livekit.SIP.UpdateSIPInboundTrunk:output_type -> livekit.SIPInboundTrunkInfo
	23,  // 131: livekit.SIP.UpdateSIPOutboundTrunk:output_type -> livekit.SIPOutboundTrunkInfo
	26,  // 132: livekit.SIP.GetSIPInboundTrunk:output_type -> livekit.GetSIPInboundTrunkResponse
	28,  // 133: livekit.SIP.GetSIPOutboundTrunk:output_type -> livekit.GetSIPOutboundTrunkResponse
	32,  // 134: livekit.SIP.ListSIPInboundTrunk:output_type -> livekit.ListSIPInboundTrunkResponse
	34,  // 135: livekit.SIP.ListSIPOutboundTrunk:output_type -> livekit.ListSIPOutboundTrunkResponse
	16,  // 136: livekit.SIP.DeleteSIPTrunk:output_type -> livekit.SIPTrunkInfo
	42,  // 137: livekit.SIP.CreateSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	42,  // 138: livekit.SIP.UpdateSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	45,  // 139: livekit.SIP.ListSIPDispatchRule:output_type -> livekit.ListSIPDispatchRuleResponse
	42,  // 140: livekit.SIP.DeleteSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	49,  // 141: livekit.SIP.CreateSIPParticipant:output_type -> livekit.SIPParticipantInfo
	51,  // 142: livekit.SIP.TransferSIPParticipant:output_type -> livekit.TransferSIPParticipantResponse
...
func file_livekit_sip_proto_init() {
	...
	file_livekit_sip_proto_msgTypes[13].OneofWrappers = []any{}
	...
	file_livekit_sip_proto_msgTypes[45].OneofWrappers = []any{
		(*SIPRequestDest_Raw)(nil),
		(*SIPRequestDest_Values)(nil),
	}
	file_livekit_sip_proto_msgTypes[46].OneofWrappers = []any{
