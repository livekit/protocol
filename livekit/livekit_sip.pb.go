...
type SIPInboundTrunkInfo struct {
	...
	// SIP status code if ringing_timeout elapses. Unset means using system default.
	RingingTimeoutStatus SIPStatusCode `protobuf:"varint,21,opt,name=ringing_timeout_status,json=ringingTimeoutStatus,proto3,enum=livekit.SIPStatusCode" json:"ringing_timeout_status,omitempty"`
	// Max call duration.
...
func (x *SIPInboundTrunkInfo) GetRingingTimeoutStatus() SIPStatusCode {
	if x != nil {
...
const file_livekit_sip_proto_rawDesc = "" +
	...
	"\x0fringing_timeout\x18\v \x01(\v2\x19.google.protobuf.DurationR\x0eringingTimeout\x12L\n" +
	"\x16ringing_timeout_status\x18\x15 \x01(\x0e2\x16.livekit.SIPStatusCodeR\x14ringingTimeoutStatus\x12E\n" +
...
var file_livekit_sip_proto_depIdxs = []int32{
	...
	0,   // 15: livekit.SIPInboundTrunkInfo.ringing_timeout_status:type_name -> livekit.SIPStatusCode
