...
type SIPInboundTrunkInfo struct {
	...
	MediaTimeout  *durationpb.Duration `protobuf:"bytes,19,opt,name=media_timeout,json=mediaTimeout,proto3" json:"media_timeout,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SIPInboundTrunkInfo) GetMediaTimeout() *durationpb.Duration {
	if x != nil {
...
type SIPInboundTrunkUpdate struct {
	...
	MediaTimeout     *durationpb.Duration   `protobuf:"bytes,9,opt,name=media_timeout,json=mediaTimeout,proto3,oneof" json:"media_timeout,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *SIPInboundTrunkUpdate) GetMediaTimeout() *durationpb.Duration {
	if x != nil {
		return x.MediaTimeout
	}
	return nil
...
type SIPOutboundTrunkInfo struct {
	...
	// Max time a call can last without incoming RTP data received. If unset, defaults are used.
	MediaTimeout  *durationpb.Duration `protobuf:"bytes,18,opt,name=media_timeout,json=mediaTimeout,proto3" json:"media_timeout,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SIPOutboundTrunkInfo) GetMediaTimeout() *durationpb.Duration {
	if x != nil {
		return x.MediaTimeout
	}
	return nil
...
type SIPOutboundTrunkUpdate struct {
	...
	MediaTimeout       *durationpb.Duration   `protobuf:"bytes,11,opt,name=media_timeout,json=mediaTimeout,proto3,oneof" json:"media_timeout,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *SIPOutboundTrunkUpdate) GetMediaTimeout() *durationpb.Duration {
	if x != nil {
		return x.MediaTimeout
	}
	return nil
...
type SIPOutboundConfig struct {
	...
	// Max time a call can last without incoming RTP data received. If unset, defaults are used.
	MediaTimeout  *durationpb.Duration `protobuf:"bytes,9,opt,name=media_timeout,json=mediaTimeout,proto3" json:"media_timeout,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SIPOutboundConfig) GetMediaTimeout() *durationpb.Duration {
	if x != nil {
		return x.MediaTimeout
	}
	return nil
...
const file_livekit_sip_proto_rawDesc = "" +
	...
	"\x04name\x18\n" +
	" \x01(\tR\x04name\x12@\n" +
	"\bmetadata\x18\v \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\bmetadata:\x02\x18\x01\"\x88\x01\n" +
	...
	"\rmedia_timeout\x18\x13 \x01(\v2\x19.google.protobuf.DurationR\fmediaTimeout\x1a:\n" +
	...
	"\x10media_encryption\x18\b \x01(\x0e2\x1b.livekit.SIPMediaEncryptionH\x04R\x0fmediaEncryption\x88\x01\x01\x12C\n" +
	"\rmedia_timeout\x18\t \x01(\v2\x19.google.protobuf.DurationH\x05R\fmediaTimeout\x88\x01\x01B\x10\n" +
	"\x0e_auth_usernameB\x10\n" +
	"\x0e_auth_passwordB\a\n" +
	"\x05_nameB\v\n" +
	"\t_metadataB\x13\n" +
	"\x11_media_encryptionB\x10\n" +
	"\x0e_media_timeout\"T\n" +
	...
	"\rmedia_timeout\x18\x12 \x01(\v2\x19.google.protobuf.DurationR\fmediaTimeout\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aF\n" +
	"\x18HeadersToAttributesEntry\x12\x10\n" +
	...
	"\tfrom_host\x18\n" +
	" \x01(\tH\bR\bfromHost\x88\x01\x01\x12C\n" +
	"\rmedia_timeout\x18\v \x01(\v2\x19.google.protobuf.DurationH\tR\fmediaTimeout\x88\x01\x01B\n" +
	"\n" +
	"\b_addressB\f\n" +
	"\n" +
	"_transportB\x16\n" +
	...
	"\x14sip_dispatch_rule_id\x18\x01 \x01(\tB\x14\xbaP\x11sipDispatchRuleIDR\x11sipDispatchRuleId\"\xa8\x05\n" +
	...
	"\tfrom_host\x18\b \x01(\tR\bfromHost\x12>\n" +
	"\rmedia_timeout\x18\t \x01(\v2\x19.google.protobuf.DurationR\fmediaTimeout\x1aF\n" +
	"\x18HeadersToAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aF\n" +
	"\x18AttributesToHeadersEntry\x12\x10\n" +
...
var file_livekit_sip_proto_depIdxs = []int32{
	...
	67,  // 16: livekit.SIPInboundTrunkInfo.media_timeout:type_name -> google.protobuf.Duration
	69,  // 17: livekit.SIPInboundTrunkUpdate.numbers:type_name -> livekit.ListUpdate
	69,  // 18: livekit.SIPInboundTrunkUpdate.allowed_addresses:type_name -> livekit.ListUpdate
	69,  // 19: livekit.SIPInboundTrunkUpdate.allowed_numbers:type_name -> livekit.ListUpdate
	3,   // 20: livekit.SIPInboundTrunkUpdate.media_encryption:type_name -> livekit.SIPMediaEncryption
	67,  // 21: livekit.SIPInboundTrunkUpdate.media_timeout:type_name -> google.protobuf.Duration
	20,  // 22: livekit.CreateSIPOutboundTrunkRequest.trunk:type_name -> livekit.SIPOutboundTrunkInfo
	20,  // 23: livekit.UpdateSIPOutboundTrunkRequest.replace:type_name -> livekit.SIPOutboundTrunkInfo
	21,  // 24: livekit.UpdateSIPOutboundTrunkRequest.update:type_name -> livekit.SIPOutboundTrunkUpdate
	1,   // 25: livekit.SIPOutboundTrunkInfo.transport:type_name -> livekit.SIPTransport
	55,  // 26: livekit.SIPOutboundTrunkInfo.headers:type_name -> livekit.SIPOutboundTrunkInfo.HeadersEntry
	56,  // 27: livekit.SIPOutboundTrunkInfo.headers_to_attributes:type_name -> livekit.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	57,  // 28: livekit.SIPOutboundTrunkInfo.attributes_to_headers:type_name -> livekit.SIPOutboundTrunkInfo.AttributesToHeadersEntry
	...
	68,  // 31: livekit.SIPOutboundTrunkInfo.created_at:type_name -> google.protobuf.Timestamp
	68,  // 32: livekit.SIPOutboundTrunkInfo.updated_at:type_name -> google.protobuf.Timestamp
	67,  // 33: livekit.SIPOutboundTrunkInfo.media_timeout:type_name -> google.protobuf.Duration
	1,   // 34: livekit.SIPOutboundTrunkUpdate.transport:type_name -> livekit.SIPTransport
	69,  // 35: livekit.SIPOutboundTrunkUpdate.numbers:type_name -> livekit.ListUpdate
	3,   // 36: livekit.SIPOutboundTrunkUpdate.media_encryption:type_name -> livekit.SIPMediaEncryption
	67,  // 37: livekit.SIPOutboundTrunkUpdate.media_timeout:type_name -> google.protobuf.Duration
	16,  // 38: livekit.GetSIPInboundTrunkResponse.trunk:type_name -> livekit.SIPInboundTrunkInfo
	20,  // 39: livekit.GetSIPOutboundTrunkResponse.trunk:type_name -> livekit.SIPOutboundTrunkInfo
	70,  // 40: livekit.ListSIPTrunkRequest.page:type_name -> livekit.Pagination
	13,  // 41: livekit.ListSIPTrunkResponse.items:type_name -> livekit.SIPTrunkInfo
	70,  // 42: livekit.ListSIPInboundTrunkRequest.page:type_name -> livekit.Pagination
	16,  // 43: livekit.ListSIPInboundTrunkResponse.items:type_name -> livekit.SIPInboundTrunkInfo
	70,  // 44: livekit.ListSIPOutboundTrunkRequest.page:type_name -> livekit.Pagination
	20,  // 45: livekit.ListSIPOutboundTrunkResponse.items:type_name -> livekit.SIPOutboundTrunkInfo
	33,  // 46: livekit.SIPDispatchRule.dispatch_rule_direct:type_name -> livekit.SIPDispatchRuleDirect
	34,  // 47: livekit.SIPDispatchRule.dispatch_rule_individual:type_name -> livekit.SIPDispatchRuleIndividual
	35,  // 48: livekit.SIPDispatchRule.dispatch_rule_callee:type_name -> livekit.SIPDispatchRuleCallee
	39,  // 49: livekit.CreateSIPDispatchRuleRequest.dispatch_rule:type_name -> livekit.SIPDispatchRuleInfo
	36,  // 50: livekit.CreateSIPDispatchRuleRequest.rule:type_name -> livekit.SIPDispatchRule
	58,  // 51: livekit.CreateSIPDispatchRuleRequest.attributes:type_name -> livekit.CreateSIPDispatchRuleRequest.AttributesEntry
	71,  // 52: livekit.CreateSIPDispatchRuleRequest.room_config:type_name -> livekit.RoomConfiguration
	39,  // 53: livekit.UpdateSIPDispatchRuleRequest.replace:type_name -> livekit.SIPDispatchRuleInfo
	40,  // 54: livekit.UpdateSIPDispatchRuleRequest.update:type_name -> livekit.SIPDispatchRuleUpdate
	36,  // 55: livekit.SIPDispatchRuleInfo.rule:type_name -> livekit.SIPDispatchRule
	59,  // 56: livekit.SIPDispatchRuleInfo.attributes:type_name -> livekit.SIPDispatchRuleInfo.AttributesEntry
	71,  // 57: livekit.SIPDispatchRuleInfo.room_config:type_name -> livekit.RoomConfiguration
	3,   // 58: livekit.SIPDispatchRuleInfo.media_encryption:type_name -> livekit.SIPMediaEncryption
	68,  // 59: livekit.SIPDispatchRuleInfo.created_at:type_name -> google.protobuf.Timestamp
	68,  // 60: livekit.SIPDispatchRuleInfo.updated_at:type_name -> google.protobuf.Timestamp
	69,  // 61: livekit.SIPDispatchRuleUpdate.trunk_ids:type_name -> livekit.ListUpdate
	36,  // 62: livekit.SIPDispatchRuleUpdate.rule:type_name -> livekit.SIPDispatchRule
	60,  // 63: livekit.SIPDispatchRuleUpdate.attributes:type_name -> livekit.SIPDispatchRuleUpdate.AttributesEntry
	3,   // 64: livekit.SIPDispatchRuleUpdate.media_encryption:type_name -> livekit.SIPMediaEncryption
	70,  // 65: livekit.ListSIPDispatchRuleRequest.page:type_name -> livekit.Pagination
	39,  // 66: livekit.ListSIPDispatchRuleResponse.items:type_name -> livekit.SIPDispatchRuleInfo
	1,   // 67: livekit.SIPOutboundConfig.transport:type_name -> livekit.SIPTransport
	61,  // 68: livekit.SIPOutboundConfig.headers_to_attributes:type_name -> livekit.SIPOutboundConfig.HeadersToAttributesEntry
	62,  // 69: livekit.SIPOutboundConfig.attributes_to_headers:type_name -> livekit.SIPOutboundConfig.AttributesToHeadersEntry
	67,  // 70: livekit.SIPOutboundConfig.media_timeout:type_name -> google.protobuf.Duration
	44,  // 71: livekit.CreateSIPParticipantRequest.trunk:type_name -> livekit.SIPOutboundConfig
	63,  // 72: livekit.CreateSIPParticipantRequest.participant_attributes:type_name -> livekit.CreateSIPParticipantRequest.ParticipantAttributesEntry
	64,  // 73: livekit.CreateSIPParticipantRequest.headers:type_name -> livekit.CreateSIPParticipantRequest.HeadersEntry
	2,   // 74: livekit.CreateSIPParticipantRequest.include_headers:type_name -> livekit.SIPHeaderOptions
	67,  // 75: livekit.CreateSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	67,  // 76: livekit.CreateSIPParticipantRequest.max_call_duration:type_name -> google.protobuf.Duration
	3,   // 77: livekit.CreateSIPParticipantRequest.media_encryption:type_name -> livekit.SIPMediaEncryption
	51,  // 78: livekit.CreateSIPParticipantRequest.destination:type_name -> livekit.Destination
	65,  // 79: livekit.TransferSIPParticipantRequest.headers:type_name -> livekit.TransferSIPParticipantRequest.HeadersEntry
	67,  // 80: livekit.TransferSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	66,  // 81: livekit.SIPCallInfo.participant_attributes:type_name -> livekit.SIPCallInfo.ParticipantAttributesEntry
	50,  // 82: livekit.SIPCallInfo.from_uri:type_name -> livekit.SIPUri
	50,  // 83: livekit.SIPCallInfo.to_uri:type_name -> livekit.SIPUri
	...
	72,  // 87: livekit.SIPCallInfo.disconnect_reason:type_name -> livekit.DisconnectReason
	10,  // 88: livekit.SIPCallInfo.call_status_code:type_name -> livekit.SIPStatus
	73,  // 89: livekit.SIPCallInfo.call_context:type_name -> google.protobuf.Any
	12,  // 90: livekit.SIPCallInfo.provider_info:type_name -> livekit.ProviderInfo
	...
	26,  // 94: livekit.SIP.ListSIPTrunk:input_type -> livekit.ListSIPTrunkRequest
	14,  // 95: livekit.SIP.CreateSIPInboundTrunk:input_type -> livekit.CreateSIPInboundTrunkRequest
	18,  // 96: livekit.SIP.CreateSIPOutboundTrunk:input_type -> livekit.CreateSIPOutboundTrunkRequest
	15,  // 97: livekit.SIP.UpdateSIPInboundTrunk:input_type -> livekit.UpdateSIPInboundTrunkRequest
	19,  // 98: livekit.SIP.UpdateSIPOutboundTrunk:input_type -> livekit.UpdateSIPOutboundTrunkRequest
	22,  // 99: livekit.SIP.GetSIPInboundTrunk:input_type -> livekit.GetSIPInboundTrunkRequest
	24,  // 100: livekit.SIP.GetSIPOutboundTrunk:input_type -> livekit.GetSIPOutboundTrunkRequest
	28,  // 101: livekit.SIP.ListSIPInboundTrunk:input_type -> livekit.ListSIPInboundTrunkRequest
	30,  // 102: livekit.SIP.ListSIPOutboundTrunk:input_type -> livekit.ListSIPOutboundTrunkRequest
	32,  // 103: livekit.SIP.DeleteSIPTrunk:input_type -> livekit.DeleteSIPTrunkRequest
	37,  // 104: livekit.SIP.CreateSIPDispatchRule:input_type -> livekit.CreateSIPDispatchRuleRequest
	38,  // 105: livekit.SIP.UpdateSIPDispatchRule:input_type -> livekit.UpdateSIPDispatchRuleRequest
	41,  // 106: livekit.SIP.ListSIPDispatchRule:input_type -> livekit.ListSIPDispatchRuleRequest
	43,  // 107: livekit.SIP.DeleteSIPDispatchRule:input_type -> livekit.DeleteSIPDispatchRuleRequest
	45,  // 108: livekit.SIP.CreateSIPParticipant:input_type -> livekit.CreateSIPParticipantRequest
	47,  // 109: livekit.SIP.TransferSIPParticipant:input_type -> livekit.TransferSIPParticipantRequest
	27,  // 110: livekit.SIP.ListSIPTrunk:output_type -> livekit.ListSIPTrunkResponse
	16,  // 111: livekit.SIP.CreateSIPInboundTrunk:output_type -> livekit.SIPInboundTrunkInfo
	20,  // 112: livekit.SIP.CreateSIPOutboundTrunk:output_type -> livekit.SIPOutboundTrunkInfo
	16,  // 113: livekit.SIP.UpdateSIPInboundTrunk:output_type -> livekit.SIPInboundTrunkInfo
	20,  // 114: livekit.SIP.UpdateSIPOutboundTrunk:output_type -> livekit.SIPOutboundTrunkInfo
	23,  // 115: livekit.SIP.GetSIPInboundTrunk:output_type -> livekit.GetSIPInboundTrunkResponse
	25,  // 116: livekit.SIP.GetSIPOutboundTrunk:output_type -> livekit.GetSIPOutboundTrunkResponse
	29,  // 117: livekit.SIP.ListSIPInboundTrunk:output_type -> livekit.ListSIPInboundTrunkResponse
	31,  // 118: livekit.SIP.ListSIPOutboundTrunk:output_type -> livekit.ListSIPOutboundTrunkResponse
	13,  // 119: livekit.SIP.DeleteSIPTrunk:output_type -> livekit.SIPTrunkInfo
	39,  // 120: livekit.SIP.CreateSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	39,  // 121: livekit.SIP.UpdateSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	42,  // 122: livekit.SIP.ListSIPDispatchRule:output_type -> livekit.ListSIPDispatchRuleResponse
	39,  // 123: livekit.SIP.DeleteSIPDispatchRule:output_type -> livekit.SIPDispatchRuleInfo
	46,  // 124: livekit.SIP.CreateSIPParticipant:output_type -> livekit.SIPParticipantInfo
	74,  // 125: livekit.SIP.TransferSIPParticipant:output_type -> google.protobuf.Empty
