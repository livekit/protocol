...
type SIPOutboundTrunkInfo struct {
	...
	CustomFromHost string `protobuf:"bytes,15,opt,name=custom_from_host,json=customFromHost,proto3" json:"custom_from_host,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SIPOutboundTrunkInfo) GetCustomFromHost() string {
	if x != nil {
		return x.CustomFromHost
	}
	return ""
}
...
type SIPOutboundTrunkUpdate struct {
	...
	Metadata           *string                `protobuf:"bytes,7,opt,name=metadata,proto3,oneof" json:"metadata,omitempty"`
	MediaEncryption    *SIPMediaEncryption    `protobuf:"varint,8,opt,name=media_encryption,json=mediaEncryption,proto3,enum=livekit.SIPMediaEncryption,oneof" json:"media_encryption,omitempty"`
	CustomFromHost     *string                `protobuf:"bytes,10,opt,name=custom_from_host,json=customFromHost,proto3,oneof" json:"custom_from_host,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *SIPOutboundTrunkUpdate) GetCustomFromHost() string {
	if x != nil && x.CustomFromHost != nil {
		return *x.CustomFromHost
	}
	return ""
}
...
type SIPOutboundConfig struct {
	...
	CustomFromHost string `protobuf:"bytes,8,opt,name=custom_from_host,json=customFromHost,proto3" json:"custom_from_host,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SIPOutboundConfig) GetCustomFromHost() string {
	if x != nil {
		return x.CustomFromHost
	}
	return ""
...
const file_livekit_sip_proto_rawDesc = "" +
	...
	"\x10media_encryption\x18\r \x01(\x0e2\x1b.livekit.SIPMediaEncryptionR\x0fmediaEncryption\x12(\n" +
	"\x10custom_from_host\x18\x0f \x01(\tR\x0ecustomFromHost\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aF\n" +
	"\x18HeadersToAttributesEntry\x12\x10\n" +
	...
	"\x10custom_from_host\x18\n" +
	" \x01(\tH\bR\x0ecustomFromHost\x88\x01\x01B\n" +
	"\n" +
	"\b_addressB\f\n" +
	"\n" +
	"_transportB\x16\n" +
	...
	"\x05_nameB\v\n" +
	"\t_metadataB\x13\n" +
	"\x11_media_encryptionB\x13\n" +
	"\x11_custom_from_host\"=\n" +
	...
	"\x14sip_dispatch_rule_id\x18\x01 \x01(\tR\x11sipDispatchRuleId\"\xf7\x04\n" +
	...
	"\x15attributes_to_headers\x18\x06 \x03(\v23.livekit.SIPOutboundConfig.AttributesToHeadersEntryR\x13attributesToHeaders\x12(\n" +
	"\x10custom_from_host\x18\b \x01(\tR\x0ecustomFromHost\x1aF\n" +
	"\x18HeadersToAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aF\n" +
	"\x18AttributesToHeadersEntry\x12\x10\n" +
