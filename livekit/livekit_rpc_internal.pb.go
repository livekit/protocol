...
type StartIngressRequest struct {
	...
	SentAt    int64  `protobuf:"varint,4,opt,name=sent_at,json=sentAt,proto3" json:"sent_at,omitempty"`
	// request
	Request *CreateIngressRequest `protobuf:"bytes,5,opt,name=request,proto3" json:"request,omitempty"`
}
...
func (x *StartIngressRequest) GetIngressId() string {
	if x != nil {
		return x.IngressId
	}
	return ""
...
func (x *StartIngressRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *StartIngressRequest) GetSenderId() string {
	if x != nil {
		return x.SenderId
	}
	return ""
...
func (x *StartIngressRequest) GetSentAt() int64 {
	if x != nil {
		return x.SentAt
	}
	return 0
...
func (x *StartIngressRequest) GetRequest() *CreateIngressRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *IngressRequest) GetStop() *DeleteIngressRequest {
	if x, ok := x.GetRequest().(*IngressRequest_Stop); ok {
		return x.Stop
	}
	return nil
}
...
type IngressRequest_Stop struct {
	Stop *DeleteIngressRequest `protobuf:"bytes,5,opt,name=stop,proto3,oneof"`
}

func (*IngressRequest_Update) isIngressRequest_Request() {}

func (*IngressRequest_Stop) isIngressRequest_Request() {}
...
var file_livekit_rpc_internal_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0xc2, 0x01,
	...
	0x03, 0x52, 0x06, 0x73, 0x65, 0x6e, 0x74, 0x41, 0x74, 0x12, 0x37, 0x0a, 0x07, 0x72, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6c, 0x69, 0x76,
	...
	0x73, 0x74, 0x22, 0xe4, 0x01, 0x0a, 0x0e, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x69, 0x6e, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x00, 0x52, 0x06, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x33, 0x0a, 0x04, 0x73, 0x74, 0x6f,
	0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
	...
	0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x70, 0x0a, 0x0f, 0x49, 0x6e, 0x67,
	...
	0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x42, 0x46, 0x5a, 0x23, 0x67,
...
var file_livekit_rpc_internal_proto_goTypes = []interface{}{
	...
	(*StartIngressRequest)(nil),         // 3: livekit.StartIngressRequest
	(*IngressRequest)(nil),              // 4: livekit.IngressRequest
	...
	(*CreateIngressRequest)(nil),        // 12: livekit.CreateIngressRequest
...
var file_livekit_rpc_internal_proto_depIdxs = []int32{
	...
	12, // 6: livekit.StartIngressRequest.request:type_name -> livekit.CreateIngressRequest
	13, // 7: livekit.IngressRequest.update:type_name -> livekit.UpdateIngressRequest
	14, // 8: livekit.IngressRequest.stop:type_name -> livekit.DeleteIngressRequest
	15, // 9: livekit.IngressResponse.info:type_name -> livekit.IngressInfo
...
func file_livekit_rpc_internal_proto_init() {
	...
	file_livekit_rpc_internal_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*IngressRequest_Update)(nil),
		(*IngressRequest_Stop)(nil),
	}
	type x struct{}
