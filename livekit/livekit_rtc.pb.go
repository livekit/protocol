...
type ReconnectResponse struct {
	...
	Participant         *ParticipantInfo     `protobuf:"bytes,4,opt,name=participant,proto3" json:"participant,omitempty"`
	OtherParticipants   []*ParticipantInfo   `protobuf:"bytes,5,rep,name=other_participants,json=otherParticipants,proto3" json:"other_participants,omitempty"`
}
...
func (x *ReconnectResponse) GetRoom() *Room {
	if x != nil {
		return x.Room
	}
	return nil
...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xc1, 0x02, 0x0a,
	...
	0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x21, 0x0a, 0x04, 0x72, 0x6f, 0x6f, 0x6d,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x64, 0x70, 0x22, 0x51, 0x0a, 0x11, 0x50,
	0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x01, 0x28, 0x0d, 0x52, 0x08, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x66, 0x0a,
	...
	0x79, 0x65, 0x72, 0x73, 0x22, 0x37, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61,
...
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	40, // 43: livekit.ReconnectResponse.room:type_name -> livekit.Room
	41, // 44: livekit.ReconnectResponse.participant:type_name -> livekit.ParticipantInfo
	41, // 45: livekit.ReconnectResponse.other_participants:type_name -> livekit.ParticipantInfo
	44, // 46: livekit.TrackPublishedResponse.track:type_name -> livekit.TrackInfo
	41, // 47: livekit.ParticipantUpdate.participants:type_name -> livekit.ParticipantInfo
	45, // 48: livekit.UpdateSubscription.participant_tracks:type_name -> livekit.ParticipantTracks
	46, // 49: livekit.UpdateTrackSettings.quality:type_name -> livekit.VideoQuality
	47, // 50: livekit.LeaveRequest.reason:type_name -> livekit.DisconnectReason
	38, // 51: livekit.UpdateVideoLayers.layers:type_name -> livekit.VideoLayer
	48, // 52: livekit.SpeakersChanged.speakers:type_name -> livekit.SpeakerInfo
	40, // 53: livekit.RoomUpdate.room:type_name -> livekit.Room
	49, // 54: livekit.ConnectionQualityInfo.quality:type_name -> livekit.ConnectionQuality
	...
	46, // 58: livekit.SubscribedQuality.quality:type_name -> livekit.VideoQuality
