...
const file_livekit_rtc_proto_rawDesc = "" +
	...
	"\busername\x18\x02 \x01(\tB&\x88\xec,\x01\x92\xec,\x1e<redacted ({{ .Size }} bytes)>R\busername\x12F\n" +
	"\n" +
	"credential\x18\x03 \x01(\tB&\x88\xec,\x01\x92\xec,\x1e<redacted ({{ .Size }} bytes)>R\n" +
	"credential\"C\n" +
