...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x05, 0x6d, 0x75, 0x74, 0x65, 0x64, 0x22, 0xe0, 0x03, 0x0a, 0x0c, 0x4a, 0x6f,
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x22, 0x54, 0x0a, 0x16,
	...
	0x61, 0x6e, 0x74, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x22, 0xaf, 0x01, 0x0a, 0x13, 0x55, 0x70,
	...
	0x22, 0x5d, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x4c,
	...
	0x22, 0x85, 0x01, 0x0a, 0x17, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x64, 0x51,
	...
	0x08, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x53, 0x69, 0x64, 0x12, 0x4d, 0x0a, 0x14, 0x73, 0x75, 0x62,
	...
	0x69, 0x74, 0x79, 0x52, 0x13, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x64, 0x51,
	0x75, 0x61, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x22, 0x78, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x63,
	...
	0x64, 0x73, 0x22, 0x8a, 0x01, 0x0a, 0x16, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74,
	...
	0x88, 0x02, 0x0a, 0x09, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x33, 0x0a,
	...
	0x74, 0x61, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x73, 0x22, 0x66, 0x0a, 0x0f, 0x44, 0x61,
	...
	0x65, 0x74, 0x22, 0xb1, 0x01, 0x0a, 0x10, 0x53, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x53,
	...
	0x65, 0x72, 0x76, 0x65, 0x72, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x73, 0x63,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x50, 0x41, 0x55, 0x53, 0x45, 0x44, 0x10, 0x01, 0x42, 0x46, 0x5a, 0x23,
...
var file_livekit_rtc_proto_goTypes = []interface{}{
	...
	(*TrackUnpublishedResponse)(nil),     // 9: livekit.TrackUnpublishedResponse
	(*SessionDescription)(nil),           // 10: livekit.SessionDescription
	(*ParticipantUpdate)(nil),            // 11: livekit.ParticipantUpdate
	(*UpdateSubscription)(nil),           // 12: livekit.UpdateSubscription
	(*UpdateTrackSettings)(nil),          // 13: livekit.UpdateTrackSettings
	(*LeaveRequest)(nil),                 // 14: livekit.LeaveRequest
	(*UpdateVideoLayers)(nil),            // 15: livekit.UpdateVideoLayers
	(*ICEServer)(nil),                    // 16: livekit.ICEServer
	(*SpeakersChanged)(nil),              // 17: livekit.SpeakersChanged
	(*RoomUpdate)(nil),                   // 18: livekit.RoomUpdate
	(*ConnectionQualityInfo)(nil),        // 19: livekit.ConnectionQualityInfo
	(*ConnectionQualityUpdate)(nil),      // 20: livekit.ConnectionQualityUpdate
	(*StreamStateInfo)(nil),              // 21: livekit.StreamStateInfo
	(*StreamStateUpdate)(nil),            // 22: livekit.StreamStateUpdate
	(*SubscribedQuality)(nil),            // 23: livekit.SubscribedQuality
	(*SubscribedQualityUpdate)(nil),      // 24: livekit.SubscribedQualityUpdate
	(*TrackPermission)(nil),              // 25: livekit.TrackPermission
	(*SubscriptionPermission)(nil),       // 26: livekit.SubscriptionPermission
	(*SubscriptionPermissionUpdate)(nil), // 27: livekit.SubscriptionPermissionUpdate
	(*SyncState)(nil),                    // 28: livekit.SyncState
	(*DataChannelInfo)(nil),              // 29: livekit.DataChannelInfo
	(*SimulateScenario)(nil),             // 30: livekit.SimulateScenario
	(TrackType)(0),                       // 31: livekit.TrackType
	(TrackSource)(0),                     // 32: livekit.TrackSource
	...
	(VideoQuality)(0),                    // 39: livekit.VideoQuality
	(*SpeakerInfo)(nil),                  // 40: livekit.SpeakerInfo
	(ConnectionQuality)(0),               // 41: livekit.ConnectionQuality
}
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	12, // 5: livekit.SignalRequest.subscription:type_name -> livekit.UpdateSubscription
	13, // 6: livekit.SignalRequest.track_setting:type_name -> livekit.UpdateTrackSettings
	14, // 7: livekit.SignalRequest.leave:type_name -> livekit.LeaveRequest
	15, // 8: livekit.SignalRequest.update_layers:type_name -> livekit.UpdateVideoLayers
	26, // 9: livekit.SignalRequest.subscription_permission:type_name -> livekit.SubscriptionPermission
	28, // 10: livekit.SignalRequest.sync_state:type_name -> livekit.SyncState
	30, // 11: livekit.SignalRequest.simulate:type_name -> livekit.SimulateScenario
	7,  // 12: livekit.SignalResponse.join:type_name -> livekit.JoinResponse
	10, // 13: livekit.SignalResponse.answer:type_name -> livekit.SessionDescription
	10, // 14: livekit.SignalResponse.offer:type_name -> livekit.SessionDescription
	5,  // 15: livekit.SignalResponse.trickle:type_name -> livekit.TrickleRequest
	11, // 16: livekit.SignalResponse.update:type_name -> livekit.ParticipantUpdate
	8,  // 17: livekit.SignalResponse.track_published:type_name -> livekit.TrackPublishedResponse
	14, // 18: livekit.SignalResponse.leave:type_name -> livekit.LeaveRequest
	6,  // 19: livekit.SignalResponse.mute:type_name -> livekit.MuteTrackRequest
	17, // 20: livekit.SignalResponse.speakers_changed:type_name -> livekit.SpeakersChanged
	18, // 21: livekit.SignalResponse.room_update:type_name -> livekit.RoomUpdate
	20, // 22: livekit.SignalResponse.connection_quality:type_name -> livekit.ConnectionQualityUpdate
	22, // 23: livekit.SignalResponse.stream_state_update:type_name -> livekit.StreamStateUpdate
	24, // 24: livekit.SignalResponse.subscribed_quality_update:type_name -> livekit.SubscribedQualityUpdate
	27, // 25: livekit.SignalResponse.subscription_permission_update:type_name -> livekit.SubscriptionPermissionUpdate
	9,  // 26: livekit.SignalResponse.track_unpublished:type_name -> livekit.TrackUnpublishedResponse
	31, // 27: livekit.AddTrackRequest.type:type_name -> livekit.TrackType
	32, // 28: livekit.AddTrackRequest.source:type_name -> livekit.TrackSource
	33, // 29: livekit.AddTrackRequest.layers:type_name -> livekit.VideoLayer
	0,  // 30: livekit.TrickleRequest.target:type_name -> livekit.SignalTarget
	34, // 31: livekit.JoinResponse.room:type_name -> livekit.Room
	35, // 32: livekit.JoinResponse.participant:type_name -> livekit.ParticipantInfo
	35, // 33: livekit.JoinResponse.other_participants:type_name -> livekit.ParticipantInfo
	16, // 34: livekit.JoinResponse.ice_servers:type_name -> livekit.ICEServer
	36, // 35: livekit.JoinResponse.client_configuration:type_name -> livekit.ClientConfiguration
	37, // 36: livekit.TrackPublishedResponse.track:type_name -> livekit.TrackInfo
	35, // 37: livekit.ParticipantUpdate.participants:type_name -> livekit.ParticipantInfo
	38, // 38: livekit.UpdateSubscription.participant_tracks:type_name -> livekit.ParticipantTracks
	39, // 39: livekit.UpdateTrackSettings.quality:type_name -> livekit.VideoQuality
	33, // 40: livekit.UpdateVideoLayers.layers:type_name -> livekit.VideoLayer
	40, // 41: livekit.SpeakersChanged.speakers:type_name -> livekit.SpeakerInfo
	34, // 42: livekit.RoomUpdate.room:type_name -> livekit.Room
	41, // 43: livekit.ConnectionQualityInfo.quality:type_name -> livekit.ConnectionQuality
	19, // 44: livekit.ConnectionQualityUpdate.updates:type_name -> livekit.ConnectionQualityInfo
	1,  // 45: livekit.StreamStateInfo.state:type_name -> livekit.StreamState
	21, // 46: livekit.StreamStateUpdate.stream_states:type_name -> livekit.StreamStateInfo
	39, // 47: livekit.SubscribedQuality.quality:type_name -> livekit.VideoQuality
	23, // 48: livekit.SubscribedQualityUpdate.subscribed_qualities:type_name -> livekit.SubscribedQuality
	25, // 49: livekit.SubscriptionPermission.track_permissions:type_name -> livekit.TrackPermission
	10, // 50: livekit.SyncState.answer:type_name -> livekit.SessionDescription
	12, // 51: livekit.SyncState.subscription:type_name -> livekit.UpdateSubscription
	8,  // 52: livekit.SyncState.publish_tracks:type_name -> livekit.TrackPublishedResponse
	29, // 53: livekit.SyncState.data_channels:type_name -> livekit.DataChannelInfo
	0,  // 54: livekit.DataChannelInfo.target:type_name -> livekit.SignalTarget
...
func file_livekit_rtc_proto_init() {
	...
	file_livekit_rtc_proto_msgTypes[28].OneofWrappers = []interface{}{
