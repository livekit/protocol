...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0xc9, 0x01, 0x0a, 0x09, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x33, 0x0a,
	...
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x22, 0xb1, 0x01, 0x0a, 0x10,
	...
	0x61, 0x76, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x73, 0x63, 0x65, 0x6e, 0x61, 0x72, 0x69, 0x6f, 0x2a,
	...
	0x53, 0x45, 0x44, 0x10, 0x01, 0x42, 0x46, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_livekit_rtc_proto_goTypes = []interface{}{
	...
	(VideoQuality)(0),                    // 37: livekit.VideoQuality
	(*SpeakerInfo)(nil),                  // 38: livekit.SpeakerInfo
	(ConnectionQuality)(0),               // 39: livekit.ConnectionQuality
}
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	34, // 34: livekit.JoinResponse.client_configuration:type_name -> livekit.ClientConfiguration
	35, // 35: livekit.TrackPublishedResponse.track:type_name -> livekit.TrackInfo
	33, // 36: livekit.ParticipantUpdate.participants:type_name -> livekit.ParticipantInfo
	36, // 37: livekit.UpdateSubscription.participant_tracks:type_name -> livekit.ParticipantTracks
	37, // 38: livekit.UpdateTrackSettings.quality:type_name -> livekit.VideoQuality
	31, // 39: livekit.UpdateVideoLayers.layers:type_name -> livekit.VideoLayer
	38, // 40: livekit.SpeakersChanged.speakers:type_name -> livekit.SpeakerInfo
	32, // 41: livekit.RoomUpdate.room:type_name -> livekit.Room
	39, // 42: livekit.ConnectionQualityInfo.quality:type_name -> livekit.ConnectionQuality
	...
	37, // 46: livekit.SubscribedQuality.quality:type_name -> livekit.VideoQuality
