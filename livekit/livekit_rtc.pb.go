...
type UpdateParticipantMetadata struct {
	...
	KvMetadata *Metadata `protobuf:"bytes,3,opt,name=kv_metadata,json=kvMetadata,proto3" json:"kv_metadata,omitempty"`
	Name       string    `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
}
...
func (x *UpdateParticipantMetadata) GetKvMetadata() *Metadata {
	if x != nil {
		return x.KvMetadata
	}
	return nil
...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x3a, 0x02, 0x18, 0x01, 0x22, 0x7f, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x32, 0x0a, 0x0b, 0x6b, 0x76, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03,
...
var file_livekit_rtc_proto_goTypes = []interface{}{
	...
	(*Metadata)(nil),                     // 57: livekit.Metadata
...
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	57, // 57: livekit.UpdateParticipantMetadata.kv_metadata:type_name -> livekit.Metadata
