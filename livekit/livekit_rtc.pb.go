...
const file_livekit_rtc_proto_rawDesc = "" +
	...
	"\x12other_participants\x18\x04 \x03(\v2\x18.livekit.ParticipantInfoR\x11otherParticipants\"\x83\x05\n" +
	"\tSyncState\x12H\n" +
	"\x11subscriber_answer\x18\x01 \x01(\v2\x1b.livekit.SessionDescriptionR\x10subscriberAnswer\x12?\n" +
	...
	"\rdata_channels\x18\x04 \x03(\v2\x18.livekit.DataChannelInfoR\fdataChannels\x12F\n" +
	"\x10subscriber_offer\x18\x05 \x01(\v2\x1b.livekit.SessionDescriptionR\x0fsubscriberOffer\x12.\n" +
	"\x13track_sids_disabled\x18\x06 \x03(\tR\x11trackSidsDisabled\x12^\n" +
	"\x1adatachannel_receive_states\x18\a \x03(\v2 .livekit.DataChannelReceiveStateR\x18datachannelReceiveStates\x12D\n" +
	"\x0fpublisher_offer\x18\b \x01(\v2\x1b.livekit.SessionDescriptionR\x0epublisherOffer\x12F\n" +
	"\x10publisher_answer\x18\t \x01(\v2\x1b.livekit.SessionDescriptionR\x0fpublisherAnswer\"Y\n" +
