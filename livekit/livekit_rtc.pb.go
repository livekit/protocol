...
func (x *GetStreamDataRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetStreamDataResponse) Reset() {
	*x = GetStreamDataResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetStreamDataResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStreamDataResponse) ProtoMessage() {}

func (x *GetStreamDataResponse) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_rtc_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetStreamDataResponse.ProtoReflect.Descriptor instead.
func (*GetStreamDataResponse) Descriptor() ([]byte, []int) {
...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0x22, 0x2a, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x44, 0x61, 0x74,
	...
	0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x70, 0x0a, 0x0e, 0x53, 0x69, 0x6d, 0x75, 0x6c, 0x63, 0x61,
	...
	0x74, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0xae, 0x03, 0x0a, 0x0f, 0x41, 0x64, 0x64, 0x54,
	...
	0x73, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x64, 0x22, 0x65, 0x0a, 0x0e, 0x54, 0x72, 0x69, 0x63,
	...
	0x52, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x54, 0x0a, 0x16,
	...
	0x61, 0x6e, 0x74, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x22, 0xc1, 0x01, 0x0a, 0x13, 0x55, 0x70,
	...
	0x70, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x66, 0x70, 0x73, 0x22, 0x66, 0x0a,
...
var file_livekit_rtc_proto_goTypes = []interface{}{
	...
	(*GetStreamDataRequest)(nil),         // 5: livekit.GetStreamDataRequest
	(*GetStreamDataResponse)(nil),        // 6: livekit.GetStreamDataResponse
...
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	11, // 12: livekit.SignalResponse.join:type_name -> livekit.JoinResponse
	14, // 13: livekit.SignalResponse.answer:type_name -> livekit.SessionDescription
	14, // 14: livekit.SignalResponse.offer:type_name -> livekit.SessionDescription
	9,  // 15: livekit.SignalResponse.trickle:type_name -> livekit.TrickleRequest
	15, // 16: livekit.SignalResponse.update:type_name -> livekit.ParticipantUpdate
	12, // 17: livekit.SignalResponse.track_published:type_name -> livekit.TrackPublishedResponse
	18, // 18: livekit.SignalResponse.leave:type_name -> livekit.LeaveRequest
	10, // 19: livekit.SignalResponse.mute:type_name -> livekit.MuteTrackRequest
	21, // 20: livekit.SignalResponse.speakers_changed:type_name -> livekit.SpeakersChanged
	22, // 21: livekit.SignalResponse.room_update:type_name -> livekit.RoomUpdate
	24, // 22: livekit.SignalResponse.connection_quality:type_name -> livekit.ConnectionQualityUpdate
	26, // 23: livekit.SignalResponse.stream_state_update:type_name -> livekit.StreamStateUpdate
	29, // 24: livekit.SignalResponse.subscribed_quality_update:type_name -> livekit.SubscribedQualityUpdate
	32, // 25: livekit.SignalResponse.subscription_permission_update:type_name -> livekit.SubscriptionPermissionUpdate
	13, // 26: livekit.SignalResponse.track_unpublished:type_name -> livekit.TrackUnpublishedResponse
	36, // 27: livekit.AddTrackRequest.type:type_name -> livekit.TrackType
	37, // 28: livekit.AddTrackRequest.source:type_name -> livekit.TrackSource
	38, // 29: livekit.AddTrackRequest.layers:type_name -> livekit.VideoLayer
	7,  // 30: livekit.AddTrackRequest.simulcast_codecs:type_name -> livekit.SimulcastCodec
	0,  // 31: livekit.TrickleRequest.target:type_name -> livekit.SignalTarget
	39, // 32: livekit.JoinResponse.room:type_name -> livekit.Room
	40, // 33: livekit.JoinResponse.participant:type_name -> livekit.ParticipantInfo
	40, // 34: livekit.JoinResponse.other_participants:type_name -> livekit.ParticipantInfo
	20, // 35: livekit.JoinResponse.ice_servers:type_name -> livekit.ICEServer
	41, // 36: livekit.JoinResponse.client_configuration:type_name -> livekit.ClientConfiguration
	42, // 37: livekit.JoinResponse.server_info:type_name -> livekit.ServerInfo
	43, // 38: livekit.TrackPublishedResponse.track:type_name -> livekit.TrackInfo
	40, // 39: livekit.ParticipantUpdate.participants:type_name -> livekit.ParticipantInfo
	44, // 40: livekit.UpdateSubscription.participant_tracks:type_name -> livekit.ParticipantTracks
	45, // 41: livekit.UpdateTrackSettings.quality:type_name -> livekit.VideoQuality
	46, // 42: livekit.LeaveRequest.reason:type_name -> livekit.DisconnectReason
	38, // 43: livekit.UpdateVideoLayers.layers:type_name -> livekit.VideoLayer
	47, // 44: livekit.SpeakersChanged.speakers:type_name -> livekit.SpeakerInfo
	39, // 45: livekit.RoomUpdate.room:type_name -> livekit.Room
	48, // 46: livekit.ConnectionQualityInfo.quality:type_name -> livekit.ConnectionQuality
	23, // 47: livekit.ConnectionQualityUpdate.updates:type_name -> livekit.ConnectionQualityInfo
	1,  // 48: livekit.StreamStateInfo.state:type_name -> livekit.StreamState
	25, // 49: livekit.StreamStateUpdate.stream_states:type_name -> livekit.StreamStateInfo
	45, // 50: livekit.SubscribedQuality.quality:type_name -> livekit.VideoQuality
	27, // 51: livekit.SubscribedCodec.qualities:type_name -> livekit.SubscribedQuality
	27, // 52: livekit.SubscribedQualityUpdate.subscribed_qualities:type_name -> livekit.SubscribedQuality
	28, // 53: livekit.SubscribedQualityUpdate.subscribed_codecs:type_name -> livekit.SubscribedCodec
	30, // 54: livekit.SubscriptionPermission.track_permissions:type_name -> livekit.TrackPermission
	14, // 55: livekit.SyncState.answer:type_name -> livekit.SessionDescription
	16, // 56: livekit.SyncState.subscription:type_name -> livekit.UpdateSubscription
	12, // 57: livekit.SyncState.publish_tracks:type_name -> livekit.TrackPublishedResponse
	34, // 58: livekit.SyncState.data_channels:type_name -> livekit.DataChannelInfo
	14, // 59: livekit.SyncState.offer:type_name -> livekit.SessionDescription
...
func file_livekit_rtc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_livekit_rtc_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetStreamDataRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_livekit_rtc_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetStreamDataResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
