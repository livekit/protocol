...
type SubscribedAudioCodecUpdate struct {
	state            protoimpl.MessageState  `protogen:"open.v1"`
	TrackSid         string                  `protobuf:"bytes,1,opt,name=track_sid,json=trackSid,proto3" json:"track_sid,omitempty"`
	SubscribedCodecs []*SubscribedAudioCodec `protobuf:"bytes,2,rep,name=subscribed_codecs,json=subscribedCodecs,proto3" json:"subscribed_codecs,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *SubscribedAudioCodecUpdate) GetSubscribedCodecs() []*SubscribedAudioCodec {
	if x != nil {
		return x.SubscribedCodecs
	}
	return nil
...
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	75,  // 79: livekit.SubscribedAudioCodecUpdate.subscribed_codecs:type_name -> livekit.SubscribedAudioCodec
