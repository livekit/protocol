...
type PublishDataTrackResponse_Error int32

const (
	PublishDataTrackResponse_UNKNOWN           PublishDataTrackResponse_Error = 0 // Unknown reason.
	PublishDataTrackResponse_INVALID_NAME      PublishDataTrackResponse_Error = 1 // Name is invalid.
	PublishDataTrackResponse_INVALID_MIME_TYPE PublishDataTrackResponse_Error = 2 // MIME type is invalid.
	PublishDataTrackResponse_NAME_TAKEN        PublishDataTrackResponse_Error = 3 // Publisher already has a data track published with the same name.
	PublishDataTrackResponse_UNAUTHORIZED      PublishDataTrackResponse_Error = 4 // Publisher is not authorized to publish data tracks.
)

// Enum value maps for PublishDataTrackResponse_Error.
var (
	PublishDataTrackResponse_Error_name = map[int32]string{
		0: "UNKNOWN",
		1: "INVALID_NAME",
		2: "INVALID_MIME_TYPE",
		3: "NAME_TAKEN",
	...
	PublishDataTrackResponse_Error_value = map[string]int32{
		"UNKNOWN":           0,
		"INVALID_NAME":      1,
		"INVALID_MIME_TYPE": 2,
		"NAME_TAKEN":        3,
...
func (x PublishDataTrackResponse_Error) Enum() *PublishDataTrackResponse_Error {
	p := new(PublishDataTrackResponse_Error)
	*p = x
	return p
}

func (x PublishDataTrackResponse_Error) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PublishDataTrackResponse_Error) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_rtc_proto_enumTypes[3].Descriptor()
}

func (PublishDataTrackResponse_Error) Type() protoreflect.EnumType {
	return &file_livekit_rtc_proto_enumTypes[3]
}

func (x PublishDataTrackResponse_Error) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PublishDataTrackResponse_Error.Descriptor instead.
func (PublishDataTrackResponse_Error) EnumDescriptor() ([]byte, []int) {
	return file_livekit_rtc_proto_rawDescGZIP(), []int{5, 0}
}
...
func (LeaveRequest_Action) EnumDescriptor() ([]byte, []int) {
	return file_livekit_rtc_proto_rawDescGZIP(), []int{19, 0}
}
...
func (WrappedJoinRequest_Compression) EnumDescriptor() ([]byte, []int) {
	return file_livekit_rtc_proto_rawDescGZIP(), []int{50, 0}
}
...
type SignalRequest struct {
	...
	//	*SignalRequest_PublishDataTrack
...
func (x *SignalRequest) GetPublishDataTrack() *PublishDataTrackRequest {
	if x != nil {
		if x, ok := x.Message.(*SignalRequest_PublishDataTrack); ok {
...
type SignalRequest_PublishDataTrack struct {
	// Publish a data track
	PublishDataTrack *PublishDataTrackRequest `protobuf:"bytes,19,opt,name=publish_data_track,json=publishDataTrack,proto3,oneof"`
}

type SignalRequest_UpdateDataSubscription struct {
	// Update subscription state for one or more data tracks
	UpdateDataSubscription *UpdateDataSubscription `protobuf:"bytes,20,opt,name=update_data_subscription,json=updateDataSubscription,proto3,oneof"`
}
...
func (*SignalRequest_PublishDataTrack) isSignalRequest_Message() {}
...
type SignalResponse struct {
	...
	//	*SignalResponse_PublishDataTrack
...
func (x *SignalResponse) GetPublishDataTrack() *PublishDataTrackResponse {
	if x != nil {
		if x, ok := x.Message.(*SignalResponse_PublishDataTrack); ok {
			return x.PublishDataTrack
		}
	}
	return nil
...
type SignalResponse_PublishDataTrack struct {
	// Sent in response to `PublishDataTrackRequest`.
	PublishDataTrack *PublishDataTrackResponse `protobuf:"bytes,27,opt,name=publish_data_track,json=publishDataTrack,proto3,oneof"`
}
...
func (*SignalResponse_PublishDataTrack) isSignalResponse_Message() {}
...
type PublishDataTrackResponse struct {
	...
	//
	//	*PublishDataTrackResponse_Ok
	//	*PublishDataTrackResponse_Error_
	Result        isPublishDataTrackResponse_Result `protobuf_oneof:"result"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PublishDataTrackResponse) GetRequestId() uint32 {
	if x != nil {
		return x.RequestId
	}
	return 0
...
func (x *PublishDataTrackResponse) GetResult() isPublishDataTrackResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *PublishDataTrackResponse) GetOk() *DataTrackInfo {
	if x != nil {
		if x, ok := x.Result.(*PublishDataTrackResponse_Ok); ok {
			return x.Ok
		}
	}
	return nil
...
func (x *PublishDataTrackResponse) GetError() PublishDataTrackResponse_Error {
	if x != nil {
		if x, ok := x.Result.(*PublishDataTrackResponse_Error_); ok {
			return x.Error
		}
	}
	return PublishDataTrackResponse_UNKNOWN
}

type isPublishDataTrackResponse_Result interface {
	isPublishDataTrackResponse_Result()
}

type PublishDataTrackResponse_Ok struct {
	// Track was successfully published, track info is provided.
	Ok *DataTrackInfo `protobuf:"bytes,2,opt,name=ok,proto3,oneof"`
}

type PublishDataTrackResponse_Error_ struct {
	// Track could not be published, reason is provided.
	Error PublishDataTrackResponse_Error `protobuf:"varint,3,opt,name=error,proto3,enum=livekit.PublishDataTrackResponse_Error,oneof"`
}

func (*PublishDataTrackResponse_Ok) isPublishDataTrackResponse_Result() {}

func (*PublishDataTrackResponse_Error_) isPublishDataTrackResponse_Result() {}
...
func (*UpdateDataSubscription_Update) Descriptor() ([]byte, []int) {
	return file_livekit_rtc_proto_rawDescGZIP(), []int{15, 0}
}
...
var file_livekit_rtc_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
var file_livekit_rtc_proto_goTypes = []any{
	...
	(PublishDataTrackResponse_Error)(0),   // 3: livekit.PublishDataTrackResponse.Error
	...
	(*JoinResponse)(nil),                  // 15: livekit.JoinResponse
	(*ReconnectResponse)(nil),             // 16: livekit.ReconnectResponse
	(*TrackPublishedResponse)(nil),        // 17: livekit.TrackPublishedResponse
	(*TrackUnpublishedResponse)(nil),      // 18: livekit.TrackUnpublishedResponse
	(*SessionDescription)(nil),            // 19: livekit.SessionDescription
	(*ParticipantUpdate)(nil),             // 20: livekit.ParticipantUpdate
	(*UpdateSubscription)(nil),            // 21: livekit.UpdateSubscription
	(*UpdateDataSubscription)(nil),        // 22: livekit.UpdateDataSubscription
	(*UpdateTrackSettings)(nil),           // 23: livekit.UpdateTrackSettings
	(*UpdateLocalAudioTrack)(nil),         // 24: livekit.UpdateLocalAudioTrack
	(*UpdateLocalVideoTrack)(nil),         // 25: livekit.UpdateLocalVideoTrack
	(*LeaveRequest)(nil),                  // 26: livekit.LeaveRequest
	(*UpdateVideoLayers)(nil),             // 27: livekit.UpdateVideoLayers
	(*UpdateParticipantMetadata)(nil),     // 28: livekit.UpdateParticipantMetadata
	(*ICEServer)(nil),                     // 29: livekit.ICEServer
	(*SpeakersChanged)(nil),               // 30: livekit.SpeakersChanged
	(*RoomUpdate)(nil),                    // 31: livekit.RoomUpdate
	(*ConnectionQualityInfo)(nil),         // 32: livekit.ConnectionQualityInfo
	(*ConnectionQualityUpdate)(nil),       // 33: livekit.ConnectionQualityUpdate
	(*StreamStateInfo)(nil),               // 34: livekit.StreamStateInfo
	(*StreamStateUpdate)(nil),             // 35: livekit.StreamStateUpdate
	(*SubscribedQuality)(nil),             // 36: livekit.SubscribedQuality
	(*SubscribedCodec)(nil),               // 37: livekit.SubscribedCodec
	(*SubscribedQualityUpdate)(nil),       // 38: livekit.SubscribedQualityUpdate
	(*SubscribedAudioCodecUpdate)(nil),    // 39: livekit.SubscribedAudioCodecUpdate
	(*TrackPermission)(nil),               // 40: livekit.TrackPermission
	(*SubscriptionPermission)(nil),        // 41: livekit.SubscriptionPermission
	(*SubscriptionPermissionUpdate)(nil),  // 42: livekit.SubscriptionPermissionUpdate
	(*RoomMovedResponse)(nil),             // 43: livekit.RoomMovedResponse
	(*SyncState)(nil),                     // 44: livekit.SyncState
	(*DataChannelReceiveState)(nil),       // 45: livekit.DataChannelReceiveState
	(*DataChannelInfo)(nil),               // 46: livekit.DataChannelInfo
	(*SimulateScenario)(nil),              // 47: livekit.SimulateScenario
	(*Ping)(nil),                          // 48: livekit.Ping
	(*Pong)(nil),                          // 49: livekit.Pong
	(*RegionSettings)(nil),                // 50: livekit.RegionSettings
	(*RegionInfo)(nil),                    // 51: livekit.RegionInfo
	(*SubscriptionResponse)(nil),          // 52: livekit.SubscriptionResponse
	(*RequestResponse)(nil),               // 53: livekit.RequestResponse
	(*TrackSubscribed)(nil),               // 54: livekit.TrackSubscribed
	(*ConnectionSettings)(nil),            // 55: livekit.ConnectionSettings
	(*JoinRequest)(nil),                   // 56: livekit.JoinRequest
	(*WrappedJoinRequest)(nil),            // 57: livekit.WrappedJoinRequest
	(*MediaSectionsRequirement)(nil),      // 58: livekit.MediaSectionsRequirement
	(*UpdateDataSubscription_Update)(nil), // 59: livekit.UpdateDataSubscription.Update
	nil,                                   // 60: livekit.UpdateParticipantMetadata.AttributesEntry
	nil,                                   // 61: livekit.JoinRequest.ParticipantAttributesEntry
	(*VideoLayer)(nil),                    // 62: livekit.VideoLayer
	(VideoLayer_Mode)(0),                  // 63: livekit.VideoLayer.Mode
	(TrackType)(0),                        // 64: livekit.TrackType
	(TrackSource)(0),                      // 65: livekit.TrackSource
	(Encryption_Type)(0),                  // 66: livekit.Encryption.Type
	(BackupCodecPolicy)(0),                // 67: livekit.BackupCodecPolicy
	(AudioTrackFeature)(0),                // 68: livekit.AudioTrackFeature
	(*DataTrackInfo)(nil),                 // 69: livekit.DataTrackInfo
	(*Room)(nil),                          // 70: livekit.Room
	(*ParticipantInfo)(nil),               // 71: livekit.ParticipantInfo
	(*ClientConfiguration)(nil),           // 72: livekit.ClientConfiguration
	(*ServerInfo)(nil),                    // 73: livekit.ServerInfo
	(*Codec)(nil),                         // 74: livekit.Codec
	(*TrackInfo)(nil),                     // 75: livekit.TrackInfo
	(*ParticipantTracks)(nil),             // 76: livekit.ParticipantTracks
	(VideoQuality)(0),                     // 77: livekit.VideoQuality
	(DisconnectReason)(0),                 // 78: livekit.DisconnectReason
	(*SpeakerInfo)(nil),                   // 79: livekit.SpeakerInfo
	(ConnectionQuality)(0),                // 80: livekit.ConnectionQuality
	(*SubscribedAudioCodec)(nil),          // 81: livekit.SubscribedAudioCodec
	(SubscriptionError)(0),                // 82: livekit.SubscriptionError
	(*ClientInfo)(nil),                    // 83: livekit.ClientInfo
	(ReconnectReason)(0),                  // 84: livekit.ReconnectReason
	(*DataTrackSubscriptionOptions)(nil),  // 85: livekit.DataTrackSubscriptionOptions
}
var file_livekit_rtc_proto_depIdxs = []int32{
	19,  // 0: livekit.SignalRequest.offer:type_name -> livekit.SessionDescription
	19,  // 1: livekit.SignalRequest.answer:type_name -> livekit.SessionDescription
	13,  // 2: livekit.SignalRequest.trickle:type_name -> livekit.TrickleRequest
	10,  // 3: livekit.SignalRequest.add_track:type_name -> livekit.AddTrackRequest
	14,  // 4: livekit.SignalRequest.mute:type_name -> livekit.MuteTrackRequest
	21,  // 5: livekit.SignalRequest.subscription:type_name -> livekit.UpdateSubscription
	23,  // 6: livekit.SignalRequest.track_setting:type_name -> livekit.UpdateTrackSettings
	26,  // 7: livekit.SignalRequest.leave:type_name -> livekit.LeaveRequest
	27,  // 8: livekit.SignalRequest.update_layers:type_name -> livekit.UpdateVideoLayers
	41,  // 9: livekit.SignalRequest.subscription_permission:type_name -> livekit.SubscriptionPermission
	44,  // 10: livekit.SignalRequest.sync_state:type_name -> livekit.SyncState
	47,  // 11: livekit.SignalRequest.simulate:type_name -> livekit.SimulateScenario
	28,  // 12: livekit.SignalRequest.update_metadata:type_name -> livekit.UpdateParticipantMetadata
	48,  // 13: livekit.SignalRequest.ping_req:type_name -> livekit.Ping
	24,  // 14: livekit.SignalRequest.update_audio_track:type_name -> livekit.UpdateLocalAudioTrack
	25,  // 15: livekit.SignalRequest.update_video_track:type_name -> livekit.UpdateLocalVideoTrack
	11,  // 16: livekit.SignalRequest.publish_data_track:type_name -> livekit.PublishDataTrackRequest
	22,  // 17: livekit.SignalRequest.update_data_subscription:type_name -> livekit.UpdateDataSubscription
	15,  // 18: livekit.SignalResponse.join:type_name -> livekit.JoinResponse
	19,  // 19: livekit.SignalResponse.answer:type_name -> livekit.SessionDescription
	19,  // 20: livekit.SignalResponse.offer:type_name -> livekit.SessionDescription
	13,  // 21: livekit.SignalResponse.trickle:type_name -> livekit.TrickleRequest
	20,  // 22: livekit.SignalResponse.update:type_name -> livekit.ParticipantUpdate
	17,  // 23: livekit.SignalResponse.track_published:type_name -> livekit.TrackPublishedResponse
	26,  // 24: livekit.SignalResponse.leave:type_name -> livekit.LeaveRequest
	14,  // 25: livekit.SignalResponse.mute:type_name -> livekit.MuteTrackRequest
	30,  // 26: livekit.SignalResponse.speakers_changed:type_name -> livekit.SpeakersChanged
	31,  // 27: livekit.SignalResponse.room_update:type_name -> livekit.RoomUpdate
	33,  // 28: livekit.SignalResponse.connection_quality:type_name -> livekit.ConnectionQualityUpdate
	35,  // 29: livekit.SignalResponse.stream_state_update:type_name -> livekit.StreamStateUpdate
	38,  // 30: livekit.SignalResponse.subscribed_quality_update:type_name -> livekit.SubscribedQualityUpdate
	42,  // 31: livekit.SignalResponse.subscription_permission_update:type_name -> livekit.SubscriptionPermissionUpdate
	18,  // 32: livekit.SignalResponse.track_unpublished:type_name -> livekit.TrackUnpublishedResponse
	16,  // 33: livekit.SignalResponse.reconnect:type_name -> livekit.ReconnectResponse
	49,  // 34: livekit.SignalResponse.pong_resp:type_name -> livekit.Pong
	52,  // 35: livekit.SignalResponse.subscription_response:type_name -> livekit.SubscriptionResponse
	53,  // 36: livekit.SignalResponse.request_response:type_name -> livekit.RequestResponse
	54,  // 37: livekit.SignalResponse.track_subscribed:type_name -> livekit.TrackSubscribed
	43,  // 38: livekit.SignalResponse.room_moved:type_name -> livekit.RoomMovedResponse
	58,  // 39: livekit.SignalResponse.media_sections_requirement:type_name -> livekit.MediaSectionsRequirement
	39,  // 40: livekit.SignalResponse.subscribed_audio_codec_update:type_name -> livekit.SubscribedAudioCodecUpdate
	12,  // 41: livekit.SignalResponse.publish_data_track:type_name -> livekit.PublishDataTrackResponse
	62,  // 42: livekit.SimulcastCodec.layers:type_name -> livekit.VideoLayer
	63,  // 43: livekit.SimulcastCodec.video_layer_mode:type_name -> livekit.VideoLayer.Mode
	64,  // 44: livekit.AddTrackRequest.type:type_name -> livekit.TrackType
	65,  // 45: livekit.AddTrackRequest.source:type_name -> livekit.TrackSource
	62,  // 46: livekit.AddTrackRequest.layers:type_name -> livekit.VideoLayer
	9,   // 47: livekit.AddTrackRequest.simulcast_codecs:type_name -> livekit.SimulcastCodec
	66,  // 48: livekit.AddTrackRequest.encryption:type_name -> livekit.Encryption.Type
	67,  // 49: livekit.AddTrackRequest.backup_codec_policy:type_name -> livekit.BackupCodecPolicy
	68,  // 50: livekit.AddTrackRequest.audio_features:type_name -> livekit.AudioTrackFeature
	66,  // 51: livekit.PublishDataTrackRequest.encryption:type_name -> livekit.Encryption.Type
	69,  // 52: livekit.PublishDataTrackResponse.ok:type_name -> livekit.DataTrackInfo
	3,   // 53: livekit.PublishDataTrackResponse.error:type_name -> livekit.PublishDataTrackResponse.Error
	0,   // 54: livekit.TrickleRequest.target:type_name -> livekit.SignalTarget
	70,  // 55: livekit.JoinResponse.room:type_name -> livekit.Room
	71,  // 56: livekit.JoinResponse.participant:type_name -> livekit.ParticipantInfo
	71,  // 57: livekit.JoinResponse.other_participants:type_name -> livekit.ParticipantInfo
	29,  // 58: livekit.JoinResponse.ice_servers:type_name -> livekit.ICEServer
	72,  // 59: livekit.JoinResponse.client_configuration:type_name -> livekit.ClientConfiguration
	73,  // 60: livekit.JoinResponse.server_info:type_name -> livekit.ServerInfo
	74,  // 61: livekit.JoinResponse.enabled_publish_codecs:type_name -> livekit.Codec
	29,  // 62: livekit.ReconnectResponse.ice_servers:type_name -> livekit.ICEServer
	72,  // 63: livekit.ReconnectResponse.client_configuration:type_name -> livekit.ClientConfiguration
	73,  // 64: livekit.ReconnectResponse.server_info:type_name -> livekit.ServerInfo
	75,  // 65: livekit.TrackPublishedResponse.track:type_name -> livekit.TrackInfo
	71,  // 66: livekit.ParticipantUpdate.participants:type_name -> livekit.ParticipantInfo
	76,  // 67: livekit.UpdateSubscription.participant_tracks:type_name -> livekit.ParticipantTracks
	59,  // 68: livekit.UpdateDataSubscription.updates:type_name -> livekit.UpdateDataSubscription.Update
	77,  // 69: livekit.UpdateTrackSettings.quality:type_name -> livekit.VideoQuality
	68,  // 70: livekit.UpdateLocalAudioTrack.features:type_name -> livekit.AudioTrackFeature
	78,  // 71: livekit.LeaveRequest.reason:type_name -> livekit.DisconnectReason
	4,   // 72: livekit.LeaveRequest.action:type_name -> livekit.LeaveRequest.Action
	50,  // 73: livekit.LeaveRequest.regions:type_name -> livekit.RegionSettings
	62,  // 74: livekit.UpdateVideoLayers.layers:type_name -> livekit.VideoLayer
	60,  // 75: livekit.UpdateParticipantMetadata.attributes:type_name -> livekit.UpdateParticipantMetadata.AttributesEntry
	79,  // 76: livekit.SpeakersChanged.speakers:type_name -> livekit.SpeakerInfo
	70,  // 77: livekit.RoomUpdate.room:type_name -> livekit.Room
	80,  // 78: livekit.ConnectionQualityInfo.quality:type_name -> livekit.ConnectionQuality
	32,  // 79: livekit.ConnectionQualityUpdate.updates:type_name -> livekit.ConnectionQualityInfo
	1,   // 80: livekit.StreamStateInfo.state:type_name -> livekit.StreamState
	34,  // 81: livekit.StreamStateUpdate.stream_states:type_name -> livekit.StreamStateInfo
	77,  // 82: livekit.SubscribedQuality.quality:type_name -> livekit.VideoQuality
	36,  // 83: livekit.SubscribedCodec.qualities:type_name -> livekit.SubscribedQuality
	36,  // 84: livekit.SubscribedQualityUpdate.subscribed_qualities:type_name -> livekit.SubscribedQuality
	37,  // 85: livekit.SubscribedQualityUpdate.subscribed_codecs:type_name -> livekit.SubscribedCodec
	81,  // 86: livekit.SubscribedAudioCodecUpdate.subscribed_audio_codecs:type_name -> livekit.SubscribedAudioCodec
	40,  // 87: livekit.SubscriptionPermission.track_permissions:type_name -> livekit.TrackPermission
	70,  // 88: livekit.RoomMovedResponse.room:type_name -> livekit.Room
	71,  // 89: livekit.RoomMovedResponse.participant:type_name -> livekit.ParticipantInfo
	71,  // 90: livekit.RoomMovedResponse.other_participants:type_name -> livekit.ParticipantInfo
	19,  // 91: livekit.SyncState.answer:type_name -> livekit.SessionDescription
	21,  // 92: livekit.SyncState.subscription:type_name -> livekit.UpdateSubscription
	17,  // 93: livekit.SyncState.publish_tracks:type_name -> livekit.TrackPublishedResponse
	46,  // 94: livekit.SyncState.data_channels:type_name -> livekit.DataChannelInfo
	19,  // 95: livekit.SyncState.offer:type_name -> livekit.SessionDescription
	45,  // 96: livekit.SyncState.datachannel_receive_states:type_name -> livekit.DataChannelReceiveState
	0,   // 97: livekit.DataChannelInfo.target:type_name -> livekit.SignalTarget
	2,   // 98: livekit.SimulateScenario.switch_candidate_protocol:type_name -> livekit.CandidateProtocol
	51,  // 99: livekit.RegionSettings.regions:type_name -> livekit.RegionInfo
	82,  // 100: livekit.SubscriptionResponse.err:type_name -> livekit.SubscriptionError
	5,   // 101: livekit.RequestResponse.reason:type_name -> livekit.RequestResponse.Reason
	13,  // 102: livekit.RequestResponse.trickle:type_name -> livekit.TrickleRequest
	10,  // 103: livekit.RequestResponse.add_track:type_name -> livekit.AddTrackRequest
	14,  // 104: livekit.RequestResponse.mute:type_name -> livekit.MuteTrackRequest
	28,  // 105: livekit.RequestResponse.update_metadata:type_name -> livekit.UpdateParticipantMetadata
	24,  // 106: livekit.RequestResponse.update_audio_track:type_name -> livekit.UpdateLocalAudioTrack
	25,  // 107: livekit.RequestResponse.update_video_track:type_name -> livekit.UpdateLocalVideoTrack
	83,  // 108: livekit.JoinRequest.client_info:type_name -> livekit.ClientInfo
	55,  // 109: livekit.JoinRequest.connection_settings:type_name -> livekit.ConnectionSettings
	61,  // 110: livekit.JoinRequest.participant_attributes:type_name -> livekit.JoinRequest.ParticipantAttributesEntry
	10,  // 111: livekit.JoinRequest.add_track_requests:type_name -> livekit.AddTrackRequest
	19,  // 112: livekit.JoinRequest.publisher_offer:type_name -> livekit.SessionDescription
	84,  // 113: livekit.JoinRequest.reconnect_reason:type_name -> livekit.ReconnectReason
	44,  // 114: livekit.JoinRequest.sync_state:type_name -> livekit.SyncState
	6,   // 115: livekit.WrappedJoinRequest.compression:type_name -> livekit.WrappedJoinRequest.Compression
	85,  // 116: livekit.UpdateDataSubscription.Update.options:type_name -> livekit.DataTrackSubscriptionOptions
...
func file_livekit_rtc_proto_init() {
	...
	file_livekit_rtc_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*SignalRequest_PublishDataTrack)(nil),
	...
	file_livekit_rtc_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*SignalResponse_PublishDataTrack)(nil),
	}
	file_livekit_rtc_proto_msgTypes[5].OneofWrappers = []any{
		(*PublishDataTrackResponse_Ok)(nil),
		(*PublishDataTrackResponse_Error_)(nil),
	}
	file_livekit_rtc_proto_msgTypes[40].OneofWrappers = []any{
	...
	file_livekit_rtc_proto_msgTypes[48].OneofWrappers = []any{}
	type x struct{}
