...
func (x *SignalRequest) GetPong() bool {
	if x, ok := x.GetMessage().(*SignalRequest_Pong); ok {
		return x.Pong
	}
	return false
}
...
type SignalRequest_Pong struct {
	// respond to ping
	Pong bool `protobuf:"varint,14,opt,name=pong,proto3,oneof"`
}
...
func (*SignalRequest_Pong) isSignalRequest_Message() {}
...
func (x *SignalResponse) GetPing() bool {
	if x, ok := x.GetMessage().(*SignalResponse_Ping); ok {
		return x.Ping
	}
	return false
}
...
type SignalResponse_Ping struct {
	// server triggered ping
	Ping bool `protobuf:"varint,18,opt,name=ping,proto3,oneof"`
}
...
func (*SignalResponse_Ping) isSignalResponse_Message() {}
...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x12, 0x14, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x0e, 0x20, 0x01, 0x28,
	0x08, 0x48, 0x00, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73,
	...
	0x14, 0x0a, 0x04, 0x70, 0x69, 0x6e, 0x67, 0x18, 0x12, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52,
	0x04, 0x70, 0x69, 0x6e, 0x67, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x6d, 0x75, 0x74, 0x65, 0x64, 0x22, 0x83, 0x04,
	...
	0x6f, 0x75, 0x74, 0x22, 0x54, 0x0a, 0x16, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x50, 0x75, 0x62, 0x6c,
	...
	0x68, 0x74, 0x22, 0x66, 0x0a, 0x0c, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
