...
const (
	ErrorResponse_UNKNOWN          ErrorResponse_Reason = 0
	ErrorResponse_NOT_FOUND        ErrorResponse_Reason = 1
	ErrorResponse_NOT_ALLOWED      ErrorResponse_Reason = 2
	ErrorResponse_INVALID_ARGUMENT ErrorResponse_Reason = 3
)
...
type SignalRequest struct {
	...
	//	*SignalRequest_ParticipantMessage
	//	*SignalRequest_GetParticipantMessages
...
func (x *SignalRequest) GetParticipantMessage() *ParticipantMessage {
	if x, ok := x.GetMessage().(*SignalRequest_ParticipantMessage); ok {
		return x.ParticipantMessage
	}
	return nil
}

func (x *SignalRequest) GetGetParticipantMessages() *ParticipantMessageRequest {
	if x, ok := x.GetMessage().(*SignalRequest_GetParticipantMessages); ok {
		return x.GetParticipantMessages
	}
	return nil
}
...
type SignalRequest_ParticipantMessage struct {
	// Send/Update ParticipantMessage
	ParticipantMessage *ParticipantMessage `protobuf:"bytes,19,opt,name=participant_message,json=participantMessage,proto3,oneof"`
}

type SignalRequest_GetParticipantMessages struct {
	// Query Participant Messages
	GetParticipantMessages *ParticipantMessageRequest `protobuf:"bytes,20,opt,name=get_participant_messages,json=getParticipantMessages,proto3,oneof"`
}
...
func (*SignalRequest_ParticipantMessage) isSignalRequest_Message() {}

func (*SignalRequest_GetParticipantMessages) isSignalRequest_Message() {}
...
type SignalResponse struct {
	...
	//	*SignalResponse_ParticipantMessages
...
func (x *SignalResponse) GetParticipantMessages() *ParticipantMessageResponse {
	if x, ok := x.GetMessage().(*SignalResponse_ParticipantMessages); ok {
		return x.ParticipantMessages
	}
	return nil
}
...
type SignalResponse_ParticipantMessages struct {
	// Receive/Acknowledge ParticipantMessages
	ParticipantMessages *ParticipantMessageResponse `protobuf:"bytes,23,opt,name=participant_messages,json=participantMessages,proto3,oneof"`
}
...
func (*SignalResponse_ParticipantMessages) isSignalResponse_Message() {}
...
type ErrorResponse struct {
	...
	Reason    ErrorResponse_Reason `protobuf:"varint,2,opt,name=reason,proto3,enum=livekit.ErrorResponse_Reason" json:"reason,omitempty"`
...
type ParticipantMessage struct {
	...
	// Types that are assignable to Message:
	//
	//	*ParticipantMessage_Chat
	//	*ParticipantMessage_Transcription
	Message isParticipantMessage_Message `protobuf_oneof:"message"`
}
...
func (m *ParticipantMessage) GetMessage() isParticipantMessage_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *ParticipantMessage) GetChat() *ChatMessage {
	if x, ok := x.GetMessage().(*ParticipantMessage_Chat); ok {
		return x.Chat
	}
	return nil
}

func (x *ParticipantMessage) GetTranscription() *Transcription {
	if x, ok := x.GetMessage().(*ParticipantMessage_Transcription); ok {
		return x.Transcription
	}
	return nil
}

type isParticipantMessage_Message interface {
	isParticipantMessage_Message()
}

type ParticipantMessage_Chat struct {
	Chat *ChatMessage `protobuf:"bytes,2,opt,name=chat,proto3,oneof"`
}

type ParticipantMessage_Transcription struct {
	Transcription *Transcription `protobuf:"bytes,3,opt,name=transcription,proto3,oneof"`
}

func (*ParticipantMessage_Chat) isParticipantMessage_Message() {}

func (*ParticipantMessage_Transcription) isParticipantMessage_Message() {}

type ParticipantMessageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Messages []*ParticipantMessage `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"`
}

func (x *ParticipantMessageResponse) Reset() {
	*x = ParticipantMessageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ParticipantMessageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ParticipantMessageResponse) ProtoMessage() {}

func (x *ParticipantMessageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_rtc_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ParticipantMessageResponse.ProtoReflect.Descriptor instead.
func (*ParticipantMessageResponse) Descriptor() ([]byte, []int) {
	return file_livekit_rtc_proto_rawDescGZIP(), []int{42}
}

func (x *ParticipantMessageResponse) GetMessages() []*ParticipantMessage {
	if x != nil {
		return x.Messages
	}
	return nil
...
type ParticipantMessageRequest struct {
	...
	Timestamp uint64 `protobuf:"varint,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // Retrieve all messages with local participant as recepient since timestamp
}

func (x *ParticipantMessageRequest) Reset() {
	*x = ParticipantMessageRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ParticipantMessageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ParticipantMessageRequest) ProtoMessage() {}

func (x *ParticipantMessageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_livekit_rtc_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ParticipantMessageRequest.ProtoReflect.Descriptor instead.
func (*ParticipantMessageRequest) Descriptor() ([]byte, []int) {
	return file_livekit_rtc_proto_rawDescGZIP(), []int{43}
}

func (x *ParticipantMessageRequest) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xce, 0x09, 0x0a, 0x0d, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x52, 0x65, 0x71,
	...
	,
	...
	0x52, 0x16, 0x67, 0x65, 0x74, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x22, 0xa4, 0x0b, 0x0a, 0x0e, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x52, 0x65,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x0e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x72, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6c,
	...
	,
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x12, 0x42, 0x0a, 0x10, 0x73, 0x69, 0x6d, 0x75, 0x6c, 0x63,
	0x61, 0x73, 0x74, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x63, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b,
	...
	0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x06,
	0x73, 0x74, 0x65, 0x72, 0x65, 0x6f, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74,
	0x65, 0x72, 0x65, 0x6f, 0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x5f,
	0x72, 0x65, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x64, 0x69, 0x73, 0x61, 0x62,
	0x6c, 0x65, 0x52, 0x65, 0x64, 0x12, 0x38, 0x0a, 0x0a, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6c, 0x69, 0x76, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x0a, 0x73, 0x69, 0x66, 0x54, 0x72, 0x61, 0x69, 0x6c, 0x65, 0x72, 0x22, 0x99, 0x01, 0x0a,
	0x11, 0x52, 0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x33, 0x0a, 0x0b, 0x69, 0x63, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x13, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x54, 0x0a, 0x16, 0x54, 0x72, 0x61, 0x63,
	...
	0x61, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x22, 0x37,
	0x0a, 0x18, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x55, 0x6e, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
	0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x72,
	0x61, 0x63, 0x6b, 0x5f, 0x73, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74,
	0x72, 0x61, 0x63, 0x6b, 0x53, 0x69, 0x64, 0x22, 0x3a, 0x0a, 0x12, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	0x72, 0x61, 0x63, 0x6b, 0x73, 0x22, 0xdd, 0x01, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	,
	...
	0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x84, 0x02, 0x0a, 0x0c, 0x4c, 0x65, 0x61, 0x76,
	...
	0x0c, 0x63, 0x61, 0x6e, 0x52, 0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x31, 0x0a,
	0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e,
	...
	,
	...
	0x4c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x06, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x3a, 0x02, 0x18,
	0x01, 0x22, 0xfd, 0x01, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x74,
	...
	0x09, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12,
	0x52, 0x0a, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x55, 0x70,
	...
	0x01, 0x22, 0x5b, 0x0a, 0x09, 0x49, 0x43, 0x45, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x12,
	...
	0x28, 0x09, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x43,
	0x0a, 0x0f, 0x53, 0x70, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x73, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
	0x64, 0x12, 0x30, 0x0a, 0x08, 0x73, 0x70, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20,
	...
	0x65, 0x72, 0x73, 0x22, 0x2f, 0x0a, 0x0a, 0x52, 0x6f, 0x6f, 0x6d, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x72, 0x6f, 0x6f, 0x6d, 0x22, 0x8c, 0x01, 0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x51, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x27,
	...
	0x70, 0x61, 0x6e, 0x74, 0x53, 0x69, 0x64, 0x12, 0x34, 0x0a, 0x07, 0x71, 0x75, 0x61, 0x6c, 0x69,
	0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b,
	...
	0x6f, 0x72, 0x65, 0x22, 0x53, 0x0a, 0x17, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x51, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x38,
	0x0a, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x51, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x52,
	0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x0f, 0x53, 0x74, 0x72,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x53, 0x69, 0x64, 0x12, 0x4d,
	...
	0x69, 0x62, 0x65, 0x64, 0x51, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12, 0x45, 0x0a,
	0x11, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x64, 0x5f, 0x63, 0x6f, 0x64, 0x65,
	0x63, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b,
	0x69, 0x74, 0x2e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x64, 0x43, 0x6f, 0x64,
	0x65, 0x63, 0x52, 0x10, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x64, 0x43, 0x6f,
	0x64, 0x65, 0x63, 0x73, 0x22, 0xab, 0x01, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x50, 0x65,
	0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x0f, 0x70, 0x61, 0x72, 0x74,
	...
	0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x6c, 0x6c, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x61, 0x6c, 0x6c, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73,
	0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x5f, 0x73, 0x69, 0x64, 0x73, 0x18, 0x03,
	...
	,
	...
	0x63, 0x6b, 0x53, 0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x22,
	0xeb, 0x02, 0x0a, 0x09, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x33, 0x0a,
	0x06, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	...
	0x65, 0x72, 0x12, 0x3f, 0x0a, 0x0c, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b,
	...
	,
	...
	,
	...
	0x01, 0x12, 0x0f, 0x0a, 0x0b, 0x4e, 0x4f, 0x54, 0x5f, 0x41, 0x4c, 0x4c, 0x4f, 0x57, 0x45, 0x44,
	0x10, 0x02, 0x12, 0x14, 0x0a, 0x10, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f, 0x41, 0x52,
	0x47, 0x55, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x03, 0x22, 0x8b, 0x01, 0x0a, 0x12, 0x50, 0x61, 0x72,
	0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	0x2a, 0x0a, 0x04, 0x63, 0x68, 0x61, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x04, 0x63, 0x68, 0x61, 0x74, 0x12, 0x3e, 0x0a, 0x0d, 0x74,
	...
	0x61, 0x6e, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x09, 0x0a, 0x07, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x55, 0x0a, 0x1a, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63,
	0x69, 0x70, 0x61, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70,
	...
	0x2e, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x52, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x39, 0x0a,
	0x19, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69,
...
var file_livekit_rtc_proto_goTypes = []any{
	...
	(ErrorResponse_Reason)(0),            // 4: livekit.ErrorResponse.Reason
	...
	(*ErrorResponse)(nil),                // 45: livekit.ErrorResponse
	(*ParticipantMessage)(nil),           // 46: livekit.ParticipantMessage
	(*ParticipantMessageResponse)(nil),   // 47: livekit.ParticipantMessageResponse
	(*ParticipantMessageRequest)(nil),    // 48: livekit.ParticipantMessageRequest
	...
	(*ChatMessage)(nil),                  // 66: livekit.ChatMessage
	(*Transcription)(nil),                // 67: livekit.Transcription
}
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	46, // 16: livekit.SignalRequest.participant_message:type_name -> livekit.ParticipantMessage
	48, // 17: livekit.SignalRequest.get_participant_messages:type_name -> livekit.ParticipantMessageRequest
	11, // 18: livekit.SignalResponse.join:type_name -> livekit.JoinResponse
	15, // 19: livekit.SignalResponse.answer:type_name -> livekit.SessionDescription
	15, // 20: livekit.SignalResponse.offer:type_name -> livekit.SessionDescription
	9,  // 21: livekit.SignalResponse.trickle:type_name -> livekit.TrickleRequest
	16, // 22: livekit.SignalResponse.update:type_name -> livekit.ParticipantUpdate
	13, // 23: livekit.SignalResponse.track_published:type_name -> livekit.TrackPublishedResponse
	21, // 24: livekit.SignalResponse.leave:type_name -> livekit.LeaveRequest
	10, // 25: livekit.SignalResponse.mute:type_name -> livekit.MuteTrackRequest
	25, // 26: livekit.SignalResponse.speakers_changed:type_name -> livekit.SpeakersChanged
	26, // 27: livekit.SignalResponse.room_update:type_name -> livekit.RoomUpdate
	28, // 28: livekit.SignalResponse.connection_quality:type_name -> livekit.ConnectionQualityUpdate
	30, // 29: livekit.SignalResponse.stream_state_update:type_name -> livekit.StreamStateUpdate
	33, // 30: livekit.SignalResponse.subscribed_quality_update:type_name -> livekit.SubscribedQualityUpdate
	36, // 31: livekit.SignalResponse.subscription_permission_update:type_name -> livekit.SubscriptionPermissionUpdate
	14, // 32: livekit.SignalResponse.track_unpublished:type_name -> livekit.TrackUnpublishedResponse
	12, // 33: livekit.SignalResponse.reconnect:type_name -> livekit.ReconnectResponse
	41, // 34: livekit.SignalResponse.pong_resp:type_name -> livekit.Pong
	44, // 35: livekit.SignalResponse.subscription_response:type_name -> livekit.SubscriptionResponse
	45, // 36: livekit.SignalResponse.error_response:type_name -> livekit.ErrorResponse
	47, // 37: livekit.SignalResponse.participant_messages:type_name -> livekit.ParticipantMessageResponse
	50, // 38: livekit.AddTrackRequest.type:type_name -> livekit.TrackType
	51, // 39: livekit.AddTrackRequest.source:type_name -> livekit.TrackSource
	52, // 40: livekit.AddTrackRequest.layers:type_name -> livekit.VideoLayer
	7,  // 41: livekit.AddTrackRequest.simulcast_codecs:type_name -> livekit.SimulcastCodec
	53, // 42: livekit.AddTrackRequest.encryption:type_name -> livekit.Encryption.Type
	...
	56, // 51: livekit.ReconnectResponse.client_configuration:type_name -> livekit.ClientConfiguration
	58, // 52: livekit.TrackPublishedResponse.track:type_name -> livekit.TrackInfo
	55, // 53: livekit.ParticipantUpdate.participants:type_name -> livekit.ParticipantInfo
	...
	52, // 60: livekit.UpdateVideoLayers.layers:type_name -> livekit.VideoLayer
	49, // 61: livekit.UpdateParticipantMetadata.attributes:type_name -> livekit.UpdateParticipantMetadata.AttributesEntry
	63, // 62: livekit.SpeakersChanged.speakers:type_name -> livekit.SpeakerInfo
	54, // 63: livekit.RoomUpdate.room:type_name -> livekit.Room
	...
	4,  // 82: livekit.ErrorResponse.reason:type_name -> livekit.ErrorResponse.Reason
	66, // 83: livekit.ParticipantMessage.chat:type_name -> livekit.ChatMessage
	67, // 84: livekit.ParticipantMessage.transcription:type_name -> livekit.Transcription
	46, // 85: livekit.ParticipantMessageResponse.messages:type_name -> livekit.ParticipantMessage
...
func file_livekit_rtc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_livekit_rtc_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[17].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[18].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[24].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[25].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[26].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[27].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[28].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[29].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[30].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[31].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[32].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[33].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[34].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[35].Exporter = func(v any, i int) any {
			switch v := v.(*Ping); i {
			case 0:
				return &v.state
			case 1:
		...
		file_livekit_rtc_proto_msgTypes[36].Exporter = func(v any, i int) any {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
		...
		file_livekit_rtc_proto_msgTypes[37].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[38].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[39].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[40].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[41].Exporter = func(v any, i int) any {
		...
		file_livekit_rtc_proto_msgTypes[42].Exporter = func(v any, i int) any {
			switch v := v.(*ParticipantMessageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_livekit_rtc_proto_msgTypes[43].Exporter = func(v any, i int) any {
			switch v := v.(*ParticipantMessageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_livekit_rtc_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*SignalRequest_ParticipantMessage)(nil),
		(*SignalRequest_GetParticipantMessages)(nil),
	}
	file_livekit_rtc_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*SignalResponse_ParticipantMessages)(nil),
	}
	...
	file_livekit_rtc_proto_msgTypes[41].OneofWrappers = []any{
		(*ParticipantMessage_Chat)(nil),
		(*ParticipantMessage_Transcription)(nil),
	}
	type x struct{}
