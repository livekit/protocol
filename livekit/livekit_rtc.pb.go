...
type LeaveRequest_LeaveReason int32

const (
	LeaveRequest_UNKNOWN_REASON      LeaveRequest_LeaveReason = 0
	LeaveRequest_CLIENT_INITIATED    LeaveRequest_LeaveReason = 1
	LeaveRequest_DUPLICATE_IDENTITY  LeaveRequest_LeaveReason = 2
	LeaveRequest_SERVER_SHUTDOWN     LeaveRequest_LeaveReason = 3
	LeaveRequest_PARTICIPANT_REMOVED LeaveRequest_LeaveReason = 4
	LeaveRequest_ROOM_DELETED        LeaveRequest_LeaveReason = 5
	LeaveRequest_STATE_MISMATCH      LeaveRequest_LeaveReason = 6
)

// Enum value maps for LeaveRequest_LeaveReason.
var (
	LeaveRequest_LeaveReason_name = map[int32]string{
		0: "UNKNOWN_REASON",
		1: "CLIENT_INITIATED",
	...
	LeaveRequest_LeaveReason_value = map[string]int32{
		"UNKNOWN_REASON":      0,
		"CLIENT_INITIATED":    1,
...
func (x LeaveRequest_LeaveReason) Enum() *LeaveRequest_LeaveReason {
	p := new(LeaveRequest_LeaveReason)
	*p = x
	return p
}

func (x LeaveRequest_LeaveReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LeaveRequest_LeaveReason) Descriptor() protoreflect.EnumDescriptor {
	return file_livekit_rtc_proto_enumTypes[3].Descriptor()
}

func (LeaveRequest_LeaveReason) Type() protoreflect.EnumType {
	return &file_livekit_rtc_proto_enumTypes[3]
}

func (x LeaveRequest_LeaveReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LeaveRequest_LeaveReason.Descriptor instead.
func (LeaveRequest_LeaveReason) EnumDescriptor() ([]byte, []int) {
	return file_livekit_rtc_proto_rawDescGZIP(), []int{13, 0}
}
...
type LeaveRequest struct {
	...
	Reason       LeaveRequest_LeaveReason `protobuf:"varint,2,opt,name=reason,proto3,enum=livekit.LeaveRequest_LeaveReason" json:"reason,omitempty"`
}
...
func (x *LeaveRequest) GetReason() LeaveRequest_LeaveReason {
	if x != nil {
		return x.Reason
	}
	return LeaveRequest_UNKNOWN_REASON
}
...
var file_livekit_rtc_proto_rawDesc = []byte{
	...
	0x67, 0x68, 0x74, 0x22, 0x94, 0x02, 0x0a, 0x0c, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71,
	...
	0x52, 0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x39, 0x0a, 0x06, 0x72, 0x65, 0x61,
	0x73, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x6c, 0x69, 0x76, 0x65,
	0x6b, 0x69, 0x74, 0x2e, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x2e, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x52, 0x06, 0x72, 0x65,
	0x61, 0x73, 0x6f, 0x6e, 0x22, 0xa3, 0x01, 0x0a, 0x0b, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65,
	...
	0x4d, 0x49, 0x53, 0x4d, 0x41, 0x54, 0x43, 0x48, 0x10, 0x06, 0x22, 0x5d, 0x0a, 0x11, 0x55, 0x70,
	...
	0x72, 0x52, 0x06, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0x5b, 0x0a, 0x09, 0x49, 0x43, 0x45,
	...
	0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x22, 0x88, 0x02, 0x0a, 0x09, 0x53, 0x79, 0x6e, 0x63,
	...
	0x6c, 0x73, 0x22, 0x66, 0x0a, 0x0f, 0x44, 0x61, 0x74, 0x61, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65,
...
var file_livekit_rtc_proto_goTypes = []interface{}{
	...
	(LeaveRequest_LeaveReason)(0),        // 3: livekit.LeaveRequest.LeaveReason
...
var file_livekit_rtc_proto_depIdxs = []int32{
	...
	10, // 12: livekit.SignalResponse.join:type_name -> livekit.JoinResponse
	...
	8,  // 15: livekit.SignalResponse.trickle:type_name -> livekit.TrickleRequest
	...
	9,  // 19: livekit.SignalResponse.mute:type_name -> livekit.MuteTrackRequest
	...
	35, // 27: livekit.AddTrackRequest.type:type_name -> livekit.TrackType
	36, // 28: livekit.AddTrackRequest.source:type_name -> livekit.TrackSource
	37, // 29: livekit.AddTrackRequest.layers:type_name -> livekit.VideoLayer
	6,  // 30: livekit.AddTrackRequest.simulcast_codecs:type_name -> livekit.SimulcastCodec
	0,  // 31: livekit.TrickleRequest.target:type_name -> livekit.SignalTarget
	38, // 32: livekit.JoinResponse.room:type_name -> livekit.Room
	39, // 33: livekit.JoinResponse.participant:type_name -> livekit.ParticipantInfo
	39, // 34: livekit.JoinResponse.other_participants:type_name -> livekit.ParticipantInfo
	19, // 35: livekit.JoinResponse.ice_servers:type_name -> livekit.ICEServer
	40, // 36: livekit.JoinResponse.client_configuration:type_name -> livekit.ClientConfiguration
	41, // 37: livekit.TrackPublishedResponse.track:type_name -> livekit.TrackInfo
	39, // 38: livekit.ParticipantUpdate.participants:type_name -> livekit.ParticipantInfo
	42, // 39: livekit.UpdateSubscription.participant_tracks:type_name -> livekit.ParticipantTracks
	43, // 40: livekit.UpdateTrackSettings.quality:type_name -> livekit.VideoQuality
	3,  // 41: livekit.LeaveRequest.reason:type_name -> livekit.LeaveRequest.LeaveReason
	37, // 42: livekit.UpdateVideoLayers.layers:type_name -> livekit.VideoLayer
	44, // 43: livekit.SpeakersChanged.speakers:type_name -> livekit.SpeakerInfo
	38, // 44: livekit.RoomUpdate.room:type_name -> livekit.Room
	45, // 45: livekit.ConnectionQualityInfo.quality:type_name -> livekit.ConnectionQuality
	22, // 46: livekit.ConnectionQualityUpdate.updates:type_name -> livekit.ConnectionQualityInfo
	1,  // 47: livekit.StreamStateInfo.state:type_name -> livekit.StreamState
	24, // 48: livekit.StreamStateUpdate.stream_states:type_name -> livekit.StreamStateInfo
	43, // 49: livekit.SubscribedQuality.quality:type_name -> livekit.VideoQuality
	26, // 50: livekit.SubscribedCodec.qualities:type_name -> livekit.SubscribedQuality
	26, // 51: livekit.SubscribedQualityUpdate.subscribed_qualities:type_name -> livekit.SubscribedQuality
	27, // 52: livekit.SubscribedQualityUpdate.subscribed_codecs:type_name -> livekit.SubscribedCodec
	29, // 53: livekit.SubscriptionPermission.track_permissions:type_name -> livekit.TrackPermission
	13, // 54: livekit.SyncState.answer:type_name -> livekit.SessionDescription
	15, // 55: livekit.SyncState.subscription:type_name -> livekit.UpdateSubscription
	11, // 56: livekit.SyncState.publish_tracks:type_name -> livekit.TrackPublishedResponse
	33, // 57: livekit.SyncState.data_channels:type_name -> livekit.DataChannelInfo
