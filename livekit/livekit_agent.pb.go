...
func file_livekit_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_livekit_agent_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_agent_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_livekit_agent_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
	...
	file_livekit_agent_proto_msgTypes[9].OneofWrappers = []interface{}{
	...
	file_livekit_agent_proto_msgTypes[10].OneofWrappers = []interface{}{
	...
	file_livekit_agent_proto_msgTypes[20].OneofWrappers = []interface{}{}
	file_livekit_agent_proto_msgTypes[21].OneofWrappers = []interface{}{}
	type x struct{}
