...
const (
	...
	// a client-initiated WebSocket route; the stream carries the upgrade exchange
	// and then raw bidirectional bytes
	AgentHttp_AEK_WEBSOCKET AgentHttp_AgentEndpointKind = 1
...
type AgentHttp_AgentEndpoint struct {
	...
	// HEAD from GET); empty for AEK_WEBSOCKET
...
const file_livekit_agent_proto_rawDesc = "" +
	...
	"\x06job_id\x18\x01 \x01(\tB\b\xbaP\x05jobIDR\x05jobId\"\x84\r\n" +
	...
	"\bAEK_HTTP\x10\x00\x12\x11\n" +
	"\rAEK_WEBSOCKET\x10\x01\x12\f\n" +
	"\bAEK_TEXT\x10\x02\"Z\n" +
