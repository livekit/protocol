...
type WorkerMessage_UpdateWorker struct {
	...
	UpdateWorker *UpdateWorkerStatus `protobuf:"bytes,5,opt,name=update_worker,json=updateWorker,proto3,oneof"`
}

type WorkerMessage_Ping struct {
	Ping *WorkerPing `protobuf:"bytes,6,opt,name=ping,proto3,oneof"`
}
...
type UpdateJobStatus struct {
	...
	// the user_data can be updated multiple times
	// None = no update
...
var file_livekit_agent_proto_rawDesc = []byte{
	...
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x39, 0x0a, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x62, 0x12, 0x42, 0x0a, 0x0d, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x77, 0x6f, 0x72, 0x6b,
	...
	0x6f, 0x72, 0x6b, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x04, 0x70, 0x69, 0x6e, 0x67, 0x18, 0x06, 0x20,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74,
	...
	0x62, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69,
...
var file_livekit_agent_proto_depIdxs = []int32{
	...
	16, // 7: livekit.WorkerMessage.update_job:type_name -> livekit.UpdateJobStatus
