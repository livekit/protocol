...
const file_agent_livekit_agent_session_proto_rawDesc = "" +
	...
	"\x05error\x18\x10 \x01(\v2!.livekit.agent.SessionEvent.ErrorH\x00R\x05error\x12^\n" +
	"\x12overlapping_speech\x18\x11 \x01(\v2-.livekit.agent.SessionEvent.OverlappingSpeechH\x00R\x11overlappingSpeech\x12e\n" +
	"\x15session_usage_updated\x18\x12 \x01(\v2/.livekit.agent.SessionEvent.SessionUsageUpdatedH\x00R\x13sessionUsageUpdated\x1a\x91\x01\n" +
