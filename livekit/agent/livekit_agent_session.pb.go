...
const (
	ToolCallStatus_TC_RUNNING   ToolCallStatus = 0
	ToolCallStatus_TC_DONE      ToolCallStatus = 1
	ToolCallStatus_TC_ERROR     ToolCallStatus = 2
	ToolCallStatus_TC_CANCELLED ToolCallStatus = 3
)
...
func (ToolCallStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_livekit_agent_session_proto_enumTypes[3].Descriptor()
}

func (ToolCallStatus) Type() protoreflect.EnumType {
	return &file_agent_livekit_agent_session_proto_enumTypes[3]
}
...
type ToolReplyStatus int32

const (
	ToolReplyStatus_TR_SCHEDULED   ToolReplyStatus = 0
	ToolReplyStatus_TR_COMPLETED   ToolReplyStatus = 1
	ToolReplyStatus_TR_INTERRUPTED ToolReplyStatus = 2
	ToolReplyStatus_TR_SKIPPED     ToolReplyStatus = 3
)

// Enum value maps for ToolReplyStatus.
var (
	ToolReplyStatus_name = map[int32]string{
		0: "TR_SCHEDULED",
		1: "TR_COMPLETED",
		2: "TR_INTERRUPTED",
		3: "TR_SKIPPED",
	}
	ToolReplyStatus_value = map[string]int32{
		"TR_SCHEDULED":   0,
		"TR_COMPLETED":   1,
		"TR_INTERRUPTED": 2,
		"TR_SKIPPED":     3,
...
func (x ToolReplyStatus) Enum() *ToolReplyStatus {
	p := new(ToolReplyStatus)
	*p = x
	return p
}

func (x ToolReplyStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ToolReplyStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_livekit_agent_session_proto_enumTypes[4].Descriptor()
}

func (ToolReplyStatus) Type() protoreflect.EnumType {
	return &file_agent_livekit_agent_session_proto_enumTypes[4]
}

func (x ToolReplyStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ToolReplyStatus.Descriptor instead.
func (ToolReplyStatus) EnumDescriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{4}
}

type SessionCloseReason int32

const (
	SessionCloseReason_SC_UNKNOWN                  SessionCloseReason = 0
	SessionCloseReason_SC_ERROR                    SessionCloseReason = 1
	SessionCloseReason_SC_JOB_SHUTDOWN             SessionCloseReason = 2
	SessionCloseReason_SC_PARTICIPANT_DISCONNECTED SessionCloseReason = 3
	SessionCloseReason_SC_USER_INITIATED           SessionCloseReason = 4
	SessionCloseReason_SC_TASK_COMPLETED           SessionCloseReason = 5
)

// Enum value maps for SessionCloseReason.
var (
	SessionCloseReason_name = map[int32]string{
		0: "SC_UNKNOWN",
		1: "SC_ERROR",
		2: "SC_JOB_SHUTDOWN",
		3: "SC_PARTICIPANT_DISCONNECTED",
		4: "SC_USER_INITIATED",
		5: "SC_TASK_COMPLETED",
	}
	SessionCloseReason_value = map[string]int32{
		"SC_UNKNOWN":                  0,
		"SC_ERROR":                    1,
		"SC_JOB_SHUTDOWN":             2,
		"SC_PARTICIPANT_DISCONNECTED": 3,
		"SC_USER_INITIATED":           4,
		"SC_TASK_COMPLETED":           5,
	}
)

func (x SessionCloseReason) Enum() *SessionCloseReason {
	p := new(SessionCloseReason)
	*p = x
	return p
}

func (x SessionCloseReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SessionCloseReason) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_livekit_agent_session_proto_enumTypes[5].Descriptor()
}

func (SessionCloseReason) Type() protoreflect.EnumType {
	return &file_agent_livekit_agent_session_proto_enumTypes[5]
}

func (x SessionCloseReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SessionCloseReason.Descriptor instead.
func (SessionCloseReason) EnumDescriptor() ([]byte, []int) {
...
type MetricsReport struct {
	...
	LlmNodeTps               *float64               `protobuf:"fixed64,9,opt,name=llm_node_tps,json=llmNodeTps,proto3,oneof" json:"llm_node_tps,omitempty"`
	LlmNodeTtfs              *float64               `protobuf:"fixed64,10,opt,name=llm_node_ttfs,json=llmNodeTtfs,proto3,oneof" json:"llm_node_ttfs,omitempty"`
...
func (x *MetricsReport) GetLlmNodeTps() float64 {
	if x != nil && x.LlmNodeTps != nil {
		return *x.LlmNodeTps
	}
	return 0
}

func (x *MetricsReport) GetLlmNodeTtfs() float64 {
	if x != nil && x.LlmNodeTtfs != nil {
		return *x.LlmNodeTtfs
	}
	return 0
}
...
func (x *DebugMessage) GetPayload() *structpb.Struct {
	if x != nil {
		return x.Payload
	}
	return nil
...
type AgentSessionEvent struct {
	...
	//	*AgentSessionEvent_SessionClosed_
...
func (x *AgentSessionEvent) GetDebugMessage() *DebugMessage {
	if x != nil {
		if x, ok := x.Event.(*AgentSessionEvent_DebugMessage); ok {
...
func (x *AgentSessionEvent) GetToolExecutionUpdated() *AgentSessionEvent_ToolExecutionUpdated {
	if x != nil {
		if x, ok := x.Event.(*AgentSessionEvent_ToolExecutionUpdated_); ok {
			return x.ToolExecutionUpdated
		}
	}
	return nil
}

func (x *AgentSessionEvent) GetAgentFalseInterruption() *AgentSessionEvent_AgentFalseInterruption {
	if x != nil {
		if x, ok := x.Event.(*AgentSessionEvent_AgentFalseInterruption_); ok {
			return x.AgentFalseInterruption
		}
	}
	return nil
}

func (x *AgentSessionEvent) GetSessionClosed() *AgentSessionEvent_SessionClosed {
	if x != nil {
		if x, ok := x.Event.(*AgentSessionEvent_SessionClosed_); ok {
...
type AgentSessionEvent_DebugMessage struct {
	DebugMessage *DebugMessage `protobuf:"bytes,21,opt,name=debug_message,json=debugMessage,proto3,oneof"`
}

type AgentSessionEvent_ToolExecutionUpdated_ struct {
	ToolExecutionUpdated *AgentSessionEvent_ToolExecutionUpdated `protobuf:"bytes,22,opt,name=tool_execution_updated,json=toolExecutionUpdated,proto3,oneof"`
}

type AgentSessionEvent_AgentFalseInterruption_ struct {
...
type AgentSessionEvent_SessionClosed_ struct {
	SessionClosed *AgentSessionEvent_SessionClosed `protobuf:"bytes,24,opt,name=session_closed,json=sessionClosed,proto3,oneof"`
}
...
func (*AgentSessionEvent_DebugMessage) isAgentSessionEvent_Event() {}
...
func (*AgentSessionEvent_SessionClosed_) isAgentSessionEvent_Event() {}
...
type SessionRequest struct {
	...
	//	*SessionRequest_FinalizeSimulation_
...
func (x *SessionRequest) GetUpdateIo() *SessionRequest_UpdateIO {
	if x != nil {
		if x, ok := x.Request.(*SessionRequest_UpdateIo); ok {
			return x.UpdateIo
		}
	}
	return nil
...
func (x *SessionRequest) GetFinalizeSimulation() *SessionRequest_FinalizeSimulation {
	if x != nil {
		if x, ok := x.Request.(*SessionRequest_FinalizeSimulation_); ok {
			return x.FinalizeSimulation
		}
	}
	return nil
}
...
type SessionRequest_FinalizeSimulation_ struct {
	FinalizeSimulation *SessionRequest_FinalizeSimulation `protobuf:"bytes,12,opt,name=finalize_simulation,json=finalizeSimulation,proto3,oneof"`
}
...
func (*SessionRequest_UpdateIo) isSessionRequest_Request() {}

func (*SessionRequest_FinalizeSimulation_) isSessionRequest_Request() {}
...
type SessionResponse struct {
	...
	//	*SessionResponse_FinalizeSimulation
...
func (x *SessionResponse) GetUpdateIo() *SessionResponse_UpdateIOResponse {
	if x != nil {
		if x, ok := x.Response.(*SessionResponse_UpdateIo); ok {
			return x.UpdateIo
		}
	}
	return nil
...
func (x *SessionResponse) GetFinalizeSimulation() *SessionResponse_FinalizeSimulationResponse {
	if x != nil {
		if x, ok := x.Response.(*SessionResponse_FinalizeSimulation); ok {
			return x.FinalizeSimulation
		}
	}
	return nil
...
type SessionResponse_FinalizeSimulation struct {
	FinalizeSimulation *SessionResponse_FinalizeSimulationResponse `protobuf:"bytes,13,opt,name=finalize_simulation,json=finalizeSimulation,proto3,oneof"`
}
...
func (*SessionResponse_UpdateIo) isSessionResponse_Response() {}

func (*SessionResponse_FinalizeSimulation) isSessionResponse_Response() {}
...
func (*ChatMessage_ChatContent) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{2, 0}
}
...
func (*AgentSessionEvent_OverlappingSpeech) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 7}
}
...
func (*AgentSessionEvent_AmdPrediction) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 8}
}
...
func (*AgentSessionEvent_EotPrediction) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 9}
}
...
func (*AgentSessionEvent_SessionUsageUpdated) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 10}
}
...
type AgentSessionEvent_ToolExecutionUpdated struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Update:
	//
	//	*AgentSessionEvent_ToolExecutionUpdated_Started_
	//	*AgentSessionEvent_ToolExecutionUpdated_CallUpdated_
	//	*AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated_
	//	*AgentSessionEvent_ToolExecutionUpdated_Ended_
	Update        isAgentSessionEvent_ToolExecutionUpdated_Update `protobuf_oneof:"update"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AgentSessionEvent_ToolExecutionUpdated) Reset() {
	*x = AgentSessionEvent_ToolExecutionUpdated{}
	mi := &file_agent_livekit_agent_session_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AgentSessionEvent_ToolExecutionUpdated) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AgentSessionEvent_ToolExecutionUpdated) ProtoMessage() {}

func (x *AgentSessionEvent_ToolExecutionUpdated) ProtoReflect() protoreflect.Message {
	mi := &file_agent_livekit_agent_session_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AgentSessionEvent_ToolExecutionUpdated.ProtoReflect.Descriptor instead.
func (*AgentSessionEvent_ToolExecutionUpdated) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 11}
}

func (x *AgentSessionEvent_ToolExecutionUpdated) GetUpdate() isAgentSessionEvent_ToolExecutionUpdated_Update {
	if x != nil {
		return x.Update
	}
	return nil
...
func (x *AgentSessionEvent_ToolExecutionUpdated) GetStarted() *AgentSessionEvent_ToolExecutionUpdated_Started {
	if x != nil {
		if x, ok := x.Update.(*AgentSessionEvent_ToolExecutionUpdated_Started_); ok {
			return x.Started
		}
	}
	return nil
...
func (x *AgentSessionEvent_ToolExecutionUpdated) GetCallUpdated() *AgentSessionEvent_ToolExecutionUpdated_CallUpdated {
	if x != nil {
		if x, ok := x.Update.(*AgentSessionEvent_ToolExecutionUpdated_CallUpdated_); ok {
...
func (x *AgentSessionEvent_ToolExecutionUpdated) GetReplyUpdated() *AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated {
	if x != nil {
		if x, ok := x.Update.(*AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated_); ok {
...
func (x *AgentSessionEvent_ToolExecutionUpdated) GetEnded() *AgentSessionEvent_ToolExecutionUpdated_Ended {
	if x != nil {
		if x, ok := x.Update.(*AgentSessionEvent_ToolExecutionUpdated_Ended_); ok {
			return x.Ended
		}
	}
	return nil
...
type isAgentSessionEvent_ToolExecutionUpdated_Update interface {
	isAgentSessionEvent_ToolExecutionUpdated_Update()
}

type AgentSessionEvent_ToolExecutionUpdated_Started_ struct {
	Started *AgentSessionEvent_ToolExecutionUpdated_Started `protobuf:"bytes,1,opt,name=started,proto3,oneof"`
}

type AgentSessionEvent_ToolExecutionUpdated_CallUpdated_ struct {
	CallUpdated *AgentSessionEvent_ToolExecutionUpdated_CallUpdated `protobuf:"bytes,2,opt,name=call_updated,json=callUpdated,proto3,oneof"`
}

type AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated_ struct {
	ReplyUpdated *AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated `protobuf:"bytes,3,opt,name=reply_updated,json=replyUpdated,proto3,oneof"`
}

type AgentSessionEvent_ToolExecutionUpdated_Ended_ struct {
	Ended *AgentSessionEvent_ToolExecutionUpdated_Ended `protobuf:"bytes,4,opt,name=ended,proto3,oneof"`
}

func (*AgentSessionEvent_ToolExecutionUpdated_Started_) isAgentSessionEvent_ToolExecutionUpdated_Update() {
}

func (*AgentSessionEvent_ToolExecutionUpdated_CallUpdated_) isAgentSessionEvent_ToolExecutionUpdated_Update() {
}

func (*AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated_) isAgentSessionEvent_ToolExecutionUpdated_Update() {
}

func (*AgentSessionEvent_ToolExecutionUpdated_Ended_) isAgentSessionEvent_ToolExecutionUpdated_Update() {
}
...
func (x *AgentSessionEvent_AgentFalseInterruption) Reset() {
	*x = AgentSessionEvent_AgentFalseInterruption{}
	mi := &file_agent_livekit_agent_session_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AgentSessionEvent_AgentFalseInterruption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AgentSessionEvent_AgentFalseInterruption) ProtoMessage() {}

func (x *AgentSessionEvent_AgentFalseInterruption) ProtoReflect() protoreflect.Message {
	mi := &file_agent_livekit_agent_session_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AgentSessionEvent_AgentFalseInterruption.ProtoReflect.Descriptor instead.
func (*AgentSessionEvent_AgentFalseInterruption) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 12}
}

func (x *AgentSessionEvent_AgentFalseInterruption) GetResumed() bool {
	if x != nil {
		return x.Resumed
	}
	return false
...
// The session has ended and answers no further input. Emitted for every close,
// including one the agent initiates itself (hanging up after a farewell), which
// a driver otherwise cannot tell apart from the agent falling silent.
type AgentSessionEvent_SessionClosed struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	Reason SessionCloseReason     `protobuf:"varint,1,opt,name=reason,proto3,enum=livekit.agent.SessionCloseReason" json:"reason,omitempty"`
...
func (x *AgentSessionEvent_SessionClosed) Reset() {
	*x = AgentSessionEvent_SessionClosed{}
	mi := &file_agent_livekit_agent_session_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AgentSessionEvent_SessionClosed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AgentSessionEvent_SessionClosed) ProtoMessage() {}

func (x *AgentSessionEvent_SessionClosed) ProtoReflect() protoreflect.Message {
	mi := &file_agent_livekit_agent_session_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AgentSessionEvent_SessionClosed.ProtoReflect.Descriptor instead.
func (*AgentSessionEvent_SessionClosed) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 13}
}

func (x *AgentSessionEvent_SessionClosed) GetReason() SessionCloseReason {
	if x != nil {
		return x.Reason
	}
	return SessionCloseReason_SC_UNKNOWN
}

func (x *AgentSessionEvent_SessionClosed) GetError() string {
	if x != nil && x.Error != nil {
		return *x.Error
	}
	return ""
...
func (x *AgentSessionEvent_ToolExecutionUpdated_Started) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use AgentSessionEvent_ToolExecutionUpdated_Started.ProtoReflect.Descriptor instead.
func (*AgentSessionEvent_ToolExecutionUpdated_Started) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 11, 0}
}
...
type AgentSessionEvent_ToolExecutionUpdated_CallUpdated struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *AgentSessionEvent_ToolExecutionUpdated_CallUpdated) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use AgentSessionEvent_ToolExecutionUpdated_CallUpdated.ProtoReflect.Descriptor instead.
func (*AgentSessionEvent_ToolExecutionUpdated_CallUpdated) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 11, 1}
}

func (x *AgentSessionEvent_ToolExecutionUpdated_CallUpdated) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *AgentSessionEvent_ToolExecutionUpdated_CallUpdated) GetCallId() string {
	if x != nil {
		return x.CallId
	}
	return ""
...
func (x *AgentSessionEvent_ToolExecutionUpdated_CallUpdated) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type AgentSessionEvent_ToolExecutionUpdated_Ended struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	Status        ToolCallStatus `protobuf:"varint,4,opt,name=status,proto3,enum=livekit.agent.ToolCallStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AgentSessionEvent_ToolExecutionUpdated_Ended) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use AgentSessionEvent_ToolExecutionUpdated_Ended.ProtoReflect.Descriptor instead.
func (*AgentSessionEvent_ToolExecutionUpdated_Ended) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 11, 2}
}

func (x *AgentSessionEvent_ToolExecutionUpdated_Ended) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *AgentSessionEvent_ToolExecutionUpdated_Ended) GetCallId() string {
	if x != nil {
		return x.CallId
	}
	return ""
...
func (x *AgentSessionEvent_ToolExecutionUpdated_Ended) GetMessage() string {
...
func (x *AgentSessionEvent_ToolExecutionUpdated_Ended) GetStatus() ToolCallStatus {
	if x != nil {
		return x.Status
	}
	return ToolCallStatus_TC_RUNNING
}

type AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// buffered update ids covered by this reply; one reply can span calls
	UpdateIds []string        `protobuf:"bytes,1,rep,name=update_ids,json=updateIds,proto3" json:"update_ids,omitempty"`
	Status    ToolReplyStatus `protobuf:"varint,2,opt,name=status,proto3,enum=livekit.agent.ToolReplyStatus" json:"status,omitempty"`
	// id of the speech that voices this reply
	SpeechId      string `protobuf:"bytes,3,opt,name=speech_id,json=speechId,proto3" json:"speech_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated.ProtoReflect.Descriptor instead.
func (*AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{16, 11, 3}
}

func (x *AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated) GetUpdateIds() []string {
	if x != nil {
		return x.UpdateIds
	}
	return nil
...
func (x *AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated) GetStatus() ToolReplyStatus {
	if x != nil {
		return x.Status
	}
	return ToolReplyStatus_TR_SCHEDULED
}

func (x *AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated) GetSpeechId() string {
	if x != nil {
		return x.SpeechId
	}
	return ""
...
func (*SessionRequest_Ping) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 0}
}
...
func (*SessionRequest_GetChatHistory) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 1}
}
...
func (*SessionRequest_RunInput) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 2}
}
...
func (*SessionRequest_GetAgentInfo) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 3}
}
...
func (*SessionRequest_GetSessionState) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 4}
}
...
func (*SessionRequest_GetRTCStats) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 5}
}
...
func (*SessionRequest_GetSessionUsage) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 6}
}
...
func (*SessionRequest_GetFrameworkInfo) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 7}
}
...
func (*SessionRequest_UpdateIO) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 8}
}

func (x *SessionRequest_UpdateIO) GetInput() *SessionRequest_UpdateIO_Input {
	if x != nil {
		return x.Input
	}
	return nil
...
func (x *SessionRequest_UpdateIO) GetOutput() *SessionRequest_UpdateIO_Output {
	if x != nil {
		return x.Output
	}
	return nil
...
type SessionRequest_FinalizeSimulation struct {
	...
	ProvisionalReason  string                 `protobuf:"bytes,2,opt,name=provisional_reason,json=provisionalReason,proto3" json:"provisional_reason,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *SessionRequest_FinalizeSimulation) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use SessionRequest_FinalizeSimulation.ProtoReflect.Descriptor instead.
func (*SessionRequest_FinalizeSimulation) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 9}
}

func (x *SessionRequest_FinalizeSimulation) GetProvisionalSuccess() bool {
	if x != nil {
		return x.ProvisionalSuccess
	}
	return false
}

func (x *SessionRequest_FinalizeSimulation) GetProvisionalReason() string {
	if x != nil {
		return x.ProvisionalReason
	}
	return ""
}
...
func (x *SessionRequest_UpdateIO_Input) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*SessionRequest_UpdateIO_Input) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 8, 0}
}
...
type SessionRequest_UpdateIO_Output struct {
	...
	AudioEnabled         *bool                  `protobuf:"varint,1,opt,name=audio_enabled,json=audioEnabled,proto3,oneof" json:"audio_enabled,omitempty"`
	VideoEnabled         *bool                  `protobuf:"varint,2,opt,name=video_enabled,json=videoEnabled,proto3,oneof" json:"video_enabled,omitempty"`
	TranscriptionEnabled *bool                  `protobuf:"varint,3,opt,name=transcription_enabled,json=transcriptionEnabled,proto3,oneof" json:"transcription_enabled,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *SessionRequest_UpdateIO_Output) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*SessionRequest_UpdateIO_Output) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 8, 1}
}
...
func (x *SessionRequest_UpdateIO_Output) GetTranscriptionEnabled() bool {
	if x != nil && x.TranscriptionEnabled != nil {
		return *x.TranscriptionEnabled
	}
	return false
}
...
func (*SessionResponse_Pong) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 0}
}
...
func (*SessionResponse_GetChatHistoryResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 1}
}
...
func (*SessionResponse_GetAgentInfoResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 2}
}
...
func (*SessionResponse_RunInputResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 3}
}
...
func (*SessionResponse_GetSessionStateResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 4}
}
...
func (*SessionResponse_GetRTCStatsResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 5}
}
...
func (*SessionResponse_GetSessionUsageResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 6}
}
...
func (*SessionResponse_GetFrameworkInfoResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 7}
}
...
func (x *SessionResponse_UpdateIOResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SessionResponse_FinalizeSimulationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use SessionResponse_FinalizeSimulationResponse.ProtoReflect.Descriptor instead.
func (*SessionResponse_FinalizeSimulationResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 9}
}

func (x *SessionResponse_FinalizeSimulationResponse) GetUserVerdict() *SessionResponse_FinalizeSimulationResponse_SimulationVerdict {
	if x != nil {
...
type SessionResponse_FinalizeSimulationResponse_SimulationVerdict struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SessionResponse_FinalizeSimulationResponse_SimulationVerdict) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use SessionResponse_FinalizeSimulationResponse_SimulationVerdict.ProtoReflect.Descriptor instead.
func (*SessionResponse_FinalizeSimulationResponse_SimulationVerdict) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 9, 0}
}

func (x *SessionResponse_FinalizeSimulationResponse_SimulationVerdict) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *SessionResponse_FinalizeSimulationResponse_SimulationVerdict) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (*AgentSessionMessage_ConsoleIO) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{19, 0}
}
...
func (*AgentSessionMessage_ConsoleIO_AudioFrame) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{19, 0, 0}
}
...
func (*AgentSessionMessage_ConsoleIO_AudioPlaybackFlush) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{19, 0, 1}
}
...
func (*AgentSessionMessage_ConsoleIO_AudioPlaybackClear) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{19, 0, 2}
}
...
func (*AgentSessionMessage_ConsoleIO_AudioPlaybackFinished) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{19, 0, 3}
}
...
const file_agent_livekit_agent_session_proto_rawDesc = "" +
	"\n" +
	"!agent/livekit_agent_session.proto\x12\rlivekit.agent\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x14logger/options.proto\"\xc0\x05\n" +
	"\rMetricsReport\x12J\n" +
	...
	"e2eLatency\x88\x01\x01\x12%\n" +
	"\fllm_node_tps\x18\t \x01(\x01H\x06R\n" +
	"llmNodeTps\x88\x01\x01\x12'\n" +
	"\rllm_node_ttfs\x18\n" +
	" \x01(\x01H\aR\vllmNodeTtfs\x88\x01\x01B\x16\n" +
	...
	"\finterruption\x18\x04 \x01(\v2%.livekit.agent.InterruptionModelUsageH\x00R\finterruption\x120\n" +
	"\x03eot\x18\x05 \x01(\v2\x1c.livekit.agent.EotModelUsageH\x00R\x03eotB\a\n" +
	"\x05usage\"O\n" +
	"\x11AgentSessionUsage\x12:\n" +
	"\vmodel_usage\x18\x01 \x03(\v2\x19.livekit.agent.ModelUsageR\n" +
	"modelUsage\"A\n" +
	"\fDebugMessage\x121\n" +
	"\apayload\x18\x01 \x01(\v2\x17.google.protobuf.StructR\apayload\"\x97!\n" +
	...
	"\x18agent_false_interruption\x18\x17 \x01(\v27.livekit.agent.AgentSessionEvent.AgentFalseInterruptionH\x00R\x16agentFalseInterruption\x12W\n" +
	"\x0esession_closed\x18\x18 \x01(\v2..livekit.agent.AgentSessionEvent.SessionClosedH\x00R\rsessionClosed\x1a\x83\x01\n" +
	...
	"\aresumed\x18\x01 \x01(\bR\aresumed\x1ao\n" +
	"\rSessionClosed\x129\n" +
	"\x06reason\x18\x01 \x01(\x0e2!.livekit.agent.SessionCloseReasonR\x06reason\x12\x19\n" +
	...
	"\x11get_session_usage\x18\t \x01(\v2-.livekit.agent.SessionRequest.GetSessionUsageH\x00R\x0fgetSessionUsage\x12^\n" +
	"\x12get_framework_info\x18\n" +
	" \x01(\v2..livekit.agent.SessionRequest.GetFrameworkInfoH\x00R\x10getFrameworkInfo\x12E\n" +
	"\tupdate_io\x18\v \x01(\v2&.livekit.agent.SessionRequest.UpdateIOH\x00R\bupdateIo\x12c\n" +
	"\x13finalize_simulation\x18\f \x01(\v20.livekit.agent.SessionRequest.FinalizeSimulationH\x00R\x12finalizeSimulation\x1a\x06\n" +
	"\x04Ping\x1a\x10\n" +
	...
	"\x10GetFrameworkInfo\x1a\x8c\x04\n" +
	"\bUpdateIO\x12G\n" +
	"\x05input\x18\x01 \x01(\v2,.livekit.agent.SessionRequest.UpdateIO.InputH\x00R\x05input\x88\x01\x01\x12J\n" +
	"\x06output\x18\x02 \x01(\v2-.livekit.agent.SessionRequest.UpdateIO.OutputH\x01R\x06output\x88\x01\x01\x1a\x7f\n" +
	"\x05Input\x12(\n" +
	"\raudio_enabled\x18\x01 \x01(\bH\x00R\faudioEnabled\x88\x01\x01\x12(\n" +
	"\rvideo_enabled\x18\x02 \x01(\bH\x01R\fvideoEnabled\x88\x01\x01B\x10\n" +
	"\x0e_audio_enabledB\x10\n" +
	"\x0e_video_enabled\x1a\xd4\x01\n" +
	"\x06Output\x12(\n" +
	"\raudio_enabled\x18\x01 \x01(\bH\x00R\faudioEnabled\x88\x01\x01\x12(\n" +
	"\rvideo_enabled\x18\x02 \x01(\bH\x01R\fvideoEnabled\x88\x01\x01\x128\n" +
	"\x15transcription_enabled\x18\x03 \x01(\bH\x02R\x14transcriptionEnabled\x88\x01\x01B\x10\n" +
	"\x0e_audio_enabledB\x10\n" +
	"\x0e_video_enabledB\x18\n" +
	"\x16_transcription_enabledB\b\n" +
	"\x06_inputB\t\n" +
	"\a_output\x1at\n" +
	...
	" \x01(\v26.livekit.agent.SessionResponse.GetSessionUsageResponseH\x00R\x0fgetSessionUsage\x12g\n" +
	"\x12get_framework_info\x18\v \x01(\v27.livekit.agent.SessionResponse.GetFrameworkInfoResponseH\x00R\x10getFrameworkInfo\x12N\n" +
	"\tupdate_io\x18\f \x01(\v2/.livekit.agent.SessionResponse.UpdateIOResponseH\x00R\bupdateIo\x12l\n" +
	"\x13finalize_simulation\x18\r \x01(\v29.livekit.agent.SessionResponse.FinalizeSimulationResponseH\x00R\x12finalizeSimulation\x1a\x06\n" +
	"\x04Pong\x1aS\n" +
	...
	"sdkVersion\x1a\x12\n" +
	"\x10UpdateIOResponse\x1a\xd3\x01\n" +
	"\x1aFinalizeSimulationResponse\x12n\n" +
	"\fuser_verdict\x18\x01 \x01(\v2K.livekit.agent.SessionResponse.FinalizeSimulationResponse.SimulationVerdictR\vuserVerdict\x1aE\n" +
	"\x11SimulationVerdict\x12\x18\n" +
	...
	"\n" +
	"TR_SKIPPED\x10\x03*\x96\x01\n" +
	"\x12SessionCloseReason\x12\x0e\n" +
	"\n" +
	"SC_UNKNOWN\x10\x00\x12\f\n" +
	"\bSC_ERROR\x10\x01\x12\x13\n" +
	"\x0fSC_JOB_SHUTDOWN\x10\x02\x12\x1f\n" +
	"\x1bSC_PARTICIPANT_DISCONNECTED\x10\x03\x12\x15\n" +
	"\x11SC_USER_INITIATED\x10\x04\x12\x15\n" +
	"\x11SC_TASK_COMPLETED\x10\x05*\x86\x01\n" +
	...
	"\rAMD_UNCERTAIN\x10\x05B+Z)github.com/livekit/protocol/livekit/agentb\x06proto3"
...
var file_agent_livekit_agent_session_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_agent_livekit_agent_session_proto_goTypes = []any{
	...
	(SessionCloseReason)(0),                                     // 5: livekit.agent.SessionCloseReason
	...
	(*AgentSessionEvent_SessionClosed)(nil),                     // 43: livekit.agent.AgentSessionEvent.SessionClosed
	(*AgentSessionEvent_ToolExecutionUpdated_Started)(nil),      // 44: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.Started
	(*AgentSessionEvent_ToolExecutionUpdated_CallUpdated)(nil),  // 45: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.CallUpdated
	(*AgentSessionEvent_ToolExecutionUpdated_Ended)(nil),        // 46: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.Ended
	(*AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated)(nil), // 47: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.ReplyUpdated
	(*SessionRequest_Ping)(nil),                                 // 48: livekit.agent.SessionRequest.Ping
	(*SessionRequest_GetChatHistory)(nil),                       // 49: livekit.agent.SessionRequest.GetChatHistory
	(*SessionRequest_RunInput)(nil),                             // 50: livekit.agent.SessionRequest.RunInput
	(*SessionRequest_GetAgentInfo)(nil),                         // 51: livekit.agent.SessionRequest.GetAgentInfo
	(*SessionRequest_GetSessionState)(nil),                      // 52: livekit.agent.SessionRequest.GetSessionState
	(*SessionRequest_GetRTCStats)(nil),                          // 53: livekit.agent.SessionRequest.GetRTCStats
	(*SessionRequest_GetSessionUsage)(nil),                      // 54: livekit.agent.SessionRequest.GetSessionUsage
	(*SessionRequest_GetFrameworkInfo)(nil),                     // 55: livekit.agent.SessionRequest.GetFrameworkInfo
	(*SessionRequest_UpdateIO)(nil),                             // 56: livekit.agent.SessionRequest.UpdateIO
	(*SessionRequest_FinalizeSimulation)(nil),                   // 57: livekit.agent.SessionRequest.FinalizeSimulation
	(*SessionRequest_UpdateIO_Input)(nil),                       // 58: livekit.agent.SessionRequest.UpdateIO.Input
	(*SessionRequest_UpdateIO_Output)(nil),                      // 59: livekit.agent.SessionRequest.UpdateIO.Output
	(*SessionResponse_Pong)(nil),                                // 60: livekit.agent.SessionResponse.Pong
	(*SessionResponse_GetChatHistoryResponse)(nil),              // 61: livekit.agent.SessionResponse.GetChatHistoryResponse
	(*SessionResponse_GetAgentInfoResponse)(nil),                // 62: livekit.agent.SessionResponse.GetAgentInfoResponse
	(*SessionResponse_RunInputResponse)(nil),                    // 63: livekit.agent.SessionResponse.RunInputResponse
	(*SessionResponse_GetSessionStateResponse)(nil),             // 64: livekit.agent.SessionResponse.GetSessionStateResponse
	(*SessionResponse_GetRTCStatsResponse)(nil),                 // 65: livekit.agent.SessionResponse.GetRTCStatsResponse
	(*SessionResponse_GetSessionUsageResponse)(nil),             // 66: livekit.agent.SessionResponse.GetSessionUsageResponse
	(*SessionResponse_GetFrameworkInfoResponse)(nil),            // 67: livekit.agent.SessionResponse.GetFrameworkInfoResponse
	(*SessionResponse_UpdateIOResponse)(nil),                    // 68: livekit.agent.SessionResponse.UpdateIOResponse
	(*SessionResponse_FinalizeSimulationResponse)(nil),          // 69: livekit.agent.SessionResponse.FinalizeSimulationResponse
	nil, // 70: livekit.agent.SessionResponse.GetSessionStateResponse.OptionsEntry
	(*SessionResponse_FinalizeSimulationResponse_SimulationVerdict)(nil), // 71: livekit.agent.SessionResponse.FinalizeSimulationResponse.SimulationVerdict
	(*AgentSessionMessage_ConsoleIO)(nil),                                // 72: livekit.agent.AgentSessionMessage.ConsoleIO
	(*AgentSessionMessage_ConsoleIO_AudioFrame)(nil),                     // 73: livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame
	(*AgentSessionMessage_ConsoleIO_AudioPlaybackFlush)(nil),             // 74: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFlush
	(*AgentSessionMessage_ConsoleIO_AudioPlaybackClear)(nil),             // 75: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackClear
	(*AgentSessionMessage_ConsoleIO_AudioPlaybackFinished)(nil),          // 76: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFinished
...
var file_agent_livekit_agent_session_proto_depIdxs = []int32{
	77,  // 0: livekit.agent.MetricsReport.started_speaking_at:type_name -> google.protobuf.Timestamp
	77,  // 1: livekit.agent.MetricsReport.stopped_speaking_at:type_name -> google.protobuf.Timestamp
	...
	77,  // 6: livekit.agent.ChatMessage.created_at:type_name -> google.protobuf.Timestamp
	77,  // 7: livekit.agent.FunctionCall.created_at:type_name -> google.protobuf.Timestamp
	77,  // 8: livekit.agent.FunctionCallOutput.created_at:type_name -> google.protobuf.Timestamp
	77,  // 9: livekit.agent.AgentHandoff.created_at:type_name -> google.protobuf.Timestamp
	77,  // 10: livekit.agent.AgentConfigUpdate.created_at:type_name -> google.protobuf.Timestamp
	...
	78,  // 18: livekit.agent.DebugMessage.payload:type_name -> google.protobuf.Struct
	77,  // 19: livekit.agent.AgentSessionEvent.created_at:type_name -> google.protobuf.Timestamp
	...
	43,  // 34: livekit.agent.AgentSessionEvent.session_closed:type_name -> livekit.agent.AgentSessionEvent.SessionClosed
	48,  // 35: livekit.agent.SessionRequest.ping:type_name -> livekit.agent.SessionRequest.Ping
	49,  // 36: livekit.agent.SessionRequest.get_chat_history:type_name -> livekit.agent.SessionRequest.GetChatHistory
	50,  // 37: livekit.agent.SessionRequest.run_input:type_name -> livekit.agent.SessionRequest.RunInput
	51,  // 38: livekit.agent.SessionRequest.get_agent_info:type_name -> livekit.agent.SessionRequest.GetAgentInfo
	52,  // 39: livekit.agent.SessionRequest.get_session_state:type_name -> livekit.agent.SessionRequest.GetSessionState
	53,  // 40: livekit.agent.SessionRequest.get_rtc_stats:type_name -> livekit.agent.SessionRequest.GetRTCStats
	54,  // 41: livekit.agent.SessionRequest.get_session_usage:type_name -> livekit.agent.SessionRequest.GetSessionUsage
	55,  // 42: livekit.agent.SessionRequest.get_framework_info:type_name -> livekit.agent.SessionRequest.GetFrameworkInfo
	56,  // 43: livekit.agent.SessionRequest.update_io:type_name -> livekit.agent.SessionRequest.UpdateIO
	57,  // 44: livekit.agent.SessionRequest.finalize_simulation:type_name -> livekit.agent.SessionRequest.FinalizeSimulation
	60,  // 45: livekit.agent.SessionResponse.pong:type_name -> livekit.agent.SessionResponse.Pong
	61,  // 46: livekit.agent.SessionResponse.get_chat_history:type_name -> livekit.agent.SessionResponse.GetChatHistoryResponse
	63,  // 47: livekit.agent.SessionResponse.run_input:type_name -> livekit.agent.SessionResponse.RunInputResponse
	62,  // 48: livekit.agent.SessionResponse.get_agent_info:type_name -> livekit.agent.SessionResponse.GetAgentInfoResponse
	64,  // 49: livekit.agent.SessionResponse.get_session_state:type_name -> livekit.agent.SessionResponse.GetSessionStateResponse
	65,  // 50: livekit.agent.SessionResponse.get_rtc_stats:type_name -> livekit.agent.SessionResponse.GetRTCStatsResponse
	66,  // 51: livekit.agent.SessionResponse.get_session_usage:type_name -> livekit.agent.SessionResponse.GetSessionUsageResponse
	67,  // 52: livekit.agent.SessionResponse.get_framework_info:type_name -> livekit.agent.SessionResponse.GetFrameworkInfoResponse
	68,  // 53: livekit.agent.SessionResponse.update_io:type_name -> livekit.agent.SessionResponse.UpdateIOResponse
	69,  // 54: livekit.agent.SessionResponse.finalize_simulation:type_name -> livekit.agent.SessionResponse.FinalizeSimulationResponse
	73,  // 55: livekit.agent.AgentSessionMessage.audio_input:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame
	73,  // 56: livekit.agent.AgentSessionMessage.audio_output:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame
	23,  // 57: livekit.agent.AgentSessionMessage.event:type_name -> livekit.agent.AgentSessionEvent
	24,  // 58: livekit.agent.AgentSessionMessage.request:type_name -> livekit.agent.SessionRequest
	25,  // 59: livekit.agent.AgentSessionMessage.response:type_name -> livekit.agent.SessionResponse
	74,  // 60: livekit.agent.AgentSessionMessage.audio_playback_flush:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFlush
	75,  // 61: livekit.agent.AgentSessionMessage.audio_playback_clear:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackClear
	76,  // 62: livekit.agent.AgentSessionMessage.audio_playback_finished:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFinished
	9,   // 63: livekit.agent.ChatContext.ChatItem.message:type_name -> livekit.agent.ChatMessage
	10,  // 64: livekit.agent.ChatContext.ChatItem.function_call:type_name -> livekit.agent.FunctionCall
	11,  // 65: livekit.agent.ChatContext.ChatItem.function_call_output:type_name -> livekit.agent.FunctionCallOutput
	12,  // 66: livekit.agent.ChatContext.ChatItem.agent_handoff:type_name -> livekit.agent.AgentHandoff
	13,  // 67: livekit.agent.ChatContext.ChatItem.agent_config_update:type_name -> livekit.agent.AgentConfigUpdate
	1,   // 68: livekit.agent.AgentSessionEvent.AgentStateChanged.old_state:type_name -> livekit.agent.AgentState
	1,   // 69: livekit.agent.AgentSessionEvent.AgentStateChanged.new_state:type_name -> livekit.agent.AgentState
	2,   // 70: livekit.agent.AgentSessionEvent.UserStateChanged.old_state:type_name -> livekit.agent.UserState
	2,   // 71: livekit.agent.AgentSessionEvent.UserStateChanged.new_state:type_name -> livekit.agent.UserState
	29,  // 72: livekit.agent.AgentSessionEvent.ConversationItemAdded.item:type_name -> livekit.agent.ChatContext.ChatItem
	10,  // 73: livekit.agent.AgentSessionEvent.FunctionToolsStarted.function_calls:type_name -> livekit.agent.FunctionCall
	10,  // 74: livekit.agent.AgentSessionEvent.FunctionToolsExecuted.function_calls:type_name -> livekit.agent.FunctionCall
	11,  // 75: livekit.agent.AgentSessionEvent.FunctionToolsExecuted.function_call_outputs:type_name -> livekit.agent.FunctionCallOutput
	77,  // 76: livekit.agent.AgentSessionEvent.OverlappingSpeech.overlap_started_at:type_name -> google.protobuf.Timestamp
	77,  // 77: livekit.agent.AgentSessionEvent.OverlappingSpeech.detected_at:type_name -> google.protobuf.Timestamp
	79,  // 78: livekit.agent.AgentSessionEvent.AmdPrediction.speech_duration:type_name -> google.protobuf.Duration
	6,   // 79: livekit.agent.AgentSessionEvent.AmdPrediction.category:type_name -> livekit.agent.AmdCategory
	79,  // 80: livekit.agent.AgentSessionEvent.AmdPrediction.delay:type_name -> google.protobuf.Duration
	79,  // 81: livekit.agent.AgentSessionEvent.EotPrediction.inference_duration:type_name -> google.protobuf.Duration
	79,  // 82: livekit.agent.AgentSessionEvent.EotPrediction.delay:type_name -> google.protobuf.Duration
	21,  // 83: livekit.agent.AgentSessionEvent.SessionUsageUpdated.usage:type_name -> livekit.agent.AgentSessionUsage
	44,  // 84: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.started:type_name -> livekit.agent.AgentSessionEvent.ToolExecutionUpdated.Started
	45,  // 85: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.call_updated:type_name -> livekit.agent.AgentSessionEvent.ToolExecutionUpdated.CallUpdated
	47,  // 86: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.reply_updated:type_name -> livekit.agent.AgentSessionEvent.ToolExecutionUpdated.ReplyUpdated
	46,  // 87: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.ended:type_name -> livekit.agent.AgentSessionEvent.ToolExecutionUpdated.Ended
	5,   // 88: livekit.agent.AgentSessionEvent.SessionClosed.reason:type_name -> livekit.agent.SessionCloseReason
	10,  // 89: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.Started.function_call:type_name -> livekit.agent.FunctionCall
	3,   // 90: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.Ended.status:type_name -> livekit.agent.ToolCallStatus
	4,   // 91: livekit.agent.AgentSessionEvent.ToolExecutionUpdated.ReplyUpdated.status:type_name -> livekit.agent.ToolReplyStatus
	58,  // 92: livekit.agent.SessionRequest.UpdateIO.input:type_name -> livekit.agent.SessionRequest.UpdateIO.Input
	59,  // 93: livekit.agent.SessionRequest.UpdateIO.output:type_name -> livekit.agent.SessionRequest.UpdateIO.Output
	29,  // 94: livekit.agent.SessionResponse.GetChatHistoryResponse.items:type_name -> livekit.agent.ChatContext.ChatItem
	29,  // 95: livekit.agent.SessionResponse.GetAgentInfoResponse.chat_ctx:type_name -> livekit.agent.ChatContext.ChatItem
	29,  // 96: livekit.agent.SessionResponse.RunInputResponse.items:type_name -> livekit.agent.ChatContext.ChatItem
	1,   // 97: livekit.agent.SessionResponse.GetSessionStateResponse.agent_state:type_name -> livekit.agent.AgentState
	2,   // 98: livekit.agent.SessionResponse.GetSessionStateResponse.user_state:type_name -> livekit.agent.UserState
	70,  // 99: livekit.agent.SessionResponse.GetSessionStateResponse.options:type_name -> livekit.agent.SessionResponse.GetSessionStateResponse.OptionsEntry
	77,  // 100: livekit.agent.SessionResponse.GetSessionStateResponse.created_at:type_name -> google.protobuf.Timestamp
	78,  // 101: livekit.agent.SessionResponse.GetRTCStatsResponse.publisher_stats:type_name -> google.protobuf.Struct
	78,  // 102: livekit.agent.SessionResponse.GetRTCStatsResponse.subscriber_stats:type_name -> google.protobuf.Struct
	21,  // 103: livekit.agent.SessionResponse.GetSessionUsageResponse.usage:type_name -> livekit.agent.AgentSessionUsage
	77,  // 104: livekit.agent.SessionResponse.GetSessionUsageResponse.created_at:type_name -> google.protobuf.Timestamp
	71,  // 105: livekit.agent.SessionResponse.FinalizeSimulationResponse.user_verdict:type_name -> livekit.agent.SessionResponse.FinalizeSimulationResponse.SimulationVerdict
...
func file_agent_livekit_agent_session_proto_init() {
	...
	file_agent_livekit_agent_session_proto_msgTypes[2].OneofWrappers = []any{}
	...
	file_agent_livekit_agent_session_proto_msgTypes[16].OneofWrappers = []any{
		...
		(*AgentSessionEvent_SessionClosed_)(nil),
	}
	file_agent_livekit_agent_session_proto_msgTypes[17].OneofWrappers = []any{
		...
		(*SessionRequest_UpdateIo)(nil),
		(*SessionRequest_FinalizeSimulation_)(nil),
	}
	file_agent_livekit_agent_session_proto_msgTypes[18].OneofWrappers = []any{
		...
		(*SessionResponse_UpdateIo)(nil),
		(*SessionResponse_FinalizeSimulation)(nil),
	}
	...
	file_agent_livekit_agent_session_proto_msgTypes[22].OneofWrappers = []any{
	...
	file_agent_livekit_agent_session_proto_msgTypes[34].OneofWrappers = []any{
		(*AgentSessionEvent_ToolExecutionUpdated_Started_)(nil),
		(*AgentSessionEvent_ToolExecutionUpdated_CallUpdated_)(nil),
		(*AgentSessionEvent_ToolExecutionUpdated_ReplyUpdated_)(nil),
		(*AgentSessionEvent_ToolExecutionUpdated_Ended_)(nil),
	}
	file_agent_livekit_agent_session_proto_msgTypes[36].OneofWrappers = []any{}
	file_agent_livekit_agent_session_proto_msgTypes[39].OneofWrappers = []any{}
	file_agent_livekit_agent_session_proto_msgTypes[49].OneofWrappers = []any{}
	...
	file_agent_livekit_agent_session_proto_msgTypes[55].OneofWrappers = []any{}
	type x struct{}
