...
type SessionRequest struct {
	...
	//	*SessionRequest_SimulationFinalize_
...
func (x *SessionRequest) GetSimulationFinalize() *SessionRequest_SimulationFinalize {
	if x != nil {
		if x, ok := x.Request.(*SessionRequest_SimulationFinalize_); ok {
			return x.SimulationFinalize
		}
	}
	return nil
}
...
type SessionRequest_SimulationFinalize_ struct {
	SimulationFinalize *SessionRequest_SimulationFinalize `protobuf:"bytes,12,opt,name=simulation_finalize,json=simulationFinalize,proto3,oneof"`
}
...
func (*SessionRequest_SimulationFinalize_) isSessionRequest_Request() {}
...
type SessionResponse struct {
	...
	//	*SessionResponse_SimulationFinalize
...
func (x *SessionResponse) GetSimulationFinalize() *SessionResponse_SimulationFinalizeResponse {
	if x != nil {
		if x, ok := x.Response.(*SessionResponse_SimulationFinalize); ok {
			return x.SimulationFinalize
		}
	}
	return nil
...
type SessionResponse_SimulationFinalize struct {
	SimulationFinalize *SessionResponse_SimulationFinalizeResponse `protobuf:"bytes,13,opt,name=simulation_finalize,json=simulationFinalize,proto3,oneof"`
}
...
func (*SessionResponse_SimulationFinalize) isSessionResponse_Response() {}
...
type SessionRequest_SimulationFinalize struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SessionRequest_SimulationFinalize) Reset() {
	*x = SessionRequest_SimulationFinalize{}
	mi := &file_agent_livekit_agent_session_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SessionRequest_SimulationFinalize) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionRequest_SimulationFinalize) ProtoMessage() {}

func (x *SessionRequest_SimulationFinalize) ProtoReflect() protoreflect.Message {
	mi := &file_agent_livekit_agent_session_proto_msgTypes[43]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionRequest_SimulationFinalize.ProtoReflect.Descriptor instead.
func (*SessionRequest_SimulationFinalize) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{17, 9}
}

func (x *SessionRequest_SimulationFinalize) GetProvisionalSuccess() bool {
	if x != nil {
...
func (x *SessionRequest_SimulationFinalize) GetProvisionalReason() string {
	if x != nil {
...
// The agent's final verdict, returned in response to SimulationFinalize.
// If the agent did not override, success/reason echo the provisional values.
type SessionResponse_SimulationFinalizeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SessionResponse_SimulationFinalizeResponse) Reset() {
	*x = SessionResponse_SimulationFinalizeResponse{}
	mi := &file_agent_livekit_agent_session_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SessionResponse_SimulationFinalizeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionResponse_SimulationFinalizeResponse) ProtoMessage() {}

func (x *SessionResponse_SimulationFinalizeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_agent_livekit_agent_session_proto_msgTypes[55]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionResponse_SimulationFinalizeResponse.ProtoReflect.Descriptor instead.
func (*SessionResponse_SimulationFinalizeResponse) Descriptor() ([]byte, []int) {
	return file_agent_livekit_agent_session_proto_rawDescGZIP(), []int{18, 9}
}

func (x *SessionResponse_SimulationFinalizeResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *SessionResponse_SimulationFinalizeResponse) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *SessionResponse_SimulationFinalizeResponse) GetOverridden() bool {
	if x != nil {
		return x.Overridden
	}
	return false
...
const file_agent_livekit_agent_session_proto_rawDesc = "" +
	...
	"\x13simulation_finalize\x18\f \x01(\v20.livekit.agent.SessionRequest.SimulationFinalizeH\x00R\x12simulationFinalize\x1a\x06\n" +
	"\x04Ping\x1a\x10\n" +
	...
	"\x13simulation_finalize\x18\r \x01(\v29.livekit.agent.SessionResponse.SimulationFinalizeResponseH\x00R\x12simulationFinalize\x1a\x06\n" +
	"\x04Pong\x1aS\n" +
	...
	"\x1aSimulationFinalizeResponse\x12\x18\n" +
...
var file_agent_livekit_agent_session_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_agent_livekit_agent_session_proto_goTypes = []any{
	...
	(*SessionRequest_SimulationFinalize)(nil),          // 47: livekit.agent.SessionRequest.SimulationFinalize
	...
	(*SessionResponse_SimulationFinalizeResponse)(nil), // 59: livekit.agent.SessionResponse.SimulationFinalizeResponse
	nil,                                   // 60: livekit.agent.SessionResponse.GetSessionStateResponse.OptionsEntry
	(*AgentSessionMessage_ConsoleIO)(nil), // 61: livekit.agent.AgentSessionMessage.ConsoleIO
	(*AgentSessionMessage_ConsoleIO_AudioFrame)(nil),            // 62: livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame
	(*AgentSessionMessage_ConsoleIO_AudioPlaybackFlush)(nil),    // 63: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFlush
	(*AgentSessionMessage_ConsoleIO_AudioPlaybackClear)(nil),    // 64: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackClear
	(*AgentSessionMessage_ConsoleIO_AudioPlaybackFinished)(nil), // 65: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFinished
...
var file_agent_livekit_agent_session_proto_depIdxs = []int32{
	66, // 0: livekit.agent.MetricsReport.started_speaking_at:type_name -> google.protobuf.Timestamp
	66, // 1: livekit.agent.MetricsReport.stopped_speaking_at:type_name -> google.protobuf.Timestamp
	...
	66, // 6: livekit.agent.ChatMessage.created_at:type_name -> google.protobuf.Timestamp
	66, // 7: livekit.agent.FunctionCall.created_at:type_name -> google.protobuf.Timestamp
	66, // 8: livekit.agent.FunctionCallOutput.created_at:type_name -> google.protobuf.Timestamp
	66, // 9: livekit.agent.AgentHandoff.created_at:type_name -> google.protobuf.Timestamp
	66, // 10: livekit.agent.AgentConfigUpdate.created_at:type_name -> google.protobuf.Timestamp
	...
	67, // 18: livekit.agent.DebugMessage.payload:type_name -> google.protobuf.Struct
	66, // 19: livekit.agent.AgentSessionEvent.created_at:type_name -> google.protobuf.Timestamp
	...
	47, // 41: livekit.agent.SessionRequest.simulation_finalize:type_name -> livekit.agent.SessionRequest.SimulationFinalize
	...
	59, // 51: livekit.agent.SessionResponse.simulation_finalize:type_name -> livekit.agent.SessionResponse.SimulationFinalizeResponse
	62, // 52: livekit.agent.AgentSessionMessage.audio_input:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame
	62, // 53: livekit.agent.AgentSessionMessage.audio_output:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame
	...
	63, // 57: livekit.agent.AgentSessionMessage.audio_playback_flush:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFlush
	64, // 58: livekit.agent.AgentSessionMessage.audio_playback_clear:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackClear
	65, // 59: livekit.agent.AgentSessionMessage.audio_playback_finished:type_name -> livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFinished
	...
	66, // 73: livekit.agent.AgentSessionEvent.OverlappingSpeech.overlap_started_at:type_name -> google.protobuf.Timestamp
	66, // 74: livekit.agent.AgentSessionEvent.OverlappingSpeech.detected_at:type_name -> google.protobuf.Timestamp
	68, // 75: livekit.agent.AgentSessionEvent.AmdPrediction.speech_duration:type_name -> google.protobuf.Duration
	3,  // 76: livekit.agent.AgentSessionEvent.AmdPrediction.category:type_name -> livekit.agent.AmdCategory
	68, // 77: livekit.agent.AgentSessionEvent.AmdPrediction.delay:type_name -> google.protobuf.Duration
	68, // 78: livekit.agent.AgentSessionEvent.EotPrediction.inference_duration:type_name -> google.protobuf.Duration
	68, // 79: livekit.agent.AgentSessionEvent.EotPrediction.delay:type_name -> google.protobuf.Duration
	...
	66, // 89: livekit.agent.SessionResponse.GetSessionStateResponse.created_at:type_name -> google.protobuf.Timestamp
	67, // 90: livekit.agent.SessionResponse.GetRTCStatsResponse.publisher_stats:type_name -> google.protobuf.Struct
	67, // 91: livekit.agent.SessionResponse.GetRTCStatsResponse.subscriber_stats:type_name -> google.protobuf.Struct
	18, // 92: livekit.agent.SessionResponse.GetSessionUsageResponse.usage:type_name -> livekit.agent.AgentSessionUsage
	66, // 93: livekit.agent.SessionResponse.GetSessionUsageResponse.created_at:type_name -> google.protobuf.Timestamp
...
func file_agent_livekit_agent_session_proto_init() {
	...
	file_agent_livekit_agent_session_proto_msgTypes[17].OneofWrappers = []any{
		...
		(*SessionRequest_SimulationFinalize_)(nil),
	}
	file_agent_livekit_agent_session_proto_msgTypes[18].OneofWrappers = []any{
		...
		(*SessionResponse_SimulationFinalize)(nil),
	}
