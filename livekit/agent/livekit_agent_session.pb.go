...
func (x *AgentSessionMessage) GetAudioPlaybackFlush() *AgentSessionMessage_AudioPlaybackFlush {
	if x != nil {
		if x, ok := x.Message.(*AgentSessionMessage_AudioPlaybackFlush_); ok {
...
func (x *AgentSessionMessage) GetAudioPlaybackClear() *AgentSessionMessage_AudioPlaybackClear {
	if x != nil {
		if x, ok := x.Message.(*AgentSessionMessage_AudioPlaybackClear_); ok {
...
func (x *AgentSessionMessage) GetAudioPlaybackFinished() *AgentSessionMessage_AudioPlaybackFinished {
	if x != nil {
		if x, ok := x.Message.(*AgentSessionMessage_AudioPlaybackFinished_); ok {
...
const file_agent_livekit_agent_session_proto_rawDesc = "" +
	...
	"\bresponseB\b\n" +
	"\x06_error\"\x9f\a\n" +
	"\x13AgentSessionMessage\x12P\n" +
	"\vaudio_input\x18\x01 \x01(\v2-.livekit.agent.AgentSessionMessage.AudioFrameH\x00R\n" +
	"audioInput\x12R\n" +
	"\faudio_output\x18\x02 \x01(\v2-.livekit.agent.AgentSessionMessage.AudioFrameH\x00R\vaudioOutput\x128\n" +
	...
	"\bresponse\x18\x05 \x01(\v2\x1e.livekit.agent.SessionResponseH\x00R\bresponse\x12i\n" +
	"\x14audio_playback_flush\x18\x06 \x01(\v25.livekit.agent.AgentSessionMessage.AudioPlaybackFlushH\x00R\x12audioPlaybackFlush\x12i\n" +
	"\x14audio_playback_clear\x18\a \x01(\v25.livekit.agent.AgentSessionMessage.AudioPlaybackClearH\x00R\x12audioPlaybackClear\x12r\n" +
	"\x17audio_playback_finished\x18\b \x01(\v28.livekit.agent.AgentSessionMessage.AudioPlaybackFinishedH\x00R\x15audioPlaybackFinished\x1a\x94\x01\n" +
	"\n" +
	"AudioFrame\x12\x12\n" +
