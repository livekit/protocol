...
type StartEgressRequest struct {
	...
	//	*StartEgressRequest_FileAndStream
...
func (x *StartEgressRequest) GetFileAndStream() *FileAndStreamEgressRequest {
	if x, ok := x.GetRequest().(*StartEgressRequest_FileAndStream); ok {
...
type StartEgressRequest_FileAndStream struct {
	FileAndStream *FileAndStreamEgressRequest `protobuf:"bytes,8,opt,name=file_and_stream,json=fileAndStream,proto3,oneof"` //adding our new egress request
}
...
func (*StartEgressRequest_FileAndStream) isStartEgressRequest_Request() {}
...
var file_livekit_rpc_internal_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xfa, 0x03, 0x0a, 0x12, 0x53, 0x74, 0x61, 0x72, 0x74, 0x45, 0x67, 0x72, 0x65,
	...
	0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x65, 0x6e, 0x64, 0x65, 0x72,
	...
	0x4d, 0x0a, 0x0f, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x61, 0x6e, 0x64, 0x5f, 0x73, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b,
	0x69, 0x74, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x41, 0x6e, 0x64, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52,
	0x0d, 0x66, 0x69, 0x6c, 0x65, 0x41, 0x6e, 0x64, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x17,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x15, 0x0a,
	0x06, 0x77, 0x73, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x77,
...
var file_livekit_rpc_internal_proto_goTypes = []interface{}{
	...
	(*FileAndStreamEgressRequest)(nil),  // 11: livekit.FileAndStreamEgressRequest
...
var file_livekit_rpc_internal_proto_depIdxs = []int32{
	...
	11, // 3: livekit.StartEgressRequest.file_and_stream:type_name -> livekit.FileAndStreamEgressRequest
...
func file_livekit_rpc_internal_proto_init() {
	...
	file_livekit_rpc_internal_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*StartEgressRequest_FileAndStream)(nil),
	}
