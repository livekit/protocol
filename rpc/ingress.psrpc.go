...
func NewIngressInternalServer(serverID string, svc IngressInternalServerImpl, bus psrpc.MessageBus, opts ...psrpc.ServerOption) (IngressInternalServer, error) {
	...
	var err error
	err = psrpc.RegisterHandler(s, "ListActiveIngress", nil, svc.ListActiveIngress, nil, false)
	if err != nil {
		s.Close(false)
		return nil, err
	}
...
func (s *ingressHandlerServer) RegisterUpdateIngressTopic(topic string) error {
	return psrpc.RegisterHandler(s.rpc, "UpdateIngress", []string{topic}, s.svc.UpdateIngress, nil, true)
}
...
func (s *ingressHandlerServer) RegisterDeleteIngressTopic(topic string) error {
	return psrpc.RegisterHandler(s.rpc, "DeleteIngress", []string{topic}, s.svc.DeleteIngress, nil, true)
}
