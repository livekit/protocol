...
func NewParticipantClient[ParticipantTopicType ~string](clientID string, bus psrpc.MessageBus, opts ...psrpc.ClientOption) (ParticipantClient[ParticipantTopicType], error) {
...
func NewParticipantServer[ParticipantTopicType ~string](serverID string, svc ParticipantServerImpl, bus psrpc.MessageBus, opts ...psrpc.ServerOption) (ParticipantServer[ParticipantTopicType], error) {
	sd := &info.ServiceDefinition{
		Name: "Participant",
		ID:   serverID,
	}
