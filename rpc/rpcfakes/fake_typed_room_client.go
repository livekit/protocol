...
type FakeTypedRoomClient struct {
	DeleteRoomStub        func(context.Context, livekit.RoomTopic, *livekit.DeleteRoomRequest, ...psrpc.RequestOption) (*livekit.DeleteRoomResponse, error)
	deleteRoomMutex       sync.RWMutex
	deleteRoomArgsForCall []struct {
		arg1 context.Context
		arg2 livekit.RoomTopic
	...
	MutePublishedTrackStub        func(context.Context, livekit.ParticipantTopic, *livekit.MuteRoomTrackRequest, ...psrpc.RequestOption) (*livekit.MuteRoomTrackResponse, error)
	mutePublishedTrackMutex       sync.RWMutex
	mutePublishedTrackArgsForCall []struct {
		arg1 context.Context
		arg2 livekit.ParticipantTopic
	...
	RemoveParticipantStub        func(context.Context, livekit.ParticipantTopic, *livekit.RoomParticipantIdentity, ...psrpc.RequestOption) (*livekit.RemoveParticipantResponse, error)
	...
	SendDataStub        func(context.Context, livekit.RoomTopic, *livekit.SendDataRequest, ...psrpc.RequestOption) (*livekit.SendDataResponse, error)
	...
	UpdateParticipantStub        func(context.Context, livekit.ParticipantTopic, *livekit.UpdateParticipantRequest, ...psrpc.RequestOption) (*livekit.ParticipantInfo, error)
	...
	UpdateRoomMetadataStub        func(context.Context, livekit.RoomTopic, *livekit.UpdateRoomMetadataRequest, ...psrpc.RequestOption) (*livekit.Room, error)
	...
	UpdateSubscriptionsStub        func(context.Context, livekit.ParticipantTopic, *livekit.UpdateSubscriptionsRequest, ...psrpc.RequestOption) (*livekit.UpdateSubscriptionsResponse, error)
...
func (fake *FakeTypedRoomClient) DeleteRoom(arg1 context.Context, arg2 livekit.RoomTopic, arg3 *livekit.DeleteRoomRequest, arg4 ...psrpc.RequestOption) (*livekit.DeleteRoomResponse, error) {
...
func (fake *FakeTypedRoomClient) DeleteRoomCalls(stub func(context.Context, livekit.RoomTopic, *livekit.DeleteRoomRequest, ...psrpc.RequestOption) (*livekit.DeleteRoomResponse, error)) {
	fake.deleteRoomMutex.Lock()
	defer fake.deleteRoomMutex.Unlock()
	fake.DeleteRoomStub = stub
}

func (fake *FakeTypedRoomClient) DeleteRoomArgsForCall(i int) (context.Context, livekit.RoomTopic, *livekit.DeleteRoomRequest, []psrpc.RequestOption) {
	fake.deleteRoomMutex.RLock()
	defer fake.deleteRoomMutex.RUnlock()
...
func (fake *FakeTypedRoomClient) MutePublishedTrack(arg1 context.Context, arg2 livekit.ParticipantTopic, arg3 *livekit.MuteRoomTrackRequest, arg4 ...psrpc.RequestOption) (*livekit.MuteRoomTrackResponse, error) {
...
func (fake *FakeTypedRoomClient) MutePublishedTrackCalls(stub func(context.Context, livekit.ParticipantTopic, *livekit.MuteRoomTrackRequest, ...psrpc.RequestOption) (*livekit.MuteRoomTrackResponse, error)) {
	fake.mutePublishedTrackMutex.Lock()
	defer fake.mutePublishedTrackMutex.Unlock()
	fake.MutePublishedTrackStub = stub
}

func (fake *FakeTypedRoomClient) MutePublishedTrackArgsForCall(i int) (context.Context, livekit.ParticipantTopic, *livekit.MuteRoomTrackRequest, []psrpc.RequestOption) {
	fake.mutePublishedTrackMutex.RLock()
	defer fake.mutePublishedTrackMutex.RUnlock()
...
func (fake *FakeTypedRoomClient) RemoveParticipant(arg1 context.Context, arg2 livekit.ParticipantTopic, arg3 *livekit.RoomParticipantIdentity, arg4 ...psrpc.RequestOption) (*livekit.RemoveParticipantResponse, error) {
...
func (fake *FakeTypedRoomClient) RemoveParticipantCalls(stub func(context.Context, livekit.ParticipantTopic, *livekit.RoomParticipantIdentity, ...psrpc.RequestOption) (*livekit.RemoveParticipantResponse, error)) {
	fake.removeParticipantMutex.Lock()
	defer fake.removeParticipantMutex.Unlock()
	fake.RemoveParticipantStub = stub
}

func (fake *FakeTypedRoomClient) RemoveParticipantArgsForCall(i int) (context.Context, livekit.ParticipantTopic, *livekit.RoomParticipantIdentity, []psrpc.RequestOption) {
	fake.removeParticipantMutex.RLock()
	defer fake.removeParticipantMutex.RUnlock()
...
func (fake *FakeTypedRoomClient) SendData(arg1 context.Context, arg2 livekit.RoomTopic, arg3 *livekit.SendDataRequest, arg4 ...psrpc.RequestOption) (*livekit.SendDataResponse, error) {
...
func (fake *FakeTypedRoomClient) SendDataCalls(stub func(context.Context, livekit.RoomTopic, *livekit.SendDataRequest, ...psrpc.RequestOption) (*livekit.SendDataResponse, error)) {
	fake.sendDataMutex.Lock()
	defer fake.sendDataMutex.Unlock()
	fake.SendDataStub = stub
}

func (fake *FakeTypedRoomClient) SendDataArgsForCall(i int) (context.Context, livekit.RoomTopic, *livekit.SendDataRequest, []psrpc.RequestOption) {
	fake.sendDataMutex.RLock()
	defer fake.sendDataMutex.RUnlock()
...
func (fake *FakeTypedRoomClient) UpdateParticipant(arg1 context.Context, arg2 livekit.ParticipantTopic, arg3 *livekit.UpdateParticipantRequest, arg4 ...psrpc.RequestOption) (*livekit.ParticipantInfo, error) {
...
func (fake *FakeTypedRoomClient) UpdateParticipantCalls(stub func(context.Context, livekit.ParticipantTopic, *livekit.UpdateParticipantRequest, ...psrpc.RequestOption) (*livekit.ParticipantInfo, error)) {
	fake.updateParticipantMutex.Lock()
	defer fake.updateParticipantMutex.Unlock()
	fake.UpdateParticipantStub = stub
}

func (fake *FakeTypedRoomClient) UpdateParticipantArgsForCall(i int) (context.Context, livekit.ParticipantTopic, *livekit.UpdateParticipantRequest, []psrpc.RequestOption) {
	fake.updateParticipantMutex.RLock()
	defer fake.updateParticipantMutex.RUnlock()
...
func (fake *FakeTypedRoomClient) UpdateRoomMetadata(arg1 context.Context, arg2 livekit.RoomTopic, arg3 *livekit.UpdateRoomMetadataRequest, arg4 ...psrpc.RequestOption) (*livekit.Room, error) {
...
func (fake *FakeTypedRoomClient) UpdateRoomMetadataCalls(stub func(context.Context, livekit.RoomTopic, *livekit.UpdateRoomMetadataRequest, ...psrpc.RequestOption) (*livekit.Room, error)) {
	fake.updateRoomMetadataMutex.Lock()
	defer fake.updateRoomMetadataMutex.Unlock()
	fake.UpdateRoomMetadataStub = stub
}

func (fake *FakeTypedRoomClient) UpdateRoomMetadataArgsForCall(i int) (context.Context, livekit.RoomTopic, *livekit.UpdateRoomMetadataRequest, []psrpc.RequestOption) {
	fake.updateRoomMetadataMutex.RLock()
	defer fake.updateRoomMetadataMutex.RUnlock()
...
func (fake *FakeTypedRoomClient) UpdateSubscriptions(arg1 context.Context, arg2 livekit.ParticipantTopic, arg3 *livekit.UpdateSubscriptionsRequest, arg4 ...psrpc.RequestOption) (*livekit.UpdateSubscriptionsResponse, error) {
...
func (fake *FakeTypedRoomClient) UpdateSubscriptionsCalls(stub func(context.Context, livekit.ParticipantTopic, *livekit.UpdateSubscriptionsRequest, ...psrpc.RequestOption) (*livekit.UpdateSubscriptionsResponse, error)) {
	fake.updateSubscriptionsMutex.Lock()
	defer fake.updateSubscriptionsMutex.Unlock()
	fake.UpdateSubscriptionsStub = stub
}

func (fake *FakeTypedRoomClient) UpdateSubscriptionsArgsForCall(i int) (context.Context, livekit.ParticipantTopic, *livekit.UpdateSubscriptionsRequest, []psrpc.RequestOption) {
	fake.updateSubscriptionsMutex.RLock()
	defer fake.updateSubscriptionsMutex.RUnlock()
