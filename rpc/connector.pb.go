...
const file_rpc_connector_proto_rawDesc = "" +
	"\n" +
	"\x13rpc/connector.proto\x12\x03rpc\x1a\roptions.proto\x1a\x17livekit_connector.proto\"\x9e\x01\n" +
	...
	"\n" +
	"project_id\x18\x03 \x01(\tR\tprojectId2\xe7\x01\n" +
	"\x11ConnectorInternal\x12e\n" +
	"\x10DialWhatsAppCall\x12$.rpc.InternalDialWhatsAppCallRequest\x1a!.livekit.DialWhatsAppCallResponse\"\b\xb2\x89\x01\x04\x10\x010\x01\x12k\n" +
	"\x12AcceptWhatsAppCall\x12&.rpc.InternalAcceptWhatsAppCallRequest\x1a#.livekit.AcceptWhatsAppCallResponse\"\b\xb2\x89\x01\x04\x10\x010\x012\x98\x02\n" +
