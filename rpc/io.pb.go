...
const file_rpc_io_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x8f\x10\n" +
	...
	"\rfeature_flags\x18\x17 \x03(\v27.rpc.EvaluateSIPDispatchRulesResponse.FeatureFlagsEntryR\ffeatureFlags\x12>\n" +
	"\rmedia_timeout\x18\x18 \x01(\v2\x19.google.protobuf.DurationR\fmediaTimeout\x1aH\n" +
...
var file_rpc_io_proto_depIdxs = []int32{
	...
	29, // 23: rpc.EvaluateSIPDispatchRulesResponse.media_timeout:type_name -> google.protobuf.Duration
	32, // 24: rpc.UpdateSIPCallStateRequest.call_info:type_name -> livekit.SIPCallInfo
	33, // 25: rpc.UpdateSIPCallStateRequest.transfer_info:type_name -> livekit.SIPTransferInfo
	32, // 26: rpc.RecordCallContextRequest.call_info:type_name -> livekit.SIPCallInfo
	34, // 27: rpc.SIPCall.address:type_name -> livekit.SIPUri
	34, // 28: rpc.SIPCall.from:type_name -> livekit.SIPUri
	34, // 29: rpc.SIPCall.to:type_name -> livekit.SIPUri
	34, // 30: rpc.SIPCall.via:type_name -> livekit.SIPUri
	23, // 31: rpc.IOInfo.CreateEgress:input_type -> livekit.EgressInfo
	23, // 32: rpc.IOInfo.UpdateEgress:input_type -> livekit.EgressInfo
	2,  // 33: rpc.IOInfo.GetEgress:input_type -> rpc.GetEgressRequest
	35, // 34: rpc.IOInfo.ListEgress:input_type -> livekit.ListEgressRequest
	3,  // 35: rpc.IOInfo.UpdateMetrics:input_type -> rpc.UpdateMetricsRequest
	24, // 36: rpc.IOInfo.CreateIngress:input_type -> livekit.IngressInfo
	...
	36, // 43: rpc.IOInfo.CreateEgress:output_type -> google.protobuf.Empty
	36, // 44: rpc.IOInfo.UpdateEgress:output_type -> google.protobuf.Empty
	23, // 45: rpc.IOInfo.GetEgress:output_type -> livekit.EgressInfo
	37, // 46: rpc.IOInfo.ListEgress:output_type -> livekit.ListEgressResponse
	36, // 47: rpc.IOInfo.UpdateMetrics:output_type -> google.protobuf.Empty
	36, // 48: rpc.IOInfo.CreateIngress:output_type -> google.protobuf.Empty
	5,  // 49: rpc.IOInfo.GetIngressInfo:output_type -> rpc.GetIngressInfoResponse
	36, // 50: rpc.IOInfo.UpdateIngressState:output_type -> google.protobuf.Empty
	...
	36, // 53: rpc.IOInfo.UpdateSIPCallState:output_type -> google.protobuf.Empty
	36, // 54: rpc.IOInfo.RecordCallContext:output_type -> google.protobuf.Empty
