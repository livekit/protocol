...
var file_rpc_io_proto_rawDesc = []byte{
	...
	0x08, 0x0a, 0x04, 0x44, 0x52, 0x4f, 0x50, 0x10, 0x04, 0x32, 0xb4, 0x05, 0x0a, 0x06, 0x49, 0x4f,
...
var file_rpc_io_proto_depIdxs = []int32{
	...
	3,  // 10: rpc.IOInfo.GetIngressInfo:input_type -> rpc.GetIngressInfoRequest
	5,  // 11: rpc.IOInfo.UpdateIngressState:input_type -> rpc.UpdateIngressStateRequest
	6,  // 12: rpc.IOInfo.GetSIPTrunkAuthentication:input_type -> rpc.GetSIPTrunkAuthenticationRequest
	8,  // 13: rpc.IOInfo.EvaluateSIPDispatchRules:input_type -> rpc.EvaluateSIPDispatchRulesRequest
	15, // 14: rpc.IOInfo.CreateEgress:output_type -> google.protobuf.Empty
	15, // 15: rpc.IOInfo.UpdateEgress:output_type -> google.protobuf.Empty
	11, // 16: rpc.IOInfo.GetEgress:output_type -> livekit.EgressInfo
	16, // 17: rpc.IOInfo.ListEgress:output_type -> livekit.ListEgressResponse
	15, // 18: rpc.IOInfo.UpdateMetrics:output_type -> google.protobuf.Empty
	4,  // 19: rpc.IOInfo.GetIngressInfo:output_type -> rpc.GetIngressInfoResponse
	15, // 20: rpc.IOInfo.UpdateIngressState:output_type -> google.protobuf.Empty
	7,  // 21: rpc.IOInfo.GetSIPTrunkAuthentication:output_type -> rpc.GetSIPTrunkAuthenticationResponse
	9,  // 22: rpc.IOInfo.EvaluateSIPDispatchRules:output_type -> rpc.EvaluateSIPDispatchRulesResponse
