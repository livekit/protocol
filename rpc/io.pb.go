...
func (x *EvaluateSIPDispatchRulesResponse) GetRingingTimeoutStatus() *livekit.SIPStatus {
	if x != nil {
...
const file_rpc_io_proto_rawDesc = "" +
	...
	"\x0fringing_timeout\x18\x10 \x01(\v2\x19.google.protobuf.DurationR\x0eringingTimeout\x12H\n" +
	"\x16ringing_timeout_status\x18\x19 \x01(\v2\x12.livekit.SIPStatusR\x14ringingTimeoutStatus\x12E\n" +
...
var file_rpc_io_proto_goTypes = []any{
	...
	(*livekit.SIPStatus)(nil),                 // 33: livekit.SIPStatus
...
var file_rpc_io_proto_depIdxs = []int32{
	...
	33, // 21: rpc.EvaluateSIPDispatchRulesResponse.ringing_timeout_status:type_name -> livekit.SIPStatus
