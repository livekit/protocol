...
func (x *CreateIngressResponse) GetInfo() *livekit.IngressInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
func (x *GetSIPTrunkAuthenticationResponse) GetObservability() *SIPCallObservability {
	if x != nil {
...
type EvaluateSIPDispatchRulesResponse struct {
	...
	RingingTimeoutStatus livekit.SIPStatusCode `protobuf:"varint,25,opt,name=ringing_timeout_status,json=ringingTimeoutStatus,proto3,enum=livekit.SIPStatusCode" json:"ringing_timeout_status,omitempty"`
	// Max call duration.
...
func (x *EvaluateSIPDispatchRulesResponse) GetRingingTimeoutStatus() livekit.SIPStatusCode {
	if x != nil {
		return x.RingingTimeoutStatus
	}
	return livekit.SIPStatusCode(0)
}
...
func (x *SIPCallObservability) Reset() {
	*x = SIPCallObservability{}
	mi := &file_rpc_io_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SIPCallObservability) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SIPCallObservability) ProtoMessage() {}

func (x *SIPCallObservability) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_io_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SIPCallObservability.ProtoReflect.Descriptor instead.
func (*SIPCallObservability) Descriptor() ([]byte, []int) {
	return file_rpc_io_proto_rawDescGZIP(), []int{10}
}

func (x *SIPCallObservability) GetDestination() string {
	if x != nil {
...
func (x *SIPCallObservability) GetLifetimeDays() uint32 {
	if x != nil {
...
func (x *SIPCallObservability) GetCarrierId() string {
	if x != nil {
		return x.CarrierId
	}
	return ""
...
func (x *SIPCallObservability) GetCountryCode() string {
	if x != nil {
...
func (x *SIPCallObservability) GetNumberType() livekit.PhoneNumberType {
	if x != nil {
		return x.NumberType
	}
	return livekit.PhoneNumberType(0)
}
...
func (x *RecordCallContextRequest) Reset() {
	*x = RecordCallContextRequest{}
	mi := &file_rpc_io_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecordCallContextRequest) Descriptor() ([]byte, []int) {
	return file_rpc_io_proto_rawDescGZIP(), []int{12}
}
...
type SIPCall struct {
	...
	Features      map[string]string      `protobuf:"bytes,9,rep,name=features,proto3" json:"features,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SIPCall) Reset() {
	*x = SIPCall{}
	mi := &file_rpc_io_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPCall) Descriptor() ([]byte, []int) {
	return file_rpc_io_proto_rawDescGZIP(), []int{13}
}
...
func (x *SIPCall) GetFeatures() map[string]string {
	if x != nil {
		return x.Features
	}
	return nil
...
const file_rpc_io_proto_rawDesc = "" +
	"\n" +
	"\frpc/io.proto\x12\x03rpc\x1a\x14livekit_egress.proto\x1a\x15livekit_ingress.proto\x1a\x11livekit_sip.proto\x1a\x1alivekit_phone_number.proto\x1a\x12livekit_room.proto\x1a\x14logger/options.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1egoogle/protobuf/duration.proto\"<\n" +
	...
	"\x05state\x18\x02 \x01(\v2\x15.livekit.IngressStateR\x05state\"\x83\x02\n" +
	...
	"srcAddress\x12 \n" +
	"\x04call\x18\b \x01(\v2\f.rpc.SIPCallR\x04call\"\x8d\x05\n" +
	...
	"\rfeature_flags\x18\b \x03(\v28.rpc.GetSIPTrunkAuthenticationResponse.FeatureFlagsEntryR\ffeatureFlags\x12?\n" +
	"\robservability\x18\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xd0\x10\n" +
	...
	"\x0fringing_timeout\x18\x10 \x01(\v2\x19.google.protobuf.DurationR\x0eringingTimeout\x12L\n" +
	"\x16ringing_timeout_status\x18\x19 \x01(\x0e2\x16.livekit.SIPStatusCodeR\x14ringingTimeoutStatus\x12E\n" +
	...
	"\fcountry_code\x18\x04 \x01(\tR\vcountryCode\x129\n" +
	...
	"\rUpdateMetrics\x12\x19.rpc.UpdateMetricsRequest\x1a\x16.google.protobuf.Empty\x12A\n" +
	"\rCreateIngress\x12\x14.livekit.IngressInfo\x1a\x1a.rpc.CreateIngressResponse\x12I\n" +
...
var file_rpc_io_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_rpc_io_proto_goTypes = []any{
	...
	(*CreateIngressResponse)(nil),             // 4: rpc.CreateIngressResponse
	(*GetIngressInfoRequest)(nil),             // 5: rpc.GetIngressInfoRequest
	(*GetIngressInfoResponse)(nil),            // 6: rpc.GetIngressInfoResponse
	(*UpdateIngressStateRequest)(nil),         // 7: rpc.UpdateIngressStateRequest
	(*GetSIPTrunkAuthenticationRequest)(nil),  // 8: rpc.GetSIPTrunkAuthenticationRequest
	(*GetSIPTrunkAuthenticationResponse)(nil), // 9: rpc.GetSIPTrunkAuthenticationResponse
	(*EvaluateSIPDispatchRulesRequest)(nil),   // 10: rpc.EvaluateSIPDispatchRulesRequest
	(*EvaluateSIPDispatchRulesResponse)(nil),  // 11: rpc.EvaluateSIPDispatchRulesResponse
	(*SIPCallObservability)(nil),              // 12: rpc.SIPCallObservability
	(*UpdateSIPCallStateRequest)(nil),         // 13: rpc.UpdateSIPCallStateRequest
	(*RecordCallContextRequest)(nil),          // 14: rpc.RecordCallContextRequest
	(*SIPCall)(nil),                           // 15: rpc.SIPCall
	nil,                                       // 16: rpc.GetIngressInfoResponse.LoggingFieldsEntry
	nil,                                       // 17: rpc.GetIngressInfoResponse.FeatureFlagsEntry
	nil,                                       // 18: rpc.GetSIPTrunkAuthenticationResponse.FeatureFlagsEntry
	nil,                                       // 19: rpc.EvaluateSIPDispatchRulesRequest.ExtraAttributesEntry
	nil,                                       // 20: rpc.EvaluateSIPDispatchRulesResponse.ParticipantAttributesEntry
	nil,                                       // 21: rpc.EvaluateSIPDispatchRulesResponse.HeadersEntry
	nil,                                       // 22: rpc.EvaluateSIPDispatchRulesResponse.HeadersToAttributesEntry
	nil,                                       // 23: rpc.EvaluateSIPDispatchRulesResponse.AttributesToHeadersEntry
	nil,                                       // 24: rpc.EvaluateSIPDispatchRulesResponse.FeatureFlagsEntry
	nil,                                       // 25: rpc.SIPCall.FeaturesEntry
	(*livekit.EgressInfo)(nil),                // 26: livekit.EgressInfo
	(*livekit.IngressInfo)(nil),               // 27: livekit.IngressInfo
	(*livekit.IngressState)(nil),              // 28: livekit.IngressState
	(*livekit.ProviderInfo)(nil),              // 29: livekit.ProviderInfo
	(livekit.SIPHeaderOptions)(0),             // 30: livekit.SIPHeaderOptions
	(livekit.SIPFeature)(0),                   // 31: livekit.SIPFeature
	(*durationpb.Duration)(nil),               // 32: google.protobuf.Duration
	(livekit.SIPStatusCode)(0),                // 33: livekit.SIPStatusCode
	(*livekit.RoomConfiguration)(nil),         // 34: livekit.RoomConfiguration
	(livekit.SIPMediaEncryption)(0),           // 35: livekit.SIPMediaEncryption
	(*livekit.SIPMediaConfig)(nil),            // 36: livekit.SIPMediaConfig
	(livekit.PhoneNumberType)(0),              // 37: livekit.PhoneNumberType
	(*livekit.SIPCallInfo)(nil),               // 38: livekit.SIPCallInfo
	(*livekit.SIPTransferInfo)(nil),           // 39: livekit.SIPTransferInfo
	(*livekit.SIPUri)(nil),                    // 40: livekit.SIPUri
	(*livekit.ListEgressRequest)(nil),         // 41: livekit.ListEgressRequest
	(*emptypb.Empty)(nil),                     // 42: google.protobuf.Empty
	(*livekit.ListEgressResponse)(nil),        // 43: livekit.ListEgressResponse
}
var file_rpc_io_proto_depIdxs = []int32{
	26, // 0: rpc.UpdateMetricsRequest.info:type_name -> livekit.EgressInfo
	27, // 1: rpc.CreateIngressResponse.info:type_name -> livekit.IngressInfo
	27, // 2: rpc.GetIngressInfoResponse.info:type_name -> livekit.IngressInfo
	16, // 3: rpc.GetIngressInfoResponse.logging_fields:type_name -> rpc.GetIngressInfoResponse.LoggingFieldsEntry
	17, // 4: rpc.GetIngressInfoResponse.feature_flags:type_name -> rpc.GetIngressInfoResponse.FeatureFlagsEntry
	28, // 5: rpc.UpdateIngressStateRequest.state:type_name -> livekit.IngressState
	15, // 6: rpc.GetSIPTrunkAuthenticationRequest.call:type_name -> rpc.SIPCall
	29, // 7: rpc.GetSIPTrunkAuthenticationResponse.provider_info:type_name -> livekit.ProviderInfo
	1,  // 8: rpc.GetSIPTrunkAuthenticationResponse.error_code:type_name -> rpc.SIPTrunkAuthenticationError
	18, // 9: rpc.GetSIPTrunkAuthenticationResponse.feature_flags:type_name -> rpc.GetSIPTrunkAuthenticationResponse.FeatureFlagsEntry
	12, // 10: rpc.GetSIPTrunkAuthenticationResponse.observability:type_name -> rpc.SIPCallObservability
	19, // 11: rpc.EvaluateSIPDispatchRulesRequest.extra_attributes:type_name -> rpc.EvaluateSIPDispatchRulesRequest.ExtraAttributesEntry
	15, // 12: rpc.EvaluateSIPDispatchRulesRequest.call:type_name -> rpc.SIPCall
	20, // 13: rpc.EvaluateSIPDispatchRulesResponse.participant_attributes:type_name -> rpc.EvaluateSIPDispatchRulesResponse.ParticipantAttributesEntry
	0,  // 14: rpc.EvaluateSIPDispatchRulesResponse.result:type_name -> rpc.SIPDispatchResult
	21, // 15: rpc.EvaluateSIPDispatchRulesResponse.headers:type_name -> rpc.EvaluateSIPDispatchRulesResponse.HeadersEntry
	22, // 16: rpc.EvaluateSIPDispatchRulesResponse.headers_to_attributes:type_name -> rpc.EvaluateSIPDispatchRulesResponse.HeadersToAttributesEntry
	23, // 17: rpc.EvaluateSIPDispatchRulesResponse.attributes_to_headers:type_name -> rpc.EvaluateSIPDispatchRulesResponse.AttributesToHeadersEntry
	30, // 18: rpc.EvaluateSIPDispatchRulesResponse.include_headers:type_name -> livekit.SIPHeaderOptions
	31, // 19: rpc.EvaluateSIPDispatchRulesResponse.enabled_features:type_name -> livekit.SIPFeature
	32, // 20: rpc.EvaluateSIPDispatchRulesResponse.ringing_timeout:type_name -> google.protobuf.Duration
	33, // 21: rpc.EvaluateSIPDispatchRulesResponse.ringing_timeout_status:type_name -> livekit.SIPStatusCode
	32, // 22: rpc.EvaluateSIPDispatchRulesResponse.max_call_duration:type_name -> google.protobuf.Duration
	34, // 23: rpc.EvaluateSIPDispatchRulesResponse.room_config:type_name -> livekit.RoomConfiguration
	35, // 24: rpc.EvaluateSIPDispatchRulesResponse.media_encryption:type_name -> livekit.SIPMediaEncryption
	36, // 25: rpc.EvaluateSIPDispatchRulesResponse.media:type_name -> livekit.SIPMediaConfig
	24, // 26: rpc.EvaluateSIPDispatchRulesResponse.feature_flags:type_name -> rpc.EvaluateSIPDispatchRulesResponse.FeatureFlagsEntry
	37, // 27: rpc.SIPCallObservability.number_type:type_name -> livekit.PhoneNumberType
	38, // 28: rpc.UpdateSIPCallStateRequest.call_info:type_name -> livekit.SIPCallInfo
	39, // 29: rpc.UpdateSIPCallStateRequest.transfer_info:type_name -> livekit.SIPTransferInfo
	38, // 30: rpc.RecordCallContextRequest.call_info:type_name -> livekit.SIPCallInfo
	40, // 31: rpc.SIPCall.address:type_name -> livekit.SIPUri
	40, // 32: rpc.SIPCall.from:type_name -> livekit.SIPUri
	40, // 33: rpc.SIPCall.to:type_name -> livekit.SIPUri
	40, // 34: rpc.SIPCall.via:type_name -> livekit.SIPUri
	25, // 35: rpc.SIPCall.features:type_name -> rpc.SIPCall.FeaturesEntry
	26, // 36: rpc.IOInfo.CreateEgress:input_type -> livekit.EgressInfo
	26, // 37: rpc.IOInfo.UpdateEgress:input_type -> livekit.EgressInfo
	2,  // 38: rpc.IOInfo.GetEgress:input_type -> rpc.GetEgressRequest
	41, // 39: rpc.IOInfo.ListEgress:input_type -> livekit.ListEgressRequest
	3,  // 40: rpc.IOInfo.UpdateMetrics:input_type -> rpc.UpdateMetricsRequest
	27, // 41: rpc.IOInfo.CreateIngress:input_type -> livekit.IngressInfo
	5,  // 42: rpc.IOInfo.GetIngressInfo:input_type -> rpc.GetIngressInfoRequest
	7,  // 43: rpc.IOInfo.UpdateIngressState:input_type -> rpc.UpdateIngressStateRequest
	8,  // 44: rpc.IOInfo.GetSIPTrunkAuthentication:input_type -> rpc.GetSIPTrunkAuthenticationRequest
	10, // 45: rpc.IOInfo.EvaluateSIPDispatchRules:input_type -> rpc.EvaluateSIPDispatchRulesRequest
	...
	42, // 52: rpc.IOInfo.CreateEgress:output_type -> google.protobuf.Empty
	42, // 53: rpc.IOInfo.UpdateEgress:output_type -> google.protobuf.Empty
	26, // 54: rpc.IOInfo.GetEgress:output_type -> livekit.EgressInfo
	43, // 55: rpc.IOInfo.ListEgress:output_type -> livekit.ListEgressResponse
	42, // 56: rpc.IOInfo.UpdateMetrics:output_type -> google.protobuf.Empty
	4,  // 57: rpc.IOInfo.CreateIngress:output_type -> rpc.CreateIngressResponse
	6,  // 58: rpc.IOInfo.GetIngressInfo:output_type -> rpc.GetIngressInfoResponse
	42, // 59: rpc.IOInfo.UpdateIngressState:output_type -> google.protobuf.Empty
	9,  // 60: rpc.IOInfo.GetSIPTrunkAuthentication:output_type -> rpc.GetSIPTrunkAuthenticationResponse
	11, // 61: rpc.IOInfo.EvaluateSIPDispatchRules:output_type -> rpc.EvaluateSIPDispatchRulesResponse
	42, // 62: rpc.IOInfo.UpdateSIPCallState:output_type -> google.protobuf.Empty
	42, // 63: rpc.IOInfo.RecordCallContext:output_type -> google.protobuf.Empty
	9,  // 64: rpc.IOInfoSIP.GetSIPTrunkAuthentication:output_type -> rpc.GetSIPTrunkAuthenticationResponse
	11, // 65: rpc.IOInfoSIP.EvaluateSIPDispatchRules:output_type -> rpc.EvaluateSIPDispatchRulesResponse
	42, // 66: rpc.IOInfoSIP.UpdateSIPCallState:output_type -> google.protobuf.Empty
	42, // 67: rpc.IOInfoSIP.RecordCallContext:output_type -> google.protobuf.Empty
