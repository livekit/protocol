...
func NewIOInfoClient(clientID string, bus psrpc.MessageBus, opts ...psrpc.ClientOption) (IOInfoClient, error) {
	...
	sd.RegisterMethod("UpdateEgressInfo", false, false, true, false)
	sd.RegisterMethod("GetIngressInfo", false, false, true, false)
	sd.RegisterMethod("UpdateIngressState", false, false, true, false)
