...
type InternalTransferSIPParticipantRequest struct {
	...
	PlayRingtone bool `protobuf:"varint,3,opt,name=play_ringtone,json=playRingtone,proto3" json:"play_ringtone,omitempty"`
}
...
func (x *InternalTransferSIPParticipantRequest) GetPlayRingtone() bool {
	if x != nil {
		return x.PlayRingtone
	}
	return false
...
var file_rpc_sip_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x0a, 0x0a, 0x23, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	...
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x42, 0x0a, 0x0f, 0x72, 0x69, 0x6e, 0x67,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x70, 0x6c, 0x61, 0x79, 0x52, 0x69, 0x6e, 0x67,
...
var file_rpc_sip_proto_depIdxs = []int32{
	...
	7, // 4: rpc.InternalCreateSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	7, // 5: rpc.InternalCreateSIPParticipantRequest.max_call_duration:type_name -> google.protobuf.Duration
	0, // 6: rpc.SIPInternal.CreateSIPParticipant:input_type -> rpc.InternalCreateSIPParticipantRequest
	2, // 7: rpc.SIPInternal.TransferSIPParticipant:input_type -> rpc.InternalTransferSIPParticipantRequest
	1, // 8: rpc.SIPInternal.CreateSIPParticipant:output_type -> rpc.InternalCreateSIPParticipantResponse
	8, // 9: rpc.SIPInternal.TransferSIPParticipant:output_type -> google.protobuf.Empty
