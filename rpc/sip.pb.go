...
const file_rpc_sip_proto_rawDesc = "" +
	"\n" +
	"\rrpc/sip.proto\x12\x03rpc\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\roptions.proto\x1a\x11livekit_sip.proto\x1a\x14logger/options.proto\"\xa6\x13\n" +
	...
	"\rmedia_timeout\x18\" \x01(\v2\x19.google.protobuf.DurationR\fmediaTimeout\x1aH\n" +
...
var file_rpc_sip_proto_depIdxs = []int32{
	...
	13, // 12: rpc.InternalCreateSIPParticipantRequest.media_timeout:type_name -> google.protobuf.Duration
	...
	16, // 19: rpc.SIPInternal.TransferSIPParticipant:output_type -> google.protobuf.Empty
